...
public class ConfigurationParamsConstants {
	...
	*/
	...
	//图片开单设置 by 352676
	public static final String PKP_FOSS_PIC_WAYBILL_PENDING_SET = "TPKDSZ";
	//图片分单锁 by 352676
	public static final String PKP_FOSS_PIC_WAYBILL_PENDING_LOCK = "TPKD_LOCK";
	// 中转模块使用
	 ...
	 * 晚到退差价优惠面值
	 */                                               
	public static final String LATE_RETURN_COUPON ="LATE_RETURN_COUPON";
	/**
...
/**
	...
	*/
	 ...
	 * 代收货款上限：整数
	 */
	public static final String PKP_COD_MAX_AMOUNT = "PKP_COD_MAX_AMOUNT";

	/**
	 * 代收货款下限：整数
	 */
	public static final String PKP_COD_MIN_AMOUNT = "PKP_COD_MIN_AMOUNT";
