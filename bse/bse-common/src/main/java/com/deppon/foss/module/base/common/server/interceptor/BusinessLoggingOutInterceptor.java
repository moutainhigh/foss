 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/common/server/interceptor/BusinessLoggingOutInterceptor.java
 * 
 * FILE NAME        	: BusinessLoggingOutInterceptor.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public class BusinessLoggingOutInterceptor extends AbstractSoapInterceptor {

	/**
	 * 日志
	 */
	private static final Logger LOGGER = LoggerFactory
			.getLogger(BusinessLoggingOutInterceptor.class);
	 ...
	 */
	public BusinessLoggingOutInterceptor() {
		// 拦截阶段
	...
	public void handleMessage(SoapMessage message) throws Fault {
		...
		try {
			...
			// 获取输出参数
			MessageContentsList outObjects = MessageContentsList
			...
			info.setAction(LogInfo.END_ACTION);	// 接口返回
			...
			// 输出返回
			info.setArgs(CacheUtils.toJsonString(outObjects, true));
