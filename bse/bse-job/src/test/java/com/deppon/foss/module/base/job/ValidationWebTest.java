 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/job/ValidationWebTest.java
 * 
 ...
 ******************************************************************************/
package com.deppon.foss.module.base.job;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/bse-job/";
	}
}
