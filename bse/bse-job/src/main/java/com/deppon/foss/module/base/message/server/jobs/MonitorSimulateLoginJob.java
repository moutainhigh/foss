 ...
 */
public class MonitorSimulateLoginJob extends GridJob implements StatefulJob {

	private static final Logger LOGGER = LoggerFactory.getLogger(MonitorSimulateLoginJob.class);
