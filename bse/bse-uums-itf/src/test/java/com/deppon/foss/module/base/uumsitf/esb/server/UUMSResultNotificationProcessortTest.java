 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/uumsitf/esb/server/UUMSResultNotificationProcessortTest.java
 * 
 * FILE NAME        	: UUMSResultNotificationProcessortTest.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version
 */
public class UUMSResultNotificationProcessortTest{

    private static final Logger logger = LoggerFactory.getLogger(UUMSResultNotificationProcessortTest.class);
    ...
    @Ignore
    @Test
    public void testUUMSResultNotificationProcessort() throws Exception {
