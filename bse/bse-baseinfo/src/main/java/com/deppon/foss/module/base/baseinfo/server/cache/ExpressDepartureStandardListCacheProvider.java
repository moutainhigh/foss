 ...
 * @version 1.0
 */
public class ExpressDepartureStandardListCacheProvider implements ITTLCacheProvider<List<ExpressDepartureStandardEntity>>{
     ...
     */
    public void setExpredepartureStandardDao(IExpressDepartureStandardDao expressdepartureStandardDao) {
        this.expressdepartureStandardDao = expressdepartureStandardDao;
    }

    @Override
    public List<ExpressDepartureStandardEntity> get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return expressdepartureStandardDao.queryDepartureStandardListByLineVirtualCode(key);
    }
}
