 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/FreightRouteEntityCacheProvider.java
 * 
 * FILE NAME        	: FreightRouteEntityCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class FreightRouteEntityCacheProvider implements ITTLCacheProvider<FreightRouteEntity>{

    private IFreightRouteDao freightRouteDao;
    
    /**
     * @param freightRouteDao the freightRouteDao to set
     */
    ...
    @Override
    public FreightRouteEntity get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	
	return freightRouteDao.queryFreightRouteByVirtualCode(key);
    }
