 ...
 * @version 1.0
 */
public class ExpressDepartureStandardListCache extends FossTTLCache<List<ExpressDepartureStandardEntity>>{

    @Override
    public String getUUID() {
	return EXPRESS_DEPARTURESTANDARD_LIST_CACHE_UUID;
    }
