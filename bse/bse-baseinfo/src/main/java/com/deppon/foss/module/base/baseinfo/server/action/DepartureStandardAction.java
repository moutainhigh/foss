...
import com.deppon.foss.module.base.baseinfo.api.shared.vo.DepartureStandardVo;
 ...
 * @version
 */
public class DepartureStandardAction extends AbstractAction {
    
    /**
     * 日志.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(DepartureStandardAction.class);
     ...
     * 发车标准Vo.
     */
    private DepartureStandardVo standardVo = new DepartureStandardVo(); 
     ...
     * @return the 发车标准Vo
     */
    public DepartureStandardVo getStandardVo() {
        return standardVo;
    }
     ...
     */
    public void setStandardVo(DepartureStandardVo standardVo) {
	...
	try {
	    ...
	    DepartureStandardEntity standardEntity = standardVo.getStartStandardEntity();
	    //设置创建人
	    ...
	    // 新增发车标准，返回新增的对象
	    DepartureStandardEntity startStandardEntity = departureStandardService
	...
	try {
	    ...
	    DepartureStandardEntity standardEntity = standardVo.getStartStandardEntity();
	    standardEntity.setModifyUser(userCode);
	    departureStandardService.deleteDepartureStandard(standardEntity);
	...
	try {
	    ...
	    //修改成功返回实体
	    standardEntity = departureStandardService.updateDepartureStandard(standardEntity);
	...
	if(StringUtil.isNotBlank(colonStr)){
	    ...
	    //添加冒号
	    return buffer.append(colonStr.substring(
	    		NumberConstants.STRING_LOCATION_0, NumberConstants.STRING_LOCATION_2)).append(":").append(colonStr.substring(NumberConstants.STRING_LOCATION_2, NumberConstants.STRING_LOCATION_4)).toString();
	}else {
	    return colonStr;
	}
    }
