 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/action/commonselector/CommonVehAgencyDeptAction.java
 * 
 * FILE NAME        	: CommonVehAgencyDeptAction.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-12-6 下午2:07:11
 */
public class CommonVehAgencyDeptAction extends AbstractAction implements
		IQueryAction {
	// search condition
	...
	// servie
	/** The common veh agency dept service. */
	private ICommonVehAgencyDeptService commonVehAgencyDeptService;
	
	/** serialVersionUID. */
	private static final long serialVersionUID = -3630503180415512929L;
	...
	@Override
	public String query() {
		outerBranchEntities = commonVehAgencyDeptService
				.queryAgencyDeptsByCondition(outerBranchEntity, limit, start);
		setTotalCount(commonVehAgencyDeptService
	 ...
	 * setter.
	 *
	 * @param commonVehAgencyDeptService the new common veh agency dept service
	 */
	public void setCommonVehAgencyDeptService(
			ICommonVehAgencyDeptService commonVehAgencyDeptService) {
		this.commonVehAgencyDeptService = commonVehAgencyDeptService;
	}
