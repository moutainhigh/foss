 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/MotorcadeServeDistrictDao.java
 * 
 * FILE NAME        	: MotorcadeServeDistrictDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-12-18 上午10:53:31
 */
public class MotorcadeServeDistrictDao extends SqlSessionDaoSupport implements IMotorcadeServeDistrictDao {
     ...
     * mybatis 命名空间
     */
    private static final String NAMESPACE = ComnConst.MYBATIS_NAMESPACE_BASEINFO_PREFIX + ".motorcadeServeDistrict.";

    /**
     * 新增
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午7:42:58
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeDistrictDao#addMotorcadeServeDistrict(com.deppon.foss.module.base.baseinfo.api.shared.domain.MotorcadeServeDistrictEntity)
     */
    @Override
    public MotorcadeServeDistrictEntity addMotorcadeServeDistrict(MotorcadeServeDistrictEntity entity) {
	// 请求合法性验证：
	if (null == entity) {
	    return entity;
	}
	...
	int result = getSqlSession().insert(NAMESPACE + "addMotorcadeServeDistrict", entity);
	...
	int result = getSqlSession().update(NAMESPACE + "deleteMotorcadeServeDistrict", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午7:42:58
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeDistrictDao#deleteMotorcadeServeDistrictMore(java.lang.String[], java.lang.String)
     */
    @Override
	...
	int result = getSqlSession().update(
		NAMESPACE + "deleteMotorcadeServeDistrictMore", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
	...
	// 更新要先删除旧的数据：
	MotorcadeServeDistrictEntity result = this.deleteMotorcadeServeDistrict(entity);
	if (result == null) {
	...
	entity.setActive(FossConstants.ACTIVE);
	int resultNum = getSqlSession().insert(NAMESPACE + "addMotorcadeServeDistrict", entity);
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午7:42:58
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeDistrictDao#queryMotorcadeServeDistrictByCode(java.lang.String)
     */
	...
	List<MotorcadeServeDistrictEntity> entitys= this.getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeDistrictByVirtualCode", entity);
	return CollectionUtils.isEmpty(entitys) ? null : entitys.get(0);
    }
    /**
     * 
     *<p>通过motorcadeCode和districtCode 进行精确查询</p>
     *@author 130566-zengJunfan
     *@date   2013-8-17下午1:55:01
     * @param motorcadeCode
     * @param districtCode
     * @return
     */
    @SuppressWarnings("unchecked")
	@Override
    public MotorcadeServeDistrictEntity queryMotorcadeServeDistrictByMotorCodeAndDistrictCode(
   			String motorcadeCode, String districtCode) {
   		if(StringUtils.isBlank(motorcadeCode)&&StringUtils.isBlank(districtCode)){
   			return null;
   		}
   		//构造查询条件
   		MotorcadeServeDistrictEntity entity=new MotorcadeServeDistrictEntity();
   		...
   		List<MotorcadeServeDistrictEntity> entitys  =this.getSqlSession().selectList(NAMESPACE+"queryMotorcadeServeDistrictByMotorCodeAndDistrictCode", entity);
   		return CollectionUtils.isEmpty(entitys)?null:entitys.get(0);
   	}
    /**
     * 精确查询
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeDistrictDao#queryMotorcadeServeDistrictBatchBy(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeDistrictEntity> queryMotorcadeServeDistrictBatchByVirtualCode(String[] codes) {
	// 请求参数合法性判断
	if (ArrayUtils.isEmpty(codes)){
	    return null;
	}
	...
	return getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeDistrictBatchByVirtualCode", map);
    }
	...
	MotorcadeServeDistrictEntity queryEntity = entity == null ? new MotorcadeServeDistrictEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeDistrictExactByEntity", queryEntity, rowBounds);
    }
	...
	MotorcadeServeDistrictEntity queryEntity = entity == null ? new MotorcadeServeDistrictEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "queryMotorcadeServeDistrictExactByEntityCount", queryEntity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午7:42:58
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeDistrictDao#queryMotorcadeServeDistrictMore(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeDistrictEntity> queryMotorcadeServeDistrictByEntity(MotorcadeServeDistrictEntity entity, int start, int limit) {
	MotorcadeServeDistrictEntity queryEntity = entity == null ? new MotorcadeServeDistrictEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeDistrictByEntity", queryEntity, rowBounds);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午7:42:58
     * @see com.deppon.foss.module.base.baseinfo.server.dao.IMotorcadeServeDistrictDao#queryMotorcadeServeDistrictByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.MotorcadeServeDistrictEntity)
     */
    @Override
    public long queryMotorcadeServeDistrictByEntityCount(MotorcadeServeDistrictEntity entity) {
	MotorcadeServeDistrictEntity queryEntity = entity == null ? new MotorcadeServeDistrictEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "queryMotorcadeServeDistrictByEntityCount", queryEntity);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeDistrictEntity> queryMotorcadeServeDistrictForDownload(MotorcadeServeDistrictEntity entity){
	MotorcadeServeDistrictEntity queryEntity = entity == null ? new MotorcadeServeDistrictEntity() : entity;
	return (List<MotorcadeServeDistrictEntity>) getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeDistrictForDownload", queryEntity);
    }
	...
	// 只删除active为有效的：
	map.put("conditionActive", FossConstants.ACTIVE);
	int result = getSqlSession().update(NAMESPACE + "deleteMotorcadeServeDistrictByMotorcadeCode", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
