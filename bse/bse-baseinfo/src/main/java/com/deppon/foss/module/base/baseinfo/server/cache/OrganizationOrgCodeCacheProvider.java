 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/OrganizationOrgCodeCacheProvider.java
 * 
 * FILE NAME        	: OrganizationOrgCodeCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
public class OrganizationOrgCodeCacheProvider implements ITTLCacheProvider<OrgAdministrativeInfoEntity> {
	...
	return orgAdministrativeInfoDao.queryOrgAdministrativeInfoByCode(key);
    }
