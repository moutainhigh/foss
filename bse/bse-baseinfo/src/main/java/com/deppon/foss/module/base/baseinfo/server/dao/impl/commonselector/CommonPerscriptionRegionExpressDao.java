 ...
 */
public class CommonPerscriptionRegionExpressDao extends  SqlSessionDaoSupport implements
		ICommonPerscriptionRegionExpressDao {
	// 时效区域
	/** The Constant PRESCRIPTION_REGION_NAMESPACE. */
	private static final String PRESCRIPTION_REGION_NAMESPACE = "foss.bse.bse-baseinfo.commonPerscriptionRegionExpress.";
	// 根据条件查询区域
