 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/service/impl/PorterService.java
 * 
 * FILE NAME        	: PorterService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
public class PorterService implements IPorterService {
    ...
    /**
     * 
     * @date Mar 13, 2013 10:10:50 AM
     * @param porterDao
     * @see
     */
    public void setPorterDao(IPorterDao porterDao) {
	this.porterDao = porterDao;
    }
     ...
     * @date 2012-10-30 上午13:48:32
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.IPorterService#addPorter(com.deppon.foss.module.base.baseinfo.api.shared.domain.PorterEntity)
     */
    @Override
	...
	return porterDao.addPorter(entity);
    }
	...
	return porterDao.deletePorter(entity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-10-30 上午13:48:32
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IPorterDao#deletePorterMore(java.lang.String[])
     */
    @Override
    public PorterEntity deletePorterMore(String[] codes ,LoadAndUnloadSquadEntity loadAndUnloadSquadEntity, String deleteUser) {
	return porterDao.deletePorterMore(codes,loadAndUnloadSquadEntity, deleteUser);
    }
	...
	return porterDao.updatePorter(entity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-10-30 上午13:48:32
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IPorterService#queryPorterByCode(java.lang.String)
     */
    @Override
	...
	return (PorterEntity)  porterDao.queryPorterByEmpCode(code);
    }
     ...
     */
    @Override
    public List<PorterEntity> queryPorterBatchByEmpCode(String[] codes) {
	// 检查参数
	if (org.apache.commons.lang.ArrayUtils.isEmpty(codes)){
	    return null;
	}
	return porterDao.queryPorterBatchByEmpCode(codes);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IPorterService#queryPorterExactByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.PorterEntity, int, int)
     */
    @Override
    public List<PorterEntity> queryPorterExactByEntity(PorterEntity entity, int limit, int start) {
	// 检查参数
	if (null == entity) {
	    entity = new PorterEntity();
	}
	return porterDao.queryPorterExactByEntity(entity, limit, start);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IPorterService#queryPorterExactByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.PorterEntity)
     */
    @Override
	...
	return porterDao.queryPorterExactByEntityCount(entity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-10-30 上午13:48:32
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IPorterService#deletePorterMore(java.lang.String[])
     */
    @Override
    public List<PorterEntity> queryPorterByEntity(PorterEntity entity, int limit, int start) {
	// 检查参数
	if (null == entity) {
	    entity = new PorterEntity();
	}
	return porterDao.queryPorterByEntity(entity, limit, start);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-10-30 上午13:48:32
     * @see com.deppon.foss.module.baseinfo.server.service.IPorterService#queryPorterCountByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.district.shared.domain.PorterEntity)
     */
    @Override
	...
	return (Long) porterDao.queryPorterByEntityCount(entity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-10-18 下午4:1:47
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.IPorterService#queryPorterBatchByParentOrgCode(java.lang.String[])
     */
    @Override
	...
	return porterDao.queryPorterBatchByParentOrgCode(codes);
    }
