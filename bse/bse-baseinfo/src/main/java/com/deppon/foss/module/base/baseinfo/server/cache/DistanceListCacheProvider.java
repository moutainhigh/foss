 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/DistanceListCacheProvider.java
 * 
 * FILE NAME        	: DistanceListCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 月台库位距离cache provider类
 * @author foss-zhujunyong
 * @date Dec 17, 2012 10:46:45 AM
 * @version 1.0
 */
public class DistanceListCacheProvider implements ITTLCacheProvider<List<DistanceEntity>>{
    ...
    @Override
    public List<DistanceEntity> get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return distanceDao.queryDistanceByPlatform(key);
    }
}
