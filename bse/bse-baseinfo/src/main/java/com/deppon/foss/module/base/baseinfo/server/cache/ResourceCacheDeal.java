 ...
 * 
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/ResourceCacheDeal.java
 * 
 * 
 * FILE NAME        	: ResourceCacheDeal.java
 * 
 * 
 * 
 ...
 * 
 ******************************************* 
 * <b style="font-family:微软雅黑"><small>Description:功能权限缓存</small></b> </br> <b
 ...
 ******************************************** 
 */
public class ResourceCacheDeal {
	@SuppressWarnings({ "unchecked", "unused" })
	private ICache<String, List<ResourceEntity>> resouceCache = CacheManager.getInstance().getCache(FossTTLCache.MENU_CACHE_UUID);
}