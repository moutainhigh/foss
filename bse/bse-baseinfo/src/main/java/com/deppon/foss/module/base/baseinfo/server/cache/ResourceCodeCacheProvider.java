 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/ResourceCodeCacheProvider.java
 * 
 * FILE NAME        	: ResourceCodeCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
public class ResourceCodeCacheProvider implements ITTLCacheProvider<ResourceEntity>{
	...
	public ResourceEntity get(String key) {
		return resourceDao.getResourceByCode(key);
	}
}
