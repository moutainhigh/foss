 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/util/LineUtils.java
 * 
 * FILE NAME        	: LineUtils.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
public class LineUtils {
    ...
    /**
     * 
     * <p>根据产品类型判断到达部门是否德邦自有网点</p> 
     * 
     * @author foss-zhujunyong
     * @date Feb 28, 2013 4:46:48 PM
     * @param productCode
     * @return
     * @see
     */
    public static boolean isDPOrganizationByProduct(String productCode) {
	if (StringUtils.isBlank(productCode)) {
	    return false;
	}
	return !(StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_PARTIAL_LINE, productCode) || 
	StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_AIR_FREIGHT, productCode));
	
//	return StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_LONG_DISTANCE_FAST_FREIGHT, productCode)
...
//		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_SHORT_DISTANCE_ROAD_FREIGHT, productCode);
    ...
    /**
     * 把三级产品类型转换成中转到中转线路的运输类型(专线，偏线，空运)
     * 精准卡航
     * 精准城运
     * 精准汽运（长途）
     * 精准汽运（短途）	转成 专线
     ...
     * 
     * <p>判断是否短途产品类型</p>
     * 如果是短途的，则有可能是无中转线路组成走货路径，例如：营业部-外场-营业部 
     * 
     * 2013-5-28
     * 因需求变更，此方法不再使用
     * 
     * @author foss-zhujunyong
     * @date Jan 8, 2013 11:04:37 AM
     * @param productCode
     * @return
     * @see
     */
    /*@SuppressWarnings("unused")
    private static boolean isCityWideProduct(String productCode) {
	return StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.PRICING_PRODUCT_SHORT_DISTANCE_FAST_FREIGHT) 
		|| StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.PRICING_PRODUCT_SHORT_DISTANCE_ROAD_FREIGHT);
    }*/
     ...
     * 
     * @author foss-zhuwei
     * @date Oct 8, 2013 3:49:58 PM
     * @param productCode
     * @return
     * @see
     */
    public static boolean isExpressProduct(String productCode) {
	return StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.PRICING_PRODUCT_EXPRESS_PACKAGE);
    }
     ...
     * 
     * @author foss-WeiXing
     * @date Aug 11, 2014 4:17:58 PM
     * @param productCode
     * @return
     * @see
     */
    public static boolean isRcpProduct(String productCode) {
	return StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.PRICING_PRODUCT_ROUND_COUPON_PACKAGE);
    }
    /**
     * 
     * <p>判断是否3.60特惠件或者 快递产品</p> 
     * 
     * @author foss-zengJuanfan
     * @param productCode
     * @return
     * @see
     */
	public static boolean isExpOrRcpProduct(String productCode) {
		return (StringUtils.equals(productCode,PricingConstants.ProductEntityConstants.PRICING_PRODUCT_EXPRESS_PACKAGE) || 
						StringUtils.equals(productCode,PricingConstants.ProductEntityConstants.PRICING_PRODUCT_ROUND_COUPON_PACKAGE)||
						StringUtils.equals(productCode,PricingConstants.ProductEntityConstants.ECOMMERCE_PROMOTIONAL_ENJOY_PACKAGE)||
						StringUtils.equals(productCode,PricingConstants.ProductEntityConstants.PRICING_PRODUCT_EXPRESS_AIR_FREIGHT)
						);
	}
	 ...
	 * @return
	 */
	public static boolean isEpepProduct(String productCode) {
		return StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.ECOMMERCE_PROMOTIONAL_ENJOY_PACKAGE);
        }
	
    /**
     * 
     * <p>判断是否空运产品</p> 
     * 空运产品中： “营业部-空运总调-机场自提”   的情况无走货路径，所以需要特殊判断
     * 
     * @author foss-zhujunyong
     * @date Jan 28, 2013 3:49:58 PM
     * @param productCode
     * @return
     * @see
     */
    public static boolean isAirProduct(String productCode) {
	return StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.PRICING_PRODUCT_AIR_FREIGHT);
    }
     ...
     * <p>判断是否偏线产品</p> 
     * @author foss-zhujunyong
     * @date Mar 28, 2013 3:42:39 PM
     * @param productCode
     * @return
     * @see
     */
    public static boolean isPXProduct(String productCode) {
	return StringUtils.equals(productCode, PricingConstants.ProductEntityConstants.PRICING_PRODUCT_PARTIAL_LINE);
    }
	...
	if (StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_LONG_DISTANCE_FAST_FREIGHT, productCode)
		...
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_FULL_VEHICLE, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_EXPRESS_PACKAGE, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_ROUND_COUPON_PACKAGE, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_LONG_DISTANCE_FAST_FREIGHT_BG, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_SHORT_DISTANCE_FAST_FREIGHT_BG, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_LONG_DISTANCE_ROAD_FREIGHT_BG, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_SHORT_DISTANCE_ROAD_FREIGHT_BG, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_DOOR_TO_DOOR, productCode)
		|| StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_YARD_TO_YARD, productCode)
		||StringUtils.equals(PricingConstants.ProductEntityConstants.ECOMMERCE_PROMOTIONAL_ENJOY_PACKAGE, productCode)
		||StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_EXPRESS_AIR_FREIGHT, productCode)
		||StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_PCP, productCode)// 308865 2016-07-29新增精准包裹
		) {
	    return DictionaryValueConstants.BSE_LINE_TRANSTYPE_QIYUN;
	}

        return StringUtils.equals(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_AIR_FREIGHT, productCode) ?
                DictionaryValueConstants.BSE_LINE_TRANSTYPE_KONGYUN : null;
    }
     ...
     * 
     * @author foss-zhujunyong
     * @date Mar 13, 2013 9:54:11 AM
     * @param priority
     * @return
     * @see
     */
    public static boolean isFast(String priority) {
	return StringUtils.equals(priority, DictionaryValueConstants.PRODUCT_FAST);
    }
     ...
     * 
     * @author foss-zhujunyong
     * @date Mar 13, 2013 9:54:23 AM
     * @param priority
     * @return
     * @see
     */
    public static boolean isCommon(String priority) {
	return StringUtils.equals(priority, DictionaryValueConstants.PRODUCT_NORMAL);
    }
    
    
    /**
     * 
     * <p>把day的年月日拼上time的小时分钟，再加上t的日期，返回一个整合的Date类型</p> 
     * 
     * @author foss-zhujunyong
     * @date Nov 10, 2012 9:07:55 AM
     * @param day 包含年月日信息
     * @param time 包含时分信息
     * @param t 包含T+n信息
     * @return 整合过的Date类型
    ...
    /**
     * 
     * <p>构造符合发车标准中字符串格式的时间</p>
     *  
     * @author foss-zhujunyong
     * @date Nov 10, 2012 3:30:21 PM
     * @param inputTime
     * @param standardTime
     * @param offset 分钟
     * @return
     * @see
     */
    public static Date createStandardTime(Date inputTime, String standardTime, int offset){
	SimpleDateFormat sdf = new SimpleDateFormat("HHmm");
	Date standardDate = null;
	try {
	    standardDate = sdf.parse(standardTime);
	} catch (ParseException e) {
	    return null;
	}
	...
	standardCal.set(inputCal.get(Calendar.YEAR), inputCal.get(Calendar.MONTH), inputCal.get(Calendar.DATE));
	
	standardCal.add(Calendar.MINUTE, offset);
	return standardCal.getTime();
    }

    /**
     * 
     * <p>使用date的年月日和time的时分构造成一个新的Date对象</p> 
     * 
     * @author foss-zhujunyong
     * @date Nov 15, 2012 9:35:38 AM
     * @param date 只取年月日
     * @param time 只取时分
     * @return 拼装的Date对象
     * @see
     */
    public static Date createStandardTime(Date date, String time) {
	return createStandardTime(date, time, 0);
    }
    
    
    /**
     * 
     * <p>计算考虑时效后的发车时间，到达时间，一般用于半截线路</p> 
     * 
     * @author foss-zhujunyong
     * @date Nov 10, 2012 10:33:41 AM
     * @param time 时间字符串，小时和分钟（eg:0200表示02:00）
     * @param agingMinute 分钟
     * @return
     * @see
     */
    public static AgingDto calculatePartLineStandard(String time, int agingMinute) {
	if (time == null || BooleanUtils.isFalse(time.matches(REGULAR_TIME))) {
	    return null;
	}
	AgingDto result = new AgingDto();
	Calendar now = Calendar.getInstance();
	String d1 = new SimpleDateFormat(DateUtils.DATE_FORMAT).format(now.getTime());
	Date tmp = null;
	SimpleDateFormat sdf = new SimpleDateFormat("HHmm");
	try {
	    tmp = sdf.parse(time);
	...
	//313353 2016/11/25 start
	Calendar instance = Calendar.getInstance();
	instance.setTime(tmp);
	now.set(Calendar.HOUR_OF_DAY, instance.get(Calendar.HOUR_OF_DAY));
	now.set(Calendar.MINUTE, instance.get(Calendar.MINUTE));
//	now.set(Calendar.HOUR_OF_DAY, org.apache.commons.lang.time.DateUtils.toCalendar(tmp).get(Calendar.HOUR_OF_DAY));
//	now.set(Calendar.MINUTE, org.apache.commons.lang.time.DateUtils.toCalendar(tmp).get(Calendar.MINUTE));
	//313353 2016/11/25 end
	now.add(Calendar.MINUTE, agingMinute);
	String d2 = new SimpleDateFormat(DateUtils.DATE_FORMAT).format(now.getTime());
	int offset = DateUtils.getTimeDiff(d1, d2).intValue();
	
	result.setDay(offset);
	result.setTime(sdf.format(now.getTime()));
	return result;
    }
     ...
     * 
     * @author foss-zhujunyong
     * @date Mar 13, 2013 9:54:54 AM
     * @param aging
     * @return
     * @see
     */
    public static int convertHourToMinute(Long aging){
	if (aging == null) {
	    return 0;
	}
	double hour = (double) aging / ComnConst.NUMBER1000;
	double minute = hour * NumberConstants.NUMBER_60;
    ...
    /**
     * 
     * <p>通过发车标准和某一出发部门，到达部门的时效 计算半截线路的出发时间，到达时间等</p> 
     * 
     * @author foss-zhujunyong
     * @date Mar 13, 2013 9:55:06 AM
     * @param departureStandard
     * @param agingDto
     * @return
     * @see
     */
    public static DepartureStandardDto calculateDepartureStandardBySourceTarget(
	    DepartureStandardEntity departureStandard,
	    FreightRouteLineAgingDto agingDto) {
	DepartureStandardDto result = new DepartureStandardDto();
	result.setLineVirtualCode(agingDto.getLineVirtualCode());
	result.setSourceCode(agingDto.getSourceCode());
	result.setTargetCode(agingDto.getTargetCode());
	result.setDepartureStandardVirtualCode(departureStandard.getVirtualCode());
	result.setProductType(departureStandard.getProductType());
	result.setOrder(departureStandard.getOrder());
	
	// 如果是始发或者到达线路
	if(!StringUtils.equals(agingDto.getLineSort(),DictionaryValueConstants.BSE_LINE_SORT_TRANSFER)){
	    result.setLeaveTime(departureStandard.getLeaveTime());
	    result.setArriveTime(departureStandard.getArriveTime());
	    int day = departureStandard.getArriveDay() == null ? 0 : departureStandard.getArriveDay().intValue();
	    result.setArriveDay(day);
	    // 如果是中转线路（专线，偏线或空运）
	} else {
	    // 此处根据发车标准的发车类型（普车/卡车）取得普车时效或卡车时效
	    long leaveOffset = LineUtils.isFast(departureStandard.getProductType()) ? agingDto.getBeforeFastAging(): agingDto.getBeforeCommonAging();
	    AgingDto leaveDto = LineUtils.calculatePartLineStandard(departureStandard.getLeaveTime(), LineUtils.convertHourToMinute(leaveOffset));
	    result.setLeaveTime(leaveDto.getTime());
	    long arriveOffset = LineUtils.isFast(departureStandard.getProductType()) ? agingDto.getCurrentFastAging(): agingDto.getCurrentCommonAging();
	    AgingDto arriveDto = LineUtils.calculatePartLineStandard(leaveDto.getTime(), LineUtils.convertHourToMinute(arriveOffset));
	    result.setArriveTime(arriveDto.getTime());
	    result.setArriveDay(arriveDto.getDay());
	}
	return result;
    }
    ...
    /**
     * 
     * <p>组建一个零担DepartureStandardDto</p> 
     * 
     * @author foss-zhujunyong
     * @date Mar 13, 2013 9:55:26 AM
     * @param line
     * @param standard
     * @return
     * @see
     */
    public static DepartureStandardDto createDepartureStandardDto(LineEntity line, DepartureStandardEntity standard) {
	if (line == null) {
	    return null;
	}
	DepartureStandardDto result = new DepartureStandardDto();
	// 如果是加班车的话（班次找不到），则只返回线路相关信息
	if (standard != null) {
	    ...
	    result.setOrder(standard.getOrder());
	...
	if (StringUtils.equals(line.getLineSort(), DictionaryValueConstants.BSE_LINE_SORT_TRANSFER)) {
	    result.setCommonAging(line.getCommonAging());
	    // 如果是始发或到达线路，且有班次的情况下,根据到达时间减去出发时间，得到普车时效
	} else if (standard != null) {
	    SimpleDateFormat sdf = new SimpleDateFormat("HHmm");
	    Date start = null;
	    try {
		start = sdf.parse(standard.getLeaveTime());
	    } catch (ParseException e) {
		start = new Date();
	    }
	    Date end = null;
	    try {
		end = sdf.parse(standard.getArriveTime());
		end = org.apache.commons.lang.time.DateUtils.addDays(end, standard.getArriveDay() == null ? 0 : standard.getArriveDay().intValue());
	    } catch (ParseException e) {
		end = new Date();
	    }
	    result.setCommonAging(getTimeDiff(start, end) / (NumberConstants.NUMBER_60*NumberConstants.NUMBER_60));
	}
	return result;
    }
    ...
    /**
     * 
     * <p>组建一个快递DepartureStandardDto</p> 
     * 
     ...
     * @see
     */
    public static DepartureStandardDto createExpressDepartureStandardDto(ExpressLineEntity line, ExpressDepartureStandardEntity standard) {
	if (line == null) {
	    return null;
	}
	DepartureStandardDto result = new DepartureStandardDto();
