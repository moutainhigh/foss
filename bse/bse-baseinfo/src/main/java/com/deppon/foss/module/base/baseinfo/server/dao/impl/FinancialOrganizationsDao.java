 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/FinancialOrganizationsDao.java
 * 
 * FILE NAME        	: FinancialOrganizationsDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-12-18 上午9:55:46
 */
public class FinancialOrganizationsDao extends SqlSessionDaoSupport implements IFinancialOrganizationsDao {
     ...
     * mybatis 命名空间
     */
    private static final String NAMESPACE = ComnConst.MYBATIS_NAMESPACE_BASEINFO_PREFIX + ".financialOrganizations.";

    /**
     * 新增
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-2 上午13:25:24
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#addFinancialOrganizations(com.deppon.foss.module.base.baseinfo.api.shared.domain.FinancialOrganizationsEntity)
     */
    @Override
    @Transactional
    public FinancialOrganizationsEntity addFinancialOrganizations(FinancialOrganizationsEntity entity) {
	// 请求合法性验证：
	if (null == entity) {
	    return entity;
	}
	...
	int result = getSqlSession().insert(NAMESPACE + "addFinancialOrganizations", entity);
    ...
    @Override
    @Transactional
    public FinancialOrganizationsEntity deleteFinancialOrganizations(FinancialOrganizationsEntity entity) {
	// 请求参数合法性验证
	...
	int result = getSqlSession().update(NAMESPACE + "deleteFinancialOrganizations", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 上午13:25:24
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#deleteFinancialOrganizationsMore(java.lang.String[], java.lang.String)
     */
    @Override
    @Transactional
    public FinancialOrganizationsEntity deleteFinancialOrganizationsMore(String[] codes , String deleteUser) {
	// 请求合法性判断：
	...
	int result = getSqlSession().update(NAMESPACE + "deleteFinancialOrganizationsMore", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
    ...
    @Override
    @Transactional
    public FinancialOrganizationsEntity updateFinancialOrganizations(FinancialOrganizationsEntity entity) {
	// 请求合法性判断：
	if (null == entity || StringUtils.isBlank(entity.getCode())) {
	    return entity;
	}
	// 更新要先删除旧的数据：
	FinancialOrganizationsEntity result = this.deleteFinancialOrganizations(entity);
	if (result == null) {
	...
	entity.setActive(FossConstants.ACTIVE);
	int resultNum = getSqlSession().insert(NAMESPACE + "addFinancialOrganizations", entity);
    ...
    @Override
    public FinancialOrganizationsEntity queryFinancialOrganizationsByCode(String code) {
	// 检查参数
	...
	List<FinancialOrganizationsEntity> entitys = this.getSqlSession().selectList(NAMESPACE + "queryFinancialOrganizationsByCode", entity);
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#queryFinancialOrganizationsBatchBy(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<FinancialOrganizationsEntity> queryFinancialOrganizationsBatchByCode(String[] codes) {
	// 请求参数合法性判断
	...
	return getSqlSession().selectList(NAMESPACE + "queryFinancialOrganizationsBatchByCode", map);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#queryFinancialOrganizationsExactByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.FinancialOrganizationsEntity, int, int)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<FinancialOrganizationsEntity> queryFinancialOrganizationsExactByEntity(FinancialOrganizationsEntity entity, int start, int limit) {
	FinancialOrganizationsEntity queryEntity = entity == null ? new FinancialOrganizationsEntity() : entity ;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryFinancialOrganizationsExactByEntity", queryEntity, rowBounds);
    }

    /**
     * 精确查询-查询总条数，用于分页
     * 动态的查询条件。 如果传入的对象为空，传入一个对象，可查���所有的数据，如果传入的对象的属性不为空或者空白，则设置为查询条件
     * 
     * @author 087584-foss-lijun
     * @date 2012-10-19 上午11:09:53
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#queryFinancialOrganizationsExactByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.FinancialOrganizationsEntity)
     */
    @Override
    public long queryFinancialOrganizationsExactByEntityCount(FinancialOrganizationsEntity entity) {
	FinancialOrganizationsEntity queryEntity = entity == null ? new FinancialOrganizationsEntity() : entity ;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "queryFinancialOrganizationsExactByEntityCount", queryEntity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 上午13:25:24
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#queryFinancialOrganizationsMore(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<FinancialOrganizationsEntity> queryFinancialOrganizationsByEntity(FinancialOrganizationsEntity entity, int start, int limit) {
	FinancialOrganizationsEntity queryEntity = entity == null ? new FinancialOrganizationsEntity() : entity ;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryFinancialOrganizationsByEntity", queryEntity, rowBounds);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 上午13:25:24
     * @see com.deppon.foss.module.base.baseinfo.server.dao.IFinancialOrganizationsDao#queryFinancialOrganizationsByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.FinancialOrganizationsEntity)
     */
    @Override
    public long queryFinancialOrganizationsByEntityCount(FinancialOrganizationsEntity entity) {
	FinancialOrganizationsEntity queryEntity = entity == null ? new FinancialOrganizationsEntity() : entity ;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "queryFinancialOrganizationsByEntityCount", queryEntity);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<FinancialOrganizationsEntity> queryFinancialOrganizationsForDownload(FinancialOrganizationsEntity entity) {
	FinancialOrganizationsEntity queryEntity = entity == null ? new FinancialOrganizationsEntity() : entity ;
	return (List<FinancialOrganizationsEntity>) getSqlSession().selectList(NAMESPACE + "queryFinancialOrganizationsForDownload", queryEntity);
    }
     ...
     * 
     * @author 087584-foss-lijun
     * @date 2012-10-22 下午3:20:9
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IFinancialOrganizationsDao#queryFinancialOrganizationsUpByName(java.lang.String)
     */
    @SuppressWarnings("unchecked")
    @Override
	...
	FinancialOrganizationsEntity entity = new FinancialOrganizationsEntity();
	entity.setActive(FossConstants.ACTIVE);
	return (List<FinancialOrganizationsEntity>) this.getSqlSession().selectList(NAMESPACE + "queryFinancialOrganizationsUpByName",entity);
    }
	...
	long versionNo = (Long) getSqlSession().selectOne(NAMESPACE + "getLastUpdateTime");
