 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/OutfieldDao.java
 * 
 ...
 * @date 2012-12-18 上午10:51:25
 */
public class OutfieldDao extends SqlSessionDaoSupport implements IOutfieldDao {
	
    /**
     * 声明日志对象
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(OutfieldDao.class);
    
    /**
     * 
     * mybatis 命名空间
     */
    private static final String NAMESPACE = ComnConst.MYBATIS_NAMESPACE_BASEINFO_PREFIX + ".outfield.";

    /**
     * 新增
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-2 下午2:56:21
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IOutfieldDao#addOutfield(com.deppon.foss.module.base.baseinfo.api.shared.domain.OutfieldEntity)
     */
    @Override
    public OutfieldEntity addOutfield(OutfieldEntity entity) {
	// 请求合法性验证：
	if (null == entity) {
	    return entity;
	}
	...
	int result = getSqlSession().insert(NAMESPACE + "addOutfield", entity);
	...
	int result = getSqlSession().update(NAMESPACE + "deleteOutfield", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 下午2:56:21
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IOutfieldDao#deleteOutfieldMore(java.lang.String[], java.lang.String)
     */
    @Override
    public OutfieldEntity deleteOutfieldMore(String[] codes , String deleteUser) {
	// 请求合法性判断：
	...
	int result = getSqlSession().update(
		NAMESPACE + "deleteOutfieldMore", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
     ...
     */
    @Override
    public OutfieldEntity updateOutfield(OutfieldEntity entity) {
	// 请求合法性判断：
	if (null == entity) {
	    return entity;
	}
	...
	// 更新要先删除旧的数据：
	OutfieldEntity result = this.deleteOutfield(entity);
	if (result == null) {
	    String msg = "更新时，作废失败";
	    LOGGER.error(msg);
	}
	...
	entity.setActive(FossConstants.ACTIVE);
	int resultNum = getSqlSession().insert(NAMESPACE + "addOutfield", entity);
	...
	List<OutfieldEntity> entitys = this.getSqlSession().selectList(
		NAMESPACE + "queryOutfieldByCode", entity);
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<OutfieldEntity> queryOutfieldByOrgCodeActive(List<String> codes,
	    String active) {	
	// 请求合法性判断
	...
	List<OutfieldEntity> entitys = this.getSqlSession().selectList(
		NAMESPACE + "queryOutfieldByOrgCodeActive", map);
     ...
     * 
     * 精确查询
     * 根据多个标识编码 ORG_CODE 批量查询
     * 
     * 
     * @author 087584-foss-lijun
     * @date 2012-10-18 下午4:1:47
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IOutfieldDao#queryOutfieldBatchByOrgCode(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<OutfieldEntity> queryOutfieldBatchByOrgCode(
	    String[] codes) {
	// 请求参数合法性判断
	...
	return getSqlSession().selectList(NAMESPACE + "queryOutfieldBatchByOrgCode", map);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IOutfieldDao#queryOutfieldExactByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.OutfieldEntity, int, int)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<OutfieldEntity> queryOutfieldExactByEntity(OutfieldEntity entity, int start, int limit) {
	OutfieldEntity queryEntity = entity == null ? new OutfieldEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryOutfieldExactByEntity", queryEntity, rowBounds);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IOutfieldDao#queryOutfieldExactByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.OutfieldEntity)
     */
    @Override
    public long queryOutfieldExactByEntityCount(OutfieldEntity entity) {
	OutfieldEntity queryEntity = entity == null ? new OutfieldEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "queryOutfieldExactByEntityCount", queryEntity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 下午2:56:21
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IOutfieldDao#queryOutfieldMore(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
	...
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryOutfieldByEntity", queryEntity, rowBounds);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 下午2:56:21
     * @see com.deppon.foss.module.base.baseinfo.server.dao.IOutfieldDao#queryOutfieldByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.OutfieldEntity)
     */
    @Override
    public long queryOutfieldByEntityCount(OutfieldEntity entity) {
	OutfieldEntity queryEntity = entity == null ? new OutfieldEntity() : entity ;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "queryOutfieldByEntityCount", queryEntity);
    }
     ...
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-7 下午8:1:28
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<OutfieldEntity> queryOutfieldForDownload(OutfieldEntity entity){
	OutfieldEntity queryEntity = entity == null ? new OutfieldEntity() : entity;
	return (List<OutfieldEntity>) getSqlSession().selectList(NAMESPACE + "queryOutfieldForDownload", queryEntity);
    }
	...
	return (OutfieldEntity) getSqlSession().selectOne(NAMESPACE + "queryOutfieldByOrgCode", entity);
    }
	...
	map.put("active", FossConstants.ACTIVE);
	// 返回查询结果
	return (String) getSqlSession().selectOne(NAMESPACE + "queryTransferCenterByAirDispatchCode", map);
    }
	...
	map.put("motorcadeCode", motorcadeCode);
	map.put("active", FossConstants.ACTIVE);
	return (List<OutfieldEntity>) getSqlSession().selectList(NAMESPACE + "queryOutfieldByMotorcadeCode", map);
    }
	...
	return (List<String>) getSqlSession().selectList(NAMESPACE + "queryActiveOrgCodeList");
    }
