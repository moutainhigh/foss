 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/commonselector/CommonBigZoneDao.java
 * 
 * FILE NAME        	: CommonBigZoneDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public class CommonBigZoneDao extends SqlSessionDaoSupport implements ICommonBigZoneDao {

	private static final String NAMESPACE = "foss.bse.bse-baseinfo.commonBigzone.";
	/**
	 * 根据条件查询接送货大区.
	 * @author 101911-foss-zhouChunlai
	 * @param 
	...
	public List<BigZoneEntity> queryBigZoneByCondition(CommonBigZoneDto dto,
		...
		return this.getSqlSession().selectList(NAMESPACE + "queryBigZoneByCondition",dto, rowBounds);
	}
	/**
	 * 根据条件查询接送货大区总条数.
	 * @author 101911-foss-zhouChunlai
	 ...
	 */
	@Override
	public Long queryRecordCount(CommonBigZoneDto dto) {
