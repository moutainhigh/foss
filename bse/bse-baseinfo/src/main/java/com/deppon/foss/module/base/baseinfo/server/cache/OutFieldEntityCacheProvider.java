 ...
 * @version 1.0
 */
public class OutFieldEntityCacheProvider implements ITTLCacheProvider<OutfieldEntity> {
    ...
    /**
     * @param outfieldDao the outfieldDao to set
     */
    ...
    @Override
    public OutfieldEntity get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return outfieldDao.queryOutfieldByOrgCode(key);
    }
