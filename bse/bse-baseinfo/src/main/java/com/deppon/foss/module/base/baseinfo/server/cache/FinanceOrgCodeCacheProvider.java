 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/FinanceOrgCodeCacheProvider.java
 * 
 * FILE NAME        	: FinanceOrgCodeCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 财务组织编码cache provider类
 * @author foss-zhujunyong
 * @date Dec 10, 2012 10:46:45 AM
 * @version 1.0
 */
public class FinanceOrgCodeCacheProvider implements ITTLCacheProvider<FinancialOrganizationsEntity> {

    private IFinancialOrganizationsDao financialOrganizationsDao;
    
    /**
     * @param financialOrganizationsDao the financialOrganizationsDao to set
     */
    ...
    @Override
    public FinancialOrganizationsEntity get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return financialOrganizationsDao.queryFinancialOrganizationsByCode(key);
    }
