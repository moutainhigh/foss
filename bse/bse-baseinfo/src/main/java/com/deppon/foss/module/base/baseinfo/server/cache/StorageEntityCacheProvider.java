 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/StorageEntityCacheProvider.java
 * 
 * FILE NAME        	: StorageEntityCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class StorageEntityCacheProvider implements ITTLCacheProvider<StorageEntity>{
    ...
    @Override
    public StorageEntity get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return storageDao.queryStorageById(key);
    }
