 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/SalesMotorcadeDao.java
 * 
 * FILE NAME        	: SalesMotorcadeDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-12-18 上午10:12:21
 */
public class SalesMotorcadeDao extends SqlSessionDaoSupport implements ISalesMotorcadeDao {
     ...
     * mybatis 命名空间
     */
    private static final String NAMESPACE = ComnConst.MYBATIS_NAMESPACE_BASEINFO_PREFIX + ".salesMotorcade.";

    /**
     * 新增
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午11:54:42
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#addSalesMotorcade(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesMotorcadeEntity)
     */
    @Override
	...
	int result = getSqlSession().insert(NAMESPACE + "addSalesMotorcade", entity);
	...
	int result = getSqlSession().update(NAMESPACE + "deleteSalesMotorcade", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午11:54:42
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#deleteSalesMotorcadeMore(java.lang.String[], java.lang.String)
     */
    @Override
	...
	int result = getSqlSession().update(NAMESPACE + "deleteSalesMotorcadeMore", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
	...
	// 更新要先删除旧的数据：
	SalesMotorcadeEntity result = this.deleteSalesMotorcade(entity);
	if (result == null) {
	    String msg = "更新时，作废失败";
	    LOGGER.error(msg);
	}
	...
	entity.setActive(FossConstants.ACTIVE);
	int resultNum = getSqlSession().insert(NAMESPACE + "addSalesMotorcade", entity);
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午11:54:42
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#querySalesMotorcadeByCode(java.lang.String)
     */
	...
	List<SalesMotorcadeEntity> entitys = this.getSqlSession().selectList(NAMESPACE + "querySalesMotorcadeByVirtualCode", entity);
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#querySalesMotorcadeBatchBy(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesMotorcadeEntity> querySalesMotorcadeBatchByVirtualCode(String[] codes) {
	// 请求参数合法性判断
	if (ArrayUtils.isEmpty(codes)){
	    return null;
	}
	...
	return getSqlSession().selectList(NAMESPACE + "querySalesMotorcadeBatchByVirtualCode", map);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#querySalesMotorcadeExactByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesMotorcadeEntity, int, int)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesMotorcadeEntity> querySalesMotorcadeExactByEntity(SalesMotorcadeEntity entity, int start, int limit) {
	SalesMotorcadeEntity queryEntity = entity == null ? new SalesMotorcadeEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "querySalesMotorcadeExactByEntity", queryEntity, rowBounds);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#querySalesMotorcadeExactByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesMotorcadeEntity)
     */
    @Override
    public long querySalesMotorcadeExactByEntityCount(SalesMotorcadeEntity entity) {
	SalesMotorcadeEntity queryEntity = entity == null ? new SalesMotorcadeEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "querySalesMotorcadeExactByEntityCount", queryEntity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午11:54:42
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesMotorcadeDao#querySalesMotorcadeMore(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesMotorcadeEntity> querySalesMotorcadeByEntity(SalesMotorcadeEntity entity, int start, int limit) {
	SalesMotorcadeEntity queryEntity = entity == null ? new SalesMotorcadeEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "querySalesMotorcadeByEntity", queryEntity, rowBounds);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午11:54:42
     * @see com.deppon.foss.module.base.baseinfo.server.dao.ISalesMotorcadeDao#querySalesMotorcadeByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesMotorcadeEntity)
     */
    @Override
    public long querySalesMotorcadeByEntityCount(SalesMotorcadeEntity entity) {
	SalesMotorcadeEntity queryEntity = entity == null ? new SalesMotorcadeEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "querySalesMotorcadeByEntityCount", queryEntity);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesMotorcadeEntity> querySalesMotorcadeForDownload(SalesMotorcadeEntity entity){
	SalesMotorcadeEntity queryEntity = entity == null ? new SalesMotorcadeEntity() : entity;
	return (List<SalesMotorcadeEntity>) getSqlSession().selectList(NAMESPACE + "querySalesMotorcadeForDownload", queryEntity);
    }
	/**
	 * 	
	 *<p>通过营业部编码和车队编码 精确查询</p>
	 *@author 130566-zengJunfan
	 *@date   2013-8-17下午3:11:42
	 * @param salesdeptCode
	 * @param motorcadeCode
	 * @return
	 */
    @SuppressWarnings("unchecked")
	@Override
	public SalesMotorcadeEntity querySalesMotorcadeBySalesCodeAndMotorCode(
			String salesdeptCode, String motorcadeCode) {
		
    	// 检查参数
    	if (StringUtils.isBlank(salesdeptCode)&&StringUtils.isBlank(motorcadeCode)) {
    	    return null;
    	}
    	// 构造查询条件：
    	SalesMotorcadeEntity entity=new SalesMotorcadeEntity();
    	...
    	List<SalesMotorcadeEntity> entitys = this.getSqlSession().selectList(NAMESPACE + "querySalesMotorcadeBySalesCodeAndMotorCode", entity);
    	return CollectionUtils.isEmpty(entitys) ? null : entitys.get(0);
	}
	...
	// 只删除active为有效的：
	map.put("conditionActive", FossConstants.ACTIVE);
	int result = getSqlSession().update(NAMESPACE + "deleteSalesMotorcadeBySalesdeptCode", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
    /**
     * 
	...
	public SalesMotorcadeEntity deleteSalesMotorcadeEntityByMotorcadeCode(
		...
		//参数合法性验证
		if(entity == null || StringUtils.isBlank(entity.getMotorcadeCode())){
			return null;
		}
		// 处理删除时要更新的数据
		Date now = new Date();
		...
		//只废除有效的
		map.put("conditionActive", FossConstants.ACTIVE);
		int result =this.getSqlSession().update(NAMESPACE+"deleteSalesMotorcadeByMotorcadeCode",map);
		return result >NumberConstants.ZERO? entity : null;
	}
}
