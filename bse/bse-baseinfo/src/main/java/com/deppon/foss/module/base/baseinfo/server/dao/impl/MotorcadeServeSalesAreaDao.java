 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/MotorcadeServeSalesAreaDao.java
 * 
 * FILE NAME        	: MotorcadeServeSalesAreaDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-12-18 上午10:54:12
 */
public class MotorcadeServeSalesAreaDao extends SqlSessionDaoSupport implements IMotorcadeServeSalesAreaDao {
     ...
     * mybatis 命名空间
     */
    private static final String NAMESPACE = ComnConst.MYBATIS_NAMESPACE_BASEINFO_PREFIX + ".motorcadeServeSalesArea.";

    /**
     * 新增
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午11:27:40
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeSalesAreaDao#addMotorcadeServeSalesArea(com.deppon.foss.module.base.baseinfo.api.shared.domain.MotorcadeServeSalesAreaEntity)
     */
    @Override
	...
	int result = getSqlSession().insert(NAMESPACE + "addMotorcadeServeSalesArea", entity);
	...
	int result = getSqlSession().update(NAMESPACE + "deleteMotorcadeServeSalesArea", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
	...
	int result = getSqlSession().update(NAMESPACE + "deleteMotorcadeServeSalesAreaMore", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
	...
	// 更新要先删除旧的数据：
	MotorcadeServeSalesAreaEntity result = this.deleteMotorcadeServeSalesArea(entity);
	if (result == null) {
	...
	entity.setActive(FossConstants.ACTIVE);
	int resultNum = getSqlSession().insert(NAMESPACE + "addMotorcadeServeSalesArea", entity);
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午11:27:40
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaByCode(java.lang.String)
     */
	...
	List<MotorcadeServeSalesAreaEntity> entitys = this.getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeSalesAreaByVirtualCode", entity);
	return CollectionUtils.isEmpty(entitys) ? null : entitys.get(0);
    }
    
    /**
     * 
     *<p> 根据车队编码和营业区编码精确查询</p>
     *@author 130566-zengJunfan
     *@date   2013-8-17下午2:57:28
     * @param motorcadeCode
     * @param salesareaCode
     * @return
     */
	@SuppressWarnings("unchecked")
	@Override
	public MotorcadeServeSalesAreaEntity queryMotorcadeServeSalesAreaByMotorCodeAndSalesAreaCode(
			String motorcadeCode, String salesareaCode) {
		// 检查参数
		if (StringUtils.isBlank(motorcadeCode)&&StringUtils.isBlank(salesareaCode)) {
		    return null;
		}
		// 构造查询条件：
		MotorcadeServeSalesAreaEntity entity = new MotorcadeServeSalesAreaEntity();
		entity.setActive(FossConstants.ACTIVE);
		entity.setMotorcadeCode(motorcadeCode);
		entity.setSalesareaCode(salesareaCode);
		List<MotorcadeServeSalesAreaEntity> entities =this.getSqlSession().selectList(NAMESPACE+"queryMotorcadeServeSalesAreaByMotorCodeAndSalesAreaCode",entity);
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaBatchBy(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeSalesAreaEntity> queryMotorcadeServeSalesAreaBatchByVirtualCode(String[] codes) {
	// 请求参数合法性判断
	...
	return getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeSalesAreaBatchByVirtualCode", map);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaExactByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.MotorcadeServeSalesAreaEntity,
     *      int, int)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeSalesAreaEntity> queryMotorcadeServeSalesAreaExactByEntity(MotorcadeServeSalesAreaEntity entity, int start, int limit) {
	MotorcadeServeSalesAreaEntity queryEntity = entity == null ? new MotorcadeServeSalesAreaEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeSalesAreaExactByEntity", queryEntity, rowBounds);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaExactByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.MotorcadeServeSalesAreaEntity)
     */
    @Override
    public long queryMotorcadeServeSalesAreaExactByEntityCount(MotorcadeServeSalesAreaEntity entity) {
	MotorcadeServeSalesAreaEntity queryEntity = entity == null ? new MotorcadeServeSalesAreaEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long) getSqlSession().selectOne(NAMESPACE + "queryMotorcadeServeSalesAreaExactByEntityCount", queryEntity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午11:27:40
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaMore(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeSalesAreaEntity> queryMotorcadeServeSalesAreaByEntity(MotorcadeServeSalesAreaEntity entity, int start, int limit) {
	MotorcadeServeSalesAreaEntity queryEntity = entity == null ? new MotorcadeServeSalesAreaEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeSalesAreaByEntity", queryEntity, rowBounds);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午11:27:40
     * @see com.deppon.foss.module.base.baseinfo.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.MotorcadeServeSalesAreaEntity)
     */
    @Override
    public long queryMotorcadeServeSalesAreaByEntityCount(MotorcadeServeSalesAreaEntity entity) {
	MotorcadeServeSalesAreaEntity queryEntity = entity == null ? new MotorcadeServeSalesAreaEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long) getSqlSession().selectOne(NAMESPACE + "queryMotorcadeServeSalesAreaByEntityCount", queryEntity);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<MotorcadeServeSalesAreaEntity> queryMotorcadeServeSalesAreaForDownload(MotorcadeServeSalesAreaEntity entity) {
	MotorcadeServeSalesAreaEntity queryEntity = entity == null ? new MotorcadeServeSalesAreaEntity() : entity;
	return (List<MotorcadeServeSalesAreaEntity>) getSqlSession().selectList(NAMESPACE + "queryMotorcadeServeSalesAreaForDownload", queryEntity);
    }
	...
	// 请求参数合法性验证
	if (null == entity || StringUtils.isBlank(entity.getMotorcadeCode())) {
	    return null;
	}
	...
	// 只删除active为有效的：
	map.put("conditionActive", FossConstants.ACTIVE);
	int result = getSqlSession().update(NAMESPACE + "deleteMotorcadeServeSalesAreaByMotorcadeCode", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
