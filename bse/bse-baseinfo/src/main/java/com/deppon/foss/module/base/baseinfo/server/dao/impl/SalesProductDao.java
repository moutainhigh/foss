 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/dao/impl/SalesProductDao.java
 * 
 ...
 */
public class SalesProductDao extends SqlSessionDaoSupport implements ISalesProductDao {
    
    /**
     * 日志
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(SalesProductDao.class);
    /**
     * 
     * mybatis 命名空间
     */
    private static final String NAMESPACE = ComnConst.MYBATIS_NAMESPACE_BASEINFO_PREFIX + ".salesProduct.";
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#addSalesProduct(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesProductEntity)
     */
    @Override
	...
	int result = getSqlSession().insert(NAMESPACE + "addSalesProduct", entity);
     ...
     * @date 2016-11-3 上午12:51:18
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#addSalesProduct(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesProductEntity)
     */
    @Override
    public List<SalesProductEntity> addSalesProductBatch(List<SalesProductEntity> entitys) {
		...
		this.getSqlSession()
				.insert(NAMESPACE + "addSalesProductBatch", entitys);
		return entitys;	
    }
	...
	int result = getSqlSession().update(NAMESPACE + "deleteSalesProduct", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午12:51:18
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#deleteSalesProductMore(java.lang.String[], java.lang.String)
     */
    @Override
	...
	int result = getSqlSession().update(
		NAMESPACE + "deleteSalesProductMore", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
	...
	// 更新要先删除旧的数据：
	SalesProductEntity result = this.deleteSalesProduct(entity);
	if (result == null) {
	...
	entity.setActive(FossConstants.ACTIVE);
	int resultNum = getSqlSession().insert(NAMESPACE + "addSalesProduct", entity);
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午12:51:18
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#querySalesProductByCode(java.lang.String)
     */
	...
	List<SalesProductEntity> entitys = this.getSqlSession().selectList(NAMESPACE + "querySalesProductByVirtualCode", entity);
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#querySalesProductBatchBy(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesProductEntity> querySalesProductBatchByVirtualCode(String[] codes) {
	// 请求参数合法性判断
	...
	return getSqlSession().selectList(NAMESPACE + "querySalesProductBatchByVirtualCode", map);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#querySalesProductExactByEntity(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesProductEntity, int, int)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesProductEntity> querySalesProductExactByEntity(SalesProductEntity entity, int start, int limit) {
	SalesProductEntity queryEntity = entity == null ? new SalesProductEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "querySalesProductExactByEntity", queryEntity, rowBounds);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#querySalesProductExactByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesProductEntity)
     */
    @Override
    public long querySalesProductExactByEntityCount(SalesProductEntity entity) {
	SalesProductEntity queryEntity = entity == null ? new SalesProductEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "querySalesProductExactByEntityCount", queryEntity);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午12:51:18
     * @see com.deppon.foss.module.base.baseinfo.api.server.dao.ISalesProductDao#querySalesProductMore(java.lang.String[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesProductEntity> querySalesProductByEntity(SalesProductEntity entity, int start, int limit) {
	SalesProductEntity queryEntity = entity == null ? new SalesProductEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	RowBounds rowBounds = new RowBounds(start, limit);
	return getSqlSession().selectList(NAMESPACE + "querySalesProductByEntity", queryEntity, rowBounds);
    }
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-14 上午12:51:18
     * @see com.deppon.foss.module.base.baseinfo.server.dao.ISalesProductDao#querySalesProductByEntityCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.SalesProductEntity)
     */
    @Override
    public long querySalesProductByEntityCount(SalesProductEntity entity) {
	SalesProductEntity queryEntity = entity == null ? new SalesProductEntity() : entity;
	queryEntity.setActive(FossConstants.ACTIVE);
	return (Long)getSqlSession().selectOne(NAMESPACE + "querySalesProductByEntityCount", queryEntity);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesProductEntity> querySalesProductForDownload(SalesProductEntity entity){
	SalesProductEntity queryEntity = entity == null ? new SalesProductEntity() : entity;
	return (List<SalesProductEntity>) getSqlSession().selectList(NAMESPACE + "querySalesProductForDownload", queryEntity);
    }
	
    
    @SuppressWarnings("unchecked")
    @Override
    public List<SalesProductEntity> querySalesProductForDownloadByPage(
    		SalesProductEntity entity,int start, int limit){
    	RowBounds rowBounds = new RowBounds(start, limit);
    	SalesProductEntity queryEntity = entity == null ? new SalesProductEntity() : entity;
    	return (List<SalesProductEntity>) getSqlSession().selectList(NAMESPACE + "querySalesProductForDownload", queryEntity, rowBounds);
    }
	...
	// 只删除active为有效的：
	map.put("conditionActive", FossConstants.ACTIVE);
	int result = getSqlSession().update(NAMESPACE + "deleteSalesProductBySalesDeptCode", map);
	return result > NumberConstants.ZERO ? entity : null;
    }
