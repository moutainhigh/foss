 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/LineItemListCacheProvider.java
 * 
 * FILE NAME        	: LineItemListCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class LineItemListCacheProvider implements ITTLCacheProvider<List<LineItemEntity>>{
    ...
    @Override
    public List<LineItemEntity> get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return lineItemDao.queryLineItemListByLineVirtualCode(key);
    }
