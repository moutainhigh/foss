 ...
 * @version 1.0
 */
public class LineEntityCacheProvider implements ITTLCacheProvider<LineEntity>{
    ...
    @Override
    public LineEntity get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	LineEntity result = lineDao.queryLineByVirtualCode(key);
	...
	if (result == null) {
	    ...
	    List<LineEntity> resultList = lineDao.queryLineListByCondition(condition, 0, 1);
