 ...
 */
public class CommonPriceRegionAction extends AbstractAction implements
		IQueryAction {
	...
	private ICommonPriceRegionService commonPriceRegionService;
	...
	@Override
	public String query() {
		priceRegionEntityVo.setPriceRegionEntities(commonPriceRegionService
				.searchRegionByCondition(
						priceRegionEntityVo.getPriceRegionEntity(), start,
						limit));
		setTotalCount(commonPriceRegionService
	...
	/**
	 * Sets the common price region service.
	 *
	 * @param commonPriceRegionService the new common price region service
	 */
	public void setCommonPriceRegionService(
			ICommonPriceRegionService commonPriceRegionService) {
		this.commonPriceRegionService = commonPriceRegionService;
	}
