 ...
 */
public class CommonPerscriptionRegionExpressAction extends AbstractAction implements
		IQueryAction {
	/**
	 * 
	 */
	private static final long serialVersionUID = -12002943797634310L;
	// vo
	...
	private ICommonPerscriptionRegionExpressService commonPerscriptionRegionExpressService;
	...
	public String query() {
		priceRegionEntityVo
				.setPriceRegionEntities(commonPerscriptionRegionExpressService
						.searchRegionByCondition(
								priceRegionEntityVo.getPriceRegionEntity(),
								start, limit));
		setTotalCount(commonPerscriptionRegionExpressService
	...
	public void setCommonPerscriptionRegionExpressService(
			ICommonPerscriptionRegionExpressService commonPerscriptionRegionExpressService) {
		this.commonPerscriptionRegionExpressService = commonPerscriptionRegionExpressService;
	}
