...
import com.deppon.foss.module.base.baseinfo.api.server.dao.commonselector.ICommonPerscriptionRegionExpressDao;
import com.deppon.foss.module.base.baseinfo.api.server.service.commonselector.ICommonPerscriptionRegionExpressService;
 ...
 */
public class CommonPerscriptionRegionExpressService implements
		ICommonPerscriptionRegionExpressService {
	
	/** The common perscription region dao. */
	private ICommonPerscriptionRegionExpressDao commonPerscriptionRegionExpressDao;
	...
	public List<PriceRegionEntity> searchRegionByCondition(
		...
		return commonPerscriptionRegionExpressDao.searchRegionByCondition(
	...
	public Long countRegionByCondition(PriceRegionEntity regionEntity) {
		return commonPerscriptionRegionExpressDao.countRegionByCondition(regionEntity);
	}
	 ...
	 */
	public void setCommonPerscriptionRegionExpressDao(
			ICommonPerscriptionRegionExpressDao commonPerscriptionRegionExpressDao) {
		this.commonPerscriptionRegionExpressDao = commonPerscriptionRegionExpressDao;
	}
}
