 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/FreightRouteLineListCacheProvider.java
 * 
 * FILE NAME        	: FreightRouteLineListCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class FreightRouteLineListCacheProvider implements ITTLCacheProvider<List<FreightRouteLineEntity>>{

    private IFreightRouteLineDao freightRouteLineDao;
    
    /**
     * @param freightRouteLineDao the freightRouteLineDao to set
     */
    ...
    @Override
    public List<FreightRouteLineEntity> get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	FreightRouteLineEntity c = new FreightRouteLineEntity();
	c.setFreightRouteVirtualCode(key);
