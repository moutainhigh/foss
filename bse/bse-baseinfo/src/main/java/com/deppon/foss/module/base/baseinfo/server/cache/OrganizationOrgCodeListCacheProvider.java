 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/OrganizationOrgCodeListCacheProvider.java
 * 
 * FILE NAME        	: OrganizationOrgCodeListCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class OrganizationOrgCodeListCacheProvider implements ITTLCacheProvider<List<OrgAdministrativeInfoEntity>> {
    ...
    @Override
    public List<OrgAdministrativeInfoEntity> get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	OrgAdministrativeInfoEntity entity = new OrgAdministrativeInfoEntity();
	entity.setCode(key);
	return orgAdministrativeInfoDao.queryOrgAdministrativeInfoForDownload(entity);
    }
