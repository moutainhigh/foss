 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/action/NetworkGroupAction.java
 * 
 * FILE NAME        	: NetworkGroupAction.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
import com.deppon.foss.module.base.baseinfo.api.shared.vo.NetworkGroupVo;
 ...
 * <p style="display:none">version:V1.0,author:094463-foss-xieyantao,date:2012-12-5 下午2:33:34 </p>
 * @author 094463-foss-xieyantao
 * @date 2012-12-5 下午2:33:34
 * @since
 * @version
 */
public class NetworkGroupAction extends AbstractAction {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = 5848619335918382584L;
     ...
     * 网点组VO
     */
    private NetworkGroupVo networkGroupVo = new NetworkGroupVo();
    
    /**
     * 
     * @date Mar 14, 2013 4:56:39 PM
    ...
    /**
     * 
     * @date Mar 14, 2013 4:56:46 PM
     * @return
     * @see
     */
    public NetworkGroupVo getNetworkGroupVo() {
        return networkGroupVo;
    }

    /**
     * 
     * @date Mar 14, 2013 4:56:51 PM
     * @param networkGroupVo
     * @see
     */
    public void setNetworkGroupVo(NetworkGroupVo networkGroupVo) {
        this.networkGroupVo = networkGroupVo;
    }

    /**
     * <p>新增网点组</p> 
     * @author 094463-foss-xieyantao
     * @date 2012-12-5 下午2:45:01
     * @return
     * @see
     */
    @JSON
    public String addNetworkGroup(){
	try {
	    UserEntity user =  FossUserContext.getCurrentUser();// 获取当前登录用户
	    String userCode = user.getEmployee().getEmpCode();// 当前登录用户empcode
	    NetGroupDto netGroup = networkGroupVo.getNetGroupDto();
	    //设置创建人
	    netGroup.setCreateUser(userCode);
	    //设置修改人
	    netGroup.setModifyUser(userCode);
	    
	    // 新增网点组
	    netGroup = netGroupService.addNetGroup(netGroup);
	    networkGroupVo.setNetGroupDto(convertObject(netGroup));
     ...
     * <p>作废网点组</p> 
     * @author 094463-foss-xieyantao
     * @date 2012-12-5 下午2:45:07
     * @return
     * @see
     */
    @JSON
    public String deleteNetworkGroup(){
	try {
	    // 获取当前登录用户
	    UserEntity user =  FossUserContext.getCurrentUser();
	    // 当前登录用户empcode
	    String userCode = user.getEmployee().getEmpCode();
	    NetGroupDto netGroupDto = networkGroupVo.getNetGroupDto();
	    netGroupDto.setModifyUser(userCode);
	    int result = netGroupService.deleteNetGroup(netGroupDto);
	   
	    if(result > 0){
		return returnSuccess(MessageType.DELETE_SUCCESS);
	    }else {
		return returnError(MessageType.DELETE_FAILURE);
	    }
	} catch (BusinessException e) {
	    return returnError(e);
	}
     ...
     * <p>修改网点组</p> 
     * @author 094463-foss-xieyantao
     * @date 2012-12-5 下午2:45:13
     * @return
     * @see
     */
    @JSON
    public String updateNetworkGroup(){
	try {
	    // 获取当前登录用户
	    UserEntity user =  FossUserContext.getCurrentUser();
	    // 当前登录用户empcode
	    ...
	    netGroupDto.setModifyUser(userCode);
	    //修改成功
	    netGroupDto = netGroupService.updateNetGroup(netGroupDto);
	    networkGroupVo.setNetGroupDto(convertObject(netGroupDto));
     ...
     * <p>查询网点组</p> 
     * @author 094463-foss-xieyantao
     * @date 2012-12-5 下午2:45:19
     * @return
     * @see
     */
    @JSON
    public String queryNetworkGroup(){
	try {
	    //获取走货路径的虚拟编码
	    String virtualCode = networkGroupVo.getFreightRouteVirtualCode();
	    List<NetGroupDto> netGroupDtos = netGroupService.queryNetGroupListByFreightRoute(virtualCode);
	   
	    networkGroupVo.setNetGroupList(convertObjects(netGroupDtos));
