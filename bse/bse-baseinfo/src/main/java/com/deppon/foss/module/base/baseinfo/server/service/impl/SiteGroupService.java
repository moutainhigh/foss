 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/service/impl/SiteGroupService.java
 * 
 * FILE NAME        	: SiteGroupService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
import com.deppon.foss.module.base.baseinfo.api.shared.exception.SiteGroupException;
import com.deppon.foss.util.UUIDUtils;
import com.deppon.foss.util.define.FossConstants;

/**
 * 站点组service接口实现：对站点组提供增删改查的操作
 * <p style="display:none">
 * modifyRecord
 * </p>
 * <p style="display:none">
 * version:V1.0,author:094463-foss-xieyantao,date:2012-10-13 上午10:42:42
 * </p>
 * 
 * @author 094463-foss-xieyantao
 * @date 2012-10-13 上午10:42:42
 * @since
 * @version
 */
public class SiteGroupService implements ISiteGroupService {
     ...
     *            站点组实体
     * @return
     * @throws SiteGroupException
     * @author 094463-foss-xieyantao
     * @date 2012-10-13 上午10:45:12
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#addSiteGroup(com.deppon.foss.module.base.baseinfo.api.shared.domain.SiteGroupEntity)
     */
    @Transactional
    @Override
    public SiteGroupEntity addSiteGroup(SiteGroupEntity entity) throws SiteGroupException {
	// 检查参数
	if (null == entity) {
	    return null;
	}
	...
	SiteGroupEntity siteGroupEntity = querySiteGroupIsExist(entity);
	if (null == siteGroupEntity) {
	    int result = siteGroupDao.addSiteGroup(entity);
	    return result > 0 ? convertInfo(entity) : null;
	} else {
	    throw new SiteGroupException("该站点组数据库已存在！");
	}
    }

    /**
     * 根据code作废站点组信息 同时删除该站点组下所有站点.
     * 
     * @param codeStr
     * @param modifyUser
     * @return 1：成功；-1：失败
     * @throws SiteGroupException
     * @author 094463-foss-xieyantao
     * @date 2012-10-13 上午10:49:02
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#deleteSiteGroupByCode(java.lang.String[])
     */
    @Transactional
    @Override
    public int deleteSiteGroupByCode(String codeStr, String modifyUser) throws SiteGroupException {
	// 检查参数
	if (StringUtil.isBlank(codeStr)) {
	    throw new SiteGroupException("站点组虚拟编码不允许为空！");
	} else {// 拆分字符串
	    LOGGER.debug("codeStr: " + codeStr);
	    String[] codes = StringUtil.split(codeStr, SymbolConstants.EN_COMMA);
	    int flag = siteGroupDao.deleteSiteGroupByCode(codes, modifyUser);

	    if (flag > 0) {
		// 删除站点组同时删除该站点组下面的所有站点
		return siteGroupDao.deleteSiteByCode(codes, modifyUser);
	    } else {
     ...
     * @throws SiteGroupException
     * @author 094463-foss-xieyantao
     * @date 2012-10-13 上午10:45:27
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#updateSiteGroup(com.deppon.foss.module.base.baseinfo.api.shared.domain.SiteGroupEntity)
     */
    @Transactional
    @Override
    public SiteGroupEntity updateSiteGroup(SiteGroupEntity entity) throws SiteGroupException {
	// 检查参数
	if (null == entity) {
	    return null;
	} else if (StringUtil.isBlank(entity.getVirtualCode())) {
	    throw new SiteGroupException("虚拟编码不允许为空！");
	}
	...
	// 作废历史记录
	int flag = siteGroupDao.deleteSiteGroupByCode(codes, entity.getModifyUser());
     ...
     * @throws SiteGroupException
     * @author 094463-foss-xieyantao
     * @date 2012-10-13 上午10:45:39
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#querySiteGroups(com.deppon.foss.module.base.baseinfo.api.shared.domain.SiteGroupEntity,
     *      int, int)
     */
    @Transactional
    @Override
    public List<SiteGroupEntity> querySiteGroups(SiteGroupEntity entity, int limit, int start) throws SiteGroupException {
	entity.setActive(FossConstants.ACTIVE);
	return convertInfoList(siteGroupDao.querySiteGroups(entity, limit, start));
    }
     ...
     * @return
     * @author 094463-foss-xieyantao
     * @date 2012-10-13 上午10:45:51
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#getCount(com.deppon.foss.module.base.baseinfo.api.shared.domain.SiteGroupEntity)
     */
    @Transactional
    @Override
    public Long queryRecordCount(SiteGroupEntity entity) {
	entity.setActive(FossConstants.ACTIVE);
	return siteGroupDao.queryRecordCount(entity);
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#querySiteGroupByCode(java.lang.String)
     */
    @Transactional
    @Override
	...
	return convertInfo(siteGroupDao.querySiteGroupByCode(siteGroupCode));
    }
     ...
     * @return
     * @author 094463-foss-xieyantao
     * @date 2012-12-7 下午1:57:28
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#querySiteGroupsBySiteCode(java.lang.String)
     */
    @Override
    public List<SiteGroupEntity> querySiteGroupsBySiteCode(String deptCode) {
	// 检查参数
	if (StringUtil.isBlank(deptCode)) {
	    throw new SiteGroupException("站点组站点编码不允许为空！");
	}
	return convertInfoList(siteGroupDao.querySiteGroupsBySiteCode(deptCode));
    }
     ...
     * @see com.deppon.foss.module.base.baseinfo.api.server.service.ISiteGroupService#querySiteGroupIsExist(com.deppon.foss.module.base.baseinfo.api.shared.domain.SiteGroupEntity)
     */
    @Override
    public SiteGroupEntity querySiteGroupIsExist(SiteGroupEntity entity) {
	// 检查参数
	if (null == entity) {
	    throw new SiteGroupException("传入的参数不允许为空！");
	} else {
	    if (StringUtil.isBlank(entity.getName())) {
		throw new SiteGroupException("站点组名不允许为空！");
	    } else if (StringUtil.isBlank(entity.getOrgCode())) {
		throw new SiteGroupException("所属部门不允许为空！");
	    } else if (StringUtil.isBlank(entity.getType())) {
		throw new SiteGroupException("站点组类型不允许为空");
	    } else {
		return convertInfo(siteGroupDao.querySiteGroupIsExist(entity));
	    }
	}
    }
     ...
     * <p>封装站点组所属部门名称</p> 
     * @author 094463-foss-xieyantao
     * @date 2013-1-23 上午9:21:26
     * @param entity
     * @return
     * @see
     */
    private SiteGroupEntity convertInfo(SiteGroupEntity entity){
	if(null == entity){
	    return null;
	}else {
	    // 通过部门编码获得该部门的实体
	    OrgAdministrativeInfoEntity org = orgAdministrativeInfoService.queryOrgAdministrativeInfoByCode(entity.getOrgCode());
	    if(null != org){
		//设置部门名称
		entity.setOrgName(org.getName());
	    }else {
		entity.setOrgName(StringUtils.EMPTY);
	    }
	    return entity;
	}
    }
     ...
     * <p>批量填充站点组所属部门名称</p> 
     * @author 094463-foss-xieyantao
     * @date 2013-1-23 上午9:28:24
     * @param list
     * @return
     * @see
     */
    private List<SiteGroupEntity> convertInfoList(List<SiteGroupEntity> list){
	List<SiteGroupEntity> entities = new ArrayList<SiteGroupEntity>();
	if (CollectionUtils.isNotEmpty(list)) {
	    for (SiteGroupEntity entity : list) {
