 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/service/impl/commonselector/CommonVehAgencyCompService.java
 * 
 * FILE NAME        	: CommonVehAgencyCompService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 公共查询组件--偏线代理公司service实现.
 *
 * @author 078823-foss-panGuangJun
 * @date 2012-12-6 上午9:38:24
 */
public class CommonVehAgencyCompService implements ICommonVehAgencyCompService {
	
	/** The common agency company dao. */
	private ICommonAgencyCompanyDao commonAgencyCompanyDao;
	 ...
	 * @author 078823-foss-panGuangJun
	 * @date 2012-12-6 上午9:38:24
	 * @see com.deppon.foss.module.base.baseinfo.api.server.service.commonselector.ICommonVehAgencyCompService#queryVehicleAgencyCompByCondtion(com.deppon.foss.module.base.baseinfo.api.shared.domain.BusinessPartnerEntity,
	 * int, int)
	 */
	@Override
	public List<BusinessPartnerEntity> queryVehicleAgencyCompByCondtion(
	 ...
	 * @author 078823-foss-panGuangJun
	 * @date 2012-12-6 上午9:38:24
	 * @see com.deppon.foss.module.base.baseinfo.api.server.service.commonselector.ICommonVehAgencyCompService#countRecordByCondition(com.deppon.foss.module.base.baseinfo.api.shared.domain.BusinessPartnerEntity)
	 */
	@Override
