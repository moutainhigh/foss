 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/server/cache/MotorcadeEntityCacheProvider.java
 * 
 * FILE NAME        	: MotorcadeEntityCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class MotorcadeEntityCacheProvider implements ITTLCacheProvider<MotorcadeEntity> {
    ...
    /**
     * @param motorcadeDao the motorcadeDao to set
     */
    ...
    @Override
    public MotorcadeEntity get(String key) {
	if (StringUtils.isBlank(key)) {
	    return null;
	}
	return motorcadeDao.queryMotorcadeByCode(key);
    }
