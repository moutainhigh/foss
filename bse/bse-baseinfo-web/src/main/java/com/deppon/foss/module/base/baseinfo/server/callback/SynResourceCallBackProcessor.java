...
import com.deppon.esb.pojo.transformer.jaxb.SyncResourceResponseTrans;
/*import com.deppon.esb.core.exception.ESBException;
import com.deppon.esb.core.process.ErrorResponse;
import com.deppon.esb.core.process.ICallBackProcess;*/

public class SynResourceCallBackProcessor implements ICallBackProcess{

	private static final Logger LOGGER = LoggerFactory.getLogger(SynResourceCallBackProcessor.class);
	
	@Override
	public void callback(Object response) throws ESBException {
		// TODO Auto-generated method stub
		if (null != response) {
			SyncResourceResponse resourceResponse = (SyncResourceResponse) response;
			LOGGER.info("send Resource info,then receive callback info.同步FOSS权限信息，收到回调信息：\n"+ 
			   new SyncResourceResponseTrans().fromMessage(resourceResponse));
		}
	}
