...
import com.deppon.foss.module.base.baseinfo.shared.request.FOSSFactorFlagRequest;
import com.deppon.foss.module.base.baseinfo.shared.response.FOSSFactorFlagResponse;
			...
			try {				
				if (payload != null) {
					...
					if(entity != null){
						...
						packSupplierBaseInfoResponse.setIsSuccess("1");
					...
					//如果不存在，返回异常
						...
						response.setHeader(ESBHeaderConstant.RESULTCODE, "1");
						packSupplierBaseInfoResponse.setIsSuccess("0");
