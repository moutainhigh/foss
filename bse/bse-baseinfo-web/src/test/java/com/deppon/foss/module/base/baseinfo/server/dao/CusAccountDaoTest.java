 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/baseinfo/server/dao/CusAccountDaoTest.java
 * 
 * FILE NAME        	: CusAccountDaoTest.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version
 */
public class CusAccountDaoTest {

    private JdbcTemplate jdbc;
    
    private ICusAccountDao cusAccountDao;
    private CusAccountEntity entity = new CusAccountEntity();
	...
	cusAccountDao = SpringTestHelper.get().getBeanByInterface(ICusAccountDao.class);
    }
...
//	jdbc.execute("delete from BSE.T_BAS_CUS_ACCOUNT where id = '"+id+"'");
    }
	...
	int result = cusAccountDao.addCusAccount(entity);
	...
	int result = cusAccountDao.deleteCusAccountByCode(crmId, "王辉");
	Assert.assertTrue(result > 0);	
    }
	...
	int result = cusAccountDao.updateCusAccount(entity);
	Assert.assertTrue(result > 0);	
    }
	...
	List<CusAccountEntity>  list = cusAccountDao.queryAccountInfoByCustCode("20100810-04623728");
