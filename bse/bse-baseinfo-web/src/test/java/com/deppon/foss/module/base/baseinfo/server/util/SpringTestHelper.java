 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/baseinfo/server/util/SpringTestHelper.java
 * 
...
public class SpringTestHelper {
	...
	try {
	    ...
	    appContext = new ClassPathXmlApplicationContext(
		    "com/deppon/foss/module/base/baseinfo/server/META-INF/springTest.xml");
	} catch (Exception e) {
