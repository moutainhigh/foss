 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/baseinfo/server/service/org/MotorcadeServeDistrictServiceTest.java
 * 
 * FILE NAME        	: MotorcadeServeDistrictServiceTest.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
@Ignore
public class MotorcadeServeDistrictServiceTest {
    /**
     * 测试新增
