 ...
 */
public class ConfigurationParamsServiceTest {
	...
	public void queryConfigurationByOrgCode(){
		String parmMouudle="SYSTEM_CONFIG_PARM__STL";
		String parmCode="STL_SERVICE_FEE_RATIO";
		String orgCodeParm="W011304061105";
		ConfigurationParamsEntity entity=configurationParamsService.queryConfigurationParamsByOrgCode(
				parmMouudle,  parmCode,  orgCodeParm);
		Assert.assertNotNull(entity);
	}
	// 返回一个数据字典信息
