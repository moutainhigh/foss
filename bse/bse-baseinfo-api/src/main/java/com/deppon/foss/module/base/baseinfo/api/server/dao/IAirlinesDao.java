 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/IAirlinesDao.java
 * 
 * FILE NAME        	: IAirlinesDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 用来操作交互“航空公司”的数据库对应数据访问DAO接口：SUC-42
 * <p style="display:none">modifyRecord</p>
 * <p style="display:none">version:V1.0,author:100847-foss-GaoPeng,date:2012-10-12 上午8:50:06</p>
 * @author 100847-foss-GaoPeng
 * @date 2012-10-12 上午8:50:06
 * @since
 * @version
 */
public interface IAirlinesDao {
     ...
     * @see
     */
    int deleteAirlinesByCode(String[] codes,String modifyUser);
     ...
     * @see
     */
    List<AirlinesEntity> queryAirlines(AirlinesEntity entity,int limit,int start);
	...
	List<AirlinesEntity> queryAirlinesById(String[] codes);
}
