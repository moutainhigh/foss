 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/shared/domain/NetGroupEntity.java
 * 
 * FILE NAME        	: NetGroupEntity.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date Oct 18, 2012 6:51:50 PM
 * @version 1.0
 */
public class NetGroupEntity extends DownloadableEntity {

    /**
     * 序列化
     */
    private static final long serialVersionUID = 8809639375697737944L;
     ...
     * 到达营业部部门编码
     */
    private String targetOrganizationCode;
	...
	result = prime
		* result
		+ ((freightRouteVirtualCode == null) ? 0
			: freightRouteVirtualCode.hashCode());
	result = prime * result
		+ ((netGroupName == null) ? 0 : netGroupName.hashCode());
	result = prime
		* result
		+ ((sourceOrganizationCode == null) ? 0
			: sourceOrganizationCode.hashCode());
	result = prime
		* result
		+ ((targetOrganizationCode == null) ? 0
			: targetOrganizationCode.hashCode());
	return result;
    }
	...
	//313353 2016/09/12  sonar优化增加  start
	if (null == obj){
		return false;
	}
	//313353 2016/09/12  sonar优化增加  end
	if (!super.equals(obj)) {
	    return false;
	}
	...
	NetGroupEntity other = (NetGroupEntity) obj;
	if (active == null) {
	...
	if (freightRouteVirtualCode == null) {
	    if (other.freightRouteVirtualCode != null) {
		return false;
	    }
	} else if (!freightRouteVirtualCode
		.equals(other.freightRouteVirtualCode)) {
	    return false;
	}
	if (netGroupName == null) {
	    if (other.netGroupName != null) {
		return false;
	    }
	} else if (!netGroupName.equals(other.netGroupName)) {
	    return false;
	}
	if (sourceOrganizationCode == null) {
	    if (other.sourceOrganizationCode != null) {
		return false;
	    }
	} else if (!sourceOrganizationCode.equals(other.sourceOrganizationCode)) {
	    return false;
	}
	if (targetOrganizationCode == null) {
	    if (other.targetOrganizationCode != null) {
		return false;
	    }
	} else if (!targetOrganizationCode.equals(other.targetOrganizationCode)) {
	    return false;
	}
	return true;
    }
