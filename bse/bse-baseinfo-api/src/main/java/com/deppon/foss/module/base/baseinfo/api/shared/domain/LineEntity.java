 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/shared/domain/LineEntity.java
 * 
 * FILE NAME        	: LineEntity.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version 1.0
 */
public class LineEntity extends DownloadableEntity {
    ...
    * 发车标准列表
    */
    private List<DepartureStandardEntity> standardList;
    ...
    */
     ...
     */
    public List<DepartureStandardEntity> getStandardList() {
        return standardList;
    }
     ...
     */
    public void setStandardList(List<DepartureStandardEntity> standardList) {
