 ...
 * @version
 */
public class ExpressOriginatingLineVo implements Serializable{
     ...
     * 始发线路实体类.
     */
    private ExpressLineEntity entity;
    
    /**
     * 始发线路实体集合.
     */
    private List<ExpressLineEntity> lineEntities;
     ...
     * 发车标准实体List.
     */
    private List<ExpressDepartureStandardEntity> departureStandardEntityList;
    
    /**
     * 发车标准实体.
     */
    private ExpressDepartureStandardEntity departureStandardEntity;
     ...
     * @return  the entity
     */
    public ExpressLineEntity getEntity() {
        return entity;
    }
     ...
     */
    public void setEntity(ExpressLineEntity entity) {
        this.entity = entity;
    }
     ...
     */
    public List<ExpressLineEntity> getLineEntities() {
        return lineEntities;
    }
     ...
     */
    public void setLineEntities(List<ExpressLineEntity> lineEntities) {
     ...
     */
    public List<ExpressDepartureStandardEntity> getDepartureStandardEntityList() {
    ...
    public void setDepartureStandardEntityList(
    	List<ExpressDepartureStandardEntity> departureStandardEntityList) {
     ...
     */
    public ExpressDepartureStandardEntity getDepartureStandardEntity() {
    ...
    public void setDepartureStandardEntity(
    		ExpressDepartureStandardEntity departureStandardEntity) {
