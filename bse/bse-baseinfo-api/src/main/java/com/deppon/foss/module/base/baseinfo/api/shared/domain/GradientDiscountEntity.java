 ...
 * 
 * @author 218392 张永雪
 * @date 2015-06-02 10:58:30
 * 梯度折基础资料entity
 * 注意的是：本实体CRM客户端和我FOSS服务端公用实体，未做转换(按习惯是要进行先get，再set进我们这边的实体 )
 *
 */

public class GradientDiscountEntity extends BaseEntity implements Serializable{
	 ...
	 * 方案条目集合(CRM)
	 */
	private List<GradientDiscItemEntity> dealItems;
	...
	public List<GradientDiscItemEntity> getDealItems() {
		return dealItems;
	}
	
	public void setDealItems(List<GradientDiscItemEntity> dealItems) {
