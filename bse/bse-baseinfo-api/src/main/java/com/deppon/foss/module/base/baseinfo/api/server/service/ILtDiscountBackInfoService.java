 ...
 * CSS 2015-08-18
 */
public interface ILtDiscountBackInfoService {
	 ...
	 */
	void addCusLtdiscountafter(CusLtdiscountafterEntity entity);
	...
	void updateCusLtdiscountafterInfo(CusLtdiscountafterEntity entity);
	/**
	 * 修改“梯度折基础资料”
