 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/complex/IOrgAdministrativeInfoEmployeeService.java
 * 
 * FILE NAME        	: IOrgAdministrativeInfoEmployeeService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-12-18 上午11:03:54
 */
public interface IOrgAdministrativeInfoEmployeeService {

    /**
     * 
     * 根据 理货部门所服务的外场，理货部门类型（装车/卸车/派送装车），部门的编号，
     *    理货员职位，理货员编号
     * 返回： 理货员直属部门编码，理货员直属部门名称，理货员编码，理货员名称，理货员职位
     * 
     * 动态条件，精确查询 理货员信息
     * 支持分页
