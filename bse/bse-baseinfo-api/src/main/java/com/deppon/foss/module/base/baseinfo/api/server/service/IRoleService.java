...
public interface IRoleService extends IService {
     ...
     * @date 2012-11-2 下午4:11:7
     */
    RoleEntity addRole(RoleEntity entity, boolean isUUMS);
    ...
    /**
     * 
     *<p>根据多个编码精确查询，不给其设置权限列表</p>
     *@author 130566-zengJunfan
     *@date   2013-9-4下午5:13:24
     * @param codes
     * @return
     */
    List<RoleEntity> queryRoleBatchByCodeNoSetResource(String[] codes);
     ...
     * @date 2012-11-2 下午4:11:7
     */
    List<RoleEntity> queryRoleByEntity(
	    RoleEntity entity,int start, int limit);
