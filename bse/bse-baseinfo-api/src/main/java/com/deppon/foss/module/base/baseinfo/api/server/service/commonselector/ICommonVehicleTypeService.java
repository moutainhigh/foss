 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/commonselector/ICommonVehicleTypeService.java
 * 
 * FILE NAME        	: ICommonVehicleTypeService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface ICommonVehicleTypeService {
     ...
     */
     List<VehicleTypeEntity> queryVehicleTypesByCondition(VehicleTypeEntity vehicleType,int offset,int limit);
    /**
     * <p>根据条件有选择的检索出符合条件的“车辆车型”实体列表（条件做自动判断，只选择实体中非空值）</p> 
     * @author 078823-foss-panGuangjun
     * @date 2012-12-10 上午10:37:46
