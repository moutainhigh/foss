 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/shared/domain/LoadAndUnloadEfficiencyTonEntity.java
 * 
 * FILE NAME        	: LoadAndUnloadEfficiencyTonEntity.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public class LoadAndUnloadEfficiencyTonEntity  extends BaseEntity {
	
	/**
	 * 序列化ID
	 */
    private static final long serialVersionUID = -3967231351673187703L;
