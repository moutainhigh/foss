 ...
 * @version
 */
public interface INewbirdinfoDao {
     ...
     * @param entity 菜鸟异常单实体    
     * @return 符合条件的实体列表
     * @see
     */
    List<NewbirdinfoEntity> queryNewbirdinfoByNoPage(
