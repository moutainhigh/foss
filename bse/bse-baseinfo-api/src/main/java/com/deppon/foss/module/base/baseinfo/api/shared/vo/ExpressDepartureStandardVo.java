 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/shared/vo/ExpressDepartureStandardVo.java
 * 
 * FILE NAME        	: ExpressDepartureStandardVo.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version
 */
public class ExpressDepartureStandardVo implements Serializable{
     ...
     * 发车标准实体.
     */
    private ExpressDepartureStandardEntity startStandardEntity;
     ...
     */
    public ExpressDepartureStandardEntity getStartStandardEntity() {
     ...
     */
    public void setStartStandardEntity(ExpressDepartureStandardEntity startStandardEntity) {
