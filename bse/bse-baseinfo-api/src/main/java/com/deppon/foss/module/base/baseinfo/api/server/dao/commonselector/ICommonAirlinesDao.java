 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonAirlinesDao.java
 * 
 * FILE NAME        	: ICommonAirlinesDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 公共查询组件--“航空公司”的数据库对应数据访问DAO接口
 * @author 078823-foss-panGuangjun
 * @date 2012-12-7 上午8:50:06
 * @since
 * @version
 */
public interface ICommonAirlinesDao {
