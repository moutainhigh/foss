 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/commonselector/ICommonVehAgencyDeptService.java
 * 
 * FILE NAME        	: ICommonVehAgencyDeptService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 公共查询组件--偏线代理网点查询service接口
 * @author 078823-foss-panGuangJun
 * @date 2012-12-6 下午1:43:44
 */
public interface ICommonVehAgencyDeptService {
	/**
     * 根据传入对象查询符合条件所有偏线代理网点信息 
     * @author 078823-foss-panGuangJun
     * @date 2012-12-6 下午1:44:44
