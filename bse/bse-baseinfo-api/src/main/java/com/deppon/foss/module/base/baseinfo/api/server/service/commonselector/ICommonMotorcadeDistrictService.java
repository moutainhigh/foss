 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/commonselector/ICommonMotorcadeDistrictService.java
 * 
 * FILE NAME        	: ICommonMotorcadeDistrictService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * FILE    NAME: ICommonMotorcadeServeDistrictService.java
...
/**
 *公共查询组件--车队对应行政区域service接口定义
 * @author 078823-foss-panGuangJun
 * @date 2012-12-5 下午2:44:39
 */
public interface ICommonMotorcadeDistrictService {
	/** 
     * 根据条件查询车队对应行政区域 
     * @author 078823-foss-panGuangjun
