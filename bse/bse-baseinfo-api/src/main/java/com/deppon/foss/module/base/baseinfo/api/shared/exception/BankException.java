 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/shared/exception/BankException.java
 * 
...
public class BankException extends BusinessException {
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = 4429437153069322987L;

    public BankException(String errCode) {
	super();
