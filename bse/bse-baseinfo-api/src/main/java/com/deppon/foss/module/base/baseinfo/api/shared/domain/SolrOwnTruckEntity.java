 ...
 * @version
 */
public class SolrOwnTruckEntity extends BaseEntity {
	...
	public final String getIsOwnTruck() {
		return isOwnTruck;
	}

	public final void setIsOwnTruck(String isOwnTruck) {
	...
	public final void setIsTrailer(String isTrailer) {
		this.isTrailer = isTrailer;
	}

	public String getReginName() {
		if(!StringUtil.isEmpty(reginName)){
			params.add("reginName:"+reginName);
		}
		return reginName;
	}
	...
	* @throws
	...
	public String getVehicleNo() {
		if(!StringUtil.isEmpty(vehicleNo)){
			params.add("vehicleNo:"+vehicleNo);
		}
		return vehicleNo;
	}
	...
	public BigDecimal getSelfWeight() {
		if(null != selfWeight){
			params.add("selfWfight:"+selfWeight);
		}
		return selfWeight;
	}
	...
	public String getUsedType() {
		if(!StringUtil.isEmpty(usedType)){
			params.add("usedType:"+usedType);
		}
		return usedType;
	}
	...
	public BigDecimal getVehicleLength() {
		if(null != vehicleLength){
			params.add("vehicleLength:"+vehicleLength);
		}
	...
	public BigDecimal getVehicleWidth() {
		if(null != vehicleWidth){
			params.add("vehicleWidth:"+vehicleWidth);
		}
		return vehicleWidth;
	}
	...
	public BigDecimal getVehicleHeight() {
		if(null != vehicleHeight){
			params.add("vehicleHeight:"+vehicleHeight);
		}
	...
	public String getTailBoard() {
		if(!StringUtil.isEmpty(tailBoard)){
			params.add("tailBoard:"+tailBoard);
		}
		return tailBoard;
	}
	...
	public String getGpsNo() {
		if(StringUtil.isEmpty(gpsNo)){
			params.add("gpsNo:"+gpsNo);
		}
		return gpsNo;
	}
	...
	public String getVehicleType() {
		if(!StringUtil.isEmpty(vehicleType)){
	...
	public String getContainerCode() {
		if(!StringUtil.isEmpty(containerCode)){
			params.add("containerCode:"+containerCode);
		}
	...
	public String getVehcleLengthCode() {
		if(!StringUtil.isEmpty(vehcleLengthCode)){
			params.add("vehcleLengthCode:"+vehcleLengthCode);
		}
	...
	public String getQueryParam() {
		if(!StringUtil.isEmpty(queryParam)){
			params.add("vehicleNo:"+vehicleNo+" or containerCode:"+containerCode);
		}
		return queryParam;
	}
	...
	public String getVehicleNoNoLike() {
		if(!StringUtil.isEmpty(vehicleNoNoLike)){
			params.add("vehicleNo:"+vehicleNoNoLike);
		}
