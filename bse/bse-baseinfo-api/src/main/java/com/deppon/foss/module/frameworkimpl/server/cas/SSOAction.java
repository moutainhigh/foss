package com.deppon.foss.module.frameworkimpl.server.cas;
...
import com.deppon.foss.module.frameworkimpl.server.util.TokenMarshalNew;
import com.deppon.foss.module.frameworkimpl.shared.domain.CookieToken;

import edu.yale.its.tp.cas.client.IContextInit;

public class SSOAction implements IContextInit {
	...
	public static String getTokenParam() {
		...
		return TokenMarshalNew.marshal(token);
	}
}
