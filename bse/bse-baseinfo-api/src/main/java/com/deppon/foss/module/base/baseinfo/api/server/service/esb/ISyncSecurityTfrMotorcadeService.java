 ...
 * @date 
 */
public interface ISyncSecurityTfrMotorcadeService extends IService {
     ...
     * @date 
     */
    void syncSecurityTfrMotorcadeToEcs(List<SecurityTfrMotorcadeEntity> entitys, int operateType);
