 ...
 * @version
 */
public class PickupAndDeliverySmallZoneException extends BusinessException {
    ...
    public PickupAndDeliverySmallZoneException(String errCode){
	super();
	super.errCode = errCode;
    }
    
    public PickupAndDeliverySmallZoneException(String code,String msg){
