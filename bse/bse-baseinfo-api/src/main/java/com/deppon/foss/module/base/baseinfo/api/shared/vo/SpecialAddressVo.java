...
public class SpecialAddressVo implements Serializable {
	...
	// 特殊地址信息
	private SpecialAddressEntity specialAddress;
	// 特殊地址集合
	private List<SpecialAddressEntity> specialAddressList;
	// 批量操作ID集合
	private List<String> batchIds;

	public SpecialAddressEntity getSpecialAddress() {
		return specialAddress;
	}

	public void setSpecialAddress(SpecialAddressEntity specialAddress) {
		this.specialAddress = specialAddress;
	}

	public List<SpecialAddressEntity> getSpecialAddressList() {
		return specialAddressList;
	}

	public void setSpecialAddressList(
			List<SpecialAddressEntity> specialAddressList) {
		this.specialAddressList = specialAddressList;
	}
