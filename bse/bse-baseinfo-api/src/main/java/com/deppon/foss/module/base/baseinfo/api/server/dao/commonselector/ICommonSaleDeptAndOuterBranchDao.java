 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonSaleDeptAndOuterBranchDao.java
 * 
 * FILE NAME        	: ICommonSaleDeptAndOuterBranchDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface ICommonSaleDeptAndOuterBranchDao{
	/**
	 * 查询营业部和偏线代理网点信息
	 * @author 101911-foss-zhouChunlai
	 * @param 
