 ...
 * @version 1.0
 */
public interface ILineService extends IService{
     ...
     * @see
     */
    LineEntity querySimpleLineByVirtualCode(String virtualCode);  
     ...
     * @see
     */
    List<LineEntity> querySimpleLineListByCondition(LineEntity line);
     ...
     */
    List<LineEntity> querySimpleLineListByCondition(LineEntity line, int start, int limit);
     ...
     * @see
     */
    LineEntity queryLineBySimpleCode(String simpleCode);
     ...
     * @see
     */
    LineEntity querySimpleLineBySimpleCode(String simpleCode);
     ...
     * @return
     */
    LineEntity querySimpleLineBySimpleCodeNoCache(String simpleCode);
    /**
     * 
     * <p>根据条件计算线路数量</p> 
     * @author foss-zhujunyong
     ...
     * @see
     */
    Long calculateAging(LineEntity line, String sourceCode, String targetCode, String productCode);
     ...
     * @see
     */
    FreightRouteLineAgingDto calculateAging(LineEntity line, String sourceCode, String targetCode);
     ...
     * @see
     */
    ExportResource exportLineList(LineEntity line); 
     ...
     * @see
     */
    LineEntity valid(String virtualCode, String modifyUser);
     ...
     * @see
     */
    LineEntity invalid(String virtualCode, String modifyUser);
     ...
     * @see
     */
    LineEntity queryLineEntityByCondition(String sourceCode, String targetCode);
    /**
     * 
     ...
     * @see
     */
	void sendLineInfoToGps(LineEntity line, int isDeleted);
}
