 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonMotorcadeSaleDeptDao.java
 * 
 * FILE NAME        	: ICommonMotorcadeSaleDeptDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 公共查询组件--车队营业部查询dao接口定义
 * 
 * @author 078823-foss-panGuangJun
 * @date 2012-12-5 下午2:29:04
 */
public interface ICommonMotorcadeSaleDeptDao {
	/**
