...
public class CookieToken extends Token{
  ...
  public CookieToken(String sessionId, String userId, String empCode, String currentDeptCode, int expireSecond){
    ...
    c.add(NumberConstants.NUMBER_14, millisecond);
  ...
  public CookieToken(byte[] tokenBytes){
    try{
      ...
      setUserId(keys[1]);
      this.empCode = keys[2];
      this.deptCode = keys[NumberConstants.NUMBER_3];
      this.expireTime = Long.valueOf(Long.parseLong(keys[NumberConstants.NUMBER_4]));
