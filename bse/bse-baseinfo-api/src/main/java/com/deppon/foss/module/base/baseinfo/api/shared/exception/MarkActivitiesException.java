 ...
 * @version
 */
public class MarkActivitiesException extends BusinessException {

    /**
     * serialVersionUID
     */
    private static final long serialVersionUID = 6125710440831899100L;
    
    public MarkActivitiesException(String errCode){
	super();
	super.errCode = errCode;
    }
    
    public MarkActivitiesException(String errCode, Object... para) {
	super(errCode, para);
	super.errCode = errCode;
    }
