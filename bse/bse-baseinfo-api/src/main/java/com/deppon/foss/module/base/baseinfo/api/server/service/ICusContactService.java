 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/ICusContactService.java
 * 
 * FILE NAME        	: ICusContactService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version
 */
public interface ICusContactService extends IService {
	 ...
	 *
	 */
     int addNonfixedCusContact(ContactEntity entity);
     ...
     */
      ...
      * 
      * @author 273296-foss
      * @date 2016-04-18 下午1:49:51
      * @param entity
      *            客户联系人信息实体
      * @return 1：成功；-1：失败
      * @see
      */
	int addCusContactNew(ContactEntity contactEntity);
