 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/commonselector/ICommonFlightService.java
 * 
 * FILE NAME        	: ICommonFlightService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface ICommonFlightService {
     ...
     * @return 符合条件的实体列表
     */
    List<FlightEntity> queryFlight(FlightDto dto,int start,int limit);
     ...
     * @return Long
     */
    Long queryRecordCount(FlightDto dto);
}
