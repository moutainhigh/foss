 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonOrgExtendsDao.java
 * 
 * FILE NAME        	: ICommonOrgExtendsDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 公共查询选择器--组织查询扩展添加营业部信息查询Dao
 * @author 101911-foss-zhouChunlai
 * @date 2013-1-28 上午10:27:14
 */
public interface ICommonOrgExtendsDao{
	/**
	 * 组织查询扩展添加营业部信息查询
	 * @author 101911-foss-zhouChunlai
	 * @param 
