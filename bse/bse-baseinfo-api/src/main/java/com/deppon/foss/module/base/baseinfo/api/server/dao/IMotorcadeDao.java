 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/IMotorcadeDao.java
 * 
 * FILE NAME        	: IMotorcadeDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
public interface IMotorcadeDao {
     ...
     * @author 087584-foss-lijun
     * @date 2012-11-2 下午2:32:19
     * @see com.deppon.foss.module.base.ICommonMotorcadeDao.api.server.dao.IMotorcadeDao#queryMotorcadeByCode(java.lang.String)
     */
     ...
     * @date 2012-11-2 下午2:32:19
     */
    List<MotorcadeEntity> queryMotorcadeExactByEntity(
     ...
     * @date 2012-11-2 下午2:32:19
     */
    List<MotorcadeEntity> queryMotorcadeByEntity(MotorcadeEntity entity,
	    int start, int limit);
     ...
     * @return
     */
    MotorcadeEntity queryTopFleetByTransferCenterCode(String code);
}
