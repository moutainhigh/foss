 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/IMotorcadeServeSalesAreaDao.java
 * 
 * FILE NAME        	: IMotorcadeServeSalesAreaDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface IMotorcadeServeSalesAreaDao {
    /**
     * 插入
     * 
     * @author 087584-foss-lijun
	...
	/**
	 * 
	 *<p>t通过车队编码和营业区编码精确查询</p>
	 *@author 130566-zengJunfan
	 *@date   2013-8-17下午2:56:30
	 * @param motorcadeCode
	 * @param salesareaCode
	 * @return
	 */
    MotorcadeServeSalesAreaEntity queryMotorcadeServeSalesAreaByMotorCodeAndSalesAreaCode(String motorcadeCode,String salesareaCode);
    /**
     * 精确查询
     * 根据多个VIRTUAL_CODE 查询
     * 
     * @author 087584-foss-lijun
     * @date 2012-11-17 下午8:56:38
     * @see com.deppon.foss.module.base.dict.api.server.dao.IMotorcadeServeSalesAreaDao#queryMotorcadeServeSalesAreaByCode(java.lang.String)
     */
     ...
     * @date 2012-11-17 下午8:56:38
     */
    List<MotorcadeServeSalesAreaEntity> queryMotorcadeServeSalesAreaByEntity(MotorcadeServeSalesAreaEntity entity,
	    int start, int limit);
     ...
     * @date 2012-11-17 下午8:56:38
     */
    List<MotorcadeServeSalesAreaEntity> queryMotorcadeServeSalesAreaForDownload(MotorcadeServeSalesAreaEntity entity);
