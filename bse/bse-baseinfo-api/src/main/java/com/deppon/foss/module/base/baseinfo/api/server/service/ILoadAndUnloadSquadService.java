 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/ILoadAndUnloadSquadService.java
 * 
 * FILE NAME        	: ILoadAndUnloadSquadService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @date 2012-11-2 下午2:25:21
 */
public interface ILoadAndUnloadSquadService extends IService {
    /**
     * 插入
     * 
     * @author 087584-foss-lijun
     ...
     * @date 2012-11-2 下午2:25:21
     */
    List<LoadAndUnloadSquadEntity> queryLoadAndUnloadSquadByEntity(
	    LoadAndUnloadSquadEntity entity,int start, int limit);
