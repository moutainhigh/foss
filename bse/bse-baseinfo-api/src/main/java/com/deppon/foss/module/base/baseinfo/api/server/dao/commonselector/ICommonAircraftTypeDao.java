 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonAircraftTypeDao.java
 * 
 * FILE NAME        	: ICommonAircraftTypeDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface ICommonAircraftTypeDao {
    /**
     ...
     */
     List<AircraftTypeEntity> queryAircraftTypeListByCondition(AircraftTypeEntity aircraftType, int offset, int limit);
    /**
     * <p>根据条件有选择的检索出符合条件的“机型信息”实体列表（条件做自动判断，只选择实体中非空值）</p> 
     * @author 078823-foss-panGuangJun
     * @date 2012-12-7 下午8:46:55
