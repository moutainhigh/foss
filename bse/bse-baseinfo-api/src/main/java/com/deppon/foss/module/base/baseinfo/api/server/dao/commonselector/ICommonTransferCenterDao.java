 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonTransferCenterDao.java
 * 
 * FILE NAME        	: ICommonTransferCenterDao.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface ICommonTransferCenterDao {
	/**
	 * 根据条件查询外场信息
	 * @author 101911-foss-zhouChunlai
	 * @param 
