 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/service/commonselector/ICommonPerscriptionRegionService.java
 * 
 * FILE NAME        	: ICommonPerscriptionRegionService.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 */
public interface ICommonPerscriptionRegionExpressService {
	/**
	 * .
	 * <p>
	 * 根据条件查询区域信息<br/>
