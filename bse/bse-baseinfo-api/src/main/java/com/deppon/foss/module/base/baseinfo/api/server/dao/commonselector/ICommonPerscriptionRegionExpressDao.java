 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/server/dao/commonselector/ICommonPerscriptionRegionDao.java
 * 
 ...
 * 公共查询组件--失效区域dao
 * @author panGuangJun
 * @date 2012-12-4 上午10:24:00
 */
public interface ICommonPerscriptionRegionExpressDao {
	/**.
	 * <p>
	 * 根据条件查询区域信息<br/>（分页）
