 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/base/baseinfo/api/shared/domain/OuterBranchEntity.java
 * 
 * FILE NAME        	: OuterBranchEntity.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
...
/**
 * 用来存储交互“空运代理网点、偏线代理网点”的数据库对应实体：SUC-720、SUC-649
 * 
 * @author 100847-foss-GaoPeng
 * @date 2012-10-15 上午9:57:23
 * @since
 * @version
 */
public class OuterBranchEntity extends BaseEntity {
     ...
     * Serial Version UID.
     */
    private static final long serialVersionUID = -8866495764577381512L;
