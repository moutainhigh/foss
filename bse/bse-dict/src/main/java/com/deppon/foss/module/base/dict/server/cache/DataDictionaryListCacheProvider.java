 ...
 */
public class DataDictionaryListCacheProvider implements ITTLCacheProvider<List<DataDictionaryValueEntity>> {
	
	private IDataDictionaryValueDao dataDictionaryValueDao;
	
	@Override
	public List<DataDictionaryValueEntity> get(String key) {
		if(StringUtil.isBlank(key)){
			return null;
		}
		return  (List<DataDictionaryValueEntity>)dataDictionaryValueDao.queryDataDictionaryValueByTermsCode(key);
	}
