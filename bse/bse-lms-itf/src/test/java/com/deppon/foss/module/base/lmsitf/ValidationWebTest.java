 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/lmsitf/ValidationWebTest.java
 * 
 ...
 ******************************************************************************/
package com.deppon.foss.module.base.lmsitf;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/bse-lms-itf/";
	}
}
