 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/base/crm/itf/ValidationWebTest.java
 * 
 ...
 ******************************************************************************/
package com.deppon.foss.module.base.crm.itf;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/bse-crm-itf/ws/syncDataService?wsdl";
	}
}
