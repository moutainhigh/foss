 ...
 *
 */
public class InformationSyncRequestTrans implements IMessageTransform<SyncMotorcadeRequest>{
	/** The Constant CLZZ. */
	 ...
	 */
	@Override
	public String fromMessage(SyncMotorcadeRequest value)
		...
		try {
			...
			JAXBElement<SyncMotorcadeRequest> element = new com.deppon.esb.inteface.domain.oms.ObjectFactory().createSyncMotorcadeRequest(value);
