...
public class SyncAccSalesDeptResponseTrans implements
		IMessageTransform<SyncAccSalesDeptResponse> {
	/** The mapper. */
	 ...
	 */
	@Override
	public SyncAccSalesDeptResponse toMessage(String string)
			throws ESBConvertException {
		SyncAccSalesDeptResponse result = null;
		try {
			result = mapper.readValue(string, SyncAccSalesDeptResponse.class);
	 ...
	 */
	@Override
	public String fromMessage(SyncAccSalesDeptResponse message)
			throws ESBConvertException {
		try {
