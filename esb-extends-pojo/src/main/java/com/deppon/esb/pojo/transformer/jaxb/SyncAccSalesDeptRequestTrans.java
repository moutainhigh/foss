...
public class SyncAccSalesDeptRequestTrans implements
		IMessageTransform<SyncAccSalesDeptRequest> {
	 ...
	 */
	@Override
	public SyncAccSalesDeptRequest toMessage(String string)
			throws ESBConvertException {
		SyncAccSalesDeptRequest result = null;
		try {
			result = mapper.readValue(string, SyncAccSalesDeptRequest.class);
	 ...
	 */
	@Override
	public String fromMessage(SyncAccSalesDeptRequest message)
			throws ESBConvertException {
		try {
