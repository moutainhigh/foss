...
public class InformationSyncResponseTrans implements IMessageTransform<SyncMotorcadeResponse>{
	/** The Constant CLZZ. */
	...
	@Override
	public String fromMessage(SyncMotorcadeResponse value)
		...
		try {
			...
			JAXBElement<SyncMotorcadeResponse> element = new com.deppon.esb.inteface.domain.oms.ObjectFactory().createSyncMotorcadeResponse(value);
