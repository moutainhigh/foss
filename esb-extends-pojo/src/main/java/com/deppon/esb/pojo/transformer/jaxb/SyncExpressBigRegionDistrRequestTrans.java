...
/**
 * SyncExpressBigRegionDistrRequest的转换类.
 * 
 * @author 273311
 * @date 2016-10-21
 */
public class SyncExpressBigRegionDistrRequestTrans implements
		IMessageTransform<SyncExpressBigRegionDistrRequest> {
	 ...
	 */
	@Override
	public SyncExpressBigRegionDistrRequest toMessage(String string)
			throws ESBConvertException {
		SyncExpressBigRegionDistrRequest result = null;
		try {
			result = mapper.readValue(string,
					SyncExpressBigRegionDistrRequest.class);
	 ...
	 */
	@Override
	public String fromMessage(SyncExpressBigRegionDistrRequest message)
			throws ESBConvertException {
		try {
