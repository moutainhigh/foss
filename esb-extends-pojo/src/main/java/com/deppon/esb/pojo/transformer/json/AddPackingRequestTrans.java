...
/**
 * AddPackingRequest的转换类.
 * 
 * @author 316759-foss-RuipengWang
 */
public class AddPackingRequestTrans implements IMessageTransform<PackingToCubcRequest> {
	 ...
	 */
	public PackingToCubcRequest toMessage(String string) throws ESBConvertException {
		return null;
	}
	 ...
	 */
	public String fromMessage(PackingToCubcRequest value) throws ESBConvertException {
