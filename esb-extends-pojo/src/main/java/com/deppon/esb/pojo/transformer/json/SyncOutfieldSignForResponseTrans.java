...
public class SyncOutfieldSignForResponseTrans implements IMessageTransform<SyncOutfieldSignForResponse> {
	 ...
	 */
	@Override
	public SyncOutfieldSignForResponse toMessage(String string)
			throws ESBConvertException {
		SyncOutfieldSignForResponse result = null;
		try {
			result = mapper.readValue(string, SyncOutfieldSignForResponse.class);
	 ...
	 */
	@Override
	public String fromMessage(SyncOutfieldSignForResponse message)
			throws ESBConvertException {
		try {
