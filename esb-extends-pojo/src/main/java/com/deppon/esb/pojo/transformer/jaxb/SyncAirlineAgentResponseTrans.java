...
/**
 * SyncAirlineAgentResponse的转换类.
 * 
 * @author 273311
 * @date 2016-10-21
 */
public class SyncAirlineAgentResponseTrans implements
		IMessageTransform<SyncAirlineAgentResponse> {
	 ...
	 */
	@Override
	public SyncAirlineAgentResponse toMessage(String string)
			throws ESBConvertException {
		SyncAirlineAgentResponse result = null;
		try {
			result = mapper.readValue(string, SyncAirlineAgentResponse.class);
	 ...
	 */
	@Override
	public String fromMessage(SyncAirlineAgentResponse message)
			throws ESBConvertException {
		try {
