...
/**
 * SyncAirlineAgentRequest的转换类.
 * 
 * @author 273311
 * @date 2016-10-21
 */
public class SyncAirlineAgentRequestTrans implements
		IMessageTransform<SyncAirlineAgentRequest> {
	 ...
	 */
	@Override
	public SyncAirlineAgentRequest toMessage(String string)
			throws ESBConvertException {
		SyncAirlineAgentRequest result = null;
		try {
			result = mapper.readValue(string, SyncAirlineAgentRequest.class);
	 ...
	 */
	@Override
	public String fromMessage(SyncAirlineAgentRequest message)
			throws ESBConvertException {
		try {
