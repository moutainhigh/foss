 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://www.deppon.com/uums/inteface/domain/usermanagement" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="SendMdmOrgResponse">
 *   &lt;xs:sequence>
 ...
 *     &lt;xs:element type="ns:SendMdmOrgProcessReult" name="processResult" minOccurs="1" maxOccurs="unbounded"/>
 *     &lt;xs:element type="xs:string" name="sysName" minOccurs="1" maxOccurs="1"/>
 *   &lt;/xs:sequence>
 * &lt;/xs:complexType>
 * </pre>
 */
public class SendMdmOrgResponse
{
    private int successCount;
    private int failedCount;
    private List<SendMdmOrgProcessReult> processResultList = new ArrayList<SendMdmOrgProcessReult>();
     ...
     * @return list
     */
    public List<SendMdmOrgProcessReult> getProcessResultList() {
     ...
     * @param list
     */
    public void setProcessResultList(List<SendMdmOrgProcessReult> list) {
