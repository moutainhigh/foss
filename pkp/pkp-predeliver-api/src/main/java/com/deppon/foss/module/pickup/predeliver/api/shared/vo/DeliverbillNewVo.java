 ...
 * @version
 */
public class DeliverbillNewVo implements Serializable {
	...
	/** 派送单查询条件（新）. */
	private DeliverbillNewDto deliverbillNewDto;
	
	
	/** 派送单查询结果列表（新）. */
	private List<DeliverbillNewDto> deliverbillNewDtoList;
	
	
	
	

	public List<DeliverbillNewDto> getDeliverbillNewDtoList() {
		return deliverbillNewDtoList;
	}

	public void setDeliverbillNewDtoList(
			List<DeliverbillNewDto> deliverbillNewDtoList) {
		this.deliverbillNewDtoList = deliverbillNewDtoList;
	}

	public DeliverbillNewDto getDeliverbillNewDto() {
		return deliverbillNewDto;
	}

	public void setDeliverbillNewDto(DeliverbillNewDto deliverbillNewDto) {
		this.deliverbillNewDto = deliverbillNewDto;
	}
