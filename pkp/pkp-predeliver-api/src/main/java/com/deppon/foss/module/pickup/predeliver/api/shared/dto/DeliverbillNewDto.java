 ...
 * @version
 */
public class DeliverbillNewDto implements Serializable {
	...
	/** 送货大区. */
	private String deliverLargeArea;
	
	/** 送货小区. */
	private String deliverSmallArea;
	
	/** 车辆归属类型. */
	private String vehicleTypeTermscode;
	...
	private String carTaskInfo;	//出车任务
	private String preCarTaskTime;	//预计出车时间
	private String virtualPreCarTaskTime;//时效排序下 虚拟的预计出车时间
	private String takeGoodsDeptCode;	//带货部门编码
	private String takeGoodsDeptName;	//带货部门
	private String transferDeptCode;	//转货部门编码
	private String transferDeptName;	//转货部门
	private BigDecimal expectedbringVolume;	//带货方数（F）
	...
	public String getDeliverLargeArea() {
		return deliverLargeArea;
	}

	public void setDeliverLargeArea(String deliverLargeArea) {
		this.deliverLargeArea = deliverLargeArea;
	}
	...
	public String getVehicleTypeTermscode() {
		return vehicleTypeTermscode;
	}

	public void setVehicleTypeTermscode(String vehicleTypeTermscode) {
		this.vehicleTypeTermscode = vehicleTypeTermscode;
	}
	...
	public String getVirtualPreCarTaskTime() {
		return virtualPreCarTaskTime;
	}

	public void setVirtualPreCarTaskTime(String virtualPreCarTaskTime) {
		this.virtualPreCarTaskTime = virtualPreCarTaskTime;
	}
