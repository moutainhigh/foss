...
public class NotificationEntity extends BaseEntity {
	...
	private String receiptHabitRemark; // 收货习惯
	...
	//是否停发收货人短信
	private boolean stopSmsToReciever;
	...
	/**
	 * @return the stopSmsToReciever
	 */
	public boolean isStopSmsToReciever() {
		return stopSmsToReciever;
	}

	/**
	 * @param stopSmsToReciever the stopSmsToReciever to set
	 */
	public void setStopSmsToReciever(boolean stopSmsToReciever) {
		this.stopSmsToReciever = stopSmsToReciever;
	}
	...
	public void setIsEmptyCar(String isEmptyCar) {
		if (StringUtils.isNotBlank(isEmptyCar)) {
