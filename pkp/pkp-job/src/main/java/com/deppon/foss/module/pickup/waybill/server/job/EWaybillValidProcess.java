...
//			List<String> eWaybillNoList = getEWaybillList(jobId);
//			if(CollectionUtils.isNotEmpty(eWaybillNoList)){
//				EWaybillConditionDto eWaybillConditionDto = new EWaybillConditionDto();
//				eWaybillConditionDto.seteWaybillNoList(eWaybillNoList);
//				autoEWaybillActiveHandleService.process(eWaybillConditionDto);
//				rowNum = eWaybillNoList.size();
//			}
//		}
//		if(rowNum > 0){
//			return rowNum;
...
//	}
//	
//	private List<String> getEWaybillList(String jobId){
//		if(StringUtils.isEmpty(jobId)){
//			return null;
//		}
//		//根据更新的JOBID获取所有激活运单集合
//		List<EWaybillProcessEntity> list = eWaybillProcessService.queryAllByCommon(jobId);
//		if(CollectionUtils.isEmpty(list)){
//			return null;
//		}
//		List<String> eWaybillNoList = new ArrayList<String>();
//		for(EWaybillProcessEntity entity : list){
//			eWaybillNoList.add(entity.getWaybillNo());
//		}
//		//如果集合不为空且大于0
//		if(CollectionUtils.isNotEmpty(eWaybillNoList)){
