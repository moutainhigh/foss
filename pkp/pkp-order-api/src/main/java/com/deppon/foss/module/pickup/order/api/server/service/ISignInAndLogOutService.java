 ...
 * 
 */
public interface ISignInAndLogOutService extends IService {
	...
	* @throws
	 */
	List<PdaSignDto> querySignedInfoByPageForLeased(PdaSignDto dto, int start,
			int limit);
}