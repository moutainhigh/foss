 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/pickup/crm/ValidationWebTest.java
 * 
 ...
 ******************************************************************************/
package com.deppon.foss.module.pickup.crm;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/pkp-crm-itf/services/esbCustomerService?wsdl";
	}
}