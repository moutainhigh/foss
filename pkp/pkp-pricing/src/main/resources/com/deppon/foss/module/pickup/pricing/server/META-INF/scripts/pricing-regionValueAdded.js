pricing.regionValueAdded.VALUATION_TYPE_REGIONVALUEADDED = 'REGIONVALUEADDED'//计费规则——规则类型——区域增值服务
pricing.regionValueAdded.PRICING_CODE_VALUEADDED = "VAS";//增值服务是BF，HK,SH等的父节点
pricing.regionValueAdded.insurance = 'BF';//保费
pricing.regionValueAdded.paymentCollection = 'HK';//代收货款
pricing.regionValueAdded.deliveryCharges = 'SH';//送货费
pricing.regionValueAdded.receivingCharges = 'JH';//接货费
pricing.regionValueAdded.sign = 'QS';//签收回单
pricing.regionValueAdded.storageCharges = 'CCF';//仓储费
pricing.regionValueAdded.otherCharges = 'QT';//其他费用
pricing.regionValueAdded.superDelivery = 'CY';//超远派送
pricing.regionValueAdded.deliveryUpstairs = 'SHSL';//送货上楼
pricing.regionValueAdded.packing = 'BZ';//包装
/**
 * 大件上楼费
 * @author:218371-foss-zhaoyanjun
 * @date:2014-12-10上午09:15
 */
pricing.regionValueAdded.largeDeliveryUpstairs = 'DJSL';
/**
 * 纤袋包装
 * @author:218371-foss-zhaoyanjun
 * @date:2014-11-11下午16:27
 */
pricing.regionValueAdded.paperFiberPacking = 'ZQBZ';
pricing.regionValueAdded.ALL = 'ALL';
pricing.regionValueAdded.LONG = 'L';//长途
pricing.regionValueAdded.SHORT = 'S';//短途
pricing.regionValueAdded.Weight = 'WEIGHT';//计价方式明细-计费类别-按重量
pricing.regionValueAdded.Volume = 'VOLUME';//计价方式明细-计费类别-按体积
pricing.regionValueAdded.originalCost = 'ORIGINALCOST';//计价方式明细-计费类别-原始费用计费
pricing.regionValueAdded.kilometer = 'KILOM';//计价方式明细-计费类别-按公里
pricing.regionValueAdded.returnSubType = 'COD__COD_TYPE';//即日退，三日退，审核退
//签单回收类型
pricing.regionValueAdded.VALUEADDED_RETURN_TYPE = 'VALUEADDED_RETURN_TYPE';
pricing.regionValueAdded.YJFD = 'ORIGINAL';//计价方式明细--服务子类型-签收回单-原件反单
pricing.regionValueAdded.CZFD = 'FAX';//计价方式明细--服务子类型-签收回单-传真反单
//包装类型subType
pricing.regionValueAdded.VALUEADDED_PACKAGE_TYPE = 'VALUEADDED_PACKAGE_TYPE';
pricing.regionValueAdded.PACKAGE_TYPE__BOX='BOX';//木箱
pricing.regionValueAdded.PACKAGE_TYPE__FRAME='FRAME';//木架
pricing.regionValueAdded.PACKAGE_TYPE_SALVER='SALVER';//木托
//费率或者费用类型
pricing.regionValueAdded.FEE = 1;//费用
pricing.regionValueAdded.RATE = 0;//费率
//KG 或者m³ 或者 公里
pricing.regionValueAdded.KG = 'KG';
pricing.regionValueAdded.M3 = 'm³';
pricing.regionValueAdded.KM = '公里';
pricing.regionValueAdded.YUAN = '元';
//元/KG 或者 元/m³ 或者 元/个 或者 元/票
pricing.regionValueAdded.YUANBYWEIGHT = '元/KG';
pricing.regionValueAdded.YUANBYVOLUME = '元/m³';
pricing.regionValueAdded.YUANBYGE = '元/个';
pricing.regionValueAdded.YUANBYTICKET = '元/票';
pricing.regionValueAdded.YUANBYWEIGHTBYTICKET = '元/kg/票';
pricing.regionValueAdded.YUANBYVOLUMEBYTICKET = '元/m³/票';
//计价方式明细—-按重量最大值
pricing.regionValueAdded.CRITERIA_DETAIL_WEIGHT_MAX = 9999999;
//计价方式明细——按体积最大值
pricing.regionValueAdded.CRITERIA_DETAIL_VOLUME_MAX = 9999999;
//计价方式明细——按原始费用计费最大值
pricing.regionValueAdded.CRITERIA_DETAIL_ORIGINALCOST_MAX = 9999999;
pricing.regionValueAdded.valueAddedType = [];//增值服务类型
pricing.regionValueAdded.otherChargesSubType = [];//其他费用（QT）的子类型
pricing.regionValueAdded.tomorrowTime = null;//服务器明天时间
//根据MANA-1320修改
pricing.regionValueAdded.defaultEndTime = null;//默认截止时间
pricing.regionValueAdded.productEntityList = [];//基础产品列表
pricing.regionValueAdded.goodTypeList = [];//货物类型列表
pricing.regionValueAdded.limitedWarrantyItems = [];//限保物品
//价格区域
pricing.regionValueAdded.PRICING_REGION = 'PRICING_REGION';
//查看明细隐藏删除按钮
pricing.regionValueAdded.viewOrUpdateOrDelete = null;
/**
 * 纸纤包装种类为基础增值
 * @author:218371-foss-zhaoyanjun
 * @date:2014-11-15上午10:31
 */
pricing.regionValueAdded.priceFibelPaperPackingEntity_Region = 'region';//基础增值
/**
 * 计价方式明细-计费类别-纸纤包装各类别按件数
 * @author:218371-foss-zhaoyanjun
 * @date:2014-11-14上午11:00
 */
pricing.regionValueAdded.NumberProductSum='NumberProductSum';
...
pricing.searchGoodTypeList = function(){
  Ext.Ajax.request({
    ...
    success:function(response){
      ...
      pricing.regionValueAdded.goodTypeList = result.pricingValuationVo.goodsTypeEntityList;
    },
    failure:function(response){
      var result = Ext.decode(response.responseText);
      if(Ext.isEmpty(result)){
        pricing.showErrorMes(pricing.regionValueAdded.i18n('i18n.pricingRegion.requestTimeOut'));
      }else{
...
pricing.searchProductEntityList = function(){
  Ext.Ajax.request({
    ...
    success:function(response){
      var result = Ext.decode(response.responseText);
      pricing.regionValueAdded.productEntityList = result.pricingValuationVo.productEntityList;
    },
    failure:function(response){
      var result = Ext.decode(response.responseText);
      if(Ext.isEmpty(result)){
...
pricing.queryLimitedWarrantyItemsByEntity = function(){
  Ext.Ajax.request({
    ...
    success:function(response){
      var result = Ext.decode(response.responseText);
      pricing.regionValueAdded.limitedWarrantyItems = result.pricingValuationVo.limitedWarrantyItemsEntityList;//查询限保物品
    },
    failure:function(response){
      var result = Ext.decode(response.responseText);
      if(Ext.isEmpty(result)){
...
pricing.searchValueAddedType = function(){
  Ext.Ajax.request({
    ...
    async:false,
    jsonData:{'pricingValuationVo':{'priceEntity':{'refCode':pricing.regionValueAdded.PRICING_CODE_VALUEADDED}}},
    success:function(response){
      var result = Ext.decode(response.responseText);
      pricing.regionValueAdded.valueAddedType = result.pricingValuationVo.priceEntityList;//将获取的增值服务类型放到全局变量中
    },
    failure:function(response){
      var result = Ext.decode(response.responseText);
      if(Ext.isEmpty(result)){
...
pricing.searchOtherChargesSubType = function(){
  Ext.Ajax.request({
    url:pricing.realPath('searchValueAddedType.action'),
    async:false,
    jsonData:{'pricingValuationVo':{'priceEntity':{'refCode':pricing.regionValueAdded.otherCharges}}},
    success:function(response){
      var result = Ext.decode(response.responseText);
      pricing.regionValueAdded.otherChargesSubType = result.pricingValuationVo.priceEntityList;//将获取的国家信息放到全局变量中
    },
    failure:function(response){
      var result = Ext.decode(response.responseText);
      if(Ext.isEmpty(result)){
...
pricing.haveServerNowTime = function(){
  Ext.Ajax.request({
    ...
    success:function(response){
      ...
      pricing.regionValueAdded.tomorrowTime = today.setDate(today.getDate()+1);//设置明天的时间
    },
    failure:function(response){
      var result = Ext.decode(response.responseText);
      if(Ext.isEmpty(result)){
...
pricing.haveDefaultEndTime = function(){
	Ext.Ajax.request({
		...
		success:function(response){
			...
			pricing.regionValueAdded.defaultEndTime = endDate;
		},
		failure:function(response){
			var result = Ext.decode(response.responseText);
			if(Ext.isEmpty(result)){
   ...
   var params = {'pricingValuationVo':{'valuationId':valuationRecord.get('id'),'priceEntity':{'code':valuationRecord.get('pricingEntryCode')}}};
      var successFun = function(json){
        ...
        if(priceCriteriaDetailEntityList.length<1){
          pricing.showErrorMes(pricing.regionValueAdded.i18n('foss.pricing.sectionAreaValueAddedServiceTheLackDetailedInformation'));
          return;
        }
        ...
        if(isUpdate){//如果是修改将生效日期修改为今天
          ...
          //windowShow.getEditForm().getForm().findField('beginTime').setValue(new Date(pricing.regionValueAdded.tomorrowTime));
          //windowShow.getEditForm().getForm().findField('endTime').setValue(new Date(pricing.regionValueAdded.tomorrowTime));
...
//            windowShow.getEditForm().getForm().findField('productId').setReadOnly(false);//如果未激活,则基础产品可以修改
        ...
        if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.deliveryUpstairs
	    		||valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.deliveryCharges
	    		||valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.receivingCharges
	    		||valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.packing
	    		||valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.storageCharges
	    		||valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.otherCharges
	    		||valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.largeDeliveryUpstairs){
	        /**
    	...
    	if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.paymentCollection){
    		Ext.Array.each(priceCriteriaDetailEntityList,function(rr){
        ...
        if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.insurance){//保费
          windowShow.getDownPanel().getInsuranceFormPanel().getSubTypeCombo().setValue(priceCriteriaDetailEntityList[0].subType);
          //windowShow.getDownPanel().getInsuranceFormPanel().loadRecord(new Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity(priceCriteriaDetailEntityList[0]));
          windowShow.getDownPanel().getInsuranceFormPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.storageCharges){//仓储
          windowShow.getDownPanel().getStorageChargesFormPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.otherCharges){//其它
          windowShow.getDownPanel().getOtherChargesGridPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.deliveryCharges){//送货
          windowShow.getDownPanel().getDeliveryChargesGridPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.paymentCollection){//代收货款
          windowShow.getDownPanel().getPaymentCollectionGridPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.superDelivery){//超远派送
          windowShow.getDownPanel().getSuperDeliveryGridPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.deliveryUpstairs){//送货上楼费
          windowShow.getDownPanel().getDeliveryUpstairsGridPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.packing){//包装费
          windowShow.getDownPanel().getPackingFormPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.sign){//签收回单
          windowShow.getDownPanel().getSignFormPanel().getStore().loadData(priceCriteriaDetailEntityList);
        }else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.receivingCharges){//接货费
    	 ...
    	 */
    	else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.paperFiberPacking){
    	 ...
    	 */
    	else if(valuationRecord.get('pricingEntryCode')==pricing.regionValueAdded.largeDeliveryUpstairs){//送货上楼费
...
pricing.addValueAddedRegion = function(editForm,me){
  var priceValuationEntity = new Foss.pricing.regionValueAdded.PriceValuationEntityModel();//创建计费规则的MODEL
  ...
  priceValuationEntity.set('type',pricing.regionValueAdded.VALUATION_TYPE_REGIONVALUEADDED);//设置增值服务类型为区域增值服务
  ...
  if(Ext.isEmpty(arrvRegionId)&&Ext.isEmpty(deptRegionId)){//目的地（区域）和 始发地（区域）必填其一
    pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.destinationAndOriginSelectOne'));//目的地（区域）和 始发地（区域）必填其一
    return ;
  }
  if(Ext.isEmpty(deptRegionId)){
    deptRegionId = pricing.regionValueAdded.ALL;
  }
  if(Ext.isEmpty(arrvRegionId)){
    arrvRegionId = pricing.regionValueAdded.ALL;
  }
...
//  }
  ...
  var pricingEntryCode = priceValuationEntity.get('pricingEntryCode');//得到计价条目CODE
    if(pricingEntryCode==pricing.regionValueAdded.insurance){//保费 BF
    	...
    	var priceCriteriaDetailEntity= new Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity();//计价方式明细
    	if(insuranceForm.isValid()){
    		...
    		if(priceCriteriaDetailEntity.get('minFee')>priceCriteriaDetailEntity.get('maxFee')){
				pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.minimumPremiumGreaterThanMaximumCoverageForMinimumInsurance'));//代收货款中有一条数据，最低一票大于最高一票！
				return ;
			}
    		priceCriteriaDetailEntity.set('caculateType',pricing.regionValueAdded.originalCost);
    		priceCriteriaDetailEntity.set('valueaddRightrange',pricing.regionValueAdded.CRITERIA_DETAIL_ORIGINALCOST_MAX);
    	...
    	*/
	}else if(pricingEntryCode==pricing.regionValueAdded.paymentCollection){//代收货款 HK
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.superDelivery){//超远派送 CY
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.deliveryUpstairs){//送货上楼 SHSL
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.deliveryCharges){//送货费 SH
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.receivingCharges){//接货费 JH
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.sign){//签收回单 QS
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.storageCharges){//仓储费 CCF
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.otherCharges){//其它费用 QT
	...
	}else if(pricingEntryCode==pricing.regionValueAdded.packing){//其它费用 QT
	 ...
	 */
	else if(pricingEntryCode==pricing.regionValueAdded.paperFiberPacking){
		var fibelPaperPackingForm=me.getDownPanel().getPaperFiberPackingFormPanel().getForm();
		var priceCriteriaDetailEntityFibelPaperPacking= new Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity();
		var priceFibelPaperPackingEntity=new Foss.pricing.regionValueAdded.PriceFibelPaperPackingEntity();
		if(fibelPaperPackingForm.isValid()){
			...
			priceFibelPaperPackingEntity.set('kind',pricing.regionValueAdded.priceFibelPaperPackingEntity_Basic);
		}else{
			return;
		}
		priceCriteriaDetailEntityFibelPaperPacking.set('priceFibelPaperPackingEntity',priceFibelPaperPackingEntity.data);
		priceCriteriaDetailEntityFibelPaperPacking.set('caculateType',pricing.regionValueAdded.originalCost);
	 ...
	 */
	else if(pricingEntryCode==pricing.regionValueAdded.largeDeliveryUpstairs){
    ...
    // 需要记录是新增操作还是升级版本操作
	var operateTypeForAddAndUpdateVersion = pricing.regionValueAdded.viewOrUpdateOrDelete;
    ...
    var successFun = function(json){
      ...
      var grid  = Ext.getCmp('T_pricing-indexRegionValuation_content').getPricingValuationGrid();
      grid.getPagingToolbar().moveFirst();
      me.hide();
    };//成功之后提示成功，隐藏现在界面
    var failureFun = function(json){
    	//新增Window提交按钮
        if (Ext.getCmp('pricing_regionValueAdded_commitButton') != undefined) {
	    	  Ext.getCmp('pricing_regionValueAdded_commitButton').enable();
        }
        //修改Window提交按钮
        if (Ext.getCmp('pricing_regionValueAdded_updateCommitButton') != undefined) {
	    	Ext.getCmp('pricing_regionValueAdded_updateCommitButton').enable();
    	}
	    if(Ext.isEmpty(json)){
	    	pricing.showErrorMes(pricing.regionValueAdded.i18n('i18n.pricingRegion.requestTimeOut'));
	    } else {
    ...
    var url = pricing.realPath('addValueAdded.action');//新增区域增值服务
	//新增Window提交按钮
    if (Ext.getCmp('pricing_regionValueAdded_commitButton') != undefined) {
    	Ext.getCmp('pricing_regionValueAdded_commitButton').disable(); // 发送请求之前禁掉提交按钮
    }
    //修改Window提交按钮
    if (Ext.getCmp('pricing_regionValueAdded_updateCommitButton') != undefined) {
		Ext.getCmp('pricing_regionValueAdded_updateCommitButton').disable();
	}
    pricing.requestJsonAjax(url,params,successFun,failureFun);//发送AJAX请求
}
//------------------------------------pricing----------------------------------
//计价条目MODEL
Ext.define('Foss.pricing.regionValueAdded.PriceEntityModel', {
...
//计费规则MODEL
Ext.define('Foss.pricing.regionValueAdded.PriceValuationEntityModel', {
    extend: 'Ext.data.Model',
    fields : [{
...
//计价方式明细MODEL
Ext.define('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
    extend: 'Ext.data.Model',
    fields : [{
        name : 'id',//id
        type : 'string'
    	...
    	/**
    	 * 将Foss.pricing.regionValueAdded.PriceFibelPaperPackingEntity封装到此类中
    	 * @author:218371-foss-zhaoyanjun
    	 * @date:2014-11-13下午19:27
    	 */
    	name:'priceFibelPaperPackingEntity',
    	type:'Foss.pricing.regionValueAdded.PriceFibelPaperPackingEntity',
    	defaultValue:null
    }]
});
//基础产品明细MODEL
Ext.define('Foss.pricing.regionValueAdded.ProductEntity', {
    extend: 'Ext.data.Model',
    fields : [{
        name : 'id',//id
        type : 'string'
...
//货物类型MODEL
Ext.define('Foss.pricing.regionValueAdded.GoodsTypeEntity', {
    extend: 'Ext.data.Model',
    fields : [{
        name : 'id',
        type : 'string'//id
 ...
 * 区域MODEL
 */
Ext.define('Foss.pricing.regionValueAdded.AreaModel', {
  extend : 'Ext.data.Model',
  fields : [ {
    name : 'id',
    type : 'string'
...
//货物类型里的grid的model
Ext.define('Foss.pricing.regionValueAdded.GoodTypeModel',{
	extend: 'Ext.data.Model',
	fields:[{
...
//基础产品里的grid的model
Ext.define('Foss.pricing.regionValueAdded.BasicProductModel',{
	extend: 'Ext.data.Model',
	fields:[{
		name:'code'
	},{
...
//------------------------------------model----------------------------------
//货物类型里的grid的store
Ext.define('Foss.pricing.regionValueAdded.GoodTypeStore',{
	extend : 'Ext.data.Store',
	model:'Foss.pricing.regionValueAdded.GoodTypeModel',
	pageSize:1000,
	proxy : {
		type : 'ajax',
		actionMethods : 'post',
...
//基础产品里的grid的store
Ext.define('Foss.pricing.regionValueAdded.BasicProductStore',{
	extend : 'Ext.data.Store',
	model:'Foss.pricing.regionValueAdded.BasicProductModel',
	pageSize:1000,
	proxy : {
		type : 'ajax',
		actionMethods : 'post',
 ...
 * 区域Store
 */
Ext.define('Foss.pricing.regionValueAdded.PricingValuationStore', {
  extend : 'Ext.data.Store',
  model : 'Foss.pricing.regionValueAdded.PriceValuationEntityModel',//引用MODEL
  pageSize:20,//每页显示20条
  proxy : {
    type : 'ajax',
    actionMethods : 'post',
 ...
 * 区域增值服务查询表单
 */
Ext.define('Foss.pricing.regionValueAdded.QueryRegionValueAddedForm', {
  extend : 'Ext.form.Panel',
  title: pricing.regionValueAdded.i18n('i18n.pricingRegion.searchCondition'),
  frame: true,
  collapsible: true,
    defaults : {
      margin : '8 10 5 10',
  ...
  constructor : function(config) {//构造器
    ...
    for(var i = 0;i<pricing.regionValueAdded.valueAddedType.length;i++){
      valueAddedType.push(pricing.regionValueAdded.valueAddedType[i]);
    }
    valueAddedType.push({'code':pricing.regionValueAdded.ALL,'name':pricing.regionValueAdded.i18n('i18n.pricingRegion.all')});
    me.items = [{
      ...
      queryMode: 'local',
        ...
        valueField: 'code',
        editable:false,
        value:pricing.regionValueAdded.ALL,
        store:pricing.getStore(null,'Foss.pricing.regionValueAdded.PriceEntityModel',null
        ,valueAddedType),
          fieldLabel: pricing.regionValueAdded.i18n('foss.pricing.theirRespectiveValueAddedServices'),//所属增值服务
          xtype : 'combo',
          columnWidth:.3
    },{
      xtype:'datefield',
      fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.businessDate'),//业务日期
      format:'Y-m-d',
      name:'beginTime',
      columnWidth:.3
    },{
      xtype: 'displayfield',
      columnWidth : .3,
      value:pricing.regionValueAdded.i18n('foss.pricing.PAccordingValueAddedServicesBusinessDatesRangeClosingDate')//根据业务日期查询介于生效日期和截止日期之间的增值服务
    },{
      name: 'startRegionId',
      valueField: 'id',
        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.originatingArea'),//始发区域
      ...
      name: 'arrvRegionId',
      valueField: 'id',
        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.destinationArea'),//始发区域
        xtype : 'commonallpriceregionselector',
        priceRegionFlag:'VALUEADD_REGION',
        columnWidth:.3
    },{
      ...
      items : [{
        ...
        width:70,
        cls:'yellow_button',
        text : pricing.regionValueAdded.i18n('i18n.pricingRegion.search'),//查询按钮
        disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationQueryButton'),
        hidden: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationQueryButton'),
        handler : function() {
          if(me.getForm().isValid()){
            var grid  = Ext.getCmp('T_pricing-indexRegionValuation_content').getPricingValuationGrid();//得大grid
 ...
 * 区域增值服务列表
 */
Ext.define('Foss.pricing.regionValueAdded.PricingRegionValuationGridPanel', {
  extend: 'Ext.grid.Panel',
  title : pricing.regionValueAdded.i18n('i18n.pricingRegion.searchResults'),
  cls: 'autoHeight',
  bodyCls: 'autoHeight', 
  ...
  emptyText: pricing.regionValueAdded.i18n('foss.pricing.theQueryResultIsEmpty'),//查询结果为空
  frame: true,
  //得到bbar（分页）
  pagingToolbar : null,
  ...
  //新增区域增值服务
    regionValueAddedWindow:null,
  getRegionValueAddedWindow:function(){
    if (Ext.isEmpty(this.regionValueAddedWindow)) {
      this.regionValueAddedWindow = Ext.create('Foss.pricing.regionValueAdded.RegionValueAddedWindow');
    }
    return this.regionValueAddedWindow;
  },
  //查看区域增值服务详情WINDOW
  regionValueAddedShowWindow:null,
  getRegionValueAddedShowWindow:function(){
    if (Ext.isEmpty(this.regionValueAddedShowWindow)) {
      this.regionValueAddedShowWindow = Ext.create('Foss.pricing.regionValueAdded.RegionValueAddedShowWindow');
    }
    return this.regionValueAddedShowWindow;
  },
  //用于修改弹出的WINDOW
  regionValueAddedUpdateWindow:null,
  getRegionValueAddedUpdateWindow:function(){
    if (Ext.isEmpty(this.regionValueAddedUpdateWindow)) {
      this.regionValueAddedUpdateWindow = Ext.create('Foss.pricing.regionValueAdded.RegionValueAddedUpdateWindow');
    }
    return this.regionValueAddedUpdateWindow;
  },
  //新增区域增值服务
  addRegionValueAdded:function(){
    var me = this;
      pricing.regionValueAdded.viewOrUpdateOrDelete = 'add';
    me.getRegionValueAddedWindow().show();//显示新增弹窗
    Ext.getCmp('pricing_regionValueAdded_commitButton').setDisabled(false);
  },
  //终止增值服务WINDOW
  regionValueAddedEndTimeWindow:null,
  getRegionValueAddedEndTimeWindow:function(){
    if (Ext.isEmpty(this.regionValueAddedEndTimeWindow)) {
      this.regionValueAddedEndTimeWindow = Ext.create('Foss.pricing.regionValueAdded.RegionValueAddedEndTimeWindow');
      this.regionValueAddedEndTimeWindow.parent = this;
    }
    return this.regionValueAddedEndTimeWindow;
  },
  //激活增值服务
  activeValueAdded:function(){
    ...
    if(selections.length<1){
      pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.pleaseSelectValueAddedServicesActivated'));//请选择要激活的增值服务！
      return;
    }
    var today = new Date(pricing.regionValueAdded.tomorrowTime);
      ...
      if(selections[i].get('active')=='N'){
        if(selections[i].get('beginTime').getTime()<=today){//过期的数据不能激活
          pricing.showWoringMessage('名称：'+selections[i].get('name')//'名称：
              ...
              +pricing.regionValueAdded.i18n('foss.pricing.regionalValueAddedServicesExpiredNotActivate'));//的区域增值服务已经过期，不可激活！
          return;
        }else{
    ...
    if(valuationIds.length<1){
      pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.pleaseSelectAtLeastOneInactiveValueAddedServices'));//请至少选择一条未激活的增值服务！
      return;
    }
    pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.doYouWantActivateInactiveRegionalValueAddedServices'),function(e){//是否要激活这些未激活的区域增值服务？
  ...
  deleteValueAdded:function(){
    ...
    var selections = me.getSelectionModel().getSelection();
    if(selections.length<1){
      pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.pleaseChooseCeleteNotActivatedValueAddedServices'));//请选择要激活的增值服务！
      return;
    }
    for(var i = 0 ; i<selections.length ; i++){
      if(selections[i].get('active')=='Y'){//只有未激活的增值服务才可以删除
        pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.pleaseChooseCeleteNotActivatedValueAddedServices'));//请选择要删除的未激活增值服务！
        return;
      }else if(selections[i].get('active')=='N'){
        valuationIds.push(selections[i].get('id'));
      }
    }
    pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteTheseValueAddedServicesNotActivated'),function(e){//是否要删除这些未激活的增值服务？
  ...
  getImmediatelyActiveWindow: function(){
    if(Ext.isEmpty(this.immediatelyActiveWindow)){
      this.immediatelyActiveWindow = Ext.create('Foss.pricing.regionValueAdded.ImmediatelyActiveTimeWindow');
  ...
  getImmediatelyStopWindow: function(){
    if(Ext.isEmpty(this.immediatelyStopWindow)){
      this.immediatelyStopWindow = Ext.create('Foss.pricing.regionValueAdded.ImmediatelyStopEndTimeWindow');
  ...
  constructor : function(config) {
    ...
    me.columns = [{xtype: 'rownumberer',
      width:40,//序号
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.num')
    },{
      align : 'center',
      xtype : 'actioncolumn',
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.opra'),//操作
      items: [{
        iconCls: 'deppon_icons_edit',
                tooltip: pricing.regionValueAdded.i18n('foss.pricing.update'),//修改
                disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationUpdateButton'),
        width:42,
          ...
          if (r.get('active') === 'N') {//未激活的显示
              ...
              return 'statementBill_hide';//隐藏图标
                ...
                handler: function(grid, rowIndex, colIndex) {
                  pricing.regionValueAdded.viewOrUpdateOrDelete = 'update';
                  var grid = Ext.getCmp('T_pricing-indexRegionValuation_content').getPricingValuationGrid();
                  var valuationRecord = grid.getStore().getAt(rowIndex);;//选中的计费规则数据
                  var windowShow =  grid.getRegionValueAddedUpdateWindow();

          	    if (Ext.getCmp('pricing_regionValueAdded_updateCommitButton') != undefined) {
          	    	Ext.getCmp('pricing_regionValueAdded_updateCommitButton').setDisabled(false);
          		}
        ...
        iconCls: 'deppon_icons_softwareUpgrade',
                tooltip: pricing.regionValueAdded.i18n('foss.pricing.upgradedVersion'),//升级版本
                disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationCopyButton'),
        width:42,
        getClass : function (v, m, r, rowIndex) {
        ...
        handler: function(grid, rowIndex, colIndex) {
        	pricing.regionValueAdded.viewOrUpdateOrDelete = 'upgradedVersion';
        	var grid = Ext.getCmp('T_pricing-indexRegionValuation_content').getPricingValuationGrid();
        	var valuationRecord = grid.getStore().getAt(rowIndex);;//选中的计费规则数据
        	var windowShow =  grid.getRegionValueAddedUpdateWindow();
			windowShow.valuationRecord = valuationRecord;
        ...
        iconCls: 'deppon_icons_showdetail',
                tooltip: pricing.regionValueAdded.i18n('foss.pricing.details'),//查看详情
                disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationQueryDetailButton'),
        width:42,
                handler: function(grid, rowIndex, colIndex) {
                  pricing.regionValueAdded.viewOrUpdateOrDelete = 'delete';
                  var grid = grid.up();
                  var valuationRecord = grid.getStore().getAt(rowIndex);;//选中的计费规则数据
                  var windowShow =  grid.getRegionValueAddedShowWindow();
                  windowShow.valuationRecord = valuationRecord;
                  pricing.requestAndSetInfoRegion(valuationRecord,windowShow,false);
                }
      }]
    },{
      text : pricing.regionValueAdded.i18n('foss.pricing.scenarioName'),//方案名称
      dataIndex : 'name'
    },{
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.lastCreateUser'),//最后创建人
      dataIndex : 'modifyUserName'
    },{
      text : pricing.regionValueAdded.i18n('foss.pricing.theirRespectiveValueAddedServices'),//增值服务
      dataIndex : 'pricingEntryCode',
      renderer:function(value){
        for(var i = 0;i<pricing.regionValueAdded.valueAddedType.length;i++){
          if(pricing.regionValueAdded.valueAddedType[i].code == value){
            return pricing.regionValueAdded.valueAddedType[i].name;
          }
        }
      }
    },{
      text :pricing.regionValueAdded.i18n('foss.pricing.departureRegion'),//出发地区域
      dataIndex : 'deptRegionName'
    },{
      text : pricing.regionValueAdded.i18n('foss.pricing.availabilityDate'),//生效日期
      dataIndex : 'beginTime',
      renderer:function(value){
        return Ext.Date.format(new Date(value), 'Y-m-d H:i:s');
      }
    },{
      text : pricing.regionValueAdded.i18n('foss.pricing.deadline'),//截止日期
      dataIndex : 'endTime',
      renderer:function(value){
        return Ext.Date.format(new Date(value), 'Y-m-d H:i:s');;
      }
    },{
      text :pricing.regionValueAdded.i18n('foss.pricing.destinationDiArea'),//出发地区域
      dataIndex : 'arrvRegionName'
    },{
      text :pricing.regionValueAdded.i18n('foss.pricing.status'),//状态
      dataIndex : 'active',
      width:50,
      renderer:function(value){
        if(value=='Y'){//'Y'表示激活
          return pricing.regionValueAdded.i18n('i18n.pricingRegion.active');
        }else if(value=='N'){//'N'表示未激活
          return  pricing.regionValueAdded.i18n('i18n.pricingRegion.unActive');
        }else{
          return '';
        }
      }
    ...
    me.store = Ext.create('Foss.pricing.regionValueAdded.PricingValuationStore',{
      autoLoad : false,//自动加载
      pageSize : 20,//每页20条
      listeners: {
        beforeload: function(store, operation, eOpts){
          var queryForm = Ext.getCmp('T_pricing-indexRegionValuation_content').getQueryForm();//得到查询的FORM表单
          if(queryForm!=null){
            Ext.apply(operation,{
              params : {
                //得到查询条件“服务类型”
                ...
                'pricingValuationVo.priceValuationEntity.type' : 
                  pricing.regionValueAdded.VALUATION_TYPE_REGIONVALUEADDED,
                'pricingValuationVo.priceValuationEntity.deptRegionId' : 
                  queryForm.getForm().findField('startRegionId').getValue(),
                'pricingValuationVo.priceValuationEntity.arrvRegionId' : 
                  queryForm.getForm().findField('arrvRegionId').getValue()
              }
            });  
          }
        }
    ...
    me.tbar = [{
      //新增
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.add'),
      disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationAddButton'),
      hidden: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationAddButton'),
      handler :function(){
        me.addRegionValueAdded();
      } 
    },'-', {
      //激活
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.active'),
      disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationActiveButton'),
      hidden: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationActiveButton'),
      handler :function(){
        me.activeValueAdded();
      } 
    },'-', {
      //删除
      text : pricing.regionValueAdded.i18n('foss.pricing.delete'),
      disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationDeleteButton'),
      hidden: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationDeleteButton'),
      handler :function(){
        me.deleteValueAdded();
      } 
    },'-',{
      //终止
      text : pricing.regionValueAdded.i18n('foss.pricing.termination'),
      disabled: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationStopButton'),
      hidden: !pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationStopButton'),
      handler :function(){
        var selections = me.getSelectionModel().getSelection();
        if(selections.length!=1){
          pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.pleaseSelectActivationEffectiveDataTermination'));
          return;
        }else{
        ...
        me.getRegionValueAddedEndTimeWindow().show();
        me.getRegionValueAddedEndTimeWindow().selection = selections[0];
      } 
    },'-', {
      text : pricing.regionValueAdded.i18n('foss.pricing.immediatelyActivationProgram'),//'立即激活',
      disabled:!pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationImmediatelyActiveButton'),
      hidden:!pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationImmediatelyActiveButton'),
      handler :function(){
        me.immediatelyActive();
      } 
    },'-', {
      text : pricing.regionValueAdded.i18n('foss.pricing.immediatelyStopProgram'),//'立即中止',
      disabled:!pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationImmediatelyStopButton'),
      hidden:!pricing.regionValueAdded.isPermission('indexRegionValuation/indexRegionValuationImmediatelyStopButton'),
      handler :function(){
        me.immediatelyStop();
      } 
    }];
...
Ext.onReady(function() {
  Ext.QuickTips.init();
  if (Ext.getCmp('T_pricing-indexRegionValuation_content')) {
    return;
  }
  ...
  var queryForm  = Ext.create('Foss.pricing.regionValueAdded.QueryRegionValueAddedForm');//查询FORM
  var pricingValuationGrid  = Ext.create('Foss.pricing.regionValueAdded.PricingRegionValuationGridPanel');//查询结果显示列表
  var setDate = Ext.create('Ext.form.field.Date');
  setDate.setValue(new Date(pricing.regionValueAdded.tomorrowTime));//得到明天时间是明天的当前时间不是明天的零点零零分
  pricing.regionValueAdded.tomorrowTime = setDate.getValue().getTime();//过一次datefield就变成零点零零分了
  Ext.getCmp('T_pricing-indexRegionValuation').add(Ext.create('Ext.panel.Panel', {
      id : 'T_pricing-indexRegionValuation_content',
 ...
 * 区域增值服务-查看详情
 */
Ext.define('Foss.pricing.regionValueAdded.RegionValueAddedShowWindow',{
  extend : 'Ext.window.Window',
  title : pricing.regionValueAdded.i18n('foss.pricing.regionalValueAddedServiceDetails'),//区域增值服务详情
  closable : true,
  modal : true,
  resizable:false,
  closeAction : 'hide',
...
//      me.getEditForm().getForm().findField('goodsTypeId').goodsTypeRecord = null;
  ...
  getEditForm:function(){
    if(Ext.isEmpty(this.editForm)){
        this.editForm = Ext.create('Foss.pricing.regionValueAdded.RegionValueAddedEditFormPanel',{
  ...
  getDownPanel:function(){
	if(this.downPanel==null){
        this.downPanel = Ext.create('Foss.pricing.regionValueAdded.RegionDownPanel',{
          'isReadOnly':true//设置是否只读
        });
      }
  ...
  returnGrid:function(){
    ...
    me.fbar = [{
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.returnGrid'),//返回列表
      handler :function(){
        me.close();
      } 
    }];
 ...
 * 区域增值服务-修改
 */
Ext.define('Foss.pricing.regionValueAdded.RegionValueAddedUpdateWindow',{
  extend : 'Ext.window.Window',
  title : pricing.regionValueAdded.i18n('foss.pricing.modifyTheRegionalValueAddedServices'),//修改区域增值服务
  closable : true,
  modal : true,
  resizable:false,
  closeAction : 'hide',
...
//        this.editForm.getForm().findField('active').items.items[1].setReadOnly(true);
  ...
  getRegionWindow:function(){
    if(Ext.isEmpty(this.regionWindow)){
        this.regionWindow = Ext.create('Foss.pricing.regionValueAdded.RegionGridShowWindow');
      }
  ...
  returnGrid:function(){
    ...
    //提交数据
    commintRegionValueAdded:function(){
      var me = this;
      ...
      if(editForm.isValid()){//判断增值服务类型，长短途，是否激活，生效日期是否全部填写级及上半部分FORM是否按要求填写
        ...
        if(me.valuationRecord.get('active')=='N'){
          var priceValuationEntity = new Foss.pricing.regionValueAdded.PriceValuationEntityModel(me.valuationRecord.data);
              editForm.updateRecord(priceValuationEntity);//将上半部分数据设置到创建计费规则的MODEL中
              var arrvRegionId = editForm.findField('arrvRegionName').regionId;//目的地（区域）ID
              var deptRegionId = editForm.findField('deptRegionName').regionId;//始发地（区域）ID
              if(Ext.isEmpty(arrvRegionId)&&Ext.isEmpty(deptRegionId)){//目的地（区域）和 始发地（区域）必填其一
              ...
              var priceCriteriaDetailEntityFibelPaperPacking = null;
                 ...
                 */
                else if(pricingEntryCode==pricing.regionValueAdded.paperFiberPacking){//纸纤包装费用修改
            		var priceFibelPaperPackingEntity=new Foss.pricing.regionValueAdded.PriceFibelPaperPackingEntity();
            		...
            		if(paperFiberPackingForm.isValid()){
            			...
            			for(var i= 0;i<me.priceCriteriaDetailEntityList.length;i++){
            				priceCriteriaDetailEntityFibelPaperPacking = new Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity(me.priceCriteriaDetailEntityList[i]);
            				priceCriteriaDetailEntityFibelPaperPacking.set('priceFibelPaperPackingEntity',priceFibelPaperPackingEntity.data);
                		}
            		}else{
            			return;
                ...
                if(pricingEntryCode==pricing.regionValueAdded.paperFiberPacking){
                ...
                var failureFun = function(json){
                    ...
                    if(Ext.isEmpty(json)){
                    	pricing.showErrorMes(pricing.regionValueAdded.i18n('i18n.pricingRegion.requestTimeOut'));//提示请求超时
                    	var grid  = Ext.getCmp('T_pricing-indexRegionValuation_content').getPricingValuationGrid();
                    	grid.getPagingToolbar().moveFirst();//重新查询计费规则
	              	} else {
	              		pricing.showErrorMes(json.message);
                ...
                var url = pricing.realPath('updateValueAdded.action');//修改区域增值服务
                //修改Window提交按钮
                if (Ext.getCmp('pricing_regionValueAdded_updateCommitButton') != undefined) {
            		Ext.getCmp('pricing_regionValueAdded_updateCommitButton').disable();
            	}
    ...
    me.items = [me.getEditForm(), me.getDownPanel()];
    me.fbar = [{
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.returnGrid'),
      handler :function(){
        me.close();
      } 
    },'->',{
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.commit'),
      cls:'yellow_button',
      id : 'pricing_regionValueAdded_updateCommitButton',
      handler :function(){
        me.commintRegionValueAdded();
      } 
    }];
    me.callParent([cfg]);
  }
 ...
 * 区域增值服务-新增
 */
Ext.define('Foss.pricing.regionValueAdded.RegionValueAddedWindow',{
  extend : 'Ext.window.Window',
  title : pricing.regionValueAdded.i18n('foss.pricing.newRegionalValueAddedServices'),//新增区域增值服务
  closable : true,
  modal : true,
  resizable:false,
  closeAction : 'hide',
...
//      me.getEditForm().getForm().findField('goodsTypeId').goodsTypeRecord = null;//货物类型属性设置为空
  ...
  getDownPanel:function(){
    ...
    me.fbar = [{
      ...
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.commit'),
      cls:'yellow_button',
      id:'pricing_regionValueAdded_commitButton',
      handler :function(){
//        this.disable();
        me.commintRegionValueAdded();
      } 
 ...
 * 增值服务表单（上部）
 */
Ext.define('Foss.pricing.regionValueAdded.RegionValueAddedEditFormPanel', {
  extend : 'Ext.form.Panel',
  frame: true,
  collapsible: true,
    defaults : {
  ...
  layout:{
    ...
    constructor : function(config) {
	    ...
	    me.items = [{
	      xtype : 'textfield',
	      fieldLabel: pricing.regionValueAdded.i18n('foss.pricing.regionalValueAddedServiceNames'),//区域增值服务名称
	      maxLength:15,
	      readOnly:isReadOnly,
	      allowBlank:false,
	      name:'name'
	      ...
	      allowBlank:true,
	      beforeLabelTextTpl: '',
	      emptyText:pricing.regionValueAdded.i18n('foss.pricing.automaticallyGeneratedCoding'),//自动生成编码
	      fieldLabel: '<span style="color:red">*</span>'+pricing.regionValueAdded.i18n('foss.pricing.regionalValueAddedServicesCoding'),//区域增值服务编码
	      maxLength:25,
	      name:'code'
	    },{
	      xtype:'datefield',
	      minValue: new Date(pricing.regionValueAdded.tomorrowTime),
	      value:new Date(pricing.regionValueAdded.tomorrowTime),
	      fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.availabilityDate'),//生效日期
	      format:'Y-m-d',
	      readOnly:isReadOnly,
	      name:'beginTime',
	      editable:false
			...
			xtype:'datefield',
		    minValue: new Date(pricing.regionValueAdded.tomorrowTime),
		    value:new Date(pricing.regionValueAdded.defaultEndTime),
		    fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.endTimeTwo'),//截止日期
		    format:'Y-m-d',
		    readOnly:isReadOnly,
		    name:'endTime',
		    editable:false
	      ...
	      items : [{
	        xtype : 'textfield',
	        fieldLabel: pricing.regionValueAdded.i18n('foss.pricing.departureRegion'),//出发地（区域）
	         colspan: 3,
	         regionId:null,//区域ID
	        readOnly:true,
	        name:'deptRegionName'
	        ...
	        colspan: 1,
	        disabled:isReadOnly,
	        text :pricing.regionValueAdded.i18n('foss.pricing.select'),//选择
	        handler : function() {
	        ...
	        colspan: 1,
	        disabled:isReadOnly,
	        text :pricing.regionValueAdded.i18n('i18n.pricingRegion.cancel'),//取消
	        handler : function() {
	      ...
	      items : [{
	        xtype : 'textfield',
	        fieldLabel: pricing.regionValueAdded.i18n('foss.pricing.destinationArea'),//目的地（区域）
	        colspan: 3,
	         regionId:null,//区域ID
	         readOnly:true,
	        name:'arrvRegionName'
	      ...
	      queryMode: 'local',
	        ...
	        allowBlank:false,
	        store:pricing.getStore(null,'Foss.pricing.regionValueAdded.PriceEntityModel',null
	        ,pricing.regionValueAdded.valueAddedType),
	          fieldLabel: pricing.regionValueAdded.i18n('foss.pricing.theirRespectiveValueAddedServices'),//所属增值服务
	          ...
	          listeners:{
	            change:function(com,newValue,oldValue){
	              ...
	              for(var i=0;i<pricing.regionValueAdded.valueAddedType.length;i++){//设置服务ID
	                if(pricing.regionValueAdded.valueAddedType[i].code==newValue){
	                  com.pricingEntryId = pricing.regionValueAdded.valueAddedType[i].id;
	                }
	              }
	              if(oldValue==pricing.regionValueAdded.insurance){//保费
	                com.up('form').up('window').getDownPanel().getInsuranceFormPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.receivingCharges){//收货费
	                com.up('form').up('window').getDownPanel().getReceivingChargesFormPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.sign){
	                com.up('form').up('window').getDownPanel().getSignFormPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.storageCharges){
	                com.up('form').up('window').getDownPanel().getStorageChargesFormPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.otherCharges){
	                com.up('form').up('window').getDownPanel().getOtherChargesGridPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.deliveryCharges){
	                com.up('form').up('window').getDownPanel().getDeliveryChargesGridPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.paymentCollection){
	                com.up('form').up('window').getDownPanel().getPaymentCollectionGridPanel().hide()
	              }else if(oldValue==pricing.regionValueAdded.superDelivery){//超远派送
	                com.up('form').up('window').getDownPanel().getSuperDeliveryGridPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.deliveryUpstairs){//送货上楼
	                com.up('form').up('window').getDownPanel().getDeliveryUpstairsGridPanel().hide();
	              }else if(oldValue==pricing.regionValueAdded.packing){//包装
	              ...
	              /**
	      		 	...
	      		 	*/
	              	else if(oldValue==pricing.regionValueAdded.paperFiberPacking){
	              ...
	              /**
	      		 	...
	      		 	* @date:2014-11-11下午16:34
	      		 	*/
	      			else if(newValue==pricing.regionValueAdded.paperFiberPacking){
	        		 ...
	        		 * @date:2014-11-11下午16:34
	        		 */
	        		else if(newValue==pricing.regionValueAdded.largeDeliveryUpstairs){
	       ...
	       allowBlank:false,
	       name:'active',
	       fieldLabel:pricing.regionValueAdded.i18n('i18n.pricingRegion.isActive'),//是否激活
	       items:[{
	          xtype:'radio',
	           boxLabel:pricing.regionValueAdded.i18n('i18n.pricingRegion.ye'),
	           name:'active',
	           readOnly:isReadOnly,
	           inputValue:'Y'
	         },{
	           xtype:'radio',
	           boxLabel:pricing.regionValueAdded.i18n('i18n.pricingRegion.no'),
	           name:'active',
	           readOnly:isReadOnly,
	           inputValue:'N'
	           }]
			...
			items:[{
	          ...
	          xtype : 'textareafield',
	          fieldLabel: pricing.regionValueAdded.i18n('foss.pricing.programDescription'),
	          readOnly:isReadOnly,
	          //根据MANA-1320修改
	          height:70,
	          allowBlank:true,
			...
			items:[{
			    ...
			    items:[{
			    	...
			    	store:Ext.create('Foss.pricing.regionValueAdded.BasicProductStore',{autoLoad:false}),
			    	columns:[{
			    		text:'产品名字',
			    		flex:1,
			    		dataIndex:'name'
				    ...
				    items:[{
				    	...
				    	handler:function(btn){
				    		...
				    		if(!selection.length){
				    			Ext.ux.Toast.msg(pricing.regionValueAdded.i18n('foss.pricing.promptMessage'),'请选择要移动的数据','error', 3000);
				    			return;
				    		}
...
Ext.define('Foss.pricing.regionValueAdded.RegionDownPanel', {
    ...
    getInsuranceFormPanel:function(isReadOnly){
      if(Ext.isEmpty(this.insuranceFormPanel)){
        this.insuranceFormPanel = Ext.create('Foss.pricing.regionValueAdded.InsuranceFormPanel',{
    ...
    getPackingFormPanel:function(isReadOnly){
      if(Ext.isEmpty(this.packingFormPanel)){
        this.packingFormPanel = Ext.create('Foss.pricing.regionValueAdded.PackingFormPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getReceivingChargesFormPanel:function(isReadOnly){
      if(Ext.isEmpty(this.receivingChargesFormPanel)){
        this.receivingChargesFormPanel = Ext.create('Foss.pricing.regionValueAdded.ReceivingChargesFormPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getSignFormPanel:function(isReadOnly){
      if(Ext.isEmpty(this.signFormPanel)){
        this.signFormPanel = Ext.create('Foss.pricing.regionValueAdded.SignFormPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getStorageChargesFormPanel:function(isReadOnly){
      if(Ext.isEmpty(this.storageChargesFormPanel)){
        this.storageChargesFormPanel = Ext.create('Foss.pricing.regionValueAdded.StorageChargesFormPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getOtherChargesGridPanel:function(isReadOnly){
      if(Ext.isEmpty(this.otherChargesGridPanel)){
        this.otherChargesGridPanel = Ext.create('Foss.pricing.regionValueAdded.OtherChargesGridPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getDeliveryChargesGridPanel:function(isReadOnly){
      if(Ext.isEmpty(this.deliveryChargesGridPanel)){
        this.deliveryChargesGridPanel = Ext.create('Foss.pricing.regionValueAdded.DeliveryChargesGridPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getPaymentCollectionGridPanel:function(isReadOnly){
      if(Ext.isEmpty(this.paymentCollectionGridPanel)){
        this.paymentCollectionGridPanel = Ext.create('Foss.pricing.regionValueAdded.PaymentCollectionGridPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
  ...
  //超远派送
    ...
    getSuperDeliveryGridPanel:function(isReadOnly){
      if(Ext.isEmpty(this.superDeliveryGridPanel)){
        this.superDeliveryGridPanel = Ext.create('Foss.pricing.regionValueAdded.SuperDeliveryGridPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getDeliveryUpstairsGridPanel:function(isReadOnly){
      if(Ext.isEmpty(this.deliveryUpstairsGridPanel)){
        this.deliveryUpstairsGridPanel = Ext.create('Foss.pricing.regionValueAdded.DeliveryUpstairsGridPanel',{
          'isReadOnly':isReadOnly//设置是否只读
        });
      }
    ...
    getPaperFiberPackingFormPanel:function(isReadOnly){
    	if(Ext.isEmpty(this.paperFiberPackingFormPanel)){
    		this.paperFiberPackingFormPanel = Ext.create('Foss.pricing.regionValueAdded.paperFiberPackingFormPanel',{
    			'isReadOnly':isReadOnly//设置是否只读
    		});
    	}
    ...
    getLargeDeliveryUpstairsGridPanel:function(isReadOnly){
    	if(Ext.isEmpty(this.largeDeliveryUpstairsGridPanel)){
    		this.largeDeliveryUpstairsGridPanel = Ext.create('Foss.pricing.regionValueAdded.largeDeliveryUpstairsGridPanel',{
    			'isReadOnly':isReadOnly//设置是否只读
    		});
    	}
 ...
 */
/*
Ext.define('Foss.pricing.regionValueAdded.InsuranceFormPanel', {
  extend : 'Ext.form.Panel',
  frame: true,
  collapsible: true,
  hidden:true,
  ...
  constructor : function(config) {
    ...
    me.items = [{
      ...
      queryMode: 'local',
          ...
          editable:false,
          readOnly:isReadOnly,
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.limitedWarrantyItems'),//限保物品
          store:pricing.getStore(null,null,['goodsName','virtualCode']
          ,pricing.regionValueAdded.limitedWarrantyItems),
            xtype : 'combo'
    },{
      xtype:'numberfield',
          decimalPrecision:4,
          ...
          readOnly:isReadOnly,
          allowBlank:false,
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.rates'),//费率
          step:0.0001,
          maxValie: 9999999.99,
          minValue: 0
    },{
      xtype:'numberfield',
          ...
          readOnly:isReadOnly,
          allowBlank:false,
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.minimumPremiumFee'),//最低保险费
          maxValue: 9999999.99,
          minValue: 0 
    },{
      xtype:'numberfield',
          ...
          readOnly:isReadOnly,
          allowBlank:false,
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.maximumCoverageForMinimumInsurance'),//最低保险最高保额
          maxValue: 9999999.99,
          minValue: 0
    }];
    me.callParent([cfg]);
...
/**
 * 增值服务表单保费（下部）可编辑表格pricing.regionValueAdded.Insurance = 'BF';//保费Panel
 */
Ext.define('Foss.pricing.regionValueAdded.InsuranceFormPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
    ...
    addOneModel:function(valueaddCaculateType){
    	var me = this;
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
			'caculateType': pricing.regionValueAdded.originalCost,
			'valueaddCaculateType':valueaddCaculateType,
//			'feeRate':pricing.regionValueAdded.RATE,
        	'valueaddLeftrange': 0,
    	...
    	if(Ext.isEmpty(this.tbar)){
    		if(!isReadOnly){//如果可编辑则给cellEditing赋值，如果不可编辑cellEditing为null
    			this.tbar = [{
    		        ...
    		        text: '按重量新增',//按重量新增
    		        handler : function(){
    		        	me.addOneModel(pricing.regionValueAdded.Weight);
    		        }
    		    },{
    		    	text:'按体积新增',//按体积新增
    		    	handler:function(){
    		    		me.addOneModel(pricing.regionValueAdded.Volume)
    		    	}
    		    }, '-' ,me.getSubTypeCombo()];
    		} else {
    ...
    constructor : function(config) {
		...
		me.columns = [{
			...
			items: [{
	                ...
	                tooltip: pricing.regionValueAdded.i18n('foss.pricing.delete'),//删除
					width:42,
					getClass : function (v, m, r, rowIndex) {
						if (pricing.regionValueAdded.viewOrUpdateOrDelete == 'delete') {
	                ...
	                handler: function(grid, rowIndex, colIndex) {
	            		...
	            		pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteThisInsuranceCharge'),function(e){//是否要删除这条送货费信息？
	            			if(e=='yes'){//询问是否删除，是则发送请求
	        ...
	        renderer:function(value,metaData,record){
	        	if(record.get('valueaddCaculateType')==pricing.regionValueAdded.Weight){
	        		return value+pricing.regionValueAdded.KG;
	        	}
	        	if(record.get('valueaddCaculateType')==pricing.regionValueAdded.Volume){
	        		return value+pricing.regionValueAdded.M3;
	        	}
	        	return value;
	        },
	        editor: {
	        ...
	        dataIndex: 'leftrange',
	        renderer:function(value){
	        	return value+pricing.regionValueAdded.YUAN;
	        },
	        editor: {
	            xtype: 'numberfield',
	            allowBlank: false,
	        ...
	        renderer:function(val){
	        	return val+pricing.regionValueAdded.YUAN;
	        },
	        editor: {
	            xtype: 'numberfield',
	            allowBlank: false,
	        ...
	        renderer: function(value){
	        	if(value=='N'){
	        		return pricing.regionValueAdded.i18n('foss.pricing.isNo');//否
	        	}else if(value=='Y'){
	        		return pricing.regionValueAdded.i18n('foss.pricing.isYes');
	        	}else{
	        		return '';
	        	}
	        },
	        editor: {
	    	    ...
	    	    ,[{'key':'N','value':pricing.regionValueAdded.i18n('foss.pricing.isNo')},{'key':'Y','value':pricing.regionValueAdded.i18n('foss.pricing.isYes')}]),
	            xtype : 'combo'
	        }
	    }];
		me.plugins=me.getPlugins(isReadOnly);
		me.getTbar(isReadOnly);//获取新增按钮
	    me.store = pricing.getStore(null,'Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity',null,[]);
		me.callParent([cfg]);
	}
});
/**
 * 增值服务表单包装费（下部）BZ
 */
Ext.define('Foss.pricing.regionValueAdded.PackingFormPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
    	var me = this;
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
        	'caculateType':pricing.regionValueAdded.Volume,
        	'valueaddCaculateType':valueaddCaculateType,
//        	'feeRate':pricing.regionValueAdded.RATE,
        	'subType':FossDataDictionary.getDataByTermsCode(pricing.regionValueAdded.VALUEADDED_PACKAGE_TYPE)[0].valueCode,
        	'valueaddLeftrange':0,
        	'valueaddRightrange':9999999,
        	'minFeeRate':1,
        	'maxFeeRate':1,
    ...
    constructor : function(config) {
		...
		me.columns = [{
			...
			items: [{
		  	...
		  	width:70,
		  	renderer:function(val){
		  		return FossDataDictionary.rendererSubmitToDisplay(val,pricing.regionValueAdded.VALUEADDED_PACKAGE_TYPE);
		  	},
		  	editor: {
	            xtype: 'combo',
	            queryMode: 'local',
	    	    ...
	    	    editable:false,
	    	    allowBlank:false,
	            store:FossDataDictionary.getDataDictionaryStore(pricing.regionValueAdded.VALUEADDED_PACKAGE_TYPE)
	        }
		  },{
	        header: '起点',//起点
	        dataIndex: 'valueaddLeftrange',
	        ...
	        width: 70,
	        renderer:function(value,metaData,record){
	        	if(record.get('subType') ==pricing.regionValueAdded.PACKAGE_TYPE__FRAME
	        		||record.get('subType') ==pricing.regionValueAdded.PACKAGE_TYPE__BOX){
	        		if(record.get('valueaddCaculateType')==pricing.regionValueAdded.Weight){
	        			return value+pricing.regionValueAdded.YUANBYVOLUME;
		        	}
		        	if(record.get('valueaddCaculateType')==pricing.regionValueAdded.Volume){
		        		return value+pricing.regionValueAdded.YUANBYVOLUME;
		        	}
	        	}
	        	if(record.get('subType')==pricing.regionValueAdded.PACKAGE_TYPE_SALVER){
	        		return value+pricing.regionValueAdded.YUANBYGE;
	        	}
	        	return value;
	        },
	        editor: {
	        ...
	        renderer:function(val,metaData,record){
	        	if(record.get('subType')==pricing.regionValueAdded.PACKAGE_TYPE_SALVER){
	        		return val+pricing.regionValueAdded.YUANBYGE;
	        	}
	        	return val+pricing.regionValueAdded.YUANBYTICKET;
	        },
	        editor: {
	            xtype: 'numberfield',
	            allowBlank: false,
	        ...
	        header: pricing.regionValueAdded.i18n('foss.pricing.ratesIsUpdate'),//费率是否可以修改
	        dataIndex: 'canmodify',
	        width: 120,
	        renderer: function(value){
	        	if(value=='N'){
 ...
 * 增值服务表单接货费（下部）JH
 */
Ext.define('Foss.pricing.regionValueAdded.ReceivingChargesFormPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
        ...
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
        	...
        	'valueaddCaculateType':valueaddCaculateType,
//        	'feeRate':pricing.regionValueAdded.FEE,
        	'valueaddLeftrange':0,
        	'valueaddRightrange':9999999,
        	'minFee':0,
        	'maxFee':9999999,
    ...
    constructor : function(config) {
		...
		me.columns = [{
		        ...
		        header: pricing.regionValueAdded.i18n('foss.pricing.whetherItCanBeModified'),//是否可修改
		        dataIndex: 'canmodify',
		        width: 95,
		        renderer: function(value){
		        	if(value=='N'){
		        		return pricing.regionValueAdded.i18n('i18n.pricingRegion.no');
		        	}else if(value=='Y'){
		        		return pricing.regionValueAdded.i18n('i18n.pricingRegion.ye');
		        	}else{
		        		return '';
		        	}
		        },
		        editor: {
		    	    ...
		    	    editable:false,
		    	    store:pricing.getStore(null,null,['key','value']
		    	    ,[{'key':'N','value':pricing.regionValueAdded.i18n('i18n.pricingRegion.no')},{'key':'Y','value':pricing.regionValueAdded.i18n('i18n.pricingRegion.ye')}]),
		            xtype : 'combo'
		        }
		    }];
		me.plugins=me.getPlugins(isReadOnly);
 ...
 * 增值服务表单签收回单（下部）QS
 */
Ext.define('Foss.pricing.regionValueAdded.SignFormPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
        ...
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
        	...
        	'valueaddCaculateType':valueaddCaculateType,
//        	'feeRate':pricing.regionValueAdded.FEE,
        	'subType':FossDataDictionary.getDataByTermsCode(pricing.regionValueAdded.VALUEADDED_RETURN_TYPE)[0].valueCode,
        	'valueaddLeftrange':0,
        	'valueaddRightrange':9999999,
        	'minFee':0,
        	'maxFee':0,
    ...
    constructor : function(config) {
		...
		me.columns = [{
		        ...
		        dataIndex: 'subType',
		        renderer:function(val){
		        	return FossDataDictionary.rendererSubmitToDisplay(val,pricing.regionValueAdded.VALUEADDED_RETURN_TYPE);
		        },
		        editor: {
		    		queryMode: 'local',
		    	    displayField: 'valueName',
		    	    ...
		    	    editable:false,
		    	    allowBlank: false,
		    	    store:FossDataDictionary.getDataDictionaryStore(pricing.regionValueAdded.VALUEADDED_RETURN_TYPE),
		            xtype : 'combo'
		        }
		    }, {
		        header: '起点',//起点
 ...
 * 增值服务表单仓储费（下部）CCF
 */
Ext.define('Foss.pricing.regionValueAdded.StorageChargesFormPanel', {
  extend : 'Ext.form.Panel',
  frame: true,
  flex:1,
  collapsible: true,
  ...
  constructor : function(config) {
    ...
    me.items = [{
      xtype:'numberfield',
          ...
          readOnly:isReadOnly,
          name:'feeRate',
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.charges'),//原件返单
          maxValue: 9999999.99,
          minValue: 0
    },{
      xtype: 'label',
          text: pricing.regionValueAdded.i18n('foss.pricing.yuanmpiao'),//元/m³/票
          margins: '0 0 0 10'
    },{
      xtype:'numberfield',
          decimalPrecision:2,
          ...
          name:'minFeeRate',
          allowBlank:false,
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.minimumChargeQu'),//最低收取
          maxValue: 9999999.99,
          minValue: 0 
    },{
      xtype: 'label',
          text: pricing.regionValueAdded.i18n('foss.pricing.yuanpiao'),//元/票
          margins: '0 0 0 10'
    },{
      xtype:'numberfield',
          decimalPrecision:0,
          ...
          name:'maxFeeRate',
          allowBlank:false,
          fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.maximumCharge'),//最高收取
          maxValue: 9999999,
          minValue: 0
    },{
      xtype: 'label',
...
//        	'feeRate':pricing.regionValueAdded.RATE,
    ...
    constructor : function(config) {
		...
		me.columns = [{
		        ...
		        renderer:function(value,metaData,record){
		        	if(record.get('valueaddCaculateType')==pricing.regionValueAdded.Weight){
		        		return value+pricing.regionValueAdded.YUANBYWEIGHTBYTICKET;
		        	}
		        	if(record.get('valueaddCaculateType')==pricing.regionValueAdded.Volume){
		        		return value+pricing.regionValueAdded.YUANBYVOLUMEBYTICKET;
		        	}
		        	return value;
		        },
		        editor: {
...
/**
 * 增值服务表单其它费（下部）可编辑表格 pricing.regionValueAdded.otherCharges = 'OTHERCHARGES';//其他费用 QT
 */
Ext.define('Foss.pricing.regionValueAdded.OtherChargesGridPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
        ...
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
        	...
        	'valueaddCaculateType':valueaddCaculateType,
        	'feeRate':1,
            'subType':pricing.regionValueAdded.otherChargesSubType[0].code,
            'valueaddLeftrange':0,
        	'valueaddRightrange':9999999,
        	'minFee':1,
        	'maxFee':1,
		...
		me.columns = [{
				...
				items: [{
		                ...
		                handler: function(grid, rowIndex, colIndex) {
		            		//获取选中的数据
		    				var record=grid.getStore().getAt(rowIndex);
		            		pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteOtherCostInformation'),function(e){//是否要删除这条其他费用信息？
		            			if(e=='yes'){//询问是否删除，是则发送请求
		            				grid.getStore().remove(record);
		            			}
		            		});
		        ...
		        dataIndex: 'subType', 
		        renderer:function(value){
		        	for(var i=0;i<pricing.regionValueAdded.otherChargesSubType.length;i++){
		        		if(pricing.regionValueAdded.otherChargesSubType[i].code==value){
		        			return pricing.regionValueAdded.otherChargesSubType[i].name;
		        		}
		        	}
		        },
		        editor: {
		    	    ...
		    	    allowBlank: false,
		    	    store:pricing.getStore(null,'Foss.pricing.regionValueAdded.PriceEntityModel',null
		    	    ,pricing.regionValueAdded.otherChargesSubType),
		            xtype : 'combo'
		        }
		    }, {
		        header: pricing.regionValueAdded.i18n('foss.pricing.imputationCategory'),
		        dataIndex: 'subType',
		        renderer:function(value,metaDatea,record){
		        	for(var i=0;i<pricing.regionValueAdded.otherChargesSubType.length;i++){
		        		if(pricing.regionValueAdded.otherChargesSubType[i].code==value){
		        			record.data.togeterCategory = pricing.regionValueAdded.otherChargesSubType[i].blongPricingCode;
		        			return pricing.regionValueAdded.otherChargesSubType[i].blongPricingName;
		        		}
		        	}
		        }
		    }, 
...
/**
 * 增值服务表单送货费（下部）可编辑表格pricing.regionValueAdded.deliveryCharges = 'SH';//送货费
 */
Ext.define('Foss.pricing.regionValueAdded.DeliveryChargesGridPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
		...
		me.columns = [{
			...
			items: [{
	                ...
	                handler: function(grid, rowIndex, colIndex) {
	            		//获取选中的数据
	    				var record=grid.getStore().getAt(rowIndex);
	            		pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteThisDeliveryCharge'),function(e){//是否要删除这条送货费信息？
	            			if(e=='yes'){//询问是否删除，是则发送请求
	            				grid.getStore().remove(record);
	            			}
	            		});
	        ...
	        renderer:function(val,metaData,record){
	        	if(record.get('valueaddCaculateType') == pricing.regionValueAdded.Weight){
	        		return val+pricing.regionValueAdded.YUANBYWEIGHT;
	        	}
	        	if(record.get('valueaddCaculateType') == pricing.regionValueAdded.Volume){
	        		return val+pricing.regionValueAdded.YUANBYVOLUME;
	        	}
	        	return val;
	        },
	        editor: {
...
/**
 * 增值服务表单代收货款（下部）可编辑表格pricing.regionValueAdded.paymentCollection = 'HK';//代收货款
 */
Ext.define('Foss.pricing.regionValueAdded.PaymentCollectionGridPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
    	var me = this;
    	var store = FossDataDictionary.getDataDictionaryStore(pricing.regionValueAdded.returnSubType);
    	var subType = '';
    	if(!Ext.isEmpty(store)){
		...
		me.columns = [{
			...
			items: [{
	                ...
	                handler: function(grid, rowIndex, colIndex) {
	            		//获取选中的数据
	    				var record=grid.getStore().getAt(rowIndex);
	            		pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteThisCollectionMoney'),function(e){//是否要删除这条代收货款信息？
	            			if(e=='yes'){//询问是否删除，是则发送请求
	            				grid.getStore().remove(record);
	            			}
	            		});
	    	...
	    	header: pricing.regionValueAdded.i18n('foss.pricing.refundType'),//退款类型
	        dataIndex: 'subType',
	        width: 95,
	        renderer: function(value){
	        	return FossDataDictionary.rendererSubmitToDisplay(value,pricing.regionValueAdded.returnSubType);
	        },
	        editor: {
	    		queryMode: 'local',
	    	    displayField: 'valueName',
	    	    valueField: 'valueCode',
	    	    editable:false,
	    	    store:FossDataDictionary.getDataDictionaryStore(pricing.regionValueAdded.returnSubType),
	    	    xtype : 'combo'
	        }
	    },{
	        header: '起点',//起点
...
/**
 * 增值服务表单超远派送（下部）可编辑表格pricing.regionValueAdded.superDelivery = 'CY';//超远派送费
 */
Ext.define('Foss.pricing.regionValueAdded.SuperDeliveryGridPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
    	var me = this;
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
        	'caculateType':pricing.regionValueAdded.kilometer,
        	'valueaddCaculateType':valueaddCaculateType,
//        	'feeRate':pricing.regionValueAdded.FEE,
        	'valueaddLeftrange':0,
        	'valueaddRightrange':9999999,
		...
		me.columns = [{
			...
			items: [{
	                ...
	                handler: function(grid, rowIndex, colIndex) {
	            		//获取选中的数据
	    				var record=grid.getStore().getAt(rowIndex);
	            		pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteFarDeliveryInformation'),function(e){//是否要删除这条超远派送信息？
	            			if(e=='yes'){//询问是否删除，是则发送请求
	            				grid.getStore().remove(record);
	            			}
	            		});
	        ...
	        width: 70,
	        renderer:function(val){
	        	return val+pricing.regionValueAdded.KM;
	        },
	        editor: {
	            xtype: 'numberfield',
	            allowBlank: false,
...
/**
 * 增值服务表单送货上楼（下部）可编辑表格pricing.regionValueAdded.deliveryUpstairs = 'SHSL';//送货上楼
 */
Ext.define('Foss.pricing.regionValueAdded.DeliveryUpstairsGridPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
    ...
    addOneModel:function(valueaddCaculateType){
    	var me = this;
        var record = Ext.create('Foss.pricing.regionValueAdded.PriceCriteriaDetailEntity', {
        	'caculateType':pricing.regionValueAdded.Weight,
        	'valueaddCaculateType':valueaddCaculateType,
//        	'feeRate':pricing.regionValueAdded.RATE,
        	'valueaddLeftrange':0,
        	'valueaddRightrange':9999999,
		...
		me.columns =  [{
			...
			items: [{
	                ...
	                handler: function(grid, rowIndex, colIndex) {
	            		//获取选中的数据
	    				var record=grid.getStore().getAt(rowIndex);
	            		pricing.showQuestionMes(pricing.regionValueAdded.i18n('foss.pricing.wantDeleteThisDeliveryUpstairs'),function(e){//是否要删除这条送货上楼信息？
	            			if(e=='yes'){//询问是否删除，是则发送请求
	            				grid.getStore().remove(record);
	            			}
	            		});
 ...
 * 区域Store
 */
Ext.define('Foss.pricing.regionValueAdded.AreaStore', {
  extend : 'Ext.data.Store',
  model : 'Foss.pricing.regionValueAdded.AreaModel',
 ...
 * 区域列表
 */
Ext.define('Foss.pricing.regionValueAdded.AreaGridPanel', {
  extend: 'Ext.grid.Panel',
  title : pricing.regionValueAdded.i18n('foss.pricing.departureDestinationArea'),//出发地/目的地区域
  frame: true,
  flex:1,
    sortableColumns:false,
    enableColumnHide:false,
  ...
  constructor : function(config) {
    ...
    me.columns = [{xtype: 'rownumberer',
      width:40,
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.num')//序号
    },{
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.regionNum'),//区域编号
      dataIndex : 'regionCode'
    },{
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.regionName'),//区域名称
      dataIndex : 'regionName'
    }];
    me.store = Ext.create('Foss.pricing.regionValueAdded.AreaStore',{
      autoLoad:false,//不需要自动加载
      listeners: {
        beforeload: function(store, operation, eOpts){
          ...
          if(queryForm!=null){
            ...
            Ext.apply(operation,{
              params : {
                ...
                //查询的只是价格区域
                'regionValueAddVo.regionEntity.regionNature':pricing.regionValueAdded.PRICING_REGION
              }
            });  
          }
        }
 ...
 * 区域查询WINDOW
 */
Ext.define('Foss.pricing.regionValueAdded.RegionGridShowWindow',{
  extend : 'Ext.window.Window',
  title : pricing.regionValueAdded.i18n('foss.pricing.queryOriginDestination'),//查询出发地/目的地
  closable : true,
  modal : true,
  resizable:false,
  closeAction : 'hide',
  ...
  selectRegion:function(){
    ...
    var selections = me.getRegionGridPanel().getSelectionModel().getSelection();//获取选择的数据
     ...
     //me.textField.setValue(pricing.regionValueAdded.i18n('foss.pricing.shanghai'));设置数据成功，只用来做测试
    if(selections.length==0){
      pricing.showWoringMessage(pricing.regionValueAdded.i18n('foss.pricing.pleaseSelectRegion'));//请选择一个区域！
      return;
    }
  ...
  getSearchRegionForm:function(){
    if(Ext.isEmpty(this.searchRegionForm)){
        this.searchRegionForm = Ext.create('Foss.pricing.regionValueAdded.SearchRegionForm');
      }
  ...
  getRegionGridPanel:function(){
    if(Ext.isEmpty(this.regionGridPanel)){
        this.regionGridPanel = Ext.create('Foss.pricing.regionValueAdded.AreaGridPanel');
      }
    ...
    me.fbar = [{
      ...
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.determine'),//确定
      cls:'yellow_button',
      handler :function(){
        me.selectRegion();
      } 
 ...
 * 查询区域
 */
Ext.define('Foss.pricing.regionValueAdded.SearchRegionForm', {
  extend : 'Ext.form.Panel',
  title: pricing.regionValueAdded.i18n('i18n.pricingRegion.searchCondition'),
  frame: true,
  collapsible: true,
  ...
  constructor : function(config) {//构造器
    ...
    me.items = [{
      xtype:'textfield',
      fieldLabel:pricing.regionValueAdded.i18n('i18n.pricingRegion.regionName'),//区域名称
      name:'regionName'
    },{
      xtype:'textfield',
      fieldLabel:pricing.regionValueAdded.i18n('i18n.pricingRegion.regionCode'),//区域编码
      name:'regionCode'
    },{
      xtype : 'container',
      margin : '0 0 0 0',
 ...
 * 修改弹窗-设置终止时间
 */
Ext.define('Foss.pricing.regionValueAdded.RegionValueAddedEndTimeWindow',{
  extend : 'Ext.window.Window',
  title : pricing.regionValueAdded.i18n('i18n.pricingRegion.setEndTime'),
  closable : true,
  modal : true,
  resizable:false,
  parent:null,//(Foss.pricing.regionValueAdded.PricingRegionValuationGridPanel)
  closeAction : 'hide',
  width :250,
  height :150,
  ...
  getEndTimeField:function(){
    if(Ext.isEmpty(this.endTimeField)){
        this.endTimeField = Ext.create('Ext.form.field.Date',{
          ...
          //labelSeparator:'',
            labelWidth:60,
          fieldLabel: pricing.regionValueAdded.i18n('i18n.pricingRegion.endTime'),//失效日期
          name:'endTime',
          editable:false
        });
      }
  ...
  commintEndTime:function(){
    ...
    me.fbar = [{
      ...
      text : pricing.regionValueAdded.i18n('i18n.pricingRegion.determine'),//确认
      margin:'0 0 0 50',
      cls:'yellow_button',
      handler :function(){
        me.commintEndTime();
 ...
 * 立即中止价格方案 Window
 */
Ext.define('Foss.pricing.regionValueAdded.ImmediatelyStopEndTimeWindow',{
    extend: 'Ext.window.Window',
    title: pricing.regionValueAdded.i18n('foss.pricing.immediatelySupendPricePriceScheme'),//"立即中止方案",
    width:380,
    height:152,
    closeAction: 'hide' ,
    stopFormPanel:null,
    ...
    getStopFormPanel : function(){
        if(Ext.isEmpty(this.stopFormPanel)){
          this.stopFormPanel = Ext.create('Foss.pricing.regionValueAdded.ImmediatelyStopFormPanel');
        }
      ...
      listeners:{
        beforeshow:function(me){
          ...
          var value = pricing.regionValueAdded.i18n('foss.pricing.showleftTimeInfo')
          +showbeginTime+pricing.regionValueAdded.i18n('foss.pricing.showmiddleTimeInfo')
          +showendTime+pricing.regionValueAdded.i18n('foss.pricing.showrightEndTimeInfo');
 ...
 * 立即中止功能FormPanel
 */
Ext.define('Foss.pricing.regionValueAdded.ImmediatelyStopFormPanel',{
  extend : 'Ext.form.Panel',
  layout:'column',
  stop:function(){
    var me = this;
      var form = me.getForm();
      if(form.isValid()){
        var priceValuationEntityModel = new Foss.pricing.regionValueAdded.PriceValuationEntityModel();
  ...
  constructor: function(config) {
    ...
    me.items = [{
        ...
        fieldLabel :pricing.regionValueAdded.i18n('foss.pricing.suspendTime') ,//'中止日期',
        name : 'endTime',
        ...
        xtype : 'button', 
        id : 'Foss_regionValueAdded1_suspendButton_ID',
        width:70,
        columnWidth:.15,
        text : pricing.regionValueAdded.i18n('i18n.pricingRegion.determine'),//"确认",
        handler : function() {
          ...
          if(result<0)
          {
            Ext.ux.Toast.msg(pricing.regionValueAdded.i18n('foss.pricing.promptMessage'),'中止时间不能小于当前时间','error', 3000);
            Ext.getCmp('Foss_regionValueAdded1_suspendButton_ID').setDisabled(false);
            return;
          }
          me.stop();
        }
 ...
 * 立即激活价格方案Window
 */
Ext.define('Foss.pricing.regionValueAdded.ImmediatelyActiveTimeWindow',{
    extend: 'Ext.window.Window',
    title: pricing.regionValueAdded.i18n('foss.pricing.immediatelyActiveationPriceScheme'),//"立即激活方案",
    width:380,
    height:152,
    ...
    getImmediatelyActiveFormPanel : function(){
        if(Ext.isEmpty(this.immediatelyActiveFormPanel)){
          this.immediatelyActiveFormPanel = Ext.create('Foss.pricing.regionValueAdded.ImmediatelyActiveFormPanel');
        }
 ...
 * 立即激活功能Form
 */
Ext.define('Foss.pricing.regionValueAdded.ImmediatelyActiveFormPanel',{
  extend : 'Ext.form.Panel',
  layout:'column',
  activetion:function(){
    var me = this;
 ...
 */
Ext.define('Foss.pricing.regionValueAdded.paperFiberPackingFormPanel', {
	extend : 'Ext.form.Panel',
	frame: true,
	flex:1,
	collapsible: true,
	...
	constructor : function(config) {
		...
		me.items = [{
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.paperBoxOne'),//纸箱1号 客户
	        name:'paperBoxOne',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelOneBlue'),//纤袋1号 蓝
	        name:'fibelOneBlue',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelOneWhite'),//纤袋1号 白
	        name:'fibelOneWhite',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.paperBoxTwo'),//纸箱2号 客户
	        name:'paperBoxTwo',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelTwoBlue'),//纤袋2号 蓝
	        name:'fibelTwoBlue',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelTwoWhite'),//纤袋2号 白
	        name:'fibelTwoWhite',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.paperBoxThree'),//纸箱3号 客户
	        name:'paperBoxThree',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelThreeBlue'),//纤袋3号 蓝
	        name:'fibelThreeBlue',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelThreeWhite'),//纤袋3号白
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.paperBoxFour'),//纸箱4号 客户
	        name:'paperBoxFour',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelFourBlue'),//纤袋4号 蓝 
	        name:'fibelFourBlue',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelFourWhite'),//纤袋4号 白
	        name:'fibelFourWhite',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelFiveWhite'),//纤袋5号 布匹白
	        name:'fibelFiveWhite',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
			...
			decimalPrecision:2,
	        allowBlank:false,
	        fieldLabel:pricing.regionValueAdded.i18n('foss.pricing.fibelSixWhite'),//纤袋6号 布匹白
	        name:'fibelFiveSix',
	        readOnly:isReadOnly,
	        maxValue: 99999.99,
	        minValue: 0
 ...
 */
Ext.define('Foss.pricing.regionValueAdded.PriceFibelPaperPackingEntity', {
    extend: 'Ext.data.Model',
    fields : [{
...
/**
 * 增值服务表单大件上楼费（下部）可编辑表格pricing.regionValueAdded.largeDeliveryUpstairs = 'DJSL';//大件上楼费
 * @author:218371-foss-zhaoyanjun
 * @date:2014-12-11下午14:17
 */
Ext.define('Foss.pricing.regionValueAdded.largeDeliveryUpstairsGridPanel', {
	extend : 'Ext.grid.Panel',
	stripeRows : true, // 交替行效果
	selType : "rowmodel", // 选择类型设置为：行选择
	frame: true,
