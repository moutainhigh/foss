...
import com.deppon.foss.module.pickup.pricing.api.server.service.IPartbussPriceCaculateService;
 ...
 * @version
 */
public class PartbussPriceCaculateService implements
	IPartbussPriceCaculateService {

	private static final double DOUBLE_05 = 0.5;
	private static final int TEN =10 ;
	private static final int NUMBER_201 = 201;
     ...
     * @see
     */
    public List<QueryPartBusinessPriceResultDto> caculateFee(
	    List<QueryPartBusinessPriceDto> dto) {
...
//				divide(BigDecimal.valueOf(PricingConstants.YUTOFEN),newScale, BigDecimal.ROUND_HALF_UP);
    ...
    {
	PartbussPriceCaculateService object =new PartbussPriceCaculateService();
	List<QueryPartBusinessPriceDto> dto=new ArrayList<QueryPartBusinessPriceDto>();
	QueryPartBusinessPriceDto e=new QueryPartBusinessPriceDto();
	e.setWeight(BigDecimal.valueOf(NUMBER_201));
	e.setSubType(PriceEntityConstants.PRICING_CODE_FRT);
	dto.add(e);
	object.caculateFee(dto);
    }
