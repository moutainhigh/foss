 ...
 * PriceRegionOrgExpressCache.java Create on 2013-2-19 上午10:23:26
 * Company:IBM
 * @author FOSSDP-sz
 * Copyright (c) 2013 Company,Inc. All Rights Reserved
 * @version V1.0
 */
public class PriceRegionOrgExpressCache extends FossTTLCache<List<PriceRegioOrgnExpressEntity>> {
	/**
     * 标记PriceRegionOrgExpressCache的UUID
     * @return
     */
    @Override
    public String getUUID() {
    	return PKP_PRICE_REGION_ORG_EXPRESS_UUID;
    }
}