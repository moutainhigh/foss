 ...
 */
@Transactional
public class ExpressPricingValueAddedDao extends SqlSessionDaoSupport implements IExpressPricingValueAddedDao {
	//计价条目ibatis命名空间
	private static final String PRICING_ENTITY_NAMESPACE = "foss.pkp.pkp-pricing.expressPriceEntityMapper.";
	//查询增值服务类型
	private static final String SEARCHVALUEADDEDTYPR = "searchValueAddedTypeExpress";
