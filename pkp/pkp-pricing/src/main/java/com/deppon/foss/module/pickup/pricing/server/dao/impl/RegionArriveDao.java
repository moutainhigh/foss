 ...
 */
@Repository
public class RegionArriveDao extends SqlSessionDaoSupport implements IRegionArriveDao {
	// 价格区域
	...
	public List<PriceRegionArriveEntity> searchRegionByCondition(PriceRegionArriveEntity regionEntity, int start, int limit) {
		// 设置分页条件
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionArriveEntity> findRegionByCondition(PriceRegionArriveEntity regionEntity) {
		String sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGION;
	 ...
	 */
	@Override
	public void addRegionOrg(PriceRegionOrgArriveEntity priceRegionOrgArriveEntity) {
		String sqlAddress = PRICING_REGION_NAMESPACE + INSERT_REGIONORG;
		getSqlSession().insert(sqlAddress, priceRegionOrgArriveEntity);
	}
	...
	public List<PriceRegionOrgArriveEntity> searchRegionOrgByCondition(PriceRegionOrgArriveEntity priceRegionOrgArriveEntity) {
		...
		return getSqlSession().selectList(sqlAddress, priceRegionOrgArriveEntity);
	}
	...
	@Override 
	@SuppressWarnings("unchecked")
	public List<PriceRegionArriveEntity> searchRegionByDistrict(PriceRegionArriveEntity regionEntity) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionArriveEntity> searchRegionByDistrictNew(PriceRegionArriveEntity regionEntity) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionArriveEntity> searchRegionByName(String regionName, String regionNature) {
	 ...
	 */
	@Override
	public PriceRegionArriveEntity searchRegionByID(String id, String regionNature) {
		String sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGION_BY_ID;
		Map<String, String> map = new HashMap<String, String>();
		map.put("id", id);
		return (PriceRegionArriveEntity) getSqlSession().selectOne(sqlAddress, map);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionArriveEntity> selectPriceRegionByCondition(PriceRegionArriveEntity priceRegionAirEntity) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionOrgArriveEntity> selectPriceRegionOrgByCondition(PriceRegionOrgArriveEntity priceRegionOrgAirEntity) {
	...
	public Map<String, PriceRegionArriveEntity> findRegionByNames(List<String> names, String regionNature, Date billDate) {
		...
		List<PriceRegionArriveEntity> regionEntityList = getSqlSession().selectList(sqlAddress, map);
		if (CollectionUtils.isNotEmpty(regionEntityList)) {
			Map<String, PriceRegionArriveEntity> returnMap = new HashMap<String, PriceRegionArriveEntity>();
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionArriveEntity> findRegionByCodes(List<String> codes, String regionNature, Date billDate) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionArriveEntity> checkRegionOrganizationType(String administrativeRegionCodes, String regionNature, Date now) {
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionArriveEntity> searchRegionByDistrictForCache(String provinceCode, String cityCode,
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionOrgArriveEntity> searchRegionOrgByDeptNo(String deptNo, String regionNature) {
