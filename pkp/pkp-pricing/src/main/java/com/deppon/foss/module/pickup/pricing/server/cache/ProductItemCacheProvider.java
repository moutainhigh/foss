 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/pricing/server/cache/ProductItemCacheProvider.java
 * 
 * FILE NAME        	: ProductItemCacheProvider.java
 * 
 * AUTHOR			: FOSS综合管理开发组
 * 
 ...
 * @version V1.0
 */
public class ProductItemCacheProvider implements ITTLCacheProvider<List<ProductItemEntity>> {

	/**
	 * 
	 */
	private static final Logger log = Logger.getLogger(ProductItemCacheProvider.class);
	/**
	 * 产品条目DAO
	 */
     ...
     */
    @Override
    public List<ProductItemEntity> get(String key) {
    	log.debug("ProductItemCacheProvider cacheKey is :"+ key);
    	if (StringUtils.isBlank(key)) {
    	    return null;
    	}
    	return productItemDao.queryProductItemByCode(key);
    }
}