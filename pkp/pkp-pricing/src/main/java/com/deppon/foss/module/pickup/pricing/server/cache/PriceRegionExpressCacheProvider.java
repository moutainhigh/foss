 ...
 * @version V1.0
 */
public class PriceRegionExpressCacheProvider implements ITTLCacheProvider<List<PriceRegionExpressEntity>> {

	/**
	 * 
	 */
	private static final Logger log = Logger.getLogger(PriceRegionExpressCacheProvider.class);
	/**
	 * 区域 DAO
	 */
    @Inject
    ...
    public List<PriceRegionExpressEntity> get(String key) {
    	log.debug("PriceRegionExpressCacheProvider cacheKey is :"+ key);
    	...
    	//根据拆分的条件来查询
    	return regionExpressDao.searchRegionByDistrictForCache(provinceCode, cityCode, countyCode, PricingConstants.PRICING_REGION, null);
    }
