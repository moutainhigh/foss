 ...
 * @version V1.0
 */
public class PriceRegionOrgExpressCacheProvider implements ITTLCacheProvider<List<PriceRegioOrgnExpressEntity>> {
    ...
    public List<PriceRegioOrgnExpressEntity> get(String key) {
    	log.debug("PriceRegionOrgExpressCacheProvider cacheKey is :"+ key);
    	if (StringUtils.isBlank(key)) {
    	    return null;
    	}
    	return regionExpressDao.searchRegionOrgByDeptNo(key, PricingConstants.PRICING_REGION);
    }
}