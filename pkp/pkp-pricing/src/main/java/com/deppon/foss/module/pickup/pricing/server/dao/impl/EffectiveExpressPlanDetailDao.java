 ...
 * @version 1.0
 */
public class EffectiveExpressPlanDetailDao extends SqlSessionDaoSupport implements IEffectiveExpressPlanDetailDao{
    
    //mybatis 
    private static final String NAME_SPACE = "foss.pricing.EffectiveExpressPlanDetailEntityMapper.";
    //下载信息
     ...
     * @param record
     * @return 
     * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IEffectivePlanDetailDao#insertSelective(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveExpressPlanDetailEntity)
     */
    @Override
    public int insertSelective(EffectiveExpressPlanDetailEntity record) {
     ...
     */
    @Override
    public EffectiveExpressPlanDetailEntity selectByPrimaryKey(String id) {
	return (EffectiveExpressPlanDetailEntity) this.getSqlSession().selectOne(NAME_SPACE + SELECT_BY_PRIMARY_KEY ,id);
    }
     ...
     * @param record
     * @return 
     * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IEffectivePlanDetailDao#updateByPrimaryKeySelective(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveExpressPlanDetailEntity)
     */
    @Override
    public int updateByPrimaryKeySelective(EffectiveExpressPlanDetailEntity record) {
	this.setEffectivePlanDetailValuesAttribute(record);
	...
	@Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailInfoForDownload(String deptRegionId, Date lastModifyTime) {
    ...
    @SuppressWarnings("unchecked")
	@Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailListByCondition(String deptRegionId, String arrvRegionId, String productCode,
	   Date businessDate) {
	   EffectiveExpressPlanDto effectivePlanDto = new EffectiveExpressPlanDto();
     ...
     * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IEffectivePlanDetailDao#queryEffectivePlanDetailInfo(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveExpressPlanDetailEntity) 
     * @return EffectiveExpressPlanDetailEntity  时效明细信息
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailInfo(
     ...
     * @param limit
     * @return 
     * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IEffectivePlanDetailDao#queryEffectivePlanDetailInfoPagging(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveExpressPlanDetailEntity, int, int)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailInfoPagging(
     ...
     * @param effectivePlanDetailEntity
     * @return 
     * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IEffectivePlanDetailDao#queryEffectivePlanDetailInfoPaggingCount(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveExpressPlanDetailEntity)
     */
    @Override
     ...
     * @param effectivePlanDetailEntity
     * @return 
     * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IEffectivePlanDetailDao#queryEffectivePlanDetailByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveExpressPlanDetailEntity)
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailByCondition(
	EffectiveExpressPlanDetailEntity effectivePlanDetailEntity) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailByConditionByPage(
    		EffectiveExpressPlanDetailEntity effectivePlanDetailEntity, int started, int limited) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<EffectiveExpressPlanDetailEntity> searchEffectivePlanDetailEntityByCondition(
    ...
    public Long searchEffectivePlanDetailEntityByConditionCount(
	    EffectiveExpressPlanDetailEntity effectivePlanEntity) {
     ...
     * @see
     */
    private void setEffectivePlanDetailValuesAttribute(EffectiveExpressPlanDetailEntity entity){
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailListByArrvIds(
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailListByRegionIds (
