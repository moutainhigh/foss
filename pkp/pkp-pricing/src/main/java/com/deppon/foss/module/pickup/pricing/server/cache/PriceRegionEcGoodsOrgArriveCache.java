 ...
 * @version V1.0
 */
public class PriceRegionEcGoodsOrgArriveCache extends FossTTLCache<List<PriceRegionEcGoodsOrgArriveEntity>> {
	/**
    ...
    public String getUUID() {
    	return PKP_PRICE_ECGOODS_REGION_ORG_ARRIVE_UUID;
    }
}