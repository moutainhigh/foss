 ...
 */
@Repository
public class RegionEcGoodsArriveDao extends SqlSessionDaoSupport implements IRegionEcGoodsArriveDao {
	// 价格区域
	private static final String PRICING_REGION_NAMESPACE = "foss.pkp.pkp-pricing.pricingRegionEcGoodsArrive.";
	// 根据条件查询区域
	...
	public List<PriceRegionEcGoodsArriveEntity> searchRegionByCondition(PriceRegionEcGoodsArriveEntity regionEntity, int start, int limit) {
		// 设置分页条件
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionEcGoodsArriveEntity> findRegionByCondition(PriceRegionEcGoodsArriveEntity regionEntity) {
		String sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGION;
	 ...
	 */
	@Override
	public void addRegionOrg(PriceRegionEcGoodsOrgArriveEntity priceRegionEcGoodsOrgArriveEntity) {
		String sqlAddress = PRICING_REGION_NAMESPACE + INSERT_REGIONORG;
		getSqlSession().insert(sqlAddress, priceRegionEcGoodsOrgArriveEntity);
	}
	...
	public List<PriceRegionEcGoodsOrgArriveEntity> searchRegionOrgByCondition(PriceRegionEcGoodsOrgArriveEntity priceRegionEcGoodsOrgArriveEntity) {
		...
		return getSqlSession().selectList(sqlAddress, priceRegionEcGoodsOrgArriveEntity);
	}
	 ...
	 */
	@Override
	public void updateRegionOrg(PriceRegionEcGoodsOrgArriveEntity priceRegionOrgAirEntity) {
	...
	@Override 
	@SuppressWarnings("unchecked")
	public List<PriceRegionEcGoodsArriveEntity> searchRegionByDistrict(PriceRegionEcGoodsArriveEntity regionEntity) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionEcGoodsArriveEntity> searchRegionByDistrictNew(PriceRegionEcGoodsArriveEntity regionEntity) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionEcGoodsArriveEntity> searchRegionByName(String regionName, String regionNature) {
	 ...
	 */
	@Override
	public PriceRegionEcGoodsArriveEntity searchRegionByID(String id, String regionNature) {
		String sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGION_BY_ID;
		Map<String, String> map = new HashMap<String, String>();
		map.put("id", id);
		return (PriceRegionEcGoodsArriveEntity) getSqlSession().selectOne(sqlAddress, map);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionEcGoodsArriveEntity> selectPriceRegionByCondition(PriceRegionEcGoodsArriveEntity priceRegionAirEntity) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionEcGoodsOrgArriveEntity> selectPriceRegionOrgByCondition(PriceRegionEcGoodsOrgArriveEntity priceRegionOrgAirEntity) {
	...
	public Map<String, PriceRegionEcGoodsArriveEntity> findRegionByNames(List<String> names, String regionNature, Date billDate) {
		...
		//批量查询
		List<List<String>> spiltList = spiltList(names, NumberConstants.NUMBER_800);
		List<PriceRegionEcGoodsArriveEntity> regionEntityList;
		List<PriceRegionEcGoodsArriveEntity> regionEcGoodsArriveEntityList = new ArrayList<PriceRegionEcGoodsArriveEntity>();
		if(CollectionUtils.isNotEmpty(spiltList)){

			for(int i=0;i<spiltList.size();i++){
				names = spiltList.get(i);
				Map map = new HashMap();
				map.put("regionNames", names);
				map.put("billDate", billDate);
				map.put("active", FossConstants.ACTIVE);
				regionEntityList = getSqlSession().selectList(sqlAddress, map);

				regionEcGoodsArriveEntityList.addAll(regionEntityList);
			}
		}

		if (CollectionUtils.isNotEmpty(regionEcGoodsArriveEntityList)) {
			Map<String, PriceRegionEcGoodsArriveEntity> returnMap = new HashMap<String, PriceRegionEcGoodsArriveEntity>();
			for (int loop = 0; loop < regionEcGoodsArriveEntityList.size(); loop++) {
				returnMap.put(regionEcGoodsArriveEntityList.get(loop).getRegionName(), regionEcGoodsArriveEntityList.get(loop));
			}
			return returnMap;
	 ...
	 * @return
	 */
	public static <T> List<List<T>> spiltList(List<T> list, int count){
		...
		//整除a，余数b
		int a = list.size()/count;
		int b = list.size()%count;

		//先考虑整数情况
		for(int i =0;i<a;i++){
			List<T> tempList = new ArrayList<T>();
			for(int j=0;j<count;j++){
				tempList.add(list.get(i*count+j));
			}
		...
		if(b>0){
			List<T> tempList = new ArrayList<T>();
			for(int k=0;k<b;k++){
				tempList.add(list.get(a*count+k));
			}
			newList.add(tempList);
		}
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionEcGoodsArriveEntity> findRegionByCodes(List<String> codes, String regionNature, Date billDate) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionEcGoodsArriveEntity> checkRegionOrganizationType(String administrativeRegionCodes, String regionNature, Date now) {
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionEcGoodsArriveEntity> searchRegionByDistrictForCache(String provinceCode, String cityCode,
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionEcGoodsOrgArriveEntity> searchRegionOrgByDeptNo(String deptNo, String regionNature) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionEcGoodsOrgArriveEntity> searchRegionOrgByRegionId(String deptRegionId) {
