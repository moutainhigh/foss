 ...
 */
@Repository
public class RegionExpressDao extends SqlSessionDaoSupport implements IRegionExpressDao {
    	/** 价格区域. */
	private static final String PRICING_REGION_NAMESPACE = "foss.pkp.pkp-pricing.pricingRegionExpress.";
	/** 时效区域. */
	private static final String PRESCRIPTION_REGION_NAMESPACE = "foss.pkp.pkp-pricing.perscriptionRegionExpress.";
	/** 根据条件查询区域. */
	...
	/** 根据区域名称查询 *. */
	private static final String SEARCH_REGIONRENAME_BY_NAME = "searchRegionReNameByName";
	/** 根据区域ID查询区域 *. */
	private static final String SEARCH_REGION_BY_ID = "searchRegionByID";
	
	/** 根据价格区域查询价格区域的所有上级区域信息 *. */
	private static final String SEARCH_EXPRESS_UP_REGION = "searchExpressAllUpRegionByCondition";
	/** 
	 * 
	 * <p>
	 * 根据条件查询区域信息（分页）
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#searchRegionByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity, int, int)
	 */
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionExpressEntity> searchRegionByCondition(PriceRegionExpressEntity regionEntity, int start, int limit) {
		// 设置分页条件
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#findRegionByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity)
	 */
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionExpressEntity> findRegionByCondition(PriceRegionExpressEntity regionEntity) {
		String sqlAddress = null;
		if (PricingConstants.PRESCRIPTION_REGION.equals(regionEntity.getRegionNature())) {
			sqlAddress = PRESCRIPTION_REGION_NAMESPACE + SEARCH_REGION;
		} else if (PricingConstants.PRICING_REGION.equals(regionEntity.getRegionNature())) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionExpressEntity> findRegionByRegion(PriceRegionExpressEntity regionEntity) {
		String sqlAddress = null;
		if (PricingConstants.PRESCRIPTION_REGION.equals(regionEntity.getRegionNature())) {
			sqlAddress = PRESCRIPTION_REGION_NAMESPACE + "searchRegionByRegion";
		} else if (PricingConstants.PRICING_REGION.equals(regionEntity.getRegionNature())) {
			sqlAddress = PRICING_REGION_NAMESPACE + "searchRegionByRegion";
		}
		return getSqlSession().selectList(sqlAddress, regionEntity);
	}
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#countRegionByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity)
	 */
	@Override
	 ...
	 * @param regionEntity 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#addRegion(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity)
	 */
	@Override
	 ...
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#addRegionOrg(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegioOrgnExpressEntity)
	 */
	@Override
	public void addRegionOrg(PriceRegioOrgnExpressEntity priceRegioOrgnExpressEntity) {
		String sqlAddress = null;
		if (PricingConstants.PRESCRIPTION_REGION.equals(priceRegioOrgnExpressEntity.getRegionNature())) {
			sqlAddress = PRESCRIPTION_REGION_NAMESPACE + INSERT_REGIONORG;
		} else if (PricingConstants.PRICING_REGION.equals(priceRegioOrgnExpressEntity.getRegionNature())) {
			sqlAddress = PRICING_REGION_NAMESPACE + INSERT_REGIONORG;
		}
		getSqlSession().insert(sqlAddress, priceRegioOrgnExpressEntity);
	}
	/** 
	 * 
	 * <p>根据条件查询区域关联部门信息<br/>
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#searchRegionOrgByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegioOrgnExpressEntity)
	 */
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegioOrgnExpressEntity> searchRegionOrgByCondition(PriceRegioOrgnExpressEntity priceRegioOrgnExpressEntity) {
		...
		return getSqlSession().selectList(sqlAddress, priceRegioOrgnExpressEntity);
	}
	/** 
	 * 
	 * <p>激活区域<br/>
	...
	public void activeRegion(List<String> regionIds, String regionNature) {
		...
		//zxy 20140327 MANA-2018 start 修改:增加版本号
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("versionNo", new Date().getTime());
		//zxy 20140327 MANA-2018 end 修改:增加版本号
	 ...
	 * @param regionEntity 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#updateRegion(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity)
	 */
	@Override
	 ...
	 * @param priceRegioOrgnExpressEntity 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#updateRegionOrg(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegioOrgnExpressEntity)
	 */
	@Override
	public void updateRegionOrg(PriceRegioOrgnExpressEntity priceRegioOrgnExpressEntity) {
		String sqlAddress = null;
		if (PricingConstants.PRESCRIPTION_REGION.equals(priceRegioOrgnExpressEntity.getRegionNature())) {
		...
		getSqlSession().update(sqlAddress, priceRegioOrgnExpressEntity);
	}
	/** 
	 * 
	 * <p>根据行政区域查逻辑区域</p> 
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#searchRegionByDistrict(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity)
	 */
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionExpressEntity> searchRegionByDistrict(PriceRegionExpressEntity regionEntity) {
		String sqlAddress = null;
		if (PricingConstants.PRESCRIPTION_REGION.equals(regionEntity.getRegionNature())) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionExpressEntity> searchRegionByDistrictNew(PriceRegionExpressEntity regionEntity) {
		String sqlAddress = null;
		if (PricingConstants.PRESCRIPTION_REGION.equals(regionEntity.getRegionNature())) {
	 ...
	 */
	@Override
	public PriceRegionExpressEntity searchRegionByID(String id, String regionNature) {
		String sqlAddress = null;
		if (regionNature != null && regionNature.equals(PricingConstants.PRESCRIPTION_REGION)) {
		...
		Map<String, String> map = new HashMap<String, String>();
		map.put("id", id);
		return (PriceRegionExpressEntity) getSqlSession().selectOne(sqlAddress, map);
	}
	/** 
	 *
	 * <p> 根据条件查询价格区域信息<br/>
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#selectPriceRegionByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegionExpressEntity)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionExpressEntity> selectPriceRegionByCondition(PriceRegionExpressEntity priceRegionEntity) {
	 ...
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#selectPriceRegionOrgByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.PriceRegioOrgnExpressEntity)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegioOrgnExpressEntity> selectPriceRegionOrgByCondition(PriceRegioOrgnExpressEntity priceRegioOrgnExpressEntity) {
	 ...
	 * @date 2013-3-14 下午2:21:32
	 * 
	 * @param effectiveRegionExpressEntity
	 * 
	 * @return 
	 * @see com.deppo
	 * n.foss.module.pickup.pricing.api.server.dao.IRegionDao#selectEffectiveRegionByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveRegionExpressEntity)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<EffectiveRegionExpressEntity> selectEffectiveRegionByCondition(EffectiveRegionExpressEntity effectiveRegionExpressEntity) {
		String sqlAddress = PRESCRIPTION_REGION_NAMESPACE + SELECT_EFFECTIVE_REGION;
		return getSqlSession().selectList(sqlAddress, effectiveRegionExpressEntity);
	}
	/** 
	 * 
	 * <p>
	 ...
	 * @date 2013-3-14 下午2:21:32
	 * 
	 * @param effectiveRegionOrgExpressEntity
	 * 
	 * @return 
	 * 
	 * @see com.deppon.foss.module.pickup.pricing.api.server.dao.IRegionDao#selectEffectiveRegionOrgByCondition(com.deppon.foss.module.pickup.pricing.api.shared.domain.EffectiveRegionOrgExpressEntity)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<EffectiveRegionOrgExpressEntity> selectEffectiveRegionOrgByCondition(
			EffectiveRegionOrgExpressEntity effectiveRegionOrgExpressEntity) {
		String sqlAddress = PRESCRIPTION_REGION_NAMESPACE + SELECT_EFFECTIVE_REGION_ORG;
		return getSqlSession().selectList(sqlAddress, effectiveRegionOrgExpressEntity);
	}
	/**
	 * 
	 * 根据区域名称批量查找区域信息
	...
	public Map<String, PriceRegionExpressEntity> findRegionByNames(List<String> names, String regionNature, Date billDate) {
		...
		List<PriceRegionExpressEntity> regionEntityList = getSqlSession().selectList(sqlAddress, map);
		if (CollectionUtils.isNotEmpty(regionEntityList)) {
			Map<String, PriceRegionExpressEntity> returnMap = new HashMap<String, PriceRegionExpressEntity>();
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionExpressEntity> findRegionByCodes(List<String> codes, String regionNature, Date billDate) {
		String sqlAddress = null;
		if (regionNature != null && regionNature.equals(PricingConstants.PRESCRIPTION_REGION)) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionExpressEntity> checkRegionOrganizationType(String id,String administrativeRegionCodes, String regionNature) {
		String sqlAddress = null;
		if (regionNature != null && regionNature.equals(PricingConstants.PRESCRIPTION_REGION)) {
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionExpressEntity> searchRegionByDistrictForCache(String provinceCode, String cityCode,
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegioOrgnExpressEntity> searchRegionOrgByDeptNo(String deptNo, String regionNature) {
		String sqlAddress = null;
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegioOrgnExpressEntity> searchRegionOrgByRegionId(String deptRegionId, String regionNature) {
		String sqlAddress = null;
		Map map = new HashMap();
	...
	@Override
	public List<PriceRegionExpressEntity> searchRegionReNameByName(
			String regionName, Date beginTime, String regionNature) {
		String sqlAddress = null;
		if (regionNature != null && regionNature.equals(PricingConstants.PRESCRIPTION_REGION)) {
			sqlAddress = PRESCRIPTION_REGION_NAMESPACE + SEARCH_REGIONRENAME_BY_NAME;
		} else if (regionNature != null && regionNature.equals(PricingConstants.PRICING_REGION)) {
			sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGIONRENAME_BY_NAME;
		}
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("regionName", regionName);
	 ...
	 * 
	 *
	 * @Function: com.deppon.foss.module.pickup.pricing.server.dao.impl.RegionExpressDao.searchExpressAllUpRegionByCondition
	...
	public List<PriceRegionExpressEntity> searchExpressAllUpRegionByCondition(
		...
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE+SEARCH_EXPRESS_UP_REGION, regionEntity);
	}
