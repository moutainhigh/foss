 ...
 * @version V1.0
 */
public class EffectiveRegionExpressCacheDeal {

	/**
	 * EffectiveRegionExpressCache 缓存
	 */
	private EffectiveRegionExpressCache effectiveRegionExpressCache;
	


	/**
	 * 获取 effectiveRegionExpressCache 缓存.
	 *
	 * @return the effectiveRegionExpressCache 缓存
	 */	
	public EffectiveRegionExpressCache getEffectiveRegionExpressCache() {
		return effectiveRegionExpressCache;
	}
	/**
	 * 设置 effectiveRegionExpressCache 缓存.
	 *
	 * @param effectiveRegionExpressCache the new effectiveRegionExpressCache 缓存
	 */
	public void setEffectiveRegionExpressCache(
			EffectiveRegionExpressCache effectiveRegionExpressCache) {
		this.effectiveRegionExpressCache = effectiveRegionExpressCache;
	}
	...
	public List<PriceRegionExpressEntity> getPriceRegionExpressByCache(String code, Date date) {
		List<PriceRegionExpressEntity> priceRegionEntities = effectiveRegionExpressCache.get(code);
