 ...
 * <p style="display:none">version:V1.0,author:094463-foss-xieyantao,date:2013-7-25 下午6:49:29 </p>
 * @author 094463-foss-xieyantao
 * @date 2013-7-25 下午6:49:29
 * @since
 * @version
 */
@Repository
public class ExpressPriceRegionDao extends SqlSessionDaoSupport implements IExpressPriceRegionDao {
    	/** 价格区域. */
	private static final String PRICING_REGION_NAMESPACE = "foss.pkp.pkp-pricing.expressPricingRegion.";
	/** 时效区域. */
	...
	public List<PriceRegionExpressEntity> searchRegionByCondition(PriceRegionExpressEntity regionEntity, int start, int limit) {
		...
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SEARCH_REGION, regionEntity, rowBounds);
	}
	/** 
	 * 
	 * <p>
	...
	public List<PriceRegionExpressEntity> findRegionByCondition(PriceRegionExpressEntity regionEntity) {
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SEARCH_REGION, regionEntity);
	}
	/** 
	 * 
	 * <p> 根据条件查询区域信息个数<br/>
	...
	public Long countRegionByCondition(PriceRegionExpressEntity regionEntity) {
		return (Long) getSqlSession().selectOne(PRICING_REGION_NAMESPACE + COUNT_REGION, regionEntity);
	}
	/** 
	 * 
	 * <p>新增区域<br/>
	...
	public void addRegion(PriceRegionExpressEntity regionEntity) {
		getSqlSession().insert(PRICING_REGION_NAMESPACE + INSERT_REGION, regionEntity);
	}
	/** 
	 * 
	 * <p>新增区域与部门的关联<br/>
	 ...
	 */
	@Override
	public void addRegionOrg(PriceRegioOrgnExpressEntity priceRegioOrgnEntity) {
		getSqlSession().insert(PRICING_REGION_NAMESPACE + INSERT_REGIONORG, priceRegioOrgnEntity);
	}
	/** 
	 * 
	 * <p>根据条件查询区域关联部门信息<br/>
	...
	public List<PriceRegioOrgnExpressEntity> searchRegionOrgByCondition(PriceRegioOrgnExpressEntity priceRegioOrgnEntity) {
		...
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SEARCH_REGIONORG, priceRegioOrgnEntity);
	}
	/** 
	 * 
	 * <p>激活区域<br/>
	...
	public void activeRegion(List<String> regionIds, String regionNature) {
		...
		getSqlSession().update(PRICING_REGION_NAMESPACE + ACTIVE_REGION, map);
	}
	/** 
	 * 
	 * <p>删除区域<br/>
	...
	public void deleteRegion(List<String> regionIds, String regionNature) {
		...
		map.put("regionIds", regionIds);
		getSqlSession().update(PRICING_REGION_NAMESPACE + DELETE_REGION, map);
	}
	/** 
	 * 
	 * <p>删除区域下关联部门<br/>
	...
	public void deleteRegionOrg(List<String> regionIds, String regionNature) {
		Map<String, List<String>> map = new HashMap<String, List<String>>();
		map.put("regionIds", regionIds);
		getSqlSession().update(PRICING_REGION_NAMESPACE + DELETE_REGION_ORG, map);
	}
	/** 
	 * 
	 * <p>激活区域下关联的区域部门<br/>
	...
	public void activeRegionOrg(String regionId, String regionNature) {
		...
		map.put("versionNo", new Date().getTime());
		getSqlSession().update(PRICING_REGION_NAMESPACE + ACTIVE_REGIONORG, map);
	}
	/** 
	 * 
	 * <p>修改区域<br/>
	...
	public void updateRegion(PriceRegionExpressEntity regionEntity) {
		getSqlSession().update(PRICING_REGION_NAMESPACE + UPDATE_REGION, regionEntity);
	}
	/** 
	 * 
	 * <p>修改区域与部门的关联<br/>
	 ...
	 */
	@Override
	public void updateRegionOrg(PriceRegioOrgnExpressEntity priceRegioOrgnEntity) {
		getSqlSession().update(PRICING_REGION_NAMESPACE + UPDATE_REGIONORG, priceRegioOrgnEntity);
	}
	/** 
	 * 
	 * <p>根据行政区域查逻辑区域</p> 
	...
	public List<PriceRegionExpressEntity> searchRegionByDistrict(PriceRegionExpressEntity regionEntity) {
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SEARCH_REGION_BY_DIS, regionEntity);
	}
	...
	public List<PriceRegionExpressEntity> searchRegionByDistrictNew(PriceRegionExpressEntity regionEntity) {
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + "searchRegionByDistrictNew", regionEntity);
	}
	/** 
	 * 
	 * <p>根据区域名称区域信息<br/>
	...
	public List<PriceRegionExpressEntity> searchRegionByName(String regionName, String regionNature) {
		...
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SEARCH_REGION_BY_NAME, map);
	}
	/** 
	 * 
	...
	public PriceRegionExpressEntity searchRegionByID(String id, String regionNature) {
		Map<String, String> map = new HashMap<String, String>();
		map.put("id", id);
		return (PriceRegionExpressEntity) getSqlSession().selectOne(PRICING_REGION_NAMESPACE + SEARCH_REGION_BY_ID, map);
	}
	/** 
	 *
	 * <p> 根据条件查询价格区域信息<br/>
	...
	public List<PriceRegionExpressEntity> selectPriceRegionByCondition(PriceRegionExpressEntity priceRegionEntity) {
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SELECT_PRICING_REGION, priceRegionEntity);
	}
	/** 
	 * 
	 * <p>
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegioOrgnExpressEntity> selectPriceRegionOrgByCondition(PriceRegioOrgnExpressEntity priceRegioOrgnEntity) {
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + SELECT_PRICING_REGION_ORG, priceRegioOrgnEntity);
	}
	/** 
	 * 
	 * <p>根据条件查询时效区域信息<br/>
	...
	public List<EffectiveRegionEntity> selectEffectiveRegionByCondition(EffectiveRegionEntity effectiveRegionEntity) {
		return getSqlSession().selectList(PRESCRIPTION_REGION_NAMESPACE + SELECT_EFFECTIVE_REGION, effectiveRegionEntity);
	}
	/** 
	 * 
	 * <p>
	...
	public List<EffectiveRegionOrgEntity> selectEffectiveRegionOrgByCondition(
		...
		return getSqlSession().selectList(PRESCRIPTION_REGION_NAMESPACE + SELECT_EFFECTIVE_REGION_ORG, effectiveRegionOrgEntity);
	}
	/**
	 * 
	 * 根据区域名称批量查找区域信息
	...
	public Map<String, PriceRegionExpressEntity> findRegionByNames(List<String> names, String regionNature, Date billDate) {
		...
		List<PriceRegionExpressEntity> regionEntityList = getSqlSession().selectList(PRICING_REGION_NAMESPACE + "findRegionByNames", map);
	...
	public List<PriceRegionExpressEntity> findRegionByCodes(List<String> codes, String regionNature, Date billDate) {
		...
		map.put("billDate", billDate);
		map.put("active", FossConstants.ACTIVE);
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + "findRegionByCodes", map);
	}
	/** 
	 * 
	...
	public List<PriceRegionExpressEntity> checkRegionOrganizationType(String id,String administrativeRegionCodes, String regionNature) {
		...
		map.put("id", id);
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + "checkRegionOrganizationType", map);
	}
	/**
	 * 
	...
	public List<PriceRegionExpressEntity> searchRegionByDistrictForCache(String provinceCode, String cityCode,
		...
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE+"searchRegionByDistrictForCache", parameterMap);
	}
	/**
	...
	public List<PriceRegioOrgnExpressEntity> searchRegionOrgByDeptNo(String deptNo, String regionNature) {
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + "searchRegionOrgByDeptNo", deptNo);
	}
	/**
	 * 
	...
	public List<PriceRegioOrgnExpressEntity> searchRegionOrgByRegionId(String deptRegionId, String regionNature) {
		...
		return getSqlSession().selectList(PRICING_REGION_NAMESPACE + "searchRegionOrgByRegionId", map);
	}
}
