 ...
 * @version 1.0
 */
public class PricingValueAddedAction extends AbstractAction {
    	/** 
    	 * 
    	 * 序列化 
    	 * 
	...
	public String searchPricingValuation() {
		try {
			pricingValuationVo.setPriceValuationEntityList(pricingValueAddedService.selectByCodition(pricingValuationVo.getPriceValuationEntity(),
					this.getStart(), this.getLimit()));// 增值服务查询结果集
			this.setTotalCount(pricingValueAddedService.countByCodition(pricingValuationVo.getPriceValuationEntity()));// 查询总数
	...
	public String searchCriteriaDetailById() {
		try {
			 ...
			 * @author:
			 */
			pricingValuationVo.setPriceCriteriaDetailEntityList(pricingValueAddedService.selectByValuationId(pricingValuationVo.getValuationId()));
			if("ZQBZ".equals(pricingValuationVo.getPriceEntity().getCode())){
				for(PriceCriteriaDetailEntity priceCriteriaDetailEntity:pricingValuationVo.getPriceCriteriaDetailEntityList()){
					List<PriceFibelPaperPackingEntity> priceFibelPaperPackingEntityList=pricingValueAddedService.selectByValuationIdAndCodeTrue(pricingValuationVo.getValuationId());
	...
	public String addValueAdded() {
		try {
			pricingValueAddedService.addValueAdded(pricingValuationVo.getPriceValuationEntity(), pricingValuationVo.getPriceCriteriaDetailEntityList());
	...
	public String updateValueAdded() {
		try {
			pricingValueAddedService.updateValueAdded(pricingValuationVo.getPriceValuationEntity(), 
	...
	public String searchValueAddedType() {
		try {
			pricingValuationVo.setPriceEntityList(pricingValueAddedService.searchValueAddedType(pricingValuationVo.getPriceEntity()));
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String activeValueAdded() {
		try {
			pricingValueAddedService.activeValueAdded(pricingValuationVo.getValuationIds());
	...
	public String activeFast() {
		try {
			...
			pricingValueAddedService.activeFast(pricingValuationVo.getPriceValuationEntity());
			return returnSuccess(MessageType.ACTIVE_SUCCESS);// 激活成功
		} catch (BusinessException e) {
	...
	public String deleteValueAdded() {
		try {
			pricingValueAddedService.deleteValueAdded(pricingValuationVo.getValuationIds());
	...
	public String findProductItemByCondiction() {
		try {
			pricingValuationVo.setProductItemEntityList(pricingValueAddedService.findProductItemByCondiction());
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String findProductByCondition() {
		try {
			pricingValuationVo.setProductEntityList(pricingValueAddedService.findProductByCondition());
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String findTwoLevelProduct() {
		try {
			pricingValuationVo.setProductEntityList(pricingValueAddedService.findTwoLevelProduct());
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String findOneLevelProduct() {
		try {
			pricingValuationVo.setProductEntityList(pricingValueAddedService.findOneLevelProduct());
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String findThreeLevelProduct() {
		try {
			pricingValuationVo.setProductEntityList(pricingValueAddedService.findThreeLevelProduct());
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String findGoodsTypeByCondiction() {
		try {
			pricingValuationVo.setGoodsTypeEntityList(pricingValueAddedService.findGoodsTypeByCondiction());
			return returnSuccess();
		} catch (BusinessException e) {
	...
	public String updatePriceValuation() {
		try {
			pricingValueAddedService.updatePriceValuation(pricingValuationVo.getPriceValuationEntity());
