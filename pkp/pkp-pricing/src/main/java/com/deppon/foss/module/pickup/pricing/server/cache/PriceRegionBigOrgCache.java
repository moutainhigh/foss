 ...
 * @version V1.0
 */
public class PriceRegionBigOrgCache extends FossTTLCache<List<PriceRegioOrgnBigGoodsEntity>> {
	/**
     * 标记PriceRegionOrgCache的UUID
     * @return
     */
    @Override
    public String getUUID() {
    	return PKP_PRICE_REGION_BIG_ORG_UUID;
    }
}