 ...
 */
@Repository
public class RegionValueAddDao extends SqlSessionDaoSupport implements IRegionValueAddDao {
	// 价格区域
	...
	public List<PriceRegionValueAddEntity> searchRegionByCondition(PriceRegionValueAddEntity regionEntity, int start, int limit) {
		// 设置分页条件
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionValueAddEntity> findRegionByCondition(PriceRegionValueAddEntity regionEntity) {
		String sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGION;
	 ...
	 */
	@Override
	public void addRegion(PriceRegionValueAddEntity regionEntity) {
	 ...
	 */
	@Override
	public void addRegionOrg(PriceRegionOrgValueAddEntity priceRegionOrgValueAddEntity) {
		String sqlAddress = PRICING_REGION_NAMESPACE + INSERT_REGIONORG;
		getSqlSession().insert(sqlAddress, priceRegionOrgValueAddEntity);
	}
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionOrgValueAddEntity> searchRegionOrgByCondition(PriceRegionOrgValueAddEntity priceRegionOrgAirEntity) {
	...
	@Override 
	@SuppressWarnings("unchecked")
	public List<PriceRegionValueAddEntity> searchRegionByDistrict(PriceRegionValueAddEntity regionEntity) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionValueAddEntity> searchRegionByDistrictNew(PriceRegionValueAddEntity regionEntity) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PriceRegionValueAddEntity> searchRegionByName(String regionName, String regionNature) {
	 ...
	 */
	@Override
	public PriceRegionValueAddEntity searchRegionByID(String id, String regionNature) {
		String sqlAddress = PRICING_REGION_NAMESPACE + SEARCH_REGION_BY_ID;
		Map<String, String> map = new HashMap<String, String>();
		map.put("id", id);
		return (PriceRegionValueAddEntity) getSqlSession().selectOne(sqlAddress, map);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionValueAddEntity> selectPriceRegionByCondition(PriceRegionValueAddEntity priceRegionAirEntity) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionOrgValueAddEntity> selectPriceRegionOrgByCondition(PriceRegionOrgValueAddEntity priceRegionOrgAirEntity) {
	...
	public Map<String, PriceRegionValueAddEntity> findRegionByNames(List<String> names, String regionNature, Date billDate) {
		...
		List<PriceRegionValueAddEntity> regionEntityList = getSqlSession().selectList(sqlAddress, map);
		if (CollectionUtils.isNotEmpty(regionEntityList)) {
			Map<String, PriceRegionValueAddEntity> returnMap = new HashMap<String, PriceRegionValueAddEntity>();
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionValueAddEntity> findRegionByCodes(List<String> codes, String regionNature, Date billDate) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionValueAddEntity> checkRegionOrganizationType(
	...
	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<PriceRegionValueAddEntity> searchRegionByDistrictForCache(String provinceCode, String cityCode,
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PriceRegionOrgValueAddEntity> searchRegionOrgByDeptNo(String deptNo, String regionNature) {
	...
	public String querySequence() {
		...
		params.put("sequenceName", "VALUEADD_REGION_SEQ");
