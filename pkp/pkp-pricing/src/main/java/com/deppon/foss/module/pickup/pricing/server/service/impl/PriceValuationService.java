...
public class PriceValuationService implements IPriceValuationService{
     ...
     * 日志
     */
    private static final Logger log = Logger.getLogger(PriceValuationService.class);
    ...
    public List<ResultProductPriceDto> queryPriceValuationByCalculaCondition(QueryProductPriceDto dto) {
    	return priceValuationDao.queryPriceValuationByCalculaCondition(dto);
    }
	...
	public List<NewResultProductPriceDto> queryPriceValuationByCodition(
    	...
    	return priceValuationDao.queryPriceValuationByCodition(queryProductPriceDto);
	}
    ...
    public List<ResultProductPriceDto> queryPriceValuationByCalculaCach(
	  QueryProductPriceDto queryProductPriceDto) {
		...
		return priceValuationDao.queryPriceValuationByCalculaCondition(queryProductPriceDto);
	    }
	} catch (Exception e) {
	    e.printStackTrace();
