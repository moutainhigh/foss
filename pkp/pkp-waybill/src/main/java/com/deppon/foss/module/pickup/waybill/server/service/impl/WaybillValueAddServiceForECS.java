...
public class WaybillValueAddServiceForECS implements IWaybillValueAddServiceForECS {

	/**
	 * 日志对象
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(WaybillValueAddServiceForECS.class);
