 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/dao/impl/WaybillDao.java
 * 
 ...
 *
 */
public class WaybillDao extends iBatis3DaoImpl implements IWaybillDao {
	...
	private static final String NAMESPACE_QMS = "foss.pkp.WaybillInfoForQmsMapper.";
	 ...
	 */
	@Override
	public String addWaybillEntity(WaybillEntity waybill) {
		// 设置UUID
		waybill.setId(UUIDUtils.getUUID());
       //零担免费接送货需求在运单表增加字段,导致影响所有快递开单,电子运单,字母件在插入运单表数据时由于值为null报错,151211,杨套红,2016/3/12
		if(StringUtils.isBlank(waybill.getFreePickupGoods())){
			waybill.setFreePickupGoods("N");
		}
	 ...
	 */
	@Override
	public int updateWaybillByWaybillNo(WaybillEntity waybill,String oldWaybillNo) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("waybill", waybill);
		map.put("oldWaybillNo", oldWaybillNo);
		return this.getSqlSession().update(
				NAMESPACE + "updateByWaybillNo", map);
	}
	 ...
	 */
	@Override
	public WaybillEntity queryRecentWaybillByNo(String waybillNo) {
		// 封装查询条件
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);
		return (WaybillEntity) this.getSqlSession().selectOne(
	 ...
	 */
	@Override
	public List<WaybillEntity> selectByWaybillNoNoActive(String waybillNo) {
		// 封装查询条件
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);

		return (List<WaybillEntity>) this.getSqlSession().selectList(
				NAMESPACE + "selectByWaybillNoNoActive", argsDto);
	}
	 ...
	 * @param waybill
	 */
	public WaybillEntity queryWaybillByNoAndOrderNo(String waybillNo,
			String orderNo) {
		// 封装查询条件
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);
	 ...
	 */
	@Override
	public WaybillEntity queryWaybillByNoExceptPDAPending(String waybillNo) {
		// 封装查询条件
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);
		argsDto.setWaybillStatus(WaybillConstants.WAYBILL_STATUS_PDA_PENDING);
		argsDto.setActive(FossConstants.YES);

		return (WaybillEntity) this.getSqlSession().selectOne(
				NAMESPACE + "selectByWaybillNoExceptPDAPending", argsDto);
	}
	...
	public WaybillEntity queryLastWaybill(String orgCode) {
		...
		List<WaybillEntity> list = this.getSqlSession().selectList(
	...
	public List<AccountingResultDto> queryWaybillInfosByAccount(
		...
		List<AccountingResultDto> accountingResultDtos = this.getSqlSession()
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<WaybillEntity> queryWaybill(WaybillDto waybill) {
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybills", waybill);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<WaybillEntity> queryWaybillNoExpress(WaybillDto waybill) {
		
//		List<WaybillEntity> waybillEntityList = this.getSqlSession().selectList(NAMESPACE + "queryLTLWaybillNoExpress", waybill);
//		waybillEntityList.addAll(this.getSqlSession().selectList(NAMESPACE + "queryWaybillNoExpress", waybill));
//		return waybillEntityList;
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillNoExpress", waybill);
	}
	...
	public WaybillEntity queryPartWaybillByNo(String waybillNo) {
		...
		List<WaybillEntity> list=this.getSqlSession().selectList(NAMESPACE + "queryPartWaybillByNo", map);
		if(list!=null && list.size()>0){
			return list.get(0);
		}else{
			return null;
	...
	public List<AbandonedGoodsDto> queryAbandonedGoodsDtoList(
		...
		return this.getSqlSession().selectList(
				NAMESPACE + "queryAbandonedGoodsDtoList", condition);
	}
	...
	public void updateAbandonedGoods(Map<String, Object> args) {
		this.getSqlSession().update(NAMESPACE + "updateAbandonedGoods", args);
	}
	 ...
	 * @param waybillNoList
	 * @return
	 * @see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#queryWaybillDetail(java.util.List)
	 */
//	@SuppressWarnings("unchecked")
//	@Override
...
//		return this.getSqlSession().selectList(
//				NAMESPACE + "queryWaybillDetail", queryListDto);
//	}
	...
	public List<CrmWaybillServiceDto> queryWaybillDetail(
		...
		return this.getSqlSession().selectList(
				NAMESPACE + "queryWaybillDetail", args);
	}
	...
	public String queryDepartureDeptNumber(String waybillNo) {
		...
		return (String)this.getSqlSession().selectOne(NAMESPACE + "queryDepartureDeptNumber", args);
	}
	...
	public List<String> queryWaybillListByComplexCondation(
		...
		RowBounds bounds = new RowBounds(0, NUMBER_3000);
		return this.getSqlSession().selectList(
				
				NAMESPACE + "queryWaybillListByComplexCondation",
				waybillListByComplexCondationDto,bounds);
	}
	 ...
	 * @param start
	 * @param limit
	 * @see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#querySalesStatementByComplexCondation(com.deppon.foss.module.pickup.waybill.shared.dto.WaybillListByComplexCondationDto, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<SalesStatementByComplexCondationResultDto> querySalesStatementByComplexCondation(
			WaybillListByComplexCondationDto condition,int start,int limit) {
		//若传的分页参数为0则默认为不进行分页
		if(limit==0){
			  return 	this.getSqlSession().selectList(
						NAMESPACE + "querySalesStatementByComplexCondation", condition);
			}else{
			RowBounds bounds = new RowBounds(start, limit);
			return this.getSqlSession().selectList(
					NAMESPACE + "querySalesStatementByComplexCondation", condition,bounds);
		}
	}
	 ...
	 * @date 2012-12-25
	 * @param condition
	 * @see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#queryBillListByComplexCondation(com.deppon.foss.module.pickup.waybill.shared.dto.WaybillListByComplexCondationDto)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<SalesStatementByComplexCondationResultDto> queryBillListByComplexCondation(
			WaybillListByComplexCondationDto condition) {
		return this.getSqlSession().selectList(NAMESPACE + "queryBillListByComplexCondation", condition);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<QueryMoneyDto> queryRecieveMoney(QueryMoneyConditionDto queryMoneyConditionDto) {
		return getSqlSession().selectList(NAMESPACE + "queryRecieveMoney", queryMoneyConditionDto);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<QueryMoneyDto> queryDeliveryMoney(QueryMoneyConditionDto queryMoneyConditionDto) {
		return getSqlSession().selectList(NAMESPACE + "queryDeliveryMoney", queryMoneyConditionDto);
	}
	 ...
	 * @param waybillNO
	 * @return
	 * @see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#queryWaybillInfoByWaybillNo(java.lang.String)
	 */
	@Override
	public WaybillInfoByWaybillNoReultDto queryWaybillInfoByWaybillNo(
		...
		map.put("active", FossConstants.ACTIVE);
		return (WaybillInfoByWaybillNoReultDto) this.getSqlSession().selectOne(NAMESPACE + "queryWaybillInfoByWaybillNo", map);
	}
	 ...
	 * @param condition
	 * @return
	 * @@see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#countQuerySalesStatementByComplexCondation(com.deppon.foss.module.pickup.waybill.shared.dto.WaybillListByComplexCondationDto)
	 */
	@Override
	public int countQuerySalesStatementByComplexCondation(
			WaybillListByComplexCondationDto condition) {
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "countQuerySalesStatementByComplexCondation", condition);
	}
	...
	public List<AdjustPlanResultDto> queryAdjustPlan(
		...
		RowBounds bounds = new RowBounds(start, limit);
		return this.getSqlSession().selectList(NAMESPACE + "queryAdjustPlanList", adjustPlanSearcherDto, bounds);
	}
	 ...
	 * @param args
	 * @return
	 * @@see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#queryWaybillInfoByCondition(java.util.Map)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<CrmWaybillServiceDto> queryWaybillInfoByCondition(
		...
		if(isRowBounds){
		  ...
		  return this.getSqlSession().selectList(NAMESPACE + "queryWaybillInfoByCondition", args, rb);
		}else{
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillInfoByCondition", args);		
		 }
	...
	public List<CrmWaybillServiceDto> queryAppWaybillInfoByCondition(Map<String, Object> args,boolean isRowBounds) {			
		if(isRowBounds){
			...
			RowBounds rb = new RowBounds(start, limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryAppWaybillInfoByCondition", args, rb);
		}else{
			return this.getSqlSession().selectList(NAMESPACE + "queryAppWaybillInfoByCondition", args);	
		}		
	}
	...
	public int countQueryAppWaybillInfoByCondition(Map<String, Object> args) {
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "countQueryAppWaybillInfoByCondition", args);
	}
	 ...
	 * @param args
	 * @return
	 * @@see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#countQueryWaybillInfoByCondition(java.util.Map)
	 */
	@Override
	public int countQueryWaybillInfoByCondition(Map<String, Object> args) {
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "countQueryWaybillInfoByCondition", args);
	}

	@Override
	public LabeledGoodEntity queryLabeledGoodByserialNo(String waybillNo, String serialNo)
	{
		// 封装查询条件
				WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
				argsDto.setWaybillNo(waybillNo);
				argsDto.setSerialNo(serialNo);
				argsDto.setActive(FossConstants.YES);

				return (LabeledGoodEntity) this.getSqlSession().selectOne(
						NAMESPACE + "selectBySerialNo", argsDto);
	}
	...
	{
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillInfo", waybillQueryInfoDto);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<WaybillInfoDto> queryWaybillInfoForQms(WaybillQueryInfoDto waybillQueryInfoDto)
	{
		return this.getSqlSession().selectList(NAMESPACE_QMS + "queryWaybillInfo", waybillQueryInfoDto);
	}
	...
	public String getIsExpressByWayBillNo(String waybillNo){
		return (String)this.getSqlSession().selectOne(NAMESPACE_QMS + "getIsExpressByWayBillNo", waybillNo);
	}

	/* (non-Javadoc)
	 * @see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#queryWaybillStatus(java.lang.String)
	 */
	@Override
	public String queryWaybillStatus(String waybillNo) {
		...
		this.getSqlSession().selectOne(NAMESPACE + "queryWaybillStatus", args);
	...
	public Long queryAdjustPlanCount(AdjustPlanSearcherDto adjustPlanSearcherDto) {
		return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryAdjustPlanListCount", adjustPlanSearcherDto);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<SimpleWaybillDto> queryWayBillListByUserDefinedQuery(SimpleWaybillDto simpleWaybillDto, int count) {
		RowBounds rowBounds = new RowBounds(0, count);
		return this.getSqlSession().selectList(NAMESPACE + "queryWayBillListByUserDefinedQuery", simpleWaybillDto, rowBounds);
	}
	 ...
	 */
	@Override
	public WaybillEntity queryWaybillExistByPDAPending(String waybillNo) {
		// 封装查询条件
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);
		argsDto.setWaybillStatus(WaybillConstants.WAYBILL_STATUS_PDA_PENDING);
		argsDto.setActive(FossConstants.YES);
		return (WaybillEntity) this.getSqlSession().selectOne(NAMESPACE + "selectByWaybillExistPDAPending", argsDto);
	}
	...
	public boolean existsActiveWaybillById(String id) {
		...
		try{
			List countList =(List) this.getSqlSession().selectList(NAMESPACE + "existsActiveWaybillById", map);
	 ...
	 * @date 2012-10-31 下午5:02:38
	 * @param code
	 * @param name
	 * @param isqueryFuzzy
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#queryByDepartmentInfo(java.lang.String,
	...
	public List<SaleDepartmentEntity> queryByDepartmentInfo(
		...
		return this.getSqlSession().selectList("foss.pkp.SaleDepartmentEntityMapper." 
				+ "selectPickupStationInfoRemote", dto);
	}
	 ...
	 * @date 2016-8-31 下午4:43:23
	 * @param dto
	 * @return
	 * @see
	 */
	@Override
	public SaleDepartmentEntity queryPartnerSalesDepartment(QueryPickupPointDto dto){
		return (SaleDepartmentEntity) this.getSqlSession().selectOne("foss.pkp.SaleDepartmentEntityMapper." 
				+ "selectStationInfoRemote", dto);
	}
	/**
	 * <p>
	 * (根据本地库 营业部名字 查询营业部信息 )
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<SaleDepartmentEntity> queryByDepartmentInfoExpress(
			QueryPickupPointDto dto) {
		
		return this.getSqlSession().selectList("foss.pkp.SaleDepartmentEntityMapper." 
				+ "selectPickupStationInfoRemoteExpress", dto);
	}
	...
	public OuterBranchEntity queryAgencyBranchInfo(String agencyBranchCode) {
		...
		map.put("active", FossConstants.ACTIVE);
		return (OuterBranchEntity) this.getSqlSession().selectOne("foss.pkp.OuterBranchEntityMapper." + "queryAgencyBranchInfo", map);
	}
	 ...
	 */
	@Override
	public int updateLastOrgcode(String lastOrgCode, String lastOrgName,
			String waybillID) {
	Map<String, String> param=new HashMap<String, String>();
	param.put("lastOrgCode", lastOrgCode);
	param.put("lastOrgName", lastOrgName);
	param.put("waybillID", waybillID);
	
	return this.getSqlSession().update(NAMESPACE+"updateLastOrgcode", param);
	}

	@Override
	public int updateEndStockOrgcode(String lastOrgCode, String waybillNO) {
		Map<String, String> param=new HashMap<String, String>();
		param.put("lastOrgCode", lastOrgCode);
		param.put("waybillNO", waybillNO);
		
		return this.getSqlSession().update(NAMESPACE+"updateEndStockOrgcode", param);
	}
    ...
    public SaleDepartmentEntity queryDepartmentInfoByDto(QueryPickupPointDto dto2){
    	List<SaleDepartmentEntity> list = this.getSqlSession().selectList("foss.pkp.SaleDepartmentEntityMapper." + "queryDepartmentInfoByDto", dto2);
		if(list!=null && list.size()>0){
			return list.get(0);
		}else{
			return null;
    ...
    public OuterBranchEntity queryOuterBranchByDto(QueryPickupPointDto dto2){
    	List<OuterBranchEntity> list =  this.getSqlSession().selectList("foss.pkp.SaleDepartmentEntityMapper."+ "queryOuterBranchByDto", dto2);
    	if(list!=null && list.size()>0){
			return list.get(0);
		}else{
			return null;
	...
	public List<String> queryWaybillNoMakeupByWaybillNo(WaybillQueryInfoDto dto){
		 return (List<String>)this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." 
					+ "selectWaybillNoMakeupByWaybillNo", dto);
	 }
	...
	public String getWaybillStatus(String waybillNo) {
		// 封装查询条件
				Map<String,Object> map =new HashMap<String,Object>();
				map.put("waybill", waybillNo);
				return (String) this.getSqlSession().selectOne(
						NAMESPACE + "getWaybillStatus", map);
	}
	...
	public List<DataDictionaryValueEntity> queryByTermsCode(String termsCode){
		...
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "selectDataDictValueByTermsCode", dataDic);				
	}
	...
	public List<ConfigurationParamsEntity> queryByConfCodeArray(String[] confCodes, String orgCode){
		...
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "selectSysConfigByConfCodeArray", sysConfig);
	}
	...
	public ConfigurationParamsEntity queryByConfCode(String confCode, String orgCode){
		...
		sysConfig.setConfType(DictionaryConstants.SYSTEM_CONFIG_PARM__PKP);
		sysConfig.setActive(FossConstants.ACTIVE);
		return (ConfigurationParamsEntity) this.getSqlSession().selectOne("foss.pkp.WaybillEntityMapper." + "selectSysConfigByConfCode", sysConfig);
	}
	...
	public List<String> queryByCodeAndPickup(String code) {
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "selectByCodeAndPickup",code);
	}
	...
	public List<String> queryByCodeAndDelivery(String code) {
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "selectByCodeAndDelivery",code);
	}
	...
	public List<BranchQueryVo> queryListByDepartment(SaleDepartmentEntity entity){
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "queryListByDepartment",entity);
	}
	...
	public List<BranchQueryVo> queryListByDepartmentAndPro(SaleDepartmentEntity entity){
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "queryListByDepartmentAndPro",entity);
	}
	...
	public List<BranchQueryVo> queryListByBranch(OuterBranchEntity entity){
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "queryListByBranch",entity);
	}

	/**
	 * 通过部门编号查询提货网点名称
	 * @author panguoyang
	 * @date 2013-7-30 下午9:10:10
	 */
	@Override
	public String queryCustomerPickupOrgNameByWayno(String orgcode,String productCode) {
		...
		if(productCode.equals(ProductEntityConstants.PRICING_PRODUCT_AIR_FREIGHT)
				||
		 productCode.endsWith(ProductEntityConstants.PRICING_PRODUCT_PARTIAL_LINE)){
			customerPickupOrgName= (String) this.getSqlSession().selectOne(NAMESPACE + "queryBranchCustomerPickupOrgNameByWaynoActive", map);
		}else{
			customerPickupOrgName= (String) this.getSqlSession().selectOne(NAMESPACE + "queryOrgCustomerPickupOrgNameByWaynoActive", map);
		}
		if(StringUtil.isEmpty(customerPickupOrgName)){
			if(productCode.equals(ProductEntityConstants.PRICING_PRODUCT_AIR_FREIGHT)
					||
			 productCode.endsWith(ProductEntityConstants.PRICING_PRODUCT_PARTIAL_LINE)){
				customerPickupOrgName= (String) this.getSqlSession().selectOne(NAMESPACE + "queryBranchCustomerPickupOrgNameByWayno", map);
			}else{
				customerPickupOrgName= (String) this.getSqlSession().selectOne(NAMESPACE + "queryOrgCustomerPickupOrgNameByWayno", map);
			}
		}
	...
	public String queryReceiveOrgNameByWayno(String orgcode) {
		Map<String,String> map = new HashMap<String,String>();
		map.put("orgcode", orgcode);
		return (String) this.getSqlSession().selectOne(NAMESPACE + "queryReceiveOrgNameByWayno", map);
	}
	...
	@Override
 	public List<SalesBillingGroupEntity> querySalesBillGroupByCodeAndBillCode(String code,String billingGroup){
		Map<String,String> map = new HashMap<String,String>();
		map.put("code", code);
		map.put("billingGroup", billingGroup);		
		map.put("active", FossConstants.ACTIVE);
		return this.getSqlSession().selectList("foss.pkp.WaybillEntityMapper." + "querySalesBillGroupByCodeAndBillCode", map);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
 	public List<SaleDepartmentEntity> querySaleDepartmentByNameForCentralized(String name,List<String> billingGroup){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("name", name);
		map.put("billingGroup", billingGroup);		
		map.put("active", FossConstants.ACTIVE);
		return this.getSqlSession().selectList("foss.pkp.SaleDepartmentEntityMapper." + "querySaleDepartmentByNameForCentralized", map);
	}
    /*按单号且创建时间升序查询运单
     * (non-Javadoc)
     * @see com.deppon.foss.module.pickup.waybill.api.server.dao.IWaybillDao#queryWaybillNo(java.lang.String)
     */
	@Override
	...
	@SuppressWarnings("unchecked")
	@Override
	public WaybillEntity queryWaybillIsPcOrPdaOrRfcActive(String waybillNo,
			List<String> pendingTypeList){
		Map<Object, Object> map = new HashMap<Object, Object>(); 
		map.put("waybillNo", waybillNo);
		map.put("active", FossConstants.ACTIVE);
		map.put("pendingTypeList", pendingTypeList);
		List<WaybillEntity> list = this.getSqlSession().selectList(NAMESPACE+"queryWaybillIsPcOrPdaOrRfcActive", map);
		if(list.size() == 0){
			return null;
		}else{
			return list.get(0);
	...
	public WaybillPendingEntity queryPendingByNo(String mixNo) {
		...
		List<WaybillPendingEntity> list =  this.getSqlSession().selectList(NAMESPACE + "queryPendingByNo", parms);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<SaleDepartmentEntity> queryByDepartmentInfoVirtual(
			QueryPickupPointDto dto) {
		//TODO
		return this.getSqlSession().selectList("foss.pkp.SaleDepartmentEntityMapper." 
				+ "selectPickupStationInfoVirtualRemote", dto);
	}
	...
	public SignDto getWaybillSignInfo(String waybillNo){
		Map<String,Object> map =new HashMap<String,Object>();
		map.put("waybillNo", waybillNo);
		List<SignDto> dtos = this.getSqlSession().selectList(
				NAMESPACE + "getWaybillSignInfo", map);
	 ...
	 */
	@Override
	public ProductEntity queryProductByCode(String id) { 
		return (ProductEntity) this.getSqlSession().selectOne(NAMESPACE + "selectProductByPrimaryKey", id);
	}
	
	
	@SuppressWarnings("unchecked")
	public List<WaybillEntity> queryWaybillByReturnBillNo(String waybillNo){
		// 封装查询条件
				WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
				argsDto.setWaybillNo(waybillNo);
				argsDto.setActive(FossConstants.YES);
				...
				List<WaybillEntity> list = this.getSqlSession().selectList(
						NAMESPACE + "queryWaybillByReturnBillNo", argsDto);
				return list;
	}
	...
	public boolean queryIsExpressBill(String waybillNo) {
		...
		List<WaybillEntity> list = this.getSqlSession().selectList(NAMESPACE+"queryIsExpressBill", map);
		if(list.size()>0){
			return true;
		}
		return false;
	 ...
	 * @date 2013-12-25 10:03:19
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<EarliestCreateTimeDto> selectPdaWaybillCreateTime(List<String> waybillNoList) {
		Map<String,Object> map =new HashMap<String,Object>();
		map.put("waybillNoList", waybillNoList);
		return this.getSqlSession().selectList(NAMESPACE + "selectPdaWaybillCreateTime", map);
	}
	
	public void updateActualFreightEntity(WaybillDto waybillDto){
		ActualFreightEntity acf=waybillDto.getActualFreightEntity();
		this.getSqlSession().update(NAMESPACE + "updateActualFreightEntity", acf);
	...
	public WaybillEntity queryWaybillForFirst(String waybillNo) {
		...
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);
		return (WaybillEntity) this.getSqlSession().selectOne(NAMESPACE + "selectByWaybillNoForFirst", argsDto);				
	}
	 ...
	 */
	@Override
	public int deleteWaybillByWaybillNo(String waybillNo){
		Map<String, Object> map = new HashMap<String, Object>();		
		...
		return this.getSqlSession().update(NAMESPACE + "deleteWaybillByWaybillNo", map);
	}
	 ...
	 */
	@Override
	public WaybillEntity queryFirstDeliveryWaybill(WaybillEntity entity) {
		//去除快递的运单，根据DEFECT-2998修改
		entity.setProductCode(ProductEntityConstants.PRICING_PRODUCT_EXPRESS_PACKAGE);
		//添加是否快递字段
		entity.setIsExpress(FossConstants.YES);
		return (WaybillEntity) this.getSqlSession().selectOne(NAMESPACE + "selectFirstDeliveryWaybill", entity);
	}
	...
	public List<WaybillEntity> queryWaybillEntityByDeliverbillById(
		...
		return this.getSqlSession().selectList(NAMESPACE+"queryWaybillEntityByDeliverbillById", map);
	}
	...
	public List<WaybillEntity> queryWaybillEntityByHandoverBillNo(
			Map<Object, Object> map) {
		return this.getSqlSession().selectList(NAMESPACE+"queryWaybillEntityByHandoverBillNo", map);
	}
	 ...
	 */
	@Override
	public int queryIsGetPickFeeByCust(WaybillEntity entity) {
		//去除快递的运单，根据DEFECT-2998修改
		entity.setProductCode(ProductEntityConstants.PRICING_PRODUCT_EXPRESS_PACKAGE);
		//添加是否快递字段
		entity.setIsExpress(FossConstants.YES);
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "queryIsGetPickFeeByCust", entity);
	}
	...
	public void insertGrandGoodAbnormal(GrandGoodAbnormalEntity grangGood) {
		this.getSqlSession().insert(NAMESPACE + "insertGrangGood", grangGood);
	}
	...
	public GrandGoodAbnormalEntity queryGrandGoodAbnormal(String waybillNo) {
		return (GrandGoodAbnormalEntity) this.getSqlSession().selectOne(NAMESPACE + "queryGrandGoodAbnormal", waybillNo);
	}
    /**
     * 更新重大货物异常
     */
	...
	public void updateGrandGoodAbnormal(GrandGoodAbnormalEntity grangGood) {
		this.getSqlSession().update(NAMESPACE + "updateGrandGoodAbnormal", grangGood);
	}
	/**
	 * 根据CRM传入参数获取运单信息
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<CrmResultDto> queryWaybillInfoByCrm(CrmParamVo crmParamVo,boolean isRowBounds){
		if(isRowBounds){
			int start = crmParamVo.getCurrentPage();
			int limit = crmParamVo.getPageSize();
			if (start>1){ 
				start= (start - 1) * limit;
			}else{
				start=0;
			...
			RowBounds rb = new RowBounds(start, limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryWaybillInfoByCrm", crmParamVo, rb);
		}else{
			return this.getSqlSession().selectList(NAMESPACE + "queryWaybillInfoByCrm", crmParamVo);	
		}
	}
	 ...
	 */
	@Override
	public int countQueryWaybillInfoByCrm(CrmParamVo crmParamVo) {
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "countQueryWaybillInfoByCrm", crmParamVo);
	}
	/**
	...
	public List<WaybillCountDto> queryWaybillByPhone(Map<String,Object> condition) {
		// TODO Auto-generated method stub
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillByPhone", condition);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<WaybillEntity> queryActiveEWaybillInfoByCondition(Map<String, Object> args, boolean isRowBounds){
		if(args!=null){
			if(isRowBounds){
				if(args.get("pageNum")==null ||  args.get("pageSize") ==null){
					return this.getSqlSession().selectList(NAMESPACE + "queryActiveEWaybillInfoByCondition", args);	
				}
				int start = (Integer) args.get("pageNum");
				int limit = (Integer) args.get("pageSize");
				if (start>1){ 
				...
				RowBounds rb = new RowBounds(start, limit);
				return this.getSqlSession().selectList(NAMESPACE + "queryActiveEWaybillInfoByCondition", args, rb);
			}else{
				return this.getSqlSession().selectList(NAMESPACE + "queryActiveEWaybillInfoByCondition", args);	
			}
		}else{
	 ...
	 * @创建人： BaiLei
	 */
	public int countQueryActiveEWaybillInfoByCondition(Map<String, Object> args){
		return (Integer)this.getSqlSession().selectOne(NAMESPACE + "countQueryActiveEWaybillInfoByCondition", args);
	}
	...
	public int setWaybillActive(List<String> waybillNoList) {
		...
		return (Integer)this.getSqlSession().update(NAMESPACE+"setWaybillActive", condition);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<BatchSendSMSDto> querySendAndReceiveGoodsDayCount(String custCode) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("custCode", custCode);
		params.put("time", 1);
		return this.getSqlSession().selectList(NAMESPACE+"querySendAndReceiveGoodsCount", params);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<BatchSendSMSDto> queryReceiveAndSignBillGoodsCount(
			String custCode) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("custCode", custCode);
		params.put("time", 1);
		return this.getSqlSession().selectList(NAMESPACE+"queryReceiveAndSignBillGoodsCount", params);
	}

	/***
	 * 统计签单和返回的 count 周次统计
	 * @author yuting@163.com
	 * @date 2014-07-16 下午6:46:39
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<BatchSendSMSDto> querySendAndReceiveGoodsWeekCount(
			String custCode) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("custCode", custCode);
		params.put("time", NumberConstants.NUMBER_7);
		return this.getSqlSession().selectList(NAMESPACE+"querySendAndReceiveGoodsCount", params);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<BatchSendSMSDto> queryReceiveAndSignBillGoodsWeekCount(
			String custCode) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("custCode", custCode);
		params.put("time", NumberConstants.NUMBER_7);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<BatchSendSMSDto> querySignBillGoodsCount(String cusCode,int day) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("custCode", cusCode);
		params.put("time", day);
		return this.getSqlSession().selectList(NAMESPACE+"querySignBillGoodsCount", params);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<BatchSendSMSDto> queryReceiveGoodsCount(String cusCode,int day) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("custCode", cusCode);
		params.put("time", day);
		return this.getSqlSession().selectList(NAMESPACE+"queryReceiveGoodsCount", params);
	}	
	@Override
	public List<WaybillAcHisPdaEntity> queryWaybillHisByNo(
			Map<String, Object> condition) {
		// TODO Auto-generated method stub
		return this.getSqlSession().selectList("foss.pkp.WaybillAcHisPdaEntityMapper." + "queryWaybillHisByNo", condition);
	}
	 ...
	 * @author foss-叶涛
	 * @date 2014-10-13 下午5:21:02
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<WaybillOneYearDto> queryWaybillOneYear(WaybillQueryOneYearDto waybillQueryOneYearDto)
	{
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillOneYear", waybillQueryOneYearDto);
	}
	/**
	 * 
	 * app根据客户手机号查询客户电子账单信息
	 * @author foss-叶涛
	 * @date 2014-11-06 下午5:21:02
	 */
	@Override
	public ComponentDto queryComponentDetail(
			ReportComponentDto reportComponentDto) {
		// TODO Auto-generated method stub
		return (ComponentDto)this.getSqlSession().selectOne(NAMESPACE+"queryComponentDetail", reportComponentDto);
	}
	...
	public List<BillingDto> queryBillingDetail(
		...
		// TODO Auto-generated method stub
		int start = (Integer) reportBillingDto.getPage_index();
		int limit = (Integer) reportBillingDto.getPage_size();
		if (start>0){
			start= start  * limit;
		}else{
			start=0;
		...
		RowBounds rb = new RowBounds(start, limit);
		return this.getSqlSession().selectList(NAMESPACE+"queryBillingDetail", reportBillingDto,rb);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<SaleDepartmentEntity> queryPickupStationInforExpress(QueryPickupPointDto dto) {
		return this.getSqlSession().selectList(
				"foss.pkp.SaleDepartmentEntityMapper." + "queryPickupStationInforExpress", dto);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<SaleDepartmentEntity> selectPickupStationInfoVirtualExpress(QueryPickupPointDto dto) {
		return this.getSqlSession().selectList(
				"foss.pkp.SaleDepartmentEntityMapper." + "selectPickupStationInfoVirtualExpress", dto);
	}

	@Override
	public String getWoodenPackageOrgCode(String waybillNo) {
		return (String) this.getSqlSession().selectOne(
				"foss.pkp.WaybillInfoForQmsMapper." + "getWoodenPackageOrgCode", waybillNo);
	}
	/**
	 ...
	 */
	@Override
	public Long queryDiscountFee(String employeeNo, Date firstMonthDate, Date lastMonthDate) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("employeeNo", employeeNo);
		params.put("firstMonthDate", firstMonthDate);
		//封装时间条件
		params.put("lastMonthDate", lastMonthDate);
		return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryDiscountFee", params);
	}
	/**
	 * 根据当期时间和发货客货编码查询当前月份的发货总金额
	 * dp-foss-dongjialing
	 * 225131
	 */
	@Override
	public Long queryTotalFee(String code, Date firstMothDay, Date lastMothDay) {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("code", code);
		params.put("firstMonthDate", firstMothDay);
		//封装时间条件
		params.put("lastMonthDate", lastMothDay);
		return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryTotalFee", params);
	}

	@Override
	public String queryDiscountInfo(String waybillNo) {
		// TODO Auto-generated method stub
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("waybillNo", waybillNo);
		params.put("entryCode", PriceEntityConstants.PRICING_CODE_FRT);
		params.put("type", DiscountTypeConstants.DISCOUNT_TYPE__FRT_GRADESREBATE);
		return (String)this.getSqlSession().selectOne(NAMESPACE + "queryDiscountInfo", params);
	}
	...
	public List<WaybillSignDetailVo> queryWayBillSignDetail(
		...
		if(flag){//进行分页查询
			...
			RowBounds rb = new RowBounds(start, limit);
			logger.debug("进入Dao层 queryWayBillSignDetail start:"+start+" limit:"+limit) ;
			return this.getSqlSession().selectList(NAMESPACE + "queryWayBillSignDetail", waybillSignDetailQueryVo,rb);
		}else{
			logger.debug("进入Dao层 queryWayBillSignDetail 不进行分页 ") ;
			return this.getSqlSession().selectList(NAMESPACE + "queryWayBillSignDetail", waybillSignDetailQueryVo);
	}
	}
	
	@Override
	public int countQueryWayBillSignDetail(WaybillSignDetailQueryVo waybillSignDetailQueryVo) {
		logger.debug("进入Dao层 countQueryWayBillSignDetail ") ;
		return (Integer)this.getSqlSession().selectOne(NAMESPACE + "countQueryWayBillSignDetail", waybillSignDetailQueryVo);
	}

	@Override
	public int queryWaybillInvalid(List<String> waybillNumList) {
		logger.debug("进入Dao层 queryWaybillInvalid ") ;
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "queryWaybillInvalid",waybillNumList);
	}

	@Override
	public int queryWaybillBack(List<String> waybillNumList) {
		logger.debug("进入Dao层 queryWaybillBack ") ;
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "queryWaybillBack",waybillNumList);
	}
	

	@Override
	public void updateWaybillActiveByWaybillNo(WaybillEntity waybillEntity) {
		this.getSqlSession().update(NAMESPACE + "updateWaybillActiveByWaybillNo", waybillEntity);
	}
	@Override
	public WaybillMessageEntity queryWaybillandOther(String waybillNo) {
//		queryWaybillandOther
		return (WaybillMessageEntity) this.getSqlSession().selectOne(NAMESPACE + "queryWaybillandOther", waybillNo);
	}	@Override
	public List<InstallationEntity> queryWaybillInstallation(String waybillNo) {
		return this.getSqlSession().selectList(NAMESPACE + "selectInstallInstation", waybillNo);
	}
	...
	{
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillInfoForSOC", waybillQueryInfoDto);
	}	
	@SuppressWarnings("unchecked")
	@Override
	public List<DeliverGoodsListVo> queryWaybillDeliverGoodsList(
			DeliverGoodsListQueryVo deliverGoodsListQueryVo,int start,int limit) {
		RowBounds rb = new RowBounds(start, limit);
		logger.debug("进入Dao层 queryWaybillDeliverGoodsList start="+start+" limit="+limit) ;
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillDeliverGoodsList", deliverGoodsListQueryVo, rb);
	}
	...
	public List<WaybillSignDetailVo> getWaybillSignList(List<String> waybillNoList){
		return this.getSqlSession().selectList(
				NAMESPACE + "getWaybillSignList", waybillNoList);
	}

	@Override
	public int queryWaybillDeliverGoodsListCount(
			DeliverGoodsListQueryVo deliverGoodsListQueryVo) {
		logger.debug("进入Dao层 queryWaybillDeliverGoodsListCount") ;
		return (Integer) this.getSqlSession().selectOne(NAMESPACE+"queryWaybillDeliverGoodsListCount",deliverGoodsListQueryVo);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public List<WaybillEntity> queryWaybillListWayBillNo(List<String> wayBillNoList){
		return this.getSqlSession().selectList(NAMESPACE+"queryWaybillListWayBillNo",wayBillNoList);
	...
	public WaybillEntity queryFirstWaybillByWaybillNo(String waybillNo) {
		...
		return (WaybillEntity) this.getSqlSession().selectOne(
				NAMESPACE + "selectFirstWaybillByWaybillNo", argsDto);
	}
	/**
	 * 
	 * 查询运单
	...
	public List<WaybillEntity> queryWaybillForPrint(WaybillDto waybill) {
		return this.getSqlSession().selectList(NAMESPACE + "queryWaybillsForPrint", waybill);
	}
	/**
	 * 查询运单基本信息（包含免费接货）
	 * 
	 * @author 306486
	 * @date 2016年2月26日09:09:56
	 */
	@Override
	...
	public String queryPickupGoodsByWaybillNo(String waybillNo) {
		...
		return (String) this.getSqlSession().selectOne(NAMESPACE+"queryPickupGoods", waybillNo);
	}
	 ...
	 */
	@Override
	public WaybillEntity queryNewWaybillByNo(String waybillNo) {
		// 封装查询条件
		WaybillQueryArgsDto argsDto = new WaybillQueryArgsDto();
		argsDto.setWaybillNo(waybillNo);
		argsDto.setActive(FossConstants.YES);
		...
		return (WaybillEntity) this.getSqlSession().selectOne(
				NAMESPACE + "selectNewByWaybillNoAndOrderNo", argsDto);
	}
	 ...
	 * 
	 * @author 280747
	 * @date 2016-10-19下午08:37:46
	 */
	@SuppressWarnings("unchecked")
	@Override
	public String queryPartnerWaybillForPrint(String waybillNo) {
	  Object one = this.getSqlSession().selectOne(NAMESPACE + "partnerWayBillNo", waybillNo);
	  return one==null?"N":(String)one;
	}
	...
	public String queryTotalAmount(CubcQueryTotalAmountRequest requestParam) {
		return (String)this.getSqlSession().selectOne(NAMESPACE+"selectTotalAmount", requestParam);
	}
