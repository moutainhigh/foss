 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncProduct.java
 * 
 * FILE NAME        	: SyncProduct.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
public class SyncProduct extends iBatis3DaoImpl implements
		ISyncDataDao<ProductEntity> {
	/**
	 *  价格 下载服务
	 */
	...
	public List getSyncData(Date fromDate,
		...
		data = priceDownLoadService.downProductServerData(clientInfo);
		if (data != null) {
			if (data.getObject() != null) {
				list = ((List<ProductEntity>) data.getObject());
			}
		}
		return list;
	}
	...
	public void setPriceDownLoadService(
			IPriceDownLoadService priceDownLoadService) {
