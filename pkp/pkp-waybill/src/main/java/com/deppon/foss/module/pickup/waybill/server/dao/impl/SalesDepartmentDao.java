 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/impl/SalesDepartmentDao.java
 * 
 * FILE NAME        	: SalesDepartmentDao.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * </p>
 * <p style="display:none">
 * version:V1.0,author:foss-sunrui,date:2012-10-29 上午11:47:57,
 * </p>
 * 
 * @author foss-sunrui
 * @date 2012-10-29 上午11:47:57
 * @since
 * @version
 *  *  * 录入货物信息SUC业务规则
 ...
 *
 */
public class SalesDepartmentDao extends iBatis3DaoImpl implements ISalesDepartmentDao {
	/**
	 * 名称空间
	 */
	private static final String NAMESPACE = "pkp.waybill.salesDepartmentMapper.";
	 ...
	 * 
	 * @author foss-sunrui
	 * @date 2012-10-29 下午12:01:41
	 * @param record
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#insert(com.deppon.foss.module.base.baseinfo.api.shared.domain.SaleDepartmentEntity)
	 */
	public int insert(SaleDepartmentEntity record) {
		return this.getSqlSession().insert(NAMESPACE + "insertSalesDept", record);
	}
	 ...
	 * 
	 * @author foss-sunrui
	 * @date 2012-10-29 下午12:01:53
	 * @param record
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#insertSelective(com.deppon.foss.module.base.baseinfo.api.shared.domain.SaleDepartmentEntity)
	 */
	public boolean insertSelective(SaleDepartmentEntity record) {
		...
		if(ObjectUtils.NULL.equals(ObjectUtils.defaultIfNull(
				id, ObjectUtils.NULL))){
			this.getSqlSession().insert(NAMESPACE + "insertSalesDeptSelective", record);
			return true;
		}else{
			return false;
		}
	 ...
	 * 
	 * @author foss-sunrui
	 * @date 2012-10-29 下午12:02:07
	 * @param id
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#queryByPrimaryKey(java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	public SaleDepartmentEntity queryByPrimaryKey(String id) {
		List<SaleDepartmentEntity> list = this.getSqlSession().selectList(NAMESPACE + "selectSalesDeptByPrimaryKey",id);
		if(list.size() == 0){
			return null;
		}else{
			return list.get(0);
	 ...
	 * 
	 * @author foss-sunrui
	 * @date 2012-10-29 下午12:02:19
	 * @param code
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#queryByCode(java.lang.String)
	 */
	public SaleDepartmentEntity queryByCode(String code) {
		List<SaleDepartmentEntity> list = this.getSqlSession().selectList(NAMESPACE + "selectSalesDeptByCode", code);
	 ...
	 * 
	 * @author foss-sunrui
	 * @date 2012-10-29 下午12:02:43
	 * @param record
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#updateByPrimaryKeySelective(com.deppon.foss.module.base.baseinfo.api.shared.domain.SaleDepartmentEntity)
	 */
	public int updateByPrimaryKeySelective(SaleDepartmentEntity record) {
		return this.getSqlSession().update(NAMESPACE + "updateSalesDeptByPrimaryKey",record);
	}
	 ...
	 * 
	 * @author foss-sunrui
	 * @date 2012-10-29 下午12:38:06
	 * @param record
	 * @return
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#updateByPrimaryKey(com.deppon.foss.module.base.baseinfo.api.shared.domain.SaleDepartmentEntity)
	 */
	public int updateByPrimaryKey(SaleDepartmentEntity record) {
		return this.getSqlSession().update(NAMESPACE+ "updateSalesDeptByPrimaryKeySelective", record);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<SaleDepartmentEntity> queryByDepartmentInfo(QueryPickupPointDto dto) {
		List<String> productCodeList = new ArrayList<String>();
		//快递一级汽运
		productCodeList.add(PricingConstants.ProductEntityConstants.PRICING_PRODUCT_C1_C20003);
		List<String> expressProductCodeList = productDao.getAllLevels3ProductCode(productCodeList);
		if(CollectionUtils.isNotEmpty(expressProductCodeList) && expressProductCodeList.contains(dto.getTransType())){
			return this.getSqlSession().selectList(NAMESPACE + "selectPickupStationInfoLocalPackage", dto);
		}else{
			return this.getSqlSession().selectList(NAMESPACE + "selectPickupStationInfoLocal", dto);
		}
	...
	public List<SaleDepartmentEntity> querySaleDepartmentExactByEntity(
		...
		SaleDepartmentEntity queryEntity;
		if (null == entity) {
			queryEntity = new SaleDepartmentEntity();
		} else {
			queryEntity = entity;
		}
		queryEntity.setActive(FossConstants.ACTIVE);
		RowBounds rowBounds = new RowBounds(start, limit);
		return this.getSqlSession().selectList(NAMESPACE+ "querySaleDepartmentExactByEntity", queryEntity, rowBounds);
	}

	/**
	 * 
	 * <p>
	 * 根据外场的部门编码查询其驻地营业部的部门编码
	 * </p>
	 * 
	 * @author foss-jiangfei
	...
	public String queryStationSaleCodeByTransferCenterCode(
		...
		List<SaleDepartmentEntity> list = querySaleDepartmentExactByEntity(
	...
	public SaleDepartmentEntity querySaleDepartmentByCode(String code) {
		...
		List<SaleDepartmentEntity> entitys = this.getSqlSession().selectList(NAMESPACE
				+ "querySaleDepartmentByCode", entity);
...
//		entity.setArrive(FossConstants.YES);
		...
		List<SaleDepartmentEntity> entitys = this.getSqlSession().selectList(NAMESPACE
				+ "querySaleDepartmentByName", entity);
	...
	public List<SaleDepartmentEntity> querySaleDepartmentInner(String name) {
		...
		List<SaleDepartmentEntity> entitys = this.getSqlSession().selectList(NAMESPACE
				+ "querySaleDepartmentInner", entity);
...
//			return null;
//		}
//		SaleDepartmentBillGroupEntity entity = new SaleDepartmentBillGroupEntity();
//		entity.setActive(FossConstants.ACTIVE);
//		entity.setName(name);
//		entity.setBillingGroup(billingGroup);
//		
//		
//		List<SaleDepartmentEntity> entitys = sqlSession.selectList(NAMESPACE
//				+ "querySaleDepartmentByNameForCentralized", entity);
//
//		if (entitys == null || entitys.size() == 0) {
//			return null;
//		} else {
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.deppon.foss.module.pickup.common.client.dao.ISalesDepartmentDao#delete(com.deppon.foss.module.base.baseinfo.api.shared.domain.SaleDepartmentEntity)
	 */
	public void delete(SaleDepartmentEntity saleDepartment) {
		this.getSqlSession().delete(NAMESPACE + "delete", saleDepartment);
	}

	@SuppressWarnings("unchecked")
	@Override
	public List<BranchQueryVo> queryListByDepartment(SaleDepartmentEntity entity) {
		return this.getSqlSession().selectList(NAMESPACE +"queryListByDepartment",entity);
	}
    ...
    public SaleDepartmentEntity queryDepartmentInfoByDto(QueryPickupPointDto dto2){
		List<SaleDepartmentEntity> list = this.getSqlSession().selectList(NAMESPACE + "queryDepartmentInfoByDto", dto2);
	...
	@Override
 	public List<SalesBillingGroupEntity> querySalesBillGroupByCodeAndBillCode(String code,String billingGroup){
		...
		return this.getSqlSession().selectList(NAMESPACE + "querySalesBillGroupByCodeAndBillCode", map);		
	}
	...
	public List<SaleDepartmentEntity> queryByDepartmentInfoVirtual(
		...
		return this.getSqlSession().selectList(NAMESPACE + "selectPickupStationInfoVirtualLocal", dto);
	}
    ...
    public int queryCountByCodeAndProduct(SalesProductEntity entity){
		return (Integer) this.getSqlSession().selectOne(NAMESPACE + "queryCountByCodeAndProduct", entity);
	}
