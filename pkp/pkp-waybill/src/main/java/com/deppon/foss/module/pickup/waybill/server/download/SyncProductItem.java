 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncProductItem.java
 * 
 * FILE NAME        	: SyncProductItem.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncProductItem extends iBatis3DaoImpl implements ISyncDataDao<ProductItemEntity> {
	/**
	 *  价格 下载服务
	 */
	...
	public List getSyncData(Date fromDate,
		...
		data = priceDownLoadService.downProductItemServerData(clientInfo);
		if(data != null){
			if(data.getObject()!=null){
				list = ((List<ProductItemEntity>)data.getObject());
			}
		}
		return  list;
	}
