 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncGoodsType.java
 * 
 * FILE NAME        	: SyncGoodsType.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
public class SyncGoodsType extends iBatis3DaoImpl implements ISyncDataDao<GoodsTypeEntity> {
	/**
	 * baseinfo 下载服务
	 */
	...
	public List<GoodsTypeEntity> getSyncData(Date fromDate,
		...
		data = priceDownLoadService.downGoodsTypeServerData(clientInfo);
		if(data != null){
			if(data.getObject()!=null){
				list = ((List<GoodsTypeEntity>)data.getObject());
			}
		}
		return  list;
	}
