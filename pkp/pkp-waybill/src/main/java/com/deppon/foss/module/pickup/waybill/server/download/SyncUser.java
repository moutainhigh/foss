 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncUser.java
 * 
 * FILE NAME        	: SyncUser.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncUser extends iBatis3DaoImpl implements ISyncDataDao<UserEntity> {
	/**
	 * baseinfo 下载服务
	 */
	...
	public List<UserEntity> getSyncData(Date fromDate,
		...
		data = baseInfoDownloadService.downloadUserData(clientInfo);
		if(data != null){
			if(data.getObject() != null){
				list = ((List<UserEntity>)data.getObject());
			}
		}
		return  list;
	}
