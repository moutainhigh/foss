 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncRole.java
 * 
 * FILE NAME        	: SyncRole.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncRole extends iBatis3DaoImpl implements ISyncDataDao<RoleEntity> {
	/**
	 * baseinfo 下载服务
	 */
	...
	public List<RoleEntity> getSyncData(Date fromDate,
		...
		data = baseInfoDownloadService.downloadRoleData(clientInfo);
		if(data != null){
			if(data.getObject() != null){
				list = ((List<RoleEntity>)data.getObject());
			}
		}
		return  list;
	}
