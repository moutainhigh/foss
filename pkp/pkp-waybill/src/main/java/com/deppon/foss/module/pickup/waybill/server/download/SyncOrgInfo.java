 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncOrgInfo.java
 * 
 * FILE NAME        	: SyncOrgInfo.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncOrgInfo  extends iBatis3DaoImpl implements ISyncDataDao<OrgAdministrativeInfoEntity>{
	/**
	 * baseinfo 下载服务
	 */
	...
	public List<OrgAdministrativeInfoEntity> getSyncData(Date fromDate,
		...
		data = baseInfoDownloadService.downloadOrganizationData(clientInfo);
		if(data != null){
			if(data.getObject() != null){
				list = ((List<OrgAdministrativeInfoEntity>)data.getObject());
			}
		}
		return  list;
	}
