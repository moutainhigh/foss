...
import com.deppon.foss.module.pickup.waybill.shared.dto.PriceValuationAirDto;

/**
 * @author 026123-foss-lifengteng
 *
 */
public class SyncPriceValuationAirDto  extends  iBatis3DaoImpl implements ISyncDataDao<PriceValuationAirDto> {
	/**
	 *  价格 下载服务
	 */
	...
	public List getSyncData(Date fromDate,
		...
		List<PriceValuationAirDto> list = new ArrayList<PriceValuationAirDto> ();
		...
		data = priceDownLoadService.downPricingValuationPricingAirServerData(clientInfo);
		if(data != null){
			if(data.getObject()!=null){
				List<PriceValuationEntity> list2  = ((List<PriceValuationEntity>)data.getObject());
				for(int i =0 ;i <list2.size();i++){
					PriceValuationEntity entity = list2.get(i);
					PriceValuationAirDto dto = new PriceValuationAirDto();
