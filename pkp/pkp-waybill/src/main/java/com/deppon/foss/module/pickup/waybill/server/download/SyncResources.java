 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncResources.java
 * 
 * FILE NAME        	: SyncResources.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncResources extends iBatis3DaoImpl implements ISyncDataDao<ResourceEntity> {
	/**
	 * baseinfo 下载服务
	 */
	...
	public List<ResourceEntity> getSyncData(Date fromDate, String userID,
		...
		data = baseInfoDownloadService.downloadResourceData(clientInfo);
		if(data != null){
			if(data.getObject() != null){
				list = ((List<ResourceEntity>)data.getObject());
			}
		}
		return  list;
	}
