 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncMakEventExOrg.java
 * 
 * FILE NAME        	: SyncMakEventExOrg.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncMakEventExOrg extends iBatis3DaoImpl implements ISyncDataDao<MakEventExOrgEntity> {
	/**
	 *  价格 下载服务
	 */
	 ...
	 * 返回数据列表
	 */
	private List<MakEventExOrgEntity> list;
	
	/**
	 * @功能：同步数据
	 */
	public List<MakEventExOrgEntity> getSyncData(Date fromDate,
