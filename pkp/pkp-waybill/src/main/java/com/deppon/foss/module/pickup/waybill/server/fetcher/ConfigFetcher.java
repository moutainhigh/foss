 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/fetcher/ConfigFetcher.java
 * 
 * FILE NAME        	: ConfigFetcher.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
@Service
@Transactional
public class ConfigFetcher  extends AbstractSyncDataFetcherWaybill<ConfigurationParamsEntity> {
	/**
	 * 数据抓取Dao接口
	 */
	private ISyncDataDao<ConfigurationParamsEntity> syncDataDao;
	/** 
     * 银行接口
     * @author dp-yangtong
     ...
     */
	public ISyncDataDao<ConfigurationParamsEntity> getSyncDataDao() {
		return syncDataDao;
	}
	/**
	 * 设置数据抓取Dao接口
	...
	public void setSyncDataDao(ISyncDataDao<ConfigurationParamsEntity> syncDataDao) {
