 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/server/download/SyncDiscountProgram.java
 * 
 * FILE NAME        	: SyncDiscountProgram.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SyncDiscountProgram extends iBatis3DaoImpl implements ISyncDataDao<DiscountProgramEntity> {
	
	//private static final String NAMESPACE = "foss.pkp.DiscountProgramEntityMapper.";
	/**
	 *  价格 下载服务
	 */
	...
	public List<DiscountProgramEntity> getSyncData(Date fromDate, 
			String empCode, String regionID,String pagionation, int page) {
//		List<DiscountProgramEntity> list = new ArrayList<DiscountProgramEntity>();
//		
//		DataBundle data;
...
//				list = ((List<DiscountProgramEntity>)data.getObject());
//			}
//		}
//		return list;
		return null;
		...
		return getSqlSession().selectList( NAMESPACE + "getDiscountPrograms", parms);*/
	}
	...
	public Date getLastModifyTime() {
		...
		Date date = null;
		/*if(list != null){
			DiscountProgramEntity discount = (DiscountProgramEntity)list.get(list.size()-1);
			date = discount.getModifyDate();
		}*/
		return date; 
	}
	 ...
	 */
	public List<DiscountProgramEntity> getSyncData(SyncDataRequest request) {
		return null;
	}
