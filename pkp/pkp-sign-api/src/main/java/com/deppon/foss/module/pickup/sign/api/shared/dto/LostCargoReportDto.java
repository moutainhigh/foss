 ...
 * @author: foss-yuting
 * @description: foss丢货差错自动  与db对应<br/>
 * @date:2014年12月18日 下午15:59:21
 */
public class LostCargoReportDto implements Serializable{
	/**
	 * 类的序列号
	 */
	...
	/**
	 * aa管理营业部出发运单，制单部门列表。当登录部门为集中开单区域营业部时，添加所属集中开单组作为制单部门查询条件
	 */
	private List<String> createOrgCodeList;
	
	/**
	 * aa管理营业部出发运单，收货部门列表。当登录部门为集中开单区域营业部时，添加所有所属集中开单组的部门 作为收货部门查询条件
	 */
