...
public class SignConstants {
	 ...
	 * add by 353654
	 */
	public static final String OPERATIONTAG_SQ = "SQ";//申请变更
	public static final String OPERATIONTAG_CZ = "CZ";//操作变更
    /**
	 * 签收情况--正常签收
	 */
	...
	/**
     * 给收货人正常签收模板，签收人信息和实际运单收货人不一致-零担
	 */
    public static final String SMS_CODE_RECEIVE_NORMAL_SIGN_LD_DIF_RECEIVER = "RECEIVE_NORMAL_SIGN_LD_DIF_RECEIVER";

    /**
     * 代签收短信模板
     */
    public static final String SMS_CODE_PKP_NOTIFY_DRIVER_ACCEPT_MODIFY = "SMS_CODE_PKP_NOTIFY_DRIVER_ACCEPT_MODIFY";
	...
	/**
	 * ORACLE最大推送ptp签收时间的数据
	 */
	public static final int ORACLE_MAX_SIZE = 3000;
     ...
     * 上报oa异常重大货物异常数据job
     */
    public static final String EXCEPTION_IMPORTANT_NOTIFY_PROCESS_JOB = "ImportantGoodsNotifyProcessJob";
	 ...
	 * 合伙人- 到付运费扣款服务接口
	 */
	public static final  String PTP_PFCR_ESB_SYN_SERVER_CODE = "/PTP_ESB2PTP_PFCR_BOND_WITHHOLD";
	 ...
	 * 合伙人二级网点历史数据校验日期
	 */
	public static final String PTP_TWOLEVELNETWORK_BILL_DATE = "2016-12-01 13:00:00";
