...
public interface IProductService extends IService {
     ...
     * @see
     */
     void activateProducts(List<String> productIds) throws ProductException;
     ...
     * @see
     */
     void deleteProduct(List<String> productIds) throws ProductException;
     ...
     * @see
     */
     List<ProductEntity> queryProductCommonToLevelByCondition(ProductEntity entity,int start, int limit) throws ProductException;
     ...
     * @see
     */
     Long countProductCommonToLevelByCondition(ProductEntity entity) throws ProductException;
...
/**
	 * 获取物流三级产品类型，物流按照：一级零担汽运、零担空运查询对应的三级产品
	 * @author Foss-105888-Zhangxingwang
	 * @date 2014-12-27 09:24:51
	 * @return
	 */
	List<ProductEntity> getLevel3ForLogistics();
	
	/**
	 * 获取快递三级产品类型，快递目前只按照一级快递查询对应的三级产品，如有后续一级快递产品请后续添加上去
	 * @author Foss-105888-Zhangxingwang
	 * @date 2014-12-27 09:24:51
	 * @return
	 */
	List<ProductEntity> getLevel3ForExpress();
    ...
    List<ProductEntity> getAllProductEntityByDeptCodeForCargoAndExpress(
			String deptCode, String typeCode, Date billTime);

	/**
	 * 获得所有对应快递所有产品类型
	 * @author Foss-105888-Zhangxingwang
	 * @date 2015-8-10 09:11:31
	 * @return
	 */
