 ...
 * 
 * @Description: 空运价格区域
 * PriceRegionAirEntity.java Create on 2013-3-12 上午10:22:47
 * Company:IBM
 * @author FOSSDP-sz
 * Copyright (c) 2013 Company,Inc. All Rights Reserved
 * @version V1.0
 */
public class PriceRegionAirExpressEntity extends BaseEntity {
	/**
	 * 序列化ID
	 */
	private static final long serialVersionUID = 6826764311468324966L;
	/**
	 * 区域编码
	 */
