 ...
 * @version
 */
public interface IPublishPriceExpressService extends IService{
    /**
     * 
     ...
     * @see
     */
    List<PublishPriceExpressEntity> queryPublishPriceDetail(String startDeptNo ,String destinationCode, Date billDate);
     ...
     * @version V1.0
     */
    List<PublishPriceExpressEntity> queryPublishPriceDetailByCity(String startCityCode ,String destinationCityCode, Date billDate);
     ...
     * @version V1.0
     */
	List<PublishPriceExpressEntity> queryPublishPriceExpressDetailByCondition(
			String startCityCode, String destinationCountryCode,
			String destinationProvinceCode, String destinationCityCode,
			String destinationCountyCode, String destinationAddress, Date billDate);
	 ...
	 * @version V1.0
	 */
	List<SaleDepartmentInfoDto> getOuterAndDepartment(List<String> codes, String regionId, String regionNature);
	 ...
	 * @return
	 */
	List<PublishPriceExpressEntity> queryPublishPriceByCityCode(
