...
import com.deppon.foss.module.pickup.pricing.api.shared.domain.ShowDeptExpressEntity;
...
public class RegionExpressVo implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3117766432008480663L;
	/**
	 *  返回区域信息结果集
	 */
	 ...
	 *  部门信息
	 */
	private List<ShowDeptExpressEntity> showDeptEntityList;
	/**
	 *  区域关联部门信息(查询)
	 */
	 ...
	 * @return the 部门信息
	 */
	public List<ShowDeptExpressEntity> getShowDeptEntityList() {
	 ...
	 */
	public void setShowDeptEntityList(List<ShowDeptExpressEntity> showDeptEntityList) {
