 ...
 * @version
 */
public interface IEffectiveExpressPlanDetailService extends IService {
     ...
     * @see
     */
     void insertEffectiveExpressPlanDetail(EffectiveExpressPlanDetailEntity effectivePlanDetail);
     ...
     * @see
     */
     void deleteEffectiveExpressPlanDetail(List<String> ids);
     ...
     * @see
     */
     void activeEffectiveExpressPlanDetail(List<String> ids);
     ...
     * @see
     */
     void updateEffectiveExpressPlanDetail(EffectiveExpressPlanDetailEntity effectivePlanDetail);
     ...
     * @return
     * List<EffectiveExpressPlanDto>
     */
     List<EffectiveExpressPlanDto> queryEffectiveExpressPlanDetailListByCityCode(String originalCityCode, String destinationCityCode,
	 ...
	 * List<EffectiveExpressPlanDto>
	 */
     List<EffectiveExpressPlanDto> queryEffectiveExpressPlanDetailListByOrgCode(
     ...
     * @version V1.0
     */
     List<EffectiveExpressPlanDetailEntity> queryEffectiveExpressPlanDetailByConditions(EffectiveExpressPlanDetailEntity effectivePlanDetailEntity);
     ...
     */
     List<EffectiveExpressPlanDetailEntity> searchEffectiveExpressPlanDetailEntityByCondition(
    		 EffectiveExpressPlanDetailEntity effectivePlanDetailEntity, int start, int limit);
     ...
     * @date 2012-11-10 下午7:50:06
     */
     Long searchEffectiveExpressPlanDetailEntityCount(EffectiveExpressPlanDetailEntity effectivePlanDetailEntity);
     ...
     * @version V1.0
     */
     List<EffectiveExpressPlanDto> queryEffectiveExpressPlanDetailListByCondition(
    ...
    * @see
    */
     EffectiveExpressPlanDetailEntity getEffectiveExpressDetailEntityById(String id);
      ...
      *      java.lang.String)
      */
     List<EffectiveExpressPlanDetailEntity> queryCuurentEffectiveExpressPlanDetailInfo(
		String deptNo, String arrvieNo, String productCode, Date billDate);
