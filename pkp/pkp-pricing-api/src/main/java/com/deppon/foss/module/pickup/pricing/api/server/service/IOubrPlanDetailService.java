 ...
 * @version
 */
public interface IOubrPlanDetailService extends IService{
 ...
 快递代理 * 激活快递代理网点运价方案明细 
     ...
     * @see
     */
    int immediatelyActivate(OubrPlanDetailEntity entity);
    
    /**
  快递代理* <p>立即中止快递代理网点运价方案明细 </p> 
     * @author 094463-foss-xieyantao
     * @date 2013-7-23 下午4:50:24
     * @快递代理am entity 快递代理网点运价方案明细实体
     * @return 1：成功；-1：失败
     * @see
     */
    int immediatelyStop(OubrPlanDetailEntity entity);
    
    /**
     * 快递代理入对象查询符合条件所有快递代理网点运价方案明细信息 
     * @author 094463-foss-xieyantao
     * @date 2013-7-18 下午2:55:11
     ...
     * @author 094463-foss-xieyantao
     * @date 2013-7-18 下午2:55:11
     *快递代理aram entity 快递代理网点运价方案明细实体
     * @return
     * @see
     */
