 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/pricing/api/shared/domain/PriceRegionEntity.java
 * 
 ...
 * </p>
 * <p style="display:none">
 * version:V1.0,author:094463-foss-xieyantao,date:2013-7-25 下午5:43:55
 * </p>
 * 
 * @author 094463-foss-xieyantao
 * @date 2013-7-25 下午5:43:55
 * @since
 * @version
 */
public class PriceRegionExpressEntity extends BaseEntity {

		/**
		 * serialVersionUID.
		 */
		private static final long serialVersionUID = 2622702102811673270L;
    	/**
    	 *  区域编码
    	 */
        ...
        public int getPriority() {
        	if (StringUtil.isNotBlank(this.getCountyCode())) {
    			return PricingConstants.NUMBER_FOURTH;
    		} else if (StringUtil.isNotBlank(this.getCityCode())) {
    			return PricingConstants.NUMBER_THIRD;
    		} else if (StringUtil.isNotBlank(this.getProCode())) {
    			return PricingConstants.NUMBER_SECOND;
    		} else {
    			return PricingConstants.NUMBER_FIRST;
    		}
        }
