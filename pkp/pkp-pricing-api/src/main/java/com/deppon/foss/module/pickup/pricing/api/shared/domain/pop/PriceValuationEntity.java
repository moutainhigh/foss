 ...
 * <p style="display:none">version:V1.0,author:094463-foss-xieyantao,date:2013-8-6 下午6:24:07 </p>
...
public class PriceValuationEntity extends BaseEntity {
	 ...
	 * 设置 计价方式明细集合.
	 *
	 * @param criteriaDetailEntities the new 计价方式明细集合
	 */
	...
	public int getPriority(){
	    if(!PricingConstants.ALL.equals(this.getDeptRegionId()) && !PricingConstants.ALL.equals(this.getArrvRegionId())){
		return 4;
	    }else if(!PricingConstants.ALL.equals(this.getDeptRegionId()) && PricingConstants.ALL.equals(this.getArrvRegionId())){
		return 3;
	    }else if(PricingConstants.ALL.equals(this.getDeptRegionId()) && !PricingConstants.ALL.equals(this.getArrvRegionId())){
		return 2;
	    }else{
