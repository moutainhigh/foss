...
public interface IRegionAirService extends IService {
	/**
	 * 
	 ...
	 * @version V1.0
	 */
	List<PriceRegionAirEntity> searchRegionByCondition(PriceRegionAirEntity priceRegionAirEntity, int start, int limit);
	 ...
	 * @version V1.0
	 */
	Long countRegionByCondition(PriceRegionAirEntity regionEntity);
	 ...
	 * @version V1.0
	 */
	void addRegion(PriceRegionAirEntity regionEntity, List<PriceRegionOrgAirEntity> addPriceRegioOrgAirEntityList);
	 ...
	 * @param regionEntity
	 * @param addPriceRegioOrgAirEntityList
	 * @param updatePriceRegioOrgnEntityList
	 * @version V1.0
	 */
	void updateRegion(PriceRegionAirEntity regionEntity, List<PriceRegionOrgAirEntity> addPriceRegioOrgAirEntityList,
			List<PriceRegionOrgAirEntity> updatePriceRegioOrgnEntityList);
	 ...
	 * @version V1.0
	 */
	void refreshPriceRegionAirCache(String provinceCode, String cityCode, String countyCode);
	 ...
	 * @version V1.0
	 */
	void refreshPriceRegionOrgAirCache(String deptNo);
	/**
	 * 
	 * @Description: 立即中止
	 * 
	 ...
	 * @version V1.0
	 */
	void immedietelyStopRegionAir(String regionId, String regionNature, Date endTime);
	/**
	 * 
	 * @Description: 
	 * 
	 ...
	 * 
	 */
	void immedietelyActiveRegionAir(String regionId, String regionNature, Date beginTime);
	/**
	 * 
