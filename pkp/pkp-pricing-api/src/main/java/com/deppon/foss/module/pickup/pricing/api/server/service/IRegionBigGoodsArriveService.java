...
public interface IRegionBigGoodsArriveService extends IService {
	/**
	 * 
	 ...
	 * @version V1.0
	 */
	List<PriceRegionBigGoodsArriveEntity> searchRegionByCondition(PriceRegionBigGoodsArriveEntity priceRegionBigGoodsArriveEntity, int start, int limit);
	 ...
	 * @version V1.0
	 */
	Long countRegionByCondition(PriceRegionBigGoodsArriveEntity regionEntity);
	 ...
	 * @version V1.0
	 */
	void addRegion(PriceRegionBigGoodsArriveEntity regionEntity, List<PriceRegionBigGoodsOrgArriveEntity> addPriceRegioOrgArriveEntityList);
	 ...
	 * @version V1.0
	 */
	void updateRegion(PriceRegionBigGoodsArriveEntity regionEntity, List<PriceRegionBigGoodsOrgArriveEntity> addPriceRegioOrgArriveEntityList,
			List<PriceRegionBigGoodsOrgArriveEntity> updatePriceRegioOrgnEntityList);
