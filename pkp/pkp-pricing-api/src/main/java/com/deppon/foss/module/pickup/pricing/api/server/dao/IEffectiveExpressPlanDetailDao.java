 ...
 * @version
 */
public interface IEffectiveExpressPlanDetailDao {
     ...
     * @see
     */
    int insertSelective(EffectiveExpressPlanDetailEntity record);
     ...
     * @see
     */
    EffectiveExpressPlanDetailEntity selectByPrimaryKey(String id);
     ...
     * @see
     */
    int updateByPrimaryKeySelective(EffectiveExpressPlanDetailEntity record);
     ...
     * @see
     */
     List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailInfoPagging(EffectiveExpressPlanDetailEntity effectivePlanDetailEntity,int start ,int limit);
     ...
     * @see
     */
     Long queryEffectivePlanDetailInfoPaggingCount(EffectiveExpressPlanDetailEntity effectivePlanDetailEntity);
     ...
     * @see
     */
     List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailInfo(EffectiveExpressPlanDetailEntity effectivePlanDetailEntity);
     ...
     */
    List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailInfoForDownload(String deptRegionId, Date lastModifyTime);
     ...
     */
     List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailListByCondition(
     ...
     * @see
     */
    public List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailByCondition(EffectiveExpressPlanDetailEntity effectivePlanDetailEntity);
     ...
     */
    List<EffectiveExpressPlanDetailEntity> searchEffectivePlanDetailEntityByCondition(EffectiveExpressPlanDetailEntity effectivePlanEntity, int start, int limit);
     ...
     * @see
     */
     Long searchEffectivePlanDetailEntityByConditionCount(EffectiveExpressPlanDetailEntity effectivePlanEntity);
     ...
     * @version V1.0
     */
     List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailListByArrvIds(
     ...
     * @version V1.0
     */
     List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailListByRegionIds (
	 ...
	 * @return
	 */
     List<EffectiveExpressPlanDetailEntity> queryEffectivePlanDetailByConditionByPage(
			EffectiveExpressPlanDetailEntity entity, int start, int limited);
