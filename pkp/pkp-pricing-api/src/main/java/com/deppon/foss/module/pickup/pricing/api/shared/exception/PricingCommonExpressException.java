 ...
 * @version
 */
public class PricingCommonExpressException extends BusinessException {

	/**
     * Serial Version UID
     */
	private static final long serialVersionUID = -1896228374087860670L;
    ...
    public PricingCommonExpressException(String code, String msg, Throwable cause) {
	super(code, msg, cause);
    }

    public PricingCommonExpressException(String code, String msg) {
	super(code, msg);
    }
}