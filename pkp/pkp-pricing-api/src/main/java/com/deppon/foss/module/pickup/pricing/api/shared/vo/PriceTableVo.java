 ...
 * 
 */
public class PriceTableVo implements Serializable {
	 ...
	 * 界面查询结果.
	 */
	private List<PriceTableEntity> priceTableEntityList;
	 ...
	 * 获取 界面查询结果.
	 *
	 * @return  the priceTableEntityList
	 */
	public List<PriceTableEntity> getPriceTableEntityList() {
	 ...
	 * 设置 界面查询结果.
	 *
	 * @param priceTableEntityList the priceTableEntityList to set
	 */
	public void setPriceTableEntityList(List<PriceTableEntity> priceTableEntityList) {
	    this.priceTableEntityList = priceTableEntityList;
	}
