 ...
 * @author 岳洪杰
 * @date 2015-10-12 上午10:47:06
 * @since
 * @version
 */
public interface ICustomerPricePlanService extends IService {
	/**
	 * 查询计价分段明细的轻重货的相关信息
	 *
    ...
    */
     ...
     * 
     * @author zhangbin
     * @date 2015-12-23 上午12:35:09
     * @param detailMap
     * @param priceRegionEntityMap
     * @param productEntityMap
     * @see
     */
     void addPricePlanDetalBatch(List<PricePlanDetailDto> detailList);
