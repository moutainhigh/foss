 ...
 * @version
 */
public class NewPublishPriceExpressVo implements Serializable {
	 ...
	 * 查询结果
	 */
	private List<PublishPriceExpressEntity> publishPriceExpressList;
	 ...
	 * @return the 查询结果
	 */
	public List<PublishPriceExpressEntity> getPublishPriceExpressList() {
		return publishPriceExpressList;
	}

	/**
	 * 设置 查询结果.
	 *
	 * @param PublishPriceExpressEntityList2 the new 查询结果
	 */
	public void setPublishPriceExpressList(
			List<PublishPriceExpressEntity> publishPriceExpressList) {
		this.publishPriceExpressList = publishPriceExpressList;
	}
