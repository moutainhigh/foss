 ...
 * @version v1.0
 */
public interface IEffectiveExpressPlanDao {
     ...
     * @see
     */
    int insertSelective(EffectiveExpressPlanEntity record);
     ...
     * @see
     */
    EffectiveExpressPlanEntity selectByPrimaryKey(String id);
     ...
     * @see
     */
    int updateByPrimaryKeySelective(EffectiveExpressPlanEntity record);
     ...
     * @see
     */
    EffectiveExpressPlanEntity findEffectivePlanByRegionId(Date cuurentTime,String active,String deptRegionId);
     ...
     */
    List<EffectiveExpressPlanEntity> searchEffectivePlanByCondition(EffectiveExpressPlanEntity effectivePlanEntity, int start, int limit);
    /**
     * 
     ...
     */
     List<EffectiveExpressPlanEntity> searchEffectivePlanByCondition(EffectiveExpressPlanEntity effectivePlanEntity);
     ...
     * @since  1.0.0
     */
     Long searchEffectivePlanByConditionCount(EffectiveExpressPlanEntity effectivePlanEntity);
     ...
     * @see
     */
     List<EffectiveExpressPlanEntity> searchEffectivePlanByName(EffectiveExpressPlanEntity effectivePlanEntity);
     /**
      * 根据结束时间为节点查询
      * @param effectiveExpressPlanEntity
      * @return
      */
	 List<EffectiveExpressPlanEntity> searchEffectivePlanOldList(EffectiveExpressPlanEntity effectiveExpressPlanEntity);
