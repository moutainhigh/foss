...
public class ResultProductPriceDto implements Serializable{
     ...
     * 计价左区间.   
     */
    private double valueAddLeftrange;
    
    /** 
     * 计价右区间.   
     */
    private double valueAddRightrange;
    ...
    public double getValueAddLeftrange() {
		return valueAddLeftrange;
	}



	public void setValueAddLeftrange(double valueAddLeftrange) {
		this.valueAddLeftrange = valueAddLeftrange;
	}



	public double getValueAddRightrange() {
		return valueAddRightrange;
	}



	public void setValueAddRightrange(double valueAddRightrange) {
