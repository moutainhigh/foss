 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/action/GISDialogChangeAction.java
 * 
...
public class GISDialogChangeAction implements
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			double width_ = Toolkit.getDefaultToolkit().getScreenSize()
					.getWidth();
			double height_ = Toolkit.getDefaultToolkit().getScreenSize()
					.getHeight();						

			CefChromeBrowserManager.PopChromeBrowserAsDialog(url,
					(int) width_ - NumberConstants.NUMBER_60, (int) height_ - NumberConstants.NUMBER_110, myCallBack, false);
