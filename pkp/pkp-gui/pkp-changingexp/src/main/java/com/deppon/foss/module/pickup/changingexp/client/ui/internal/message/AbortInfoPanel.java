 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/message/AbortInfoPanel.java
 * 
 ...
 ******************************************************************************/
package com.deppon.foss.module.pickup.changingexp.client.ui.internal.message;
...
import com.deppon.foss.module.pickup.changingexp.client.action.HandoverDetailAction;
...
public class AbortInfoPanel extends JPanel {
	...
	private JButton btnHandoverDetail = new JButton(i18n.get("foss.gui.changingexp.abortInfoPanel.handoverDetail.button"));
	...
	public AbortInfoPanel() {
		setBorder(new JDTitledBorder(i18n.get("foss.gui.changingexp.abortInfoPanel.title")));
		...
		//中止人
		JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changingexp.abortInfoPanel.operateUser.label")+"：");
		...
		//中止时间
		JLabel label_1 = new JLabel(i18n.get("foss.gui.changingexp.abortInfoPanel.operateTime.label")+"：");
		label_1.setFont(new Font("宋体", Font.BOLD, TWELVE));
		...
		//差错处理编号
		JLabel label_2 = new JLabel(i18n.get("foss.gui.changingexp.abortInfoPanel.errorCode.label")+"：");
		label_2.setFont(new Font("宋体", Font.BOLD, TWELVE));
		label_2.setForeground(Color.RED);
		add(label_2, "2, 3, right, default");

		txtErrorCode = new JTextFieldValidate();
		add(txtErrorCode, "4, 3, fill, default");
		txtErrorCode.setColumns(TEN);

		//差错处理结果
		JLabel label_3 = new JLabel(i18n.get("foss.gui.changingexp.abortInfoPanel.errorResult.label")+"：");
		label_3.setFont(new Font("宋体", Font.BOLD, TWELVE));
