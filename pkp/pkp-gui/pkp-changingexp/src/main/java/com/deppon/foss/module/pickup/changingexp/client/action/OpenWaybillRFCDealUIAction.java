 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/action/OpenWaybillRFCDealUIAction.java
 * 
...
public class OpenWaybillRFCDealUIAction extends
	...
	public void openUIAction() {
		...
		editConfig.setTitle(i18n.get("pickup.changingexp.waybillRfcDeal"));//??
		editConfig.setPluginId("com.deppon.foss.module.pkp-changingexp");
		application
				.openEditorAndRetrun(editConfig,
						"com.deppon.foss.module.pickup.changingexp.client.ui.WaybillRFCDealUI");
