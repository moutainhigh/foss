 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/ExtendPanel.java
 * 
...
public class ExtendPanel extends JPanel {
	...
	public ExtendPanel() {
		setBorder(new JDTitledBorder(i18n.get("foss.gui.changingexp.extendPanel.title")));
		...
		//计费类型
		JLabel lblBillingType = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.billingType.label")+"：");
		...
		//计费重量
		JLabel lblBillWeight = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.billWeight.label")+"：");
		...
		//费率
		JLabel lblUnitPrice = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.unitPrice.label")+"：");
		...
		//运费
		JLabel lblTransportFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.transportFee.label")+"：");
		...
		//保价申明价值
		JLabel lblInsuranceAmount = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.insuranceAmount.label")+"：");
		...
		//保价费率
		JLabel lblInsuranceRate = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.insuranceRate.label")+"：");
		...
		//保价费
		JLabel lblInsuranceFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.insuranceFee.label")+"：");
		...
		//代收货款
		JLabel lblCodAmount = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.codAmount.label")+"：");
		...
		//代收费率
		JLabel lblCodRate = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.codRate.label")+"：");
		...
		//代收手续费
		JLabel lblCodFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.codFee.label")+"：");
		...
		//包装费
		JLabel lblPackageFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.packageFee.label")+"：");
		...
		//送货费
		JLabel lblDeliveryGoodsFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.deliveryGoodsFee.label")+"：");
		...
		//其他费用
		JLabel lblOtherFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.otherFee.label")+"：");
		...
		add(separator_3, "2, 34, 3, 1");

		//优惠费用
		JLabel lblPromotionsFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.promotionsFee.label")+"：");
		...
		//费用合计
		JLabel lblTotalFee = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.totalFee.label")+"：");
