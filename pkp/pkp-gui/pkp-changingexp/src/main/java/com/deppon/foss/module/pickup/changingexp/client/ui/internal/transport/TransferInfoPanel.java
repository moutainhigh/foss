 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/transport/TransferInfoPanel.java
 * 
...
public class TransferInfoPanel extends JPanel {
	...
	private void init() {
		...
		//转运运输性质：
		JLabel lblTransferProductType = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferProductType.label")+"：");
		...
		//转运提货方式：
		JLabel lblTransferAllocationType = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferPickMode.label")+"：");
		...
		//转运目的站：
		JLabel lblTransferDestination = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferDestination.label")+"：");
		...
		//转运提货网点：
		JLabel lblTransferPickBranch = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferPickBranch.label")+"：");
		...
		//转运航班类型：
		JLabel lblTransferPredictFlight = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferPredictFlight.label")+"：");
		...
		//转运计费类型：
		JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferBillingType.label")+"：");
		...
		//转运费率：
		JLabel lblNewLabel1 = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferUnitPrice.label")+"：");
		...
		//转运费：
		JLabel label = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.transferFee.label")+"：");
		...
		//合票方式：
		label_1 = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.freightMethod.label")+"：");
		...
		//航班时间：
		label_2 = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.flightShift.label")+"：");
