 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/dialog/QueryChangeAndDealDialog.java
 * 
...
public class QueryChangeAndDealDialog extends JDialog {
	...
	private JButton printBtn = new JButton(i18n.get("pickup.changingexp.print"));;
...
//			}
	...
	private void init() {
		// 更改审核变更查询
		setTitle(i18n.get("foss.gui.changingexp.queryChangeAndDealDialog.title"));
		...
		// 变更信息
		JLabel label = new JLabel(i18n.get("foss.gui.changingexp.queryChangeAndDealDialog.changeItem"));
		...
		// 打印
		//printBtn = new JButton(i18n.get("pickup.changingexp.print"));
