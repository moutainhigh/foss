 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/dialog/DealChangeApplyDialog.java
 * 
...
public class DealChangeApplyDialog extends JDialog {
	...
	private void setComponentState(WaybillRfcChangeDto dto) {
		...
		if (waybillRfcChangeDto.getDealStauts().equals(WaybillRfcConstants.PRE_ACCECPT)) {
				textField.setText(i18n.get("foss.gui.changingexp.dealChangeApplyDialog.agree.label"));
		}else{
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (isChangeOk) {
						...
						if(isPrint){
							MsgBox.showInfo(i18n.get("foss.gui.changingexp.dealChangeApplyDialog.msgBox.acceptSuccessAndNeedPrint"));

						}else{
							MsgBox.showInfo(i18n.get("foss.gui.changingexp.dealChangeApplyDialog.msgBox.acceptSuccess"));
						}
						
						waybillRFCDealUI.waybillRFCDealUITableRefresh(selectedRow);
					} else {
						MsgBox.showInfo(i18n.get("foss.gui.changingexp.dealChangeApplyDialog.msgBox.acceptFailure"));
					}
				} catch (Exception e1) {
	 ...
	 */
	private void init() {
		setTitle(i18n.get("foss.gui.changingexp.dealChangeApplyDialog.acceptRfcBill.label"));
		...
		JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changingexp.changeCheckStatusDialog.init.acceptRemark.label"));
