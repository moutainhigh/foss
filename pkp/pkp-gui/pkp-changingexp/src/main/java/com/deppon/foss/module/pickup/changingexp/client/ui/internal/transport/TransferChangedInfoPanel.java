...
public class TransferChangedInfoPanel extends JPanel {
	...
	private void init() {
		...
		//变更运输性质：
		JLabel lblTransferProductType = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.productType.label")+"：");
		...
		//变更提货方式：											foss.gui.changingexp.transportInfoPanel.pickMode.label
		JLabel lblTransferAllocationType = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.pickMode.label")+"：");
		...
		//变更目的站：
		JLabel lblTransferDestination = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.destination.label")+"：");
		...
		//变更提货网点：
		JLabel lblTransferPickBranch = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.pickBranch.label")+"：");
		...
		//变更航班类型：
		JLabel lblTransferPredictFlight = new JLabel(i18n.get("foss.gui.changingexp.transportInfoPanel.predictFlight.label")+"：");
		...
		//变更计费类型：
		JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.billingType.label")+"：");
		...
		//变更费率：
		JLabel lblNewLabel1 = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.unitPrice.label")+"：");
		...
		//变更费：
		JLabel label = new JLabel(i18n.get("foss.gui.changingexp.extendPanel.fee.label")+"：");
