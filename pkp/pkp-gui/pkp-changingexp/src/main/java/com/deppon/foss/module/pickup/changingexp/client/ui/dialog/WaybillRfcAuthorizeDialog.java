 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/dialog/WaybillRfcAuthorizeDialog.java
 * 
...
import com.deppon.foss.module.pickup.changingexp.client.action.WaybillRfcAuthorizeCloseAction;
import com.deppon.foss.module.pickup.changingexp.client.action.WaybillRfcAuthorizeCommitAction;
...
public class WaybillRfcAuthorizeDialog extends JDialog {
	...
	private void init() {
		//"运单变更审核权限"
		setTitle(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeDialog.init.auditRfcPrivileges.label"));
		...
		//委托人：
		JLabel label = new JLabel(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeDialog.init.client.label"));
		...
		//代理人：
		JLabel label1 = new JLabel(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeDialog.init.agent.label"));
		...
		//生效时间：
		JLabel label2 = new JLabel(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeDialog.init.effectiveTime.label"));
		...
		//终止时间：
		JLabel label3 = new JLabel(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeDialog.init.terminateTime.label"));
		...
		//代理原因：
		JLabel label4 = new JLabel(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeDialog.init.agentReason.label"));
		...
		//提交
		btnSubmit = new JButton(i18n.get("foss.gui.changingexp.waybillRFCUI.common.confirm"));
		...
		//返回
		btnReturn = new JButton(i18n.get("foss.gui.changingexp.waybillRFCUI.common.cancel"));
