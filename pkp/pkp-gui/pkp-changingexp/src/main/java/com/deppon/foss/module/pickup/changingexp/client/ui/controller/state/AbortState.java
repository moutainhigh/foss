 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/controller/state/AbortState.java
 * 
...
public class AbortState extends AbstractState {
	...
	public void updateComponents(WaybillRFCUI rfcUI) {
		...
		//收货人电话
		rfcUI.getConsigneePanel().getTxtConsigneePhone().setEditable(true);
		//客户名称
		rfcUI.getConsigneePanel().getTxtConsigeeName().setEditable(true);
						
		//收货人手机
		rfcUI.getConsigneePanel().getTxtConsigneeMobile().setEditable(true);
		//收货人联系地址
		rfcUI.getConsigneePanel().getTxtConsigneeAddress().setEditable(true);
		//客户编码
		rfcUI.getConsigneePanel().getLblReceiveCustomerCode().setEnabled(true);
	...
	protected List<UploadVoucherDto> getUploadVoucherDtos() {
		...
		vo.setProofName(i18n.get("pickup.changingexp.oaErrorHandler"));
