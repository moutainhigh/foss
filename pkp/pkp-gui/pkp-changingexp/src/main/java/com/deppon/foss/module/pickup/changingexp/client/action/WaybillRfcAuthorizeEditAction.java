 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/action/WaybillRfcAuthorizeEditAction.java
 * 
...
public class WaybillRfcAuthorizeEditAction implements IButtonActionListener<WaybillRFCAuthorizeUI>{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(bean == null){
			MsgBox.showError(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeEditAction.msgBox.nullSelectedModifyRecord"));
			return;
		}
