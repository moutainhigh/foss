 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/prt/modifyWaybill/PreWayBillPrtDataSource.java
 * 
 * FILE NAME        	: PreWayBillPrtDataSource.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 *
 */
package com.deppon.foss.prt.halfModifyWaybill;
 ...
 * </p>
 * <p style="display:none">
 * version:V1.0,author:jiangfei,date:2012-10-17 下午10:38:31,
 * </p>
 * 
 * @author jiangfei
 ...
 * @version
 */
public class HalfWayBillRfcPrtDataSource implements JasperDataSource {
	...
	public Map<String, Object> createParameterDataSource(
		...
		// WaybillRfcVo resourceBean = (WaybillRfcVo) jasperContext
		// .get("waybillRfcPrintVo");
		// WaybillRfcPrintVo resourceBean = (WaybillRfcPrintVo) jasperContext
		// .get("waybillRfcPrintVo");
		...
		paramMap.put("halfTipLine", jasperContext.get("halfTipLine"));// 半页提示线
