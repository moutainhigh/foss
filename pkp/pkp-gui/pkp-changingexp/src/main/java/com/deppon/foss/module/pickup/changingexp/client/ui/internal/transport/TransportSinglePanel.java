 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/transport/TransportSinglePanel.java
 * 
...
public class TransportSinglePanel extends JPanel implements ITransterInject{
	 ...
	 */
	private void init() {
		setBorder(new JDTitledBorder(i18n.get("foss.gui.changingexp.transportSinglePanel.title.label")));
