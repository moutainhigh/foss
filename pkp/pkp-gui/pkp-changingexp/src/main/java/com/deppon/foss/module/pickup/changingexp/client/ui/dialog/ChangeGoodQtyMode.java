 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/dialog/ChangeGoodQtyMode.java
 * 
 * FILE NAME        	: ChangeGoodQtyMode.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * @version
 */
public class ChangeGoodQtyMode   extends AbstractTableModel {
	...
	public ChangeGoodQtyMode(Object[][] data){
		this.data = data;
	}
	...
	public static void adjustColumnPreferredWidths(JXTable table) {
		...
		for (int col = 0; col < table.getColumnCount(); col++) {
			...
			int maxwidth = 0;
			if(col==0){
				maxwidth = NumberConstants.NUMBER_50;
			}else{
				maxwidth = NumberConstants.NUMBER_200;
			}
