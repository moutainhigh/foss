 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/transport/TransferTabPanel.java
 * 
 ...
 */
public class TransferTabPanel extends JTabbedPane implements ITransterInject {

	/**
	 *  国际化
	 */
	private static II18n i18n = I18nManager.getI18n(TransferTabPanel.class);
	...
	private void init() {
		...
		addTab(i18n.get("foss.gui.changingexp.transportSinglePanel.title.label"), null, managedPanel, null);
		 //转运信息
		addTab(i18n.get("foss.gui.changingexp.transferInfoPanel.title.label"), null, transferInfoPanel, null);
		//转运记录
		addTab(i18n.get("foss.gui.changingexp.transferRecordPanel.title.label"), null, transferRecordPanel, null);
	 ...
	 */
	public TransferInfoPanel getTransferInfoPanel() {
	 ...
	 */
	public TransferRecordPanel getTransferRecordPanel() {
