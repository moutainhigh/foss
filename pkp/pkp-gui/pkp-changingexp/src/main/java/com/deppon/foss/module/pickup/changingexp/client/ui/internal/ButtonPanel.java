 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/ButtonPanel.java
 * 
...
import com.deppon.foss.module.pickup.changingexp.client.action.ChooseModifyWaybillPrintTypeAction;
import com.deppon.foss.module.pickup.changingexp.client.action.GISDialogChangeAction;
import com.deppon.foss.module.pickup.changingexp.client.action.QueryMemberDialogChangeAction;
import com.deppon.foss.module.pickup.changingexp.client.action.RfcInfoAction;
import com.deppon.foss.module.pickup.common.client.action.ExpQueryPublicPriceLocalUIAction;
...
public class ButtonPanel extends JPanel {
	...
	private JButton btnSubmit = new JButton(i18n.get("pickup.changingexp.commit"));

	/**
	 * 打印按键
	 */
	@ButtonAction(icon = IconConstants.PRINT, shortcutKey = "", type = ChooseModifyWaybillPrintTypeAction.class)
	private JButton btnPrint = new JButton(i18n.get("pickup.changingexp.print"));
	...
	private JButton btnSearchMember = new JButton(i18n.get("foss.gui.changingexp.ButtonPanel.queryMember"));

	/**
	 * 查询网点
	 */
	@ButtonAction(icon = IconConstants.SEARCHBRANCH, shortcutKey = "F6", type = GISDialogChangeAction.class)
	private JButton btnSearchBranch = new JButton(i18n.get("foss.gui.changingexp.ButtonPanel.queryStation"));
	...
	private JButton btnSearchPrice = new JButton(i18n.get("foss.gui.changingexp.ButtonPanel.queryPulicCharge"));
