 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/controller/state/CustomerChangeState.java
 * 
...
public class CustomerChangeState extends AbstractState {
	...
	protected void updateComponents(WaybillRFCUI rfcUI) {
		...
		// return;
		// }
		if (waybillVo.getIsChangeReason() != 1) {
			...
			rfcUI.getConsigneePanel().setEnabled(true);
		...
		// 代收货款
		if (!CommonUtils.isTaoBaoOrder(waybillVo)) {
...
//				rfcUI);
	...
	private void updateWaybillInfoComonentEnable() {
		...
		if(null!=procuctCode){
			if(ProductEntityConstants.ECOMMERCE_PROMOTIONAL_ENJOY_PACKAGE.equals(procuctCode)){
				billingPayPanel.getCombPaymentMode().setEnabled(false);
			}
		}
		/**
		...
		if (WaybillRfcConstants.RECEIVE_STOCK.equals(inventory)) {
			...
			consignerPanel.getTxtConsignerAddressNote().setEnabled(false);
	...
	private void insideFullVehicleReceiveOut(WaybillInfoVo waybillVo) {
		...
		incrementPanel.getTxtServiceCharge().setEnabled(false);
