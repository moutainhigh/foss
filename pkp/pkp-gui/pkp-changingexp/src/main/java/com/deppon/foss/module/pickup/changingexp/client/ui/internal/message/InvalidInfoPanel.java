 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/message/InvalidInfoPanel.java
 * 
...
public class InvalidInfoPanel extends JPanel {
	...
	public InvalidInfoPanel() {
		setBorder(new JDTitledBorder(i18n.get("foss.gui.changingexp.invalidInfoPanel.title")));
		...
		//作废人
		JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changingexp.invalidInfoPanel.operateUser.label")+"：");
		...
		//作废时间
		JLabel label_1 = new JLabel(i18n.get("foss.gui.changingexp.invalidInfoPanel.operateTime.label")+"：");
