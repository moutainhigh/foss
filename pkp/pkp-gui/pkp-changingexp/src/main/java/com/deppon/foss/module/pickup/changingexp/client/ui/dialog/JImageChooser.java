 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/dialog/JImageChooser.java
 * 
...
public class JImageChooser extends JFileChooser {
	...
	public String getDescription(File f) {
		//图片文件
		return i18n.get("foss.gui.changingexp.imageViewCheckDialog.image.type");
	}
}