 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/internal/message/ChangedInfoPanel.java
 * 
...
public class ChangedInfoPanel extends JPanel {
	...
	public ChangedInfoPanel() {
		setBorder(new JDTitledBorder(i18n.get("foss.gui.changingexp.changedInfoPanel.title")));
	...
	private class ChangeInfoDetailTableModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			...
			case 0:
				//变更项
				return i18n.get("foss.gui.changingexp.changedInfoPanel.GridChangeItem.label");
			case 1:
				//变更前信息
				return i18n.get("foss.gui.changingexp.changedInfoPanel.GridChangeBefore.label");
			case 2:
				//变更后信息
				return i18n.get("foss.gui.changingexp.changedInfoPanel.GridChangeAfter.label");
			default:
				return "";
			}
		}
