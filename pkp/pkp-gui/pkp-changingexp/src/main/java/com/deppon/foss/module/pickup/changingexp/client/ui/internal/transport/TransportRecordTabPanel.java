...
public class TransportRecordTabPanel extends JTabbedPane implements ITransterInject {
	...
	private void init() {
		...
		//运输信息变更
		addTab(i18n.get("foss.gui.changingexp.transportInfoChangePanel.title.label"), null, transferInfoPanel, null);
		//变更记录
		addTab(i18n.get("foss.gui.changingexp.transportChangeRecordPanel.title.label"), null, transferRecordPanel, null);
