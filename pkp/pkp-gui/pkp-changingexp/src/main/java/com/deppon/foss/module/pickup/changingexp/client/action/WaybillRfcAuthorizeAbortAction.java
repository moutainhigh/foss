 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/action/WaybillRfcAuthorizeAbortAction.java
 * 
...
public class WaybillRfcAuthorizeAbortAction implements IButtonActionListener<WaybillRFCAuthorizeUI>{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(bean == null){
			MsgBox.showError(i18n.get("foss.gui.changingexp.waybillRfcAuthorizeAbortAction.msgBox.nullSelectedAuthorizeBean"));
			return;
		}

		int option = JOptionPane.showConfirmDialog(ui, i18n.get("foss.gui.changingexp.waybillRfcAuthorizeAbortAction.confirmDialog.terminateRecord"), i18n.get("foss.gui.changingexp.waybillRFCUI.common.prompt"), JOptionPane.YES_NO_OPTION);
