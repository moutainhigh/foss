 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/ui/dialog/MultiUserChooserDialog.java
 * 
...
import com.deppon.foss.module.pickup.changingexp.client.action.MultiUserChooserOKAction;
...
//				(JFrame)multiUserChooser.getTopLevelAncestor());
	...
	private void init() {
		//人员选择
		setTitle(i18n.get("foss.gui.changingexp.multiUserChooserDialog.title"));
		setModal(true);
		setSize(NumberConstants.NUMBER_700, NumberConstants.NUMBER_480);
		...
		btnClose = new JButton(i18n.get("foss.gui.changingexp.waybillRFCUI.common.cancel"));
...
//		}
		...
		public String getColumnName(int column) {
			switch (column) {
			case ZERO:
				return i18n.get("foss.gui.changingexp.multiUserChooserDialog.columnName.workNum");
			case ONE:
				return i18n.get("foss.gui.changingexp.multiUserChooserDialog.columnName.name");
			case TWO:
				return i18n.get("foss.gui.changingexp.multiUserChooserDialog.columnName.gender");
			case THREE:
				return i18n.get("foss.gui.changingexp.multiUserChooserDialog.columnName.belongDept");
			case FOUR:
				return i18n.get("foss.gui.changingexp.multiUserChooserDialog.columnName.position");
			default:
				return "";
			}
		}
		...
		public Object getValueAt(int row, int column) {
			...
			case TWO:
				...
				return "1".equals(gender)?i18n.get("foss.gui.changingexp.multiUserChooserDialog.gender.male"):i18n.get("foss.gui.changingexp.multiUserChooserDialog.gender.female");
			case THREE:
				//所属部门
