 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changingexp/client/action/ShowEnterYokeInfoChangeDialogAction.java
 * 
...
public class ShowEnterYokeInfoChangeDialogAction implements IButtonActionListener<WaybillRFCUI> {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(FossConstants.YES.equals(bean.getDoPacking())){
			...
			MsgBox.showError(i18n.get("foss.gui.changingexp.showEnterYokeInfoChangeDialogAction.msgBox.doNotPacking"));
		}
	}
