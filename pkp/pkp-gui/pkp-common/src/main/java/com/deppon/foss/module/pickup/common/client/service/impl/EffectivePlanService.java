 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/impl/EffectivePlanService.java
 * 
...
public class EffectivePlanService implements IEffectivePlanService {
	...
	@Transactional
	@Override
	public void addEffectivePlan(EffectivePlanEntity effectivePlan) {
		effectivePlanDao.addEffective(effectivePlan);
	...
	@Transactional
	@Override
	public void updateEffectivePlan(EffectivePlanEntity effectivePlan) {
		effectivePlanDao.updateEffectivePlan(effectivePlan);
	}
	 ...
	 */
	@Override
	public void saveOrUpdate(EffectivePlanEntity effectivePlan) {
		if(!effectivePlanDao.addEffective(effectivePlan)){
			effectivePlanDao.updateEffectivePlan(effectivePlan);
		}
	}
	...
	public void deleteByRegionID(String regionID) {
		effectivePlanDao.deleteByRegionID(regionID);
