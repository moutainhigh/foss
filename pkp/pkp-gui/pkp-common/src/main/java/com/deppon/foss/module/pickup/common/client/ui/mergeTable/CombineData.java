 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/ui/mergeTable/CombineData.java
 * 
 * FILE NAME        	: CombineData.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
public class CombineData { 
    ...
    //用于保存需要合并的列号 
    public List<Integer> combineColumns = new ArrayList<Integer>();
    
    //table的数据，用来计算合并的单元格 
    private Object[][] datas;
    
    //记录要合并行的开始位置<合并列，起始行>
    private List<HashMap<Integer, Integer>> rowPoss; 
    
    //记录要合并行的合并格数<起始行，合并行数>
    private List<HashMap<Integer, Integer>> rowCounts; 
     ...
     * 根据转入的值，初始化表格数据
     * @author 026123-foss-lifengteng
     * @date 2012-10-22 上午8:27:51
     */
    public void initData(Object[][] datas, int... combineColumns) { 
        this.datas = datas; 
     ...
     * 根据转入的值，初始化表格数据
     * @author 026123-foss-lifengteng
     * @date 2012-10-22 上午8:29:37
     */
    public void initData(Object[][] datas, List<Integer> combineColumns) { 
        this.datas = datas; 
        this.combineColumns.clear(); 
        for (Integer column : combineColumns) { 
            if (column < 0) { 
     ...
     * @author 026123-foss-lifengteng
     * @date 2012-10-22 上午8:39:17
     */
    public int visibleCell(int row, int column) { 
	//list有序不重复：column最后出现的位置
        int index = combineColumns.lastIndexOf(column); 
        if ((index != -1) && row > -1) { 
