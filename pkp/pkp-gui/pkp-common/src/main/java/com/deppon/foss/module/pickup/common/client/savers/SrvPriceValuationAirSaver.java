 ...
 */
public class SrvPriceValuationAirSaver extends AbstractSyncDataSaver {
	//区域id
	...
	public Class<?> getSaveType() {
		return PriceValuationAirDto.class;
	}
	...
	public Date saveData(List<?> data) {
		...
		List<PriceValuationAirDto> list = (List<PriceValuationAirDto>)data;
		long mxVersion = 0;
		if(list != null && !list.isEmpty()){
			...
			for(PriceValuationAirDto priceValuationRegionAddDto : list){
