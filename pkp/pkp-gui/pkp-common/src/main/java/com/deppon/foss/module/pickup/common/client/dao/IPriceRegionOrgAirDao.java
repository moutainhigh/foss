 ...
 *
 */
public interface IPriceRegionOrgAirDao {
	/**
	 * 
	 * 功能：插条记录
	 * @param: orgInfo
	 ...
	 * @since:1.6
	 */
	boolean addPriceRegionOrgAirEntity(PriceRegionOrgAirEntity e);
	 ...
	 * @since:1.6
	 */
	void updatePriceRegionOrgAirEntity(PriceRegionOrgAirEntity e);
}
