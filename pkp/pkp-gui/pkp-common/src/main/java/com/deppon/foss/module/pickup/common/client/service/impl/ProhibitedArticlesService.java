 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/impl/ProhibitedArticlesService.java
 * 
...
public class ProhibitedArticlesService implements IProhibitedArticlesService {
	...
	@Inject
	private IProhibitGoodsDao prohibitGoodsDao;
	...
	@Transactional
	@Override
	public void addProhibitedArticles(
			ProhibitedArticlesEntity prohibitedArticles) {
		prohibitGoodsDao.addProhibitedArticles(prohibitedArticles);
	...
	public void updateProhibitedArticles(
			ProhibitedArticlesEntity prohibitedArticles) {
		prohibitGoodsDao.updateProhibitedArticles(prohibitedArticles);
	 ...
	 */
	@Override
	public void saveOrUpdate(ProhibitedArticlesEntity prohibitedArticles) {
		if(!prohibitGoodsDao.addProhibitedArticles(prohibitedArticles)){
			prohibitGoodsDao.updateProhibitedArticles(prohibitedArticles);
	...
	public void delete(ProhibitedArticlesEntity prohibitedArticlesEntity) {
		prohibitGoodsDao.delete(prohibitedArticlesEntity);
