 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IResourceService.java
 * 
...
public interface IResourceService {
	 ...
	 * 插条记录
	 */
	void addResources(ResourceEntity resource);
	/**
	 * 更新条记录
	 */
	void updateResources(ResourceEntity resource);
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(ResourceEntity resource);
	/**
	 * @param resource
	 */
