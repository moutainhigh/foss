...
public interface ISrvPriceArriveRegionService {

	/**
	 * 插条记录
	 */
	void add(PriceRegionArriveEntity entity);
	 
	/**
	 * 更新条记录
	 */
	void update(PriceRegionArriveEntity entity);
	
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(PriceRegionArriveEntity entity);
