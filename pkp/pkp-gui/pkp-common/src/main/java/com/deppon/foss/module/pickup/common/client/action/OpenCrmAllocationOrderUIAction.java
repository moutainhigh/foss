 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/action/OpenCrmAllocationOrderUIAction.java
 * 
 * FILE NAME        	: OpenCrmAllocationOrderUIAction.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
/**
 * CRM 订单查询，单点登录访问如下页面
 *  http://192.168.13.36:8081/crm/order/allocationOrder.action
 * @author 102246-foss-shaohongliang
 * @date 2012-12-1 上午10:28:27
 */
public class OpenCrmAllocationOrderUIAction extends
		AbstractOpenUIAction<BrowserFrame>{
	/**
	 * 国际化
	 */
	private static final II18n i18n = I18nManager.getI18n(OpenCrmAllocationOrderUIAction.class);
	/**
	 * 序列化版本
	 */
	...
	public void openUIAction() {
		...
		//得到url  crm##/order/#!allocationOrder.action
		String urlValue = service.getUrl("crm","order/allocationOrder.action");
		try {
			ChromeBrowser browser = CefChromeBrowserManager.getChromeBrowser(urlValue,false);
        	editConfig = new EditorConfig();
    		editConfig.setTitle(i18n.get("foss.gui.common.openCrmAllocationOrderUIAction.waybillQueryCRM.label"));
