 ...
 */
public class ExpQueryConsignerDialog extends JDialog {
	
	/**
	 * 国际化
	 */
	private II18n i18n = I18nManager.getI18n(ExpQueryConsignerDialog.class);
	 ...
	 */
	public ExpQueryConsignerDialog(List<CustomerQueryConditionDto> contactList ) {
		// 传入运单开单界面对象
		...
		//Enter键监控
		ExpEnterKeyForQueryMobile enterTable=new ExpEnterKeyForQueryMobile(this);
...
//		tblConsigner.packAll();
	...
	public void setTableData(List<CustomerQueryConditionDto> contactList ) {
		...
		if(tblConsigner != null){
			...
			tableModel.setData(ExpCommonUtils.convertToMemberVo(contactList));
			// 刷新表格数据
	...
	private void init() {
		...
		lblCustomer.setFont(new Font("宋体", Font.BOLD, NumberConstants.NUMBER_12));
