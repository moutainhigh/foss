 ...
 * @version
 */
public interface IPriceRegionOrgAirService  extends IService {
	/**
	 * 插条记录
	 */
	void addPriceRegionOrgAirEntity(PriceRegionOrgAirEntity priceRegionOrgAirEntity);
	
	/**
	 * 更新条记录
	 */
	void updatePriceRegionOrgAirEntity(PriceRegionOrgAirEntity priceRegionOrgAirEntity);
	
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(PriceRegionOrgAirEntity riceRegionAirEntity);
}
