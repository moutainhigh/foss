...
public interface ISrvPriceArriveRegionOrgService {
	/**
	 * 插条记录
	 */
	void add(PriceRegionOrgArriveEntity entity);
	 
	/**
	 * 更新条记录
	 */
	void update(PriceRegionOrgArriveEntity entity);
	
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(PriceRegionOrgArriveEntity entity);
