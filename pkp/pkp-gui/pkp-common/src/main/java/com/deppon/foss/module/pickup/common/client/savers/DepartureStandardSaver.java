 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/savers/DepartureStandardSaver.java
 * 
 * FILE NAME        	: DepartureStandardSaver.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 *
 */
public class DepartureStandardSaver extends AbstractSyncDataSaver {
	/**
	 * 
	 * 功能：映射实体类
	...
	public Class<?> getSaveType() {
		return DepartureStandardEntity.class;
	}
	...
	public Date saveData(List<?> data) {
		Date date = null;
		List<DepartureStandardEntity> list = (List<DepartureStandardEntity>)data;
		long mxVersion = 0;
		if(list != null && !list.isEmpty()){
			DepartureStandardService sdService = DownLoadDataServiceFactory
					.getDepartureStandardService();
			for(DepartureStandardEntity ds: list){
				sdService.saveOrUpdate(ds);
