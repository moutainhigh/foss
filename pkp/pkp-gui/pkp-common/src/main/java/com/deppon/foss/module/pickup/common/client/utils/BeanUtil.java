 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/utils/BeanUtil.java
 * 
...
public class BeanUtil {
	...
	for (int i = 0; i < method1.length; i++) {
	    ...
	    methodFix1 = methodName1.substring(THREE, methodName1.length());
		...
		for (int j = 0; j < method2.length; j++) {
		    ...
		    methodFix2 = methodName2.substring(THREE, methodName2.length());
