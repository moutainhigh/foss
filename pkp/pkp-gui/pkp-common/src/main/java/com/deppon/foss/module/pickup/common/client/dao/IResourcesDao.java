 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/IResourcesDao.java
 * 
 * FILE NAME        	: IResourcesDao.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
public interface IResourcesDao {
	 ...
	 * @since:1.6
	 */
	boolean addResources(ResourceEntity resource);
