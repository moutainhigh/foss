 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IEffectiveRegionService.java
 * 
 * FILE NAME        	: IEffectiveRegionService.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * @version
 */
public interface IEffectiveRegionService {
	
	
	/**
	 * 插条记录
	 */
	void addEffectiveRegion(EffectiveRegionEntity effectiveRegion);
	 ...
	 * 新增或更新记录
	 */
	void saveOrUpdate(EffectiveRegionEntity effectiveRegion);
