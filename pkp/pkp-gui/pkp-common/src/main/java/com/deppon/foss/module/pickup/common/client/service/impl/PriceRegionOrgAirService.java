 ...
 *
 */
public class PriceRegionOrgAirService implements IPriceRegionOrgAirService {

	@Inject
	private IPriceRegionOrgAirDao priceRegionOrgAirDao;
	/**
	 * 
	 * 功能：插条记录
	 * @param: orgInfo
	 ...
	 */
	@Transactional
	public void addPriceRegionOrgAirEntity(PriceRegionOrgAirEntity e) {
		priceRegionOrgAirDao.addPriceRegionOrgAirEntity(e);
	...
	public void updatePriceRegionOrgAirEntity(PriceRegionOrgAirEntity e) {
		priceRegionOrgAirDao.updatePriceRegionOrgAirEntity(e);
	 ...
	 * @since:1.6
	 */
	public void saveOrUpdate(PriceRegionOrgAirEntity e) {
		if(!priceRegionOrgAirDao.addPriceRegionOrgAirEntity(e)){
			priceRegionOrgAirDao.updatePriceRegionOrgAirEntity(e);
		}
	}
}
