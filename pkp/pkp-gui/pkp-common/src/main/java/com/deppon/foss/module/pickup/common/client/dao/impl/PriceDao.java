 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/impl/PriceDao.java
 * 
 * FILE NAME        	: PriceDao.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
public class PriceDao implements IPriceDao {
	 ...
	 * 名称空间
	 */
	private static final String NAMESPACE = "foss.pkp.PriceEntityMapper.";
	/**
	 * 数据库连接
	 */
	...
	public boolean addPrice(PriceEntity price) {
		...
		if(ObjectUtils.NULL.equals(ObjectUtils.defaultIfNull(
				id, ObjectUtils.NULL))){
			sqlSession.insert( NAMESPACE + "insertSelective", price);
			return true;
		}else{
			return false;
		}
	...
	public void updatePrice(PriceEntity price) {
		sqlSession.update( NAMESPACE + "updateByPrimaryKeySelective", price);
	}
