 ...
 *
 */
public class PriceRegionAirDao implements IPriceRegionAirDao {
	/**
	 * 名称空间
	 */
	private static final String NAMESPACE = "foss.pkp.PriceRegionAirEntityMapper.";
	/**
	 * 数据库连接
	 */
	 ...
	 * @since:1.6
	 */
	public boolean addPriceRegionAirEntity(PriceRegionAirEntity e) {
