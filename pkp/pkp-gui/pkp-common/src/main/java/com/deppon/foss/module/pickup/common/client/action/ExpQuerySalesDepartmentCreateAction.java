 ...
 */
public class ExpQuerySalesDepartmentCreateAction implements IButtonActionListener<ExpQueryPublishPriceUI> {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			if (entity != null) {
				...
				ui.getTxtCreateOrgCode().setText(entity.getCode());
				// 收货部门名称
				bean.setCreateOrgName(entity.getName());
				ui.getTxtCreateOrgName().setText(entity.getName());
