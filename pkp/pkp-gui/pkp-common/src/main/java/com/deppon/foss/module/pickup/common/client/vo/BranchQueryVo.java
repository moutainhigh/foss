...
public class BranchQueryVo {
	 ...
	 * 精准大票卡航
	 */
	private Boolean chbBGFLF;
	/**
	 * 精准大票汽运(长)
	 */
	private Boolean chbBGLRF;
	/**
	 * 精准大票城运
	 */
	private Boolean chbBGFSF;
	/**
	 *精准大票汽运(短)
	 */
	private Boolean chbBGSRF;
	/**
	 * 门对门
	 */
	private Boolean chbDTD;
	/**
	 * 场对场
	 */
	private Boolean chbYTY;
	/**
	 * 自提区域
	 */
	...
	//是否精准大票
	private Boolean isBigGoods;
	
	public Boolean getChbDTD() {
		return chbDTD;
	}

	public void setChbDTD(Boolean chbDTD) {
		this.chbDTD = chbDTD;
	}

	public Boolean getChbYTY() {
		return chbYTY;
	}

	public void setChbYTY(Boolean chbYTY) {
		this.chbYTY = chbYTY;
	}
	...
	public Boolean getChbBGFLF() {
		return chbBGFLF;
	}

	public void setChbBGFLF(Boolean chbBGFLF) {
		this.chbBGFLF = chbBGFLF;
	}

	public Boolean getChbBGLRF() {
		return chbBGLRF;
	}

	public void setChbBGLRF(Boolean chbBGLRF) {
		this.chbBGLRF = chbBGLRF;
	}

	public Boolean getChbBGFSF() {
		return chbBGFSF;
	}

	public void setChbBGFSF(Boolean chbBGFSF) {
		this.chbBGFSF = chbBGFSF;
	}

	public Boolean getChbBGSRF() {
		return chbBGSRF;
	}

	public void setChbBGSRF(Boolean chbBGSRF) {
		this.chbBGSRF = chbBGSRF;
	}
	...
	public Boolean getChbPCP() {
		return chbPCP;
	}

	public void setChbPCP(Boolean chbPCP) {
		this.chbPCP = chbPCP;
	}
