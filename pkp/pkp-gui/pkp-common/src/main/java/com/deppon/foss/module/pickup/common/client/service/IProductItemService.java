 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IProductItemService.java
 * 
...
public interface IProductItemService {
	 ...
	 * 插条记录
	 */
	void addProductItem(ProductItemEntity productItem);
	/**
	 * 更新条记录
	 */
	 ...
	 * 新增或更新记录
	 */
	void saveOrUpdate(ProductItemEntity productItem);
	/**
	 * @param productItem
	 */
