 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/savers/SrvMarketingEventChannelSaver.java
 * 
 * FILE NAME        	: SrvMarketingEventChannelSaver.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SrvMarketingEventChannelSaver extends AbstractSyncDataSaver {
	/**
	 * 
	 * 功能：映射实体类
	...
	public Class<?> getSaveType() {
		return MarketingEventChannelEntity.class;
	}
	...
	public Date saveData(List<?> data) {
		Date date = null;
		List<MarketingEventChannelEntity> list = (List<MarketingEventChannelEntity>)data;
		long mxVersion = 0;
		if(list != null && !list.isEmpty()){
			MarketingEventChannelService marketingEventChannelService = DownLoadDataServiceFactory
					.getMarketingEventChannelService();
			for(MarketingEventChannelEntity marketingEventChannel: list){
				marketingEventChannelService.saveOrUpdate(marketingEventChannel);
				Long version = marketingEventChannel.getVersionNo();
				//获得最大版本号
