 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/IMarketingEventDao.java
 * 
...
public interface IMarketingEventDao {
	 ...
	 * @since:1.6
	 */
	boolean addMarketingEvent(MarketingEventEntity marketingEvent);
	 ...
	 * @since:1.6
	 */
	void updateMakEventInOrg(MarketingEventEntity marketingEvent);
