 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/impl/PriceRuleService.java
 * 
...
public class PriceRuleService implements IPriceRuleService {
	...
	@Transactional
	@Override
	public void addPriceRule(PriceRuleEntity priceRule) {
		priceRuleDao.addPriceRule(priceRule);
	...
	public void updatePriceRule(PriceRuleEntity priceRule) {
		priceRuleDao.updatePriceRule(priceRule);
	}
	 ...
	 */
	@Override
	public void saveOrUpdate(PriceRuleEntity priceRule) {
		if(!priceRuleDao.addPriceRule(priceRule)){
			priceRuleDao.updatePriceRule(priceRule);
		}
	}
