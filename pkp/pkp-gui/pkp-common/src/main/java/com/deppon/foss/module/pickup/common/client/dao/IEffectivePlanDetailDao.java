 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/IEffectivePlanDetailDao.java
 * 
...
public interface IEffectivePlanDetailDao {
	 ...
	 * @since:1.6
	 */
	boolean addEffectivePlanDetail(EffectivePlanDetailEntity effectivePlanDetail);
