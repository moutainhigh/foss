 ...
 */
public class QuerySalesDepartmentTargetAction implements IButtonActionListener<QueryPublishPriceUI> {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			SalesDepartmentDialog dialog = new SalesDepartmentDialog(false, "all",true);
			// 剧中显示弹出窗口
