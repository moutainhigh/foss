 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/impl/BusinessPartnerService.java
 * 
 * FILE NAME        	: BusinessPartnerService.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
public class BusinessPartnerService implements IBusinessPartnerService {
	...
	@Inject
	IBusinessPartnerDao businessPartnerDao;
	...
	@Transactional
	@Override
	public void addBusinessPartner(BusinessPartnerEntity businessPartner) {
		businessPartnerDao.addBusinessPartner(businessPartner);
	...
	public void updateBusinessPartner(BusinessPartnerEntity businessPartner) {
		businessPartnerDao.updateBusinessPartner(businessPartner);
	 ...
	 */
	@Override
	public void saveOrUpdate(BusinessPartnerEntity businessPartner) {
		if(!businessPartnerDao.addBusinessPartner(businessPartner))	{
			businessPartnerDao.updateBusinessPartner(businessPartner);
		}
	}
