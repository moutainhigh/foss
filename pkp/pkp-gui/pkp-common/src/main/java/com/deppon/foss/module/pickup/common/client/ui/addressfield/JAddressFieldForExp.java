...
import com.deppon.foss.module.pickup.common.client.ui.addressfield.popup.AddressSelecterExtenderForExp;
 ...
 * @version
 */
public class JAddressFieldForExp extends JTextField{
	/**
	 * 11
	 */
	 ...
	 * 焦点选中弹出框扩展
	 */
	private AddressSelecterExtenderForExp addressSelecterExtender; 
	...
	private void setPopupSelecter() {
		// 弹出选择器
		addressSelecterExtender = new AddressSelecterExtenderForExp(this,hotCityList, provinceList);
