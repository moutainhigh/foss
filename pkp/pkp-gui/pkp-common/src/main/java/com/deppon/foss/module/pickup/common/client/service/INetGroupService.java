 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/INetGroupService.java
 * 
...
public interface INetGroupService {
     ...
     * 插条记录
     */
	void addNetGroup(NetGroupEntity netGroup);
	/**
	 * 更新条记录
	 */
	 ...
	 * 新增或更新记录
	 */
	void saveOrUpdate(NetGroupEntity netGroup);
	/**
