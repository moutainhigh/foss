 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/savers/SrvPriceRuleSaver.java
 * 
 * FILE NAME        	: SrvPriceRuleSaver.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SrvPriceRuleSaver extends AbstractSyncDataSaver {
	...
	public Date saveData(List<?> data) {
		Date date = null;
		List<PriceRuleEntity> list = (List<PriceRuleEntity>)data;
		long mxVersion = 0;
		if(list != null && !list.isEmpty()){
			PriceRuleService priceRuleService = DownLoadDataServiceFactory
					.getPriceRuleService();
			for(PriceRuleEntity priceRule : list){
				priceRuleService.saveOrUpdate(priceRule);
				Long version = priceRule.getVersionNo();
				//获得最大版本号
