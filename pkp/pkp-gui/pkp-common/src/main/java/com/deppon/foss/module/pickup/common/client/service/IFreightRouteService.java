 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IFreightRouteService.java
 * 
 ...
 */
public interface IFreightRouteService {
	
	
	/**
	 * 插条记录
	 */
	void addFreightRoute(FreightRouteEntity freightRoute);
	 ...
	 * 新增或更新记录
	 */
	void saveOrUpdate(FreightRouteEntity freightRoute);
	/**
	 * 删除
