 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IPricePlanService.java
 * 
...
public interface IPricePlanService {
	 ...
	 * 插条记录
	 */
	void addPricePlan(PricePlanEntity pricePlan);
	 
	/**
	 * 更新条记录
	 */
	void updatePricePlan(PricePlanEntity pricePlan);
	
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(PricePlanEntity pricePlan);
