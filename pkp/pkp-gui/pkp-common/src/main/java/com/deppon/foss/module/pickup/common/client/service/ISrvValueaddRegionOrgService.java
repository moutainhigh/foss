 ...
 * 
 */
public interface ISrvValueaddRegionOrgService {
	
	/**
	 * 插条记录
	 */
	void add(PriceRegionOrgValueAddEntity entity);
	 
	/**
	 * 更新条记录
	 */
	void update(PriceRegionOrgValueAddEntity entity);
	
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(PriceRegionOrgValueAddEntity entity);
