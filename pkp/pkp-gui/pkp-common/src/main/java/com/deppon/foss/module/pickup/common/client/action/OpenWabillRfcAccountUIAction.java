 ...
 */
public class OpenWabillRfcAccountUIAction extends AbstractOpenUIAction<BrowserFrame>{
	/**
	 * 国际化
	 */
	private static final II18n i18n = I18nManager.getI18n(OpenWabillRfcAccountUIAction.class);
	/**
	 * 序列化版本
	 */
	...
	public void openUIAction() {
		...
		String urlValue = "http://"+ip+"/pkp-deliver-web/waybill/waybillRfcAccountIndex_include.action"
		...
		try {
			...
			editConfig.setTitle(i18n.get("foss.gui.common.openPublicPriceUIAction.setTitle.account.rfc"));
