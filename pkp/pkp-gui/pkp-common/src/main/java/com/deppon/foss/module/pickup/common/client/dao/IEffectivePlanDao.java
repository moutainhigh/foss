 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/IEffectivePlanDao.java
 * 
...
public interface IEffectivePlanDao {
	 ...
	 * @since:1.6
	 */
	boolean addEffective(EffectivePlanEntity effective);
	 ...
	 * @since:1.6
	 */
	void updateEffectivePlan(EffectivePlanEntity effective);
