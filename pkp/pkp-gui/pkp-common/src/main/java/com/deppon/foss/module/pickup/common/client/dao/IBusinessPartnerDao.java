 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/IBusinessPartnerDao.java
 * 
 * FILE NAME        	: IBusinessPartnerDao.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public interface IBusinessPartnerDao {
	 ...
	 * @since:1.6
	 */
	boolean addBusinessPartner(BusinessPartnerEntity businessPartner);
