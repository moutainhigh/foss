 ...
 *
 */
public class ExpAddressSelecterExtender {
	/**
	 * 国际化
	 */
	private II18n i18n = I18nManager.getI18n(ExpAddressSelecterExtender.class);
    /**
     * 绑定的文本组件
     */
    ...
    //在线查询  zxy 20140428 DEFECT-2741 MANA-2018 
  	IAddressServiceHessianRemoting onlineAddressService;
    
    public ExpAddressSelecterExtender(JTextComponent textComponent, List<AddressFieldDto> hotCityEntityData, List<AddressFieldDto> provinceEntityData) {
	...
	private void commitValue(AddressFieldDto value) {
		textComponent.setText(value.getCityName());
    ...
    private final CommitListener provinceEntityClickListener = new CommitListener() {
    	...
    	public void commit(AddressFieldDto value) {
    		...
    		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
    			...
    			addressService.queryCityListByProvinceId(value.getProvinceId());
    		}
