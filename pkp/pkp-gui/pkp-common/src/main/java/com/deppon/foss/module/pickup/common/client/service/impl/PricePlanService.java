 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/impl/PricePlanService.java
 * 
...
public class PricePlanService implements IPricePlanService {
	...
	@Transactional
	@Override
	public void addPricePlan(PricePlanEntity pricePlan) {
		pricePlanDao.addPricePlan(pricePlan);
	 ...
	 */
	@Override
	public void saveOrUpdate(PricePlanEntity pricePlan) {
		if(!pricePlanDao.addPricePlan(pricePlan)){
			pricePlanDao.updatePricePlan(pricePlan);
		}
	...
	public void deleteByRegionID(String regionID) {
		pricePlanDao.deleteByRegionID(regionID);
	}
