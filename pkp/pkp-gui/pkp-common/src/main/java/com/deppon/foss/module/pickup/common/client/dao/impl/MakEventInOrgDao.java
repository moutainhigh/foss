 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/impl/MakEventInOrgDao.java
 * 
 * FILE NAME        	: MakEventInOrgDao.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class MakEventInOrgDao implements IMakEventInOrgDao {
	/**
	 * 名称空间
	 */
	 ...
	 * @since:1.6
	 */
	public boolean addMakEventInOrg(MakEventInOrgEntity makEventInOrg) {
		Map<String, String> map = new HashMap<String, String>();
		map.put("id", makEventInOrg.getId());
		String id = sqlSession.selectOne(NAMESPACE + "selectById", map);
		if(ObjectUtils.NULL.equals(ObjectUtils.defaultIfNull(
				id, ObjectUtils.NULL))){
			sqlSession.insert( NAMESPACE + "insertSelective", makEventInOrg);
			return true;
		}else{
			return false;
		}
	...
	public void updateMakEventInOrg(MakEventInOrgEntity makEventInOrg) {
		sqlSession.update( NAMESPACE + "updateByPrimaryKeySelective", makEventInOrg);
	}
