 ...
 */
public class AddressSelecterExtenderForExp {
	 ...
	 * 国际化
	 */
	private II18n i18n = I18nManager.getI18n(AddressSelecterExtenderForExp.class);
    /**
     * 绑定的文本组件
     */
    ...
    private LinkedGridPanel hotCityEntityPanel;
    ...
    private LinkedPageGridPanel villageTownEntityPanel;
    private CommitListener commitListener;
    private IAddressService addressService;
    //在线查询
	IAddressServiceHessianRemoting onlineAddressService;
    
    public AddressSelecterExtenderForExp(JTextComponent textComponent, List<AddressFieldDto> hotCityEntityData, List<AddressFieldDto> provinceEntityData) {
    ...
    private synchronized void initResultTab() {
        ...
        hotCityEntityPanel = new LinkedGridPanel(hotCityEntityData, hotCityEntityClickListener);
        ...
        villageTownEntityPanel=new LinkedPageGridPanel(null,villageTownEntityClickListener);
        ...
        String villageTown=i18n.get("foss.gui.common.AddressSelecterExtender.addressTab.villageTown");
        ...
        resultTab.add("<html><body><table align=center width='80'>"+ villageTown +"</table></body></html>", villageTownEntityPanel);
        // 允许提示框
...
//        originalEditText = textComponent.getText();
	...
	private void commitValue(AddressFieldDto value) {
		if("跳过".equals(value.getVillageTownName())){
			textComponent.setText(value.getProvinceName()+"-"+value.getCityName()+"-"+value.getCountyName());
			value.setVillageTownName("");
		}else{			
			textComponent.setText(value.getProvinceName()+"-"+value.getCityName()+"-"+value.getCountyName()+"-"+value.getVillageTownName());
		}
    ...
    private final CommitListener countyEntityClickListener = new CommitListener() {
    	...
    	public void commit(AddressFieldDto value) {
    		...
    		List<AddressFieldDto> countyEntitys = null;
    		AddressFieldDto other=new AddressFieldDto();  		 		
    		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
    			//在线查询
    			countyEntitys = onlineAddressService.queryCountyListByCountyId(value.getCountyId());
    		} else {
    			//离线查询
    			countyEntitys = addressService.queryCountyListByCountyId(value.getCountyId());
    		}
    		//把查出来的值赋给其他，用于跳过不需要选择乡镇 
    		other=value;
    		other.setVillageTownName("跳过");  
    		other.setVillageTownId("");
    		other.setDegree(4);   			
    		countyEntitys.add(0,other);    	
    		villageTownEntityPanel.setData(countyEntitys);
    	}    	
    };
     ...
     */
    private final CommitListener villageTownEntityClickListener = new CommitListener() {
    	@Override
    	public void commit(AddressFieldDto value) {
    		//切至区域选择页签
    		hidePopup();
