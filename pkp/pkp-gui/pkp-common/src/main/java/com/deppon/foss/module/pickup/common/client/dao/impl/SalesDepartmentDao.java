 ...
 *
 */
public class SalesDepartmentDao implements ISalesDepartmentDao {
	/**
	 * 名称空间
	 */
	private static final String NAMESPACE = "pkp.salesDepartmentMapper.";
	/**
	 * 数据库连接
	 */
	...
	public int insert(SaleDepartmentEntity record) {
		return sqlSession.insert(NAMESPACE + "insertSalesDept", record);
	}
	...
	public boolean insertSelective(SaleDepartmentEntity record) {
		...
		if(ObjectUtils.NULL.equals(ObjectUtils.defaultIfNull(
				id, ObjectUtils.NULL))){
		sqlSession.insert(NAMESPACE + "insertSalesDeptSelective", record);
			return true;
		}else{
			return false;
		}
	...
	public SaleDepartmentEntity queryByPrimaryKey(String id) {
		return sqlSession.selectOne(NAMESPACE + "selectSalesDeptByPrimaryKey",id);
	}
	...
	public SaleDepartmentEntity queryByCode(String code) {
		List<SaleDepartmentEntity> list = sqlSession.selectList(NAMESPACE + "selectSalesDeptByCode", code);
	...
	public int updateByPrimaryKeySelective(SaleDepartmentEntity record) {
		return sqlSession.update(NAMESPACE + "updateSalesDeptByPrimaryKey",record);
	}
	...
	public int updateByPrimaryKey(SaleDepartmentEntity record) {
		return sqlSession.update(NAMESPACE+ "updateSalesDeptByPrimaryKeySelective", record);
	}
	...
	public List<SaleDepartmentEntity> queryByDepartmentInfo(QueryPickupPointDto dto) {
		if(CommonUtils.directDetermineIsExpressByProductCode(dto.getTransType())){
			return sqlSession.selectList(NAMESPACE + "selectPickupStationInfoLocalPackage", dto);
		}else{
			return sqlSession.selectList(NAMESPACE + "selectPickupStationInfoLocal", dto);
		}
	...
	public List<SaleDepartmentEntity> querySaleDepartmentExactByEntity(
		...
		return sqlSession.selectList(NAMESPACE+ "querySaleDepartmentExactByEntity", queryEntity, rowBounds);
	}
...
//	}
	...
	public void delete(SaleDepartmentEntity saleDepartment) {
		sqlSession.delete(NAMESPACE + "delete", saleDepartment);
	}

	@Override
	public List<BranchQueryVo> queryListByDepartment(SaleDepartmentEntity entity) {
		return sqlSession.selectList(NAMESPACE +"queryListByDepartment",entity);
	}
    ...
    public SaleDepartmentEntity queryDepartmentInfoByDto(QueryPickupPointDto dto2){
		List<SaleDepartmentEntity> list = sqlSession.selectList(NAMESPACE + "queryDepartmentInfoByDto", dto2);
	...
	@Override
 	public List<SalesBillingGroupEntity> querySalesBillGroupByCodeAndBillCode(String code,String billingGroup){
		...
		return sqlSession.selectList(NAMESPACE + "querySalesBillGroupByCodeAndBillCode", map);		
	}
	...
	public List<SaleDepartmentEntity> queryByDepartmentInfoVirtual(
		...
		return sqlSession.selectList(NAMESPACE + "selectPickupStationInfoVirtualLocal", dto);
	}
    ...
    public int queryCountByCodeAndProduct(SalesProductEntity entity){
		return (Integer)sqlSession.selectOne(NAMESPACE + "queryCountByCodeAndProduct", entity);
	}
}