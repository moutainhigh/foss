 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/dao/impl/GoodsTypeDao.java
 * 
...
public class GoodsTypeDao implements IGoodsTypeDao {
	 ...
	 * 名称空间
	 */
	private static final String NAMESPACE = "foss.pkp.GoodsTypeEntityMapper.";
	/**
	 * 数据库连接
	 */
	 ...
	 * @since:1.6
	 */
	public boolean addGoodsType(GoodsTypeEntity goodsType) {
		...
		if(ObjectUtils.NULL.equals(ObjectUtils.defaultIfNull(
				id, ObjectUtils.NULL))){
			sqlSession.insert( NAMESPACE + "insertSelective", goodsType);
			return true;
		}else{
			return false;
		}
	...
	public void updateGoodsType(GoodsTypeEntity goodsType) {
		sqlSession.update( NAMESPACE + "updateByPrimaryKeySelective", goodsType); 
	}
