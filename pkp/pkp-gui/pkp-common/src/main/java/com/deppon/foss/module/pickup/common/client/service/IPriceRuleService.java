 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IPriceRuleService.java
 * 
...
public interface IPriceRuleService {
	 ...
	 * 插条记录
	 */
	void addPriceRule(PriceRuleEntity priceRule);
	/**
	 * 更新条记录
	 */
	 ...
	 * 新增或更新记录
	 */
	void saveOrUpdate(PriceRuleEntity priceRule);
}