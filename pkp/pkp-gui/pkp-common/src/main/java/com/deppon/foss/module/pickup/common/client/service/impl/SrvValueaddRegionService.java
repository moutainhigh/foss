...
/**
 * 
 * @ClassName: ISrvValueaddRegionService
 * 
 ...
 * 
 * @date 2013-10-8 上午11:32:33
 * 
 * 
 */
public class SrvValueaddRegionService implements ISrvValueaddRegionService {

	@Inject
	private IRegionValueAddDao regionValueAddDao;
	
	@Override
	public void add(PriceRegionValueAddEntity entity) {
		regionValueAddDao.addRegion(entity);
	}

	@Override
	public void update(PriceRegionValueAddEntity entity) {
		regionValueAddDao.updateRegion(entity);
	}

	@Override
	public void saveOrUpdate(PriceRegionValueAddEntity entity) {
		if(!regionValueAddDao.addRegion(entity)){
			regionValueAddDao.updateRegion(entity);
		}
	}
