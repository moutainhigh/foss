...
public class IntelligenceBillTimeGather implements Serializable{
	...
	/**
	 * uid  序列号实体  20160531  278328  胡金洋添加
	 */
	private static final long serialVersionUID = 1L;

	//第一次点击图片旋转
	private Date rotatePicture;
	
	//第一次点击图片扩大
	private Date magnificationPicture;
	...
	public Double getCombPaymentModeTime() {
		return combPaymentModeTime==null?0:combPaymentModeTime;
	}
	...
	public Date getRotatePicture() {
		return rotatePicture;
	}

	public void setRotatePicture(Date rotatePicture) {
		this.rotatePicture = rotatePicture;
	}

	public Date getMagnificationPicture() {
		return magnificationPicture;
	}

	public void setMagnificationPicture(Date magnificationPicture) {
		this.magnificationPicture = magnificationPicture;
	}
}
