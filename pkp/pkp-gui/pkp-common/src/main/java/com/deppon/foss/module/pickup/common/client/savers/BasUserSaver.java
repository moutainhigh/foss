 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/savers/BasUserSaver.java
 * 
 * FILE NAME        	: BasUserSaver.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class BasUserSaver extends AbstractSyncDataSaver {
	/**
	 * 
	 * 功能：映射实体类
	...
	public Date saveData(List<?> data) {
		...
		if(list != null && !list.isEmpty()){
			UserService userService = DownLoadDataServiceFactory
					.getUserService();
