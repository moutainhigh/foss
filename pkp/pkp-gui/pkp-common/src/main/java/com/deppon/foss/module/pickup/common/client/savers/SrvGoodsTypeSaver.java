 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/savers/SrvGoodsTypeSaver.java
 * 
 * FILE NAME        	: SrvGoodsTypeSaver.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class SrvGoodsTypeSaver extends AbstractSyncDataSaver {
	/**
	 * 
	 * 功能：映射实体类
	...
	public Date saveData(List<?> data) {
		Date date = null;
		List<GoodsTypeEntity> list = (List<GoodsTypeEntity>)data;
		long mxVersion = 0;
		if(list != null && !list.isEmpty()){
			GoodsTypeService goodsTypeService = DownLoadDataServiceFactory
					.getGoodsTypeService();
