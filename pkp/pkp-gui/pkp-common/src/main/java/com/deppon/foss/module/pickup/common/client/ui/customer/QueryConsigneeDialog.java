 ...
 */
public class QueryConsigneeDialog extends JDialog {
	 ...
	 * 国际化
	 */
	private II18n i18n = I18nManager.getI18n(QueryConsigneeDialog.class);
	/**
	 * 序列化标识
	 */
	 ...
	 */
	public QueryConsigneeDialog(List<CustomerQueryConditionDto> contactList) {
		// 传入运单开单界面对象
	...
	private class CustomerDetailTableModel extends DefaultTableModel{
		...
		public String getColumnName(int column) {
			switch (column) {
			case 0:
				return i18n.get("foss.gui.common.queryConsigneeDialog.columnName.contact");
			case 1:
