 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/common/client/service/IEffectivePlanDetailService.java
 * 
 ...
 * @version
 */
public interface IEffectivePlanDetailService {

    /**
     * 插条记录
     */
    void addEffectivePlanDetail(
     ...
     * 插条记录
     */
    void updateEffectivePlanDetail(
	    EffectivePlanDetailEntity effectivePlanDetail);

    /**
     * 新增或更新记录
     */
    void saveOrUpdate(EffectivePlanDetailEntity effectivePlanDetail);
