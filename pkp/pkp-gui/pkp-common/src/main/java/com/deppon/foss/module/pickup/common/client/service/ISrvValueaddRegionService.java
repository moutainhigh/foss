 ...
 * 
 */
public interface ISrvValueaddRegionService {
	
	/**
	 * 插条记录
	 */
	void add(PriceRegionValueAddEntity entity);
	 
	/**
	 * 更新条记录
	 */
	void update(PriceRegionValueAddEntity entity);
	
	/**
	 * 新增或更新记录
	 */
	void saveOrUpdate(PriceRegionValueAddEntity entity);
