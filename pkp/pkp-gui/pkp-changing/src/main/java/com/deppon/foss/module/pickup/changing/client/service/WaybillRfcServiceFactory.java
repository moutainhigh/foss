 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/service/WaybillRfcServiceFactory.java
 * 
...
public class WaybillRfcServiceFactory {
	...
	/**
	 * 获取 更改单远程服务接口类
	 * @Title:        getWaybillRfcRemotingService 
	 * @param:        @return    
	 * @return:       IWaybillRfcRemotingService    
	 * @author        355673 chenpeng
	 * @Date          2016-11-26 上午11:26:28 
	 * @throws
	 */
	public static IWaybillRfcRemotingService getWaybillRfcRemotingService(){
		Injector injector = GuiceContextFactroy.getInjector();
		return injector.getInstance(IWaybillRfcRemotingService.class);
	}
}