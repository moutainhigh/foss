 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/ConsigneePanel.java
 * 
...
import com.deppon.foss.module.pickup.changing.client.action.QueryConsigneeAction;
import com.deppon.foss.module.pickup.changing.client.action.QueryConsigneeDeptAction;
...
public class ConsigneePanel extends JPanel {
	 ...
	 */
	private void init() {
		setBorder(new JDTitledBorder(i18n.get("pickup.changing.consigneePanel")));
		...
		JLabel lblConsigneeMobile = new JLabel(i18n.get("pickup.changing.mobile"));
		...
		JLabel lblConsigneePhone = new JLabel(i18n.get("pickup.changing.phone"));
		...
		JLabel label = new JLabel(i18n.get("pickup.changing.consignerName"));
		add(label,"10, 1");
		...
		add(lblCustomerCode, "14, 1, right, default");
		...
		lblConsigneeLinkMan = new JLabel(i18n.get("pickup.changing.consigneeLinkMan"));
		...
		JLabel lblConsigneeAddress = new JLabel(i18n.get("pickup.changing.consigneeAddress"));
		add(lblConsigneeAddress, "6, 3, right, default");

		txtConsigneeArea = new JAddressField(i18n.get("foss.gui.changing.consigneePanel.consigneeArea.textFieldTip"));
		...
		add(txtConsigneeAddressNote, "13, 3, 2, 1, fill, default");
