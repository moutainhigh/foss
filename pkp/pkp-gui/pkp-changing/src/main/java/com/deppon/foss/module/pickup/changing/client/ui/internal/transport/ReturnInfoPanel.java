 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/transport/ReturnInfoPanel.java
 * 
...
public class ReturnInfoPanel extends JPanel {
	...
	private void init() {
		...
		//返货运输性质：
		JLabel lblReturnProductType = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnProductType.label")+"：");
		...
		//返货提货方式：
		JLabel lblNewLabel2 = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnPickMode.label")+"：");
		...
		//返货目的站：
		JLabel lblReturnDestination = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnDestination.label")+"：");
		...
		//返货提货网点：
		JLabel lblReturnPickBranch = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnPickBranch.label")+"：");
		...
		//返货计费类型：
		JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnBillingType.label")+"：");
		...
		//返货费率：
		JLabel lblNewLabel1 = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnUnitPrice.label")+"：");
		...
		//返货费：
		JLabel label = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnFee.label")+"：");
