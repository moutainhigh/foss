 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/action/OpenWaybillRFCCheckUIAction.java
 * 
...
public class OpenWaybillRFCCheckUIAction extends
	...
	public void openUIAction() {
		...
		editConfig.setTitle(i18n.get("pickup.changing.waybillRfcCheck"));//??
		editConfig.setPluginId("com.deppon.foss.module.pkp-changing");
		application
				.openEditorAndRetrun(editConfig,
						"com.deppon.foss.module.pickup.changing.client.ui.WaybillRFCCheckUI");
