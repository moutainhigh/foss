 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/transport/ReturnRecordPanel.java
 * 
...
public class ReturnRecordPanel extends JPanel {
	...
	private class ReturnRecordTableModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			...
			case 0:
				//返货提货方式
				return i18n.get("foss.gui.changing.transportInfoPanel.returnPickMode.label");
			case 1:
				//返货目的站
				return i18n.get("foss.gui.changing.transportInfoPanel.returnDestination.label");
			case 2:
				//返货提货网点
				return i18n.get("foss.gui.changing.transportInfoPanel.returnPickBranch.label");
			case THREE:
				//返货运输性质
				return i18n.get("foss.gui.changing.transportInfoPanel.returnProductType.label");
			case FOUR:
				//返货计费类型
				return i18n.get("foss.gui.changing.transportInfoPanel.returnBillingType.label");
			case FIVE:
				//返货费率
				return i18n.get("foss.gui.changing.transportInfoPanel.returnUnitPrice.label");
			case SIX:
				//返货费
				return i18n.get("foss.gui.changing.transportInfoPanel.returnFee.label");
			default:
				return "";
			}
		}
