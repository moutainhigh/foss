 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/transport/ReturnTabPanel.java
 * 
...
public class ReturnTabPanel extends JTabbedPane implements ITransterInject{
	...
	private void init() {
		...
		//返货信息
		addTab(i18n.get("foss.gui.changing.returnInfoPanel.title.label"), null, returnInfoPanel, null);
		//返货记录
		addTab(i18n.get("foss.gui.changing.returnRecordPanel.title.label"), null, returnRecordPanel, null);
	}
