 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/dialog/InnerPickupSalesDepartmentDialog.java
 * 
...
public class InnerPickupSalesDepartmentDialog extends JDialog {
	...
	private void init()
	{
		...
		{
			//部门名称
			JLabel lblNewLabel = new JLabel(i18n.get("foss.gui.changing.innerPickupSalesDepartmentDialog.salesDepartmentName.label")+"：");
		...
		{
			btnNewButton = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.query"));
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					String name = txtSalesDepartmentName.getText();
					if(name == null || "".equals(name))
					{
						MsgBox.showInfo(i18n.get("foss.gui.changing.innerPickupSalesDepartmentDialog.msgbox.query"));
					}else
					{
//						setData(waybillRfcService.querySaleDepartmentByName(name));
		...
		}
		{
			...
			{
				JButton okButton = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.confirm"));
...
//				getRootPane().setDefaultButton(okButton);
			...
			{
				JButton cancelButton = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.cancel"));
...
//					saleDepartmentEntity = list.get(row);
	...
	public class SaleDepartmentModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			switch (column) {
			case 0:
				return i18n.get("foss.gui.changing.innerPickupSalesDepartmentDialog.column.one");
			case 1:
				return i18n.get("foss.gui.changing.innerPickupSalesDepartmentDialog.column.two");
			default:
				return "";
			}
		}
