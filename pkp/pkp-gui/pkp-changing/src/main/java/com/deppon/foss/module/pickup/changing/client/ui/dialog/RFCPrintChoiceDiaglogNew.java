 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/dialog/RFCPrintChoiceDiaglogNew.java
 * 
...
import com.deppon.foss.module.pickup.changing.client.action.CloseDialogAction;
import com.deppon.foss.module.pickup.changing.client.action.PrintModifyWaybillAction;
...
public class RFCPrintChoiceDiaglogNew extends JDialog {
	...
	private void init() {
		setModal(true);
		//"模板选择"
		setTitle(i18n.get("foss.gui.changing.rfcPrintChoiceDialog.title"));
		...
		list.setModel(new AbstractListModel() {
			...
			//变更单表格打印\ 变更单套打
			String[] values = new String[] { i18n.get("foss.gui.changing.rfcPrintChoiceDialog.element.one"), 
					i18n.get("foss.gui.changing.rfcPrintChoiceDialog.element.two") };
		...
		btnNewButton = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.confirm"));
		panel.add(btnNewButton, "3, 4");

		btnNewButton1 = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.cancel"));
