 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/BillingPayBelongPanel.java
 * 
...
public class BillingPayBelongPanel extends JPanel {
	...
	public BillingPayBelongPanel() {
		...
		box.add(Box.createHorizontalStrut(NumberConstants.NUMBER_12));
		...
		//约车报价
		lblWholeVehicleAppfee = new JLabel(i18n.get("foss.gui.changing.billingPayBelongPanel.wholeVehicleAppfee.label")+"：");
		...
		//公布价运费
		lblPublicCharge = new JLabel(i18n.get("foss.gui.changing.billingPayBelongPanel.publicCharge.label")+"：");
