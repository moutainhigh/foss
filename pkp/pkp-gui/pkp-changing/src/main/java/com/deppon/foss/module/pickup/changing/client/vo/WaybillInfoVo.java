 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/vo/WaybillInfoVo.java
 * 
...
public class WaybillInfoVo extends WaybillPanelVo {
	 ...
	 * 标示自提件是否可编辑
	 */
	private String flagEconomyEdit;	
	
	public String getFlagEconomyEdit() {
		return flagEconomyEdit;
	}

	public void setFlagEconomyEdit(String flagEconomyEdit) {
		this.flagEconomyEdit = flagEconomyEdit;
	}

	/**
	 * 是否累加了折扣
	 */
	private String isFlagAddDiscount; 
	
	public String getIsFlagAddDiscount() {
		return isFlagAddDiscount;
	}

	
	public void setIsFlagAddDiscount(String isFlagAddDiscount) {
		this.isFlagAddDiscount = isFlagAddDiscount;
	}

	/**
	 * 标记是否累加过中转费
	 */
	private String isFlagAddZZF;
	
	public String getIsFlagAddZZF() {
		return isFlagAddZZF;
	}
	
	public void setIsFlagAddZZF(String isFlagAddZZF) {
		this.isFlagAddZZF = isFlagAddZZF;
	}
	 ...
	 * 客户变更原因类型
	 */
	private DataDictionaryValueVo rfcCustomerReason;
	/**
	 * 起草部门
	 */
	 ...
	 *接货费是否来自客户合同 
	 */
	private  boolean isPickUpFeeFromCustomer;
	/**
	 * 预配航班
	 */
	...
	public void setTransportFeeCanvas(String transportFeeCanvas) {
		//四舍五入取整数
		this.transportFeeCanvas = CalculateFeeTotalUtils.formatNumberInteger(transportFeeCanvas);
	}
...
//		this.codAmountCanvas = CalculateFeeTotalUtils.formatNumberInteger(codAmountCanvas);
	...
	public void setTotalFeeCanvas(String totalFeeCanvas) {
		//四舍五入取整数
//		this.totalFeeCanvas = CalculateFeeTotalUtils.formatNumberInteger(totalFeeCanvas);
...
//		this.totalFee = CalculateFeeTotalUtils.formatNumberInteger(totalFee);
	 ...
	 * @date 2016-10-12 下午6:04:25
	 * @return
	 * @see
	 */
	public BranchVo getFinalCustomerPickupOrgCodeForAdd() {
		// 更改类型
		String rfcType = getRfcType().getValueCode();
		// 到达部门CODE
		if (WaybillRfcConstants.TRANSFER.equals(rfcType)) {
			...
			// 返货分段计费
			return rtnCustomerPickupOrgCode;
		} else if (WaybillRfcConstants.CUSTOMER_CHANGE.equals(rfcType) || WaybillRfcConstants.INSIDE_CHANGE.equals(rfcType)) {
			return customerPickupOrgCode;
		} else {
			if(transferRecordList.size()>0 ||returnRecordList.size()>0){
				return recordCustomerPickupOrgCode;
	...
	public boolean isPickUpFeeFromCustomer() {
		return isPickUpFeeFromCustomer;
	}

	public void setPickUpFeeFromCustomer(boolean isPickUpFeeFromCustomer) {
		this.isPickUpFeeFromCustomer = isPickUpFeeFromCustomer;
	}
...
/**
	...
	public DataDictionaryValueVo getRfcCustomerReason() {
		return rfcCustomerReason;
	}

	public void setRfcCustomerReason(DataDictionaryValueVo rfcCustomerReason) {
		this.rfcCustomerReason = rfcCustomerReason;
	}
