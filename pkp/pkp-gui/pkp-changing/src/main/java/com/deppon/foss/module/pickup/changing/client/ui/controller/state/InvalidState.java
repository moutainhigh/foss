 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/controller/state/InvalidState.java
 * 
...
public class InvalidState extends AbstractState {
	...
	protected List<UploadVoucherDto> getUploadVoucherDtos() {
		...
		vo.setProofName(i18n.get("pickup.changing.invalidProof"));
		vo.setIsDefault(true);
		uploadVoucherList.add(vo);
		vo = new UploadVoucherDto();
		vo.setProofName(i18n.get("pickup.changing.waybillCustomerBill"));
		vo.setIsDefault(true);
		uploadVoucherList.add(vo);
		vo = new UploadVoucherDto();
		vo.setProofName(i18n.get("pickup.changing.idCardCopy"));
		vo.setIsDefault(true);
		uploadVoucherList.add(vo);
