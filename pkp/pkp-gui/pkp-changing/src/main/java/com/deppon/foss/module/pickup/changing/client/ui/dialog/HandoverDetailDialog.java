 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/dialog/HandoverDetailDialog.java
 * 
...
public class HandoverDetailDialog extends JDialog {
	 ...
	 */
	private void init() {
		setTitle(i18n.get("foss.gui.changing.handoverDetailDialog.init.handoverDetail.label"));
		setModal(true);
		...
		JLabel label = new JLabel(i18n.get("foss.gui.changing.handoverDetailDialog.init.waybillNo.label"));
		getContentPane().add(label, "2, 2, right, default");
		
		lblWaybillNo = new JLabel("New label");
		getContentPane().add(lblWaybillNo, "4, 2");
		
		JLabel label1 = new JLabel(i18n.get("foss.gui.changing.handoverDetailDialog.init.goodsName.label"));
		getContentPane().add(label1, "6, 2, right, default");
		
		lblGoodsName = new JLabel("New label");
		getContentPane().add(lblGoodsName, "8, 2");
		
		JLabel label2 = new JLabel(i18n.get("foss.gui.changing.handoverDetailDialog.init.goodsCount.label"));
		getContentPane().add(label2, "10, 2, right, default");
		
		lblGoodsCount = new JLabel("New label");
		getContentPane().add(lblGoodsCount, "12, 2");
		
		JLabel label3 = new JLabel(i18n.get("foss.gui.changing.handoverDetailDialog.init.departureDept.label"));
		getContentPane().add(label3, "2, 4, right, default");
		
		lblLeaveDeptName = new JLabel("New label");
		getContentPane().add(lblLeaveDeptName, "4, 4");
		
		JLabel label4 = new JLabel(i18n.get("foss.gui.changing.handoverDetailDialog.init.arriveDept.label"));
		...
		JLabel label5 = new JLabel(i18n.get("foss.gui.changing.handoverDetailDialog.init.stockDept.label"));
	...
	private class HandoverDetailTableModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			switch (column) {
			case ZERO:
				return i18n.get("foss.gui.changing.handoverDetailDialog.columnName.handoverBillNo");
			case ONE:
				return i18n.get("foss.gui.changing.handoverDetailDialog.columnName.handoverDept");
			case TWO:
				return i18n.get("foss.gui.changing.handoverDetailDialog.columnName.handoverCount");
			case THREE:
				return i18n.get("foss.gui.changing.handoverDetailDialog.columnName.unloadCount");
			case FOUR:
				return i18n.get("foss.gui.changing.handoverDetailDialog.columnName.lackGoodsCount");
			default:
				return "";
			}
		}
