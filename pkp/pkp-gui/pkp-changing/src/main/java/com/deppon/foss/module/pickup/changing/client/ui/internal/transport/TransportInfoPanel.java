 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/transport/TransportInfoPanel.java
 * 
...
//	@FocusSeq(seq=11)
	...
	private void init() {
		...
		//货物状态
		JLabel lblGoodsStatus = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.goodsStatus.label")+"：");
		...
		//提货方式
		JLabel lblPickMode = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.pickMode.label")+"：");
		...
		//目的站：
		JLabel lblDestination = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.destination.label")+"：");
		...
		//提货网点：
		JLabel lblPickBranch = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.pickBranch.label")+"：");
		...
		//运输性质：
		JLabel lblProductType = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.productType.label")+"：");
		...
		//航班类型：
		JLabel lblPredictFlight = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.predictFlight.label")+"：");
		...
		//返单类别：
		JLabel lblReturnBillType = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.returnBillType.label")+"：");
		...
		//合票方式：
		label = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.freightMethod.label")+"：");
		...
		//航班时间：
		label_1 = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.flightShift.label")+"：");
		...
		//对外备注：
		JLabel lblOutSideRemark = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.outSideRemark.label")+"：");
...
//				add(combOutSideRemark, "4, 8, 5, 1, fill, default");
		...
		//对内备注：
		JLabel lblInsideRemark = new JLabel(i18n.get("foss.gui.changing.transportInfoPanel.insideRemark.label")+"：");
		add(lblInsideRemark, "2, 8, right, default");

		txtInsideRemark = new JTextFieldValidate();
		add(txtInsideRemark, "3, 8, 10, 1, fill, default");
		
		txtInsideRemark.setColumns(TEN);
		//对内备注输入长度
		LengthDocument insideDocument = new LengthDocument(NumberConstants.NUMBER_200);		
		txtInsideRemark.setDocument(insideDocument);
	}
