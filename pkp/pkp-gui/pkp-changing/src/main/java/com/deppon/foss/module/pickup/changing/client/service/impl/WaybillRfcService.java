 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/service/impl/WaybillRfcService.java
 * 
 ...
 * @update author 094463-foss-xieyantao
 * @update date 2014-3-8 上午10:24:04
 */
public class WaybillRfcService implements IWaybillRfcService {
	...
	public String queryIndustrySourceCategory(String goodsName) {
		return waybillRemotingService.queryIndustrySourceCategory(goodsName);
	}
	...
	public List<DataDictionaryValueEntity> queryOuterRemark() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryOuterRemark();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> queryRefundType() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return waybillRemotingService.queryRefundType();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> queryReturnBillType() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryReturnBillType();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> queryPaymentMode() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return waybillRemotingService.queryPaymentMode();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> querySpecialValueAddedServiceMode(){
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return waybillRemotingService.querySpecialValueAddedServiceMode();
		}else {
			//离线查询
			return dictionaryValueSerivce.querySpecialValueAddedServiceMode();
		}
		//return dictionaryValueSerivce.queryPaymentMode();
	}
	/**
	...
	public List<DataDictionaryValueEntity> queryIndustrySourceCategory4Dict() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			...
			//离线查询
			return dictionaryValueSerivce.queryIndustrySourceCategory4Dict();
		}
	}
	/**
	 * 查询客户分群
	...
	public List<DataDictionaryValueEntity> queryFlabelleavemonth4Dict() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			...
			//离线查询
			return dictionaryValueSerivce.queryFlabelleavemonth4Dict();
		}
	}
	/**
	 * 
	...
	public LimitedWarrantyItemsEntity isInsurGoods(String goodsName) {
		return waybillRemotingService.isInsurGoods(goodsName);
	}
    ...
    public List<ProhibitedArticlesEntity> queryProhibitGoodsByType(String type) {
    	return this.waybillRemotingService.queryProhibitGoodsByType(type);
    }
	 ...
	 * @date 2013-07-24 下午04:09:11
	 */
	public List<DataDictionaryValueEntity> queryPickUpGoodsAir() {
		return waybillRemotingService.queryPickUpGoodsAir();
	}
	/**
	 * 根据特殊增值服务改变提货方式
	 */
	...
	* @author 076234-foss-panguoyang
	...
	public boolean isExistRepayment(String waybillNo){
		return waybillRfcRemotingService.isExistRepayment(waybillNo);
	}
	...
	public List<ProductEntity> queryTransType(String salesDeptId) {		
		return waybillRfcRemotingService.queryTransType(salesDeptId);	
	...
	public List<ProductEntity> queryByArriveDeptProduct(String arriveDept) {
		return waybillRfcRemotingService.queryByArriveDeptProduct(arriveDept);
	...
	public List<DataDictionaryValueEntity> queryPredictFlight() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryPredictFlight();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> queryBillingWay() {
		return this.waybillRemotingService.queryBillingWay();
	}
	...
	public ProductEntity queryTransTypeByCode(String code, Date billDate) {
		return waybillRemotingService.getProductByCache(code, billDate);
	}
	...
	public List<DataDictionaryValueEntity> queryInsideChangeType() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryInsideChangeType();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> queryCustomerChangeType() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryCustomerChangeType();
		}else {
			//离线查询
	...
	public List<DataDictionaryValueEntity> queryGoodsStatus() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryGoodsStatus();
		}else {
			//离线查询
	...
	public LostRepDto queryErrorHandlingResult(String handingID, String waybillNo) {
		return waybillRfcRemotingService.queryErrorHandlingResult(handingID, waybillNo);
	}
	 ...
	 * @date 2016-10-15 17:10:50
	 */
	@Override
	public String queryNationByCode(String nationCode) {
		return addressService.queryNationByCode(nationCode);
	}
	...
	public String queryDeptNameByCode(String code) {
		...
		OrgAdministrativeInfoEntity dept = waybillRemotingService.queryOrgInfoByCode(code);
		if (dept == null) {
			return null;
		}
		return dept.getName();
     ...
     * @date 2016-10-25 10:07:04
     * @param provCode
     * @return
     */
	@Override
	public AddressFieldDto queryNationByProvinceCode(String provCode) {
		return addressService.queryNationByProviceCode(provCode);
	}
	 ...
	 */
	@Override
	public SaleDepartmentEntity queryExsitSaleDepartmentByCode(
			String customerPickupOrgCode) {
		return waybillRfcRemotingService
	...
	public int queryPrintTimesByWaybillId(String waybillId, String waybillNo) {
		return waybillRfcRemotingService.queryPrintTimesByWaybillId(waybillId,
				waybillNo);
	}
	 ...
	 */
	@Override
	public OuterBranchEntity queryExsitAgencyBranchCompanyInfo(
			String agencyBranchCode){
	...
	public List<DataDictionaryValueEntity> queryFreightMethod() {
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			//在线查询
			return onlineDictionaryValue.queryFreightMethod();
		}else {
			//离线查询
	 ...
	 * @update 20140428 zxy MANA-2018 在线读取本地改成读在线
	...
	public AdministrativeRegionsEntity queryAdministrativeRegionsByCode(
		...
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			entity = waybillRemotingService.queryAdministrativeRegionsByCode(code);
		}else{
			entity = administrativeRegionsService.queryAdministrativeRegionsByCode(code);
		}
		return entity;
	}
	 ...
	 * @see com.deppon.foss.module.pickup.changing.client.service.IWaybillRfcService#queryValueAddPriceByCode(java.lang.String)
	 */
	@Override
...
//		return baseDataService.querySaleDepartmentByCode(code);
		//获取远程数据
		return waybillRfcRemotingService.querySaleDepartmentByCode(code);
	}
	...
	public String queryStationDeliverOrgCode(String orgCode) {
		...
		SaleDepartmentEntity deliverDepartment = waybillRemotingService.queryStationLeaveOrgByOutfieldCode(orgCode);
...
//					throw new WaybillRfcChangeException(i18n.get("foss.gui.creating.OnLineWaybillService.nullTransferCenter",dept.getName()));
				...
				SaleDepartmentEntity department = waybillRemotingService.queryStationLeaveOrgByOutfieldCode(transferCenter);
				if(department == null){
					return orgCode;
				}else{
...
//		return orgInfoService.queryOrgByUnifiedCode(unifiedCode);
	...
	/* (non-Javadoc)
	 * @see com.deppon.foss.module.pickup.changing.client.service.IWaybillRfcService#queryFreightRouteByVirtualCode(java.lang.String)
	 */
	@Override
	...
	public Date getAirLeaveTime(String orgCode , Date flightTime , String flightNumberType)
	{
		if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
			...
			{
				ConfigurationParamsEntity pickupThreshold = configurationParamsService
				.queryConfigurationParamsByOrgCode(
				DictionaryConstants.SYSTEM_CONFIG_PARM__TFR,
				ConfigurationParamsConstants.TFR_PARM__MORNING_FLIGHT_TIME,
				orgCode);
	 ...
	 /**
		...
		@Override
		public boolean isCanPaidMethodForCUBC(CusBargainVo vo) {
			return waybillRemotingService.isCanPaidMethodCUBCForRfc(vo);
		}
		...
		public SaleDepartmentEntity queryPickupCentralizedDeptCodeByBillTime(String billingGroupOrgCode,Date billTime){
			return waybillRemotingService.queryPickupCentralizedDeptCodeByBillTime(billingGroupOrgCode,billTime);
		 ...
		 */
		@Override
		public String queryTransferCenterByAirDispatchCode(
				String lastLoadOrgCode) {
			return waybillRemotingService.queryTransferCenterByAirDispatchCode(lastLoadOrgCode);
		}
		...
		public List<PriceEntity> findPriceEntityPagingByCondition(PriceEntity entity, int start, int limit){
			return waybillRemotingService.findPriceEntityPagingByCondition(entity, start, limit);
		}
		...
		public SaleDepartmentEntity queryDepartmentInfoByDto(QueryPickupPointDto dto2){
			return waybillRemotingService.queryDepartmentInfoByDto(dto2);
		}
		...
		public WaybillEntity queryWaybillForFirst(String waybillNo){
			return waybillRemotingService.queryWaybillForFirst(waybillNo);
		}
		...
		public boolean isHasPackaged(String waybillNo) {
			return waybillRfcRemotingService.isHasPackaged(waybillNo);
		}
		...
		public boolean queryIsGetPickFeeByCust(WaybillEntity entity){
			return waybillRemotingService.queryIsGetPickFeeByCust(entity);
		}
		...
		public List<HandOverBillEntity> queryHandOveredRecordsByWaybillNo(String waybillNo){
			return waybillRfcRemotingService.queryHandOveredRecordsByWaybillNo(waybillNo);
		}
		...
		public boolean queryUnloadTaskReport(String waybillNo){
			return waybillRfcRemotingService.queryUnloadTaskReport(waybillNo);
		}
		 ...
		 */
		@Override
		public boolean isStartRfcPickfeeVal(){
			boolean start=false;
			//获取配置参数
			ConfigurationParamsEntity config=waybillRemotingService.queryConfigurationParamsByEntity(DictionaryConstants.SYSTEM_CONFIG_PARM__PKP, WaybillConstants.RFC_PICKFEE_VAL_START,FossConstants.ROOT_ORG_CODE);
			if(config!=null){			
		 ...
		 */
		@Override
		public OuterBranchEntity queryOuterBranchByCode(String code,
				Date billTime) {
			//先根据开单时间进行查询，如果开单时间查询不到，需要根据当前时间时间进行查询
			OuterBranchEntity entity = baseDataService.queryOuterBranchByCode(code,billTime);
			if(entity == null){
				entity = baseDataService.queryOuterBranchByCode(code,new Date());
			}
			return entity;
		}
		...
		public void canDebit(String deliveryCustomerCode, String receiveOrgCode) {
			waybillRfcRemotingService.canDebit(deliveryCustomerCode, receiveOrgCode);
		}
		...
		public List<InOutStockEntity> queryInStockInfo(String waybillNo, String serialNo, String orgCode, Date createBillTime) {
			return waybillRemotingService.queryInStockInfo(waybillNo,serialNo,orgCode,createBillTime);
		}
		
		//查询当前货物的出库记录--206860
		@Override
		public List<HandOverBillDetailEntity> queryHandoverBillDetailByWaybillNoAndOrgCord(String waybillNo,String orgCode) {
			return waybillRemotingService.queryHandoverBillDetailByWaybillNoAndOrgCord(waybillNo,orgCode);
		}
		
		//查询走货路径--206860
		@Override
		public TransportPathEntity queryTransportPath(String waybillNo) {
			return waybillRemotingService.queryTransportPath(waybillNo);
		}
		...
		public List<OrgAdministrativeInfoEntity> querySimpleOrgAdministrativeInfoByEntity(
			...
			return waybillRemotingService.querySimpleOrgAdministrativeInfoByEntity(entity,start,limit);
		}
		
		//根据运单号查询变更记录--206860
		@Override
		public List<WaybillRfcEntity> queryWaybillRfcAcceptByWaybillNo(String waybillNo){
			return waybillRemotingService.queryWaybillRfcAcceptByWaybillNo(waybillNo);
		}
		...
		public void addWaybillRfcTransferEntity(
			...
			waybillRemotingService.addWaybillRfcTransferEntity(waybillRfcTranferEntity);
		}

		@Override
		public List<WaybillRfcTranferEntity> queryWaybillRfcTransferEntity(
				WaybillRfcTranferEntity waybillRfcTranferEntity) {
			return waybillRemotingService.queryWaybillRfcTransferEntity(waybillRfcTranferEntity);
		}
		@Override
		public List<WaybillRfcTranferEntity> queryRfcTransferHistory(
				WaybillRfcTranferEntity waybillRfcTranferEntity) {
			return waybillRemotingService.queryRfcTransferHistory(waybillRfcTranferEntity);
		}

		@Override
		public FreightRouteDto queryFreightRouteBySourceTarget(
				String orginalOrganizationCode,
				String destinationOrganizationCode, String productCode,
				Date time) {
			return waybillRemotingService.queryFreightRouteBySourceTarget(orginalOrganizationCode, destinationOrganizationCode, productCode, time);
		}
		...
		public List<DataDictionaryValueEntity> queryRfcCusReason() {
			if (WaybillConstants.ONLINE_LOGIN.equals(SessionContext.get(WaybillConstants.LOGIN_TYPE).toString())) {
				//在线查询
				return onlineDictionaryValue.queryRfcCusReason();
			}else {
				//离线查询
				return dictionaryValueSerivce.queryRfcCusReason();
			}
		}
		@Override
		public BigDecimal queryTotalFeeByDelevyCode(String code,
				Date recevieDate) {
			return waybillRemotingService.queryTotalFeeByDelevyCode(code, recevieDate);
		}
		@Override
		public BigDecimal queryDiscountInfo(String waybillNo) {
			return waybillRemotingService.queryDiscountInfo(waybillNo);
		}		
		@Override
		...
		@Override
		public List<LabeledGoodEntity> queryAllSerialByWaybillNo(
				String waybillNo) {
			return waybillRemotingService.queryAllSerialByWaybillNo(waybillNo);
		}

		@Override
		public List<InOutStockEntity> queryInStockInfo(String waybillNo,
				Object object, String customerPickupOrgCode, Date billTime) {
			return waybillRemotingService.queryInStockInfo(waybillNo, null, customerPickupOrgCode, billTime);
		}
		...
		public WaybillPictureEntity queryWaybillPictureByEntity(
			...
			return waybillRemotingService.queryWaybillPictureByWaybillNo(waybillNo);
		}
		...
		/**
	     ...
	     public String queryRfcChangeItemsByWaybillRfcId(String waybillRfcId) {
	         ...
	         return waybillRfcRemotingService.queryRfcChangeItemsByWaybillRfcId(waybillRfcId);
	     }
		  /**
	      *  查询订单类型
	      * @author 367726-wangweiliu
	      * @date 2016-08-25
	      */
		@Override
		...
		public String queryServiceType(String orderno) {
			return waybillRfcRemotingService.queryServiceType(orderno);
		}
		
		 /**
	     * 查询是否可开装卸费
	     * @author 354805
	     * @date 2016-12-6 16:35:11
	     * @param code 装卸费开单部门
	     * @param billTime 开单时间
	     * @return 是否可开装卸费
	     */
	    public String queryCanPayServiceFeeByCodeAndTime(String code, Date billTime ){
	    	return waybillRfcRemotingService.queryCanPayServiceFeeByCodeAndTime(code, billTime);
	    }
		...
		public CustomerCircleNewDto queryCustomerByCusCode(String provinceCode,Date date, String active) {
			return waybillRfcRemotingService.queryCustomerByCusCodegetByCustCode(provinceCode,date,active);
		}
}