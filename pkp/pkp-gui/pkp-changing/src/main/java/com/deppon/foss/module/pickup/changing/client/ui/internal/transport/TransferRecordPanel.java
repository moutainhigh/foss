 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/transport/TransferRecordPanel.java
 * 
...
public class TransferRecordPanel extends JPanel {
	...
	private class TransferRecordTableModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			...
			case ZERO:
				//转运提货方式
				return i18n.get("foss.gui.changing.transportInfoPanel.transferPickMode.label");
			case ONE:
				//转运目的站
				return i18n.get("foss.gui.changing.transportInfoPanel.transferDestination.label");
			case TWO:
				//转运提货网点
				return i18n.get("foss.gui.changing.transportInfoPanel.transferPickBranch.label");
			case THREE:
				//转运运输性质
				return i18n.get("foss.gui.changing.transportInfoPanel.transferProductType.label");
			case FOUR:
				//转运航班类型
				return i18n.get("foss.gui.changing.transportInfoPanel.transferPredictFlight.label");
			case FIVE:
				//转运计费类型
				return i18n.get("foss.gui.changing.transportInfoPanel.transferBillingType.label");
			case SIX:
				//转运费率
				return i18n.get("foss.gui.changing.transportInfoPanel.transferUnitPrice.label");
			case SEVEN:
				//转运费
				return i18n.get("foss.gui.changing.transportInfoPanel.transferFee.label");
			default:
				return "";
			}
		}
