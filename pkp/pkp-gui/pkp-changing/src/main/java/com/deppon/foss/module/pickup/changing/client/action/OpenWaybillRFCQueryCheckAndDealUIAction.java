 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/action/OpenWaybillRFCQueryCheckAndDealUIAction.java
 * 
...
import com.deppon.foss.module.pickup.changing.client.ui.WaybillRFCQueryCheckAndDealUI;
...
public class OpenWaybillRFCQueryCheckAndDealUIAction extends
	...
	public void openUIAction() {
		...
		editConfig.setTitle(i18n.get("pickup.changing.waybillRfcQueryCheckAndDeal"));//??
		editConfig.setPluginId("com.deppon.foss.module.pkp-changing");
		application
				.openEditorAndRetrun(editConfig,
						"com.deppon.foss.module.pickup.changing.client.ui.WaybillRFCQueryCheckAndDealUI");
		LOG.info("open UI :com.deppon.foss.module.pickup.changing.client.ui.WaybillRFCQueryCheckAndDealUI");
