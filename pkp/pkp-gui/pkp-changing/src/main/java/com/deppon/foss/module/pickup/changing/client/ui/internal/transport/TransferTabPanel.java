...
public class TransferTabPanel extends JTabbedPane implements ITransterInject {
	...
	private void init() {
		...
		addTab(i18n.get("foss.gui.changing.transportSinglePanel.title.label"), null, managedPanel, null);
		 //转运信息
		addTab(i18n.get("foss.gui.changing.transferInfoPanel.title.label"), null, transferInfoPanel, null);
		//转运记录
		addTab(i18n.get("foss.gui.changing.transferRecordPanel.title.label"), null, transferRecordPanel, null);
