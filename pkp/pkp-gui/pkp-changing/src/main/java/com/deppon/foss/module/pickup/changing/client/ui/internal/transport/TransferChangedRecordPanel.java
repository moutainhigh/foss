...
public class TransferChangedRecordPanel extends JPanel {
	...
	public class TransferRecordTableModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			...
			case ZERO:
				//变更提货方式
				return i18n.get("foss.gui.changing.transportInfoPanel.pickMode.label");
			case ONE:
				//变更目的站
				return i18n.get("foss.gui.changing.transportInfoPanel.destination.label");
			case TWO:
				//变更提货网点
				return i18n.get("foss.gui.changing.transportInfoPanel.pickBranch.label");
			case THREE:
				//变更运输性质
				return i18n.get("foss.gui.changing.transportInfoPanel.productType.label");
			case FOUR:
				//变更航班类型
				return i18n.get("foss.gui.changing.transportInfoPanel.predictFlight.label");
			case FIVE:
				//变更计费类型
				return i18n.get("foss.gui.changing.extendPanel.billingType.label");
			case SIX:
				//变更费率
				return i18n.get("foss.gui.changing.extendPanel.unitPrice.label");
			case SEVEN:
				//变更费
				return i18n.get("foss.gui.changing.extendPanel.fee.label");
			default:
				return "";
			}
		}
