 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/action/WaybillRfcAuthorizeDeleteAction.java
 * 
...
public class WaybillRfcAuthorizeDeleteAction implements IButtonActionListener<WaybillRFCAuthorizeUI>{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(bean == null){
			MsgBox.showError(i18n.get("foss.gui.changing.waybillRfcAuthorizeDeleteAction.msgBox.nullSelectedDeleteRecord"));
			return;
		}
		int option = JOptionPane.showConfirmDialog(ui, i18n.get("foss.gui.changing.waybillRfcAuthorizeDeleteAction.confirmDialog.deleteRecord"), i18n.get("foss.gui.changing.waybillRFCUI.common.prompt"), JOptionPane.YES_NO_OPTION);
