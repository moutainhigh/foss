 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/dialog/ChangeGoodsQtyDialog.java
 * 
...
/*
 * PROJECT NAME: pkp-changing
 * PACKAGE NAME: com.deppon.foss.module.pickup.changing.client.ui.dialog
 * FILE    NAME: ChangeGoodsQtyDialog.java
 * COPYRIGHT: Copyright(c) 2012 Deppon All Rights Reserved.
 */
...
import com.deppon.foss.module.pickup.changing.client.action.ChangeGoodsQtyConfimrAction;
...
public class ChangeGoodsQtyDialog extends JDialog {
	...
	private void init() {
		...
		tablePanel.setBorder(new TitledBorder(null, i18n.get("foss.gui.changing.changeGoodsQtyDialog.init.changeGoodsDetailInfo.label"), 
		...
		button = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.confirm"));
	...
	private void initTable() {
		...
		ChangeModeCheckBoxColumn checkColumn 
			= new ChangeModeCheckBoxColumn(table.getColumn(i18n.get("foss.gui.changing.waybillRFCUI.common.delete")), this, currentWaybillInfoVo);
		...
		new ChangeModeComboxColumn(table.getColumn(i18n.get("foss.gui.changing.changeGoodsQtyDialog.initTable.acceptDept.label")), this , originalWaybillInfoVo);
