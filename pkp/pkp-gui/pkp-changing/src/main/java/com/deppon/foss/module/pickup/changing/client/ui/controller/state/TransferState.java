 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/controller/state/TransferState.java
 * 
...
public class TransferState extends CustomerChangeState {
	...
	protected void updateComponents(WaybillRFCUI rfcUI) {
		...
		if(waybillVo.getIsEconomyGoods()!=null && waybillVo.getIsEconomyGoods()){
			...
			//提货方式不可编辑
			getWaybillRfcUI().getWaybillInfoPanel().getTransferPanel().getTransferTabPanel().getTransferInfoPanel().getCombTransferAllocationType().setEnabled(false);
		}
		//大票貨
