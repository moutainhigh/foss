 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/action/WaybillRfcDealQueryAction.java
 * 
...
import com.deppon.foss.module.pickup.changing.client.ui.WaybillRFCDealUI.ApplyChangeVoModel;
...
public class WaybillRfcDealQueryAction implements
	...
	public void actionPerformed(ActionEvent e) {
		//起始日期不能大于结束日期
		if(waybillRFCDealUI.getFossdBeginDate().getDate().compareTo(waybillRFCDealUI.getFossdEndDate().getDate())>0){
		 ...
		 * 查询日期范围不能超过10天！
		 */
		if(DateUtils.getTimeDiff(waybillRFCDealUI.getFossdBeginDate().getDate(), waybillRFCDealUI.getFossdEndDate().getDate()) > NumberConstants.NUMBER_9){
			MsgBox.showInfo(i18n.get("foss.gui.changing.waybillRfcDealQueryAction.msgBox.notPassTenDays"));
			return;
		}else{
