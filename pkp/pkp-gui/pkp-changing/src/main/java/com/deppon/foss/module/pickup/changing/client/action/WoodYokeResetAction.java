 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/action/WoodYokeResetAction.java
 * 
...
public class WoodYokeResetAction extends
	...
	public void actionPerformed(ActionEvent e) {
		...
		// ===========lianhe/增加非木包装费清空/2017-3-8/start=======
		//非木包装费
		yoke.nonWoodPackingAmount.setText("");
		// ===========lianhe/增加非木包装费清空/2017-3-8/end=======
		// 打木架货物件数
		...
		//zxy 20131118 ISSUE-4391 start 新增：打木托界面重置
		
		yoke.txtSalverGoodsAmount.setText("");
		yoke.txtSalverGoodsPieces.setText("");
		yoke.txtSalverRequire.setText("");
		yoke.listSalver.clearSelection();
		//zxy 20131118 ISSUE-4391 end 新增：打木托界面重置
		...
		if(brak!=null){
			...
			for(int	j=0;j<strs.length;j++){
				...
				str.append(strs[j]).append(";");
			}
			if(ish){
			bean.setTransportationRemark(str.toString());
			}
