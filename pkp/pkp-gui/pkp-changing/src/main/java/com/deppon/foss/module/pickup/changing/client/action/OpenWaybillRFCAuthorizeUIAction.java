 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/action/OpenWaybillRFCAuthorizeUIAction.java
 * 
...
public class OpenWaybillRFCAuthorizeUIAction extends
	...
	public void openUIAction() {
		...
		editConfig.setTitle(i18n.get("foss.gui.changing.openWaybillRFCAuthorizeUIAction.setTitle.authorizeAudit"));// ??
		editConfig.setPluginId("com.deppon.foss.module.pkp-changing");
		application
				.openEditorAndRetrun(
						editConfig,
						"com.deppon.foss.module.pickup.changing.client.ui.WaybillRFCAuthorizeUI");
