 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/internal/ImportPanel.java
 * 
...
import com.deppon.foss.module.pickup.changing.client.action.WaybillImportAction;
...
public class ImportPanel extends JPanel {
	...
	@FocusSeq(seq=2)
	private JButton btnImport = new JButton(i18n.get("pickup.changing.import"));
	...
	@Bind("rfcCustomerReason")
	@FocusSeq(seq=6)
    private JComboBox txtCustomerRfcReason;
	public JComboBox getTxtCustomerRfcReason() {
		return txtCustomerRfcReason;
	}	
	private DefaultComboBoxModel rfcTypeComboBoxModel;
	//客户要求更改原因
	private DefaultComboBoxModel rfcCusReasonComboBoxModel;
	public DefaultComboBoxModel getRfcCusReasonComboBoxModel() {
		return rfcCusReasonComboBoxModel;
	}

	public void setRfcCusReasonComboBoxModel(
			DefaultComboBoxModel rfcCusReasonComboBoxModel) {
		this.rfcCusReasonComboBoxModel = rfcCusReasonComboBoxModel;
	}
	...
	private void init() {
		...
		JLabel lblWaybillNo = new JLabel(i18n.get("pickup.changing.waybillNo"));
		...
		txtWaybillNo.setDocument(new NumberDocument(NIVE));

		add(btnImport, "6, 1");

		rdoCustomerRequire = new JRadioButton(i18n.get("pickup.changing.customerRequire"));

		btnGroupRequire.add(rdoCustomerRequire);
		add(rdoCustomerRequire, "8, 1");

		rdoInsideRequire = new JRadioButton(i18n.get("pickup.changing.insideRequire"));

		btnGroupRequire.add(rdoInsideRequire);
		if(!BZPartnersJudge.IS_PARTENER || !BZPartnersJudge.INTERNAL_REQUIRE_RFC){
			add(rdoInsideRequire, "10, 1");
		}

		JLabel lblRfcType = new JLabel(i18n.get("pickup.changing.rfcType"));
		...
		JLabel lblRfcReason = new JLabel(i18n.get("pickup.changing.rfcReason"));
		...
		txtRfcReason.setDocument(new LengthDocument(NumberConstants.NUMBER_66));
		txtRfcReason.setColumns(TEN);
		//客户更改更改原因
		txtCustomerRfcReason = new JComboBox();
		add(txtCustomerRfcReason, "18, 1, fill, default");
		txtCustomerRfcReason.setVisible(false);
		rfcCusReasonComboBoxModel = (DefaultComboBoxModel) txtCustomerRfcReason.getModel();
	}
