 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/changing/client/ui/dialog/RFCInfoDialog.java
 * 
...
import com.deppon.foss.module.pickup.changing.client.action.WaybillRfcCommitAction;
...
public class RFCInfoDialog extends JDialog {
	...
	private void setDefaultValue() {
		...
		messagePanel.getInvalidInfoPanel().getLblOperateTime().setText(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
	...
	private void init() {
		...
		setResizable(false);
		setTitle(i18n.get("foss.gui.changing.rfcInfoDialog.init.waybillRFC.label"));
		...
		lblTotalLbl = new JLabel(i18n.get("foss.gui.changing.rfcInfoDialog.init.totalFeeChange.label"));
		panel.add(lblTotalLbl);
		
		lblTotalTxt = new JLabel(i18n.get("foss.gui.changing.rfcInfoDialog.init.fiftyYuan.label"));
		panel.add(lblTotalTxt);

		JLabel label = new JLabel(i18n.get("foss.gui.changing.rfcInfoDialog.init.messageNotice.label"));
		label.setHorizontalAlignment(SwingConstants.TRAILING);
		getContentPane().add(label, "2, 6");

		btnOk = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.confirm"));

		cboConsigner = new JCheckBox(i18n.get("foss.gui.changing.rfcInfoDialog.init.consigner.label"));
		getContentPane().add(cboConsigner, "4, 6");

		cboConsignee = new JCheckBox(i18n.get("foss.gui.changing.rfcInfoDialog.init.consignee.label"));
		...
		btnCancel = new JButton(i18n.get("foss.gui.changing.waybillRFCUI.common.cancel"));
	...
	public void setTotalFeeChange(BigDecimal changedTotalFee) {
		String totalFeeStr = MessageFormat.format(i18n.get("foss.gui.changing.rfcInfoDialog.MessageFormat.totalFeeChange"), changedTotalFee);
