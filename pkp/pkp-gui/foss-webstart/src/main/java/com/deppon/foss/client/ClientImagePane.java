 ...
 * 
 * FILE PATH        	: foss-webstart/src/main/java/com/deppon/foss/client/ClientImagePane.java
 * 
 * FILE NAME        	: ClientImagePane.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * 
 */
public class ClientImagePane extends JPanel
{
     ...
     */
    public ClientImagePane()
    {
        this(null, CENTRE);
    }
    
    /**
     * 构造一个具有指定背景图片和指定显示模式的ClientImagePane
     * @param image 背景图片
     * @param modeName 背景图片显示模式
     */
    public ClientImagePane(Image image, String modeName)
    {
        super();
    ...
    protected void paintComponent(Graphics g)
    {
        ...
        if(backgroundImage != null)
        {
			...
			g2d.scale(width / imageWidth, height / imageHeight);
             */			
            switch(modeIndex)
            {
                //居中
