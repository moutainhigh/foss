...
public class CheckBoxColumn  extends AbstractCellEditor implements  TableCellEditor, TableCellRenderer  {  
	...
	//log
	private Log LOG = LogFactory.getLog(CheckBoxColumn.class);
     ...
     * @param ui
     */
    public CheckBoxColumn(TableColumn tc, SalesDeptWaybillUI ui)  
    {  
	...
	*/
	 ...
	 */
	public void setCheckBoxPartSelected(SalesDeptWaybillUI ui,JCheckBox checkBox){
		//获得对象集合
	 ...
	 */
	public void setCheckBoxAllSelected(SalesDeptWaybillUI ui){
		//获得对象集合
		List<JCheckBox> list = ui.getList();
		//判断集合是否为空
		if(CollectionUtils.isEmpty(list)){
