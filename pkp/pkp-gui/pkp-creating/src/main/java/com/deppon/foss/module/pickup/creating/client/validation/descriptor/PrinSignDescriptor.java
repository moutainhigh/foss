 ...
 * 
 */
package com.deppon.foss.module.pickup.creating.client.validation.descriptor;
 ...
 * @version
 */
public class PrinSignDescriptor {
	
	/**
	 * 日志
	 */
	private static final Log LOG = LogFactory.getLog(PrinSignDescriptor.class);
	...
	private static final II18n i18n = I18nManager
			.getI18n(PrinSignDescriptor.class);
	...
	public String validateWaybillNo(String waybillNo) {
		if (NumberValidate.checkBetweenLength(waybillNo, EIGHT, NINE)) {
			...
			return i18n.get("foss.gui.creating.waybillDescriptor.waybillNo.length");
		}
	}
}