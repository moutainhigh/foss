 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/action/QueryConsigneeDeptAction.java
 * 
 ...
 */
public class QueryConsigneeDeptAction implements IButtonActionListener<WaybillEditUI> {
