 ...
 *
 */
public class BatchCheckBoxColumn  extends AbstractCellEditor implements  TableCellEditor, TableCellRenderer  {  
	...
	//log
	private Log LOG = LogFactory.getLog(BatchCheckBoxColumn.class);
     ...
     * LinkTableMode
     */
    private BatchCreateWaybillTableModel dtm;  
     ...
     * @param ui
     */
    public BatchCheckBoxColumn(TableColumn tc, OpenBatchCreateWaybillUI ui)  
    {  
    ...
    public Component getTableCellEditorComponent(JTable table,  
        ...
        //  当单元格处于编辑状态时  
    	if(dtm==null){
    		dtm = (BatchCreateWaybillTableModel)table.getModel(); 
    	}
	...
	*/
	    ...
	    public void itemStateChanged(ItemEvent e) { 
			...
			if(obj!=null && obj.equals(renderButton)) {
				if(renderButton.isSelected()) {
					String waybillNo = dtm.getValueAt(row, NumberConstants.NUMBER_4).toString();
	 ...
	 */
	public void setCheckBoxPartSelected(OpenBatchCreateWaybillUI ui,JCheckBox checkBox){
		//获得对象集合
	 ...
	 */
	public void setCheckBoxAllSelected(OpenBatchCreateWaybillUI ui){
		//获得对象集合
		List<JCheckBox> list = ui.getList();
		//判断集合是否为空
		if(CollectionUtils.isEmpty(list)){
	 ...
	 * @param rows
	 */
	public void setMultipleRow(OpenBatchCreateWaybillUI ui,int row,List<Integer> rows) {
