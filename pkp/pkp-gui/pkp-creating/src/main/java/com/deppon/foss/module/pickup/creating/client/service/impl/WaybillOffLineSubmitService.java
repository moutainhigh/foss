 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/service/impl/WaybillOffLineSubmitService.java
 * 
 * FILE NAME        	: WaybillOffLineSubmitService.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * @version
 */
public class WaybillOffLineSubmitService implements IWaybillOffLineSubmitService {
	 ...
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(WaybillOffLineSubmitService.class);
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 上午09:52:26
	 */
	@org.mybatis.guice.transactional.Transactional
	@Override
	public void submitWaybill(WaybillDto waybillDto) {

		// 校验运单是否符合业务规则
		verifyWaybill(waybillDto);

		// 生成运单完整信息
		addWaybill(waybillDto);

		// 运单冗余信息新增
		addActualFreightInfo(waybillDto);
	}
	...
	public void addActualFreightInfo(WaybillDto waybillDto) {
		...
		if (actualFreightEntity.getId() == null) {
			actualFreightEntity.setId(UUIDUtils.getUUID());
		}
		actualFreightDao.insertActualFreightEntity(actualFreightEntity);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 上午09:41:35
	 */
	public void addWaybill(WaybillDto waybillDto) {
		// 当前用户信息
		...
		this.addWaybillEntity(waybill, systemDto);
		if (Common.notNull(discoutDetail)) {
			addWaybillDisDtlEntityBatch(discoutDetail, systemDto);
		}

		if (Common.notNull(chargeDetail)) {
			addWaybillChargeDtlEntityBatch(chargeDetail, systemDto);
		}

		if (Common.notNull(chargeDetail)) {
			addWaybillPaymentEntityBatch(paymentList, systemDto);
		}

		if (wooden != null) {
			addWoodenRequirements(wooden, systemDto);
		}
	}
	 ...
	 * 新增打木架/打木箱数据
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 下午01:52:30
	 * @param WaybillOffLineSubmitService
	 */
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 上午10:06:43
	 */
	public void addWaybillPaymentEntityBatch(List<WaybillPaymentEntity> waybillPaymentList, WaybillSystemDto systemDto) {
		...
		waybillPaymentDao.addBatch(waybillPaymentList);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 上午10:03:45
	 */
	public void addWaybillChargeDtlEntityBatch(List<WaybillChargeDtlEntity> waybillChargeDtlList, WaybillSystemDto systemDto) {
		...
		waybillChargeDtlDao.addBatch(waybillChargeDtlList);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 上午10:01:35
	 */
	public void addWaybillDisDtlEntityBatch(List<WaybillDisDtlEntity> list, WaybillSystemDto systemDto) {
		...
		waybillDisDtlDao.addBatch(list);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-12-22 上午09:47:15
	 */
	public int addWaybillEntity(WaybillEntity waybillEntity, WaybillSystemDto systemDto) {
		...
		waybillEntity.setCreateUser(systemDto.getCurrentUser().getEmpCode());
		waybillEntity.setModifyUserCode(systemDto.getCurrentUser().getEmpCode());
		// 运输类型
		waybillEntity.setTransportType(CommonUtils.convertProductCodeToTransType(waybillEntity.getProductCode()));
		...
		return waybillDao.addWaybillEntity(waybillEntity);
	}
	...
	private void checkWaybillData(WaybillDto waybill) {
		...
		// 折扣信息
		List<WaybillDisDtlEntity> discoutDetail = waybill.getWaybillDisDtlEntity();
		...
		if (waybillEntity != null) {
			...
			throw new WaybillValidateException(i18n.get("foss.gui.creating.waybillOffLinePendingService.exception.waybillCheck.one"), i18n.get("foss.gui.creating.waybillOffLineSubmitService.exception.waybillCheck.noEmptyWaybillBasInfo"));
		}
	}
