 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/service/impl/AbstractWaybillService.java
 * 
 * FILE NAME        	: AbstractWaybillService.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * 
 */
public abstract class AbstractWaybillService implements IWaybillService {
	 ...
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(AbstractWaybillService.class);
	 ...
	 *  网点自提派送区域
	 */
	ISalesDescExpandsService salesDescExpandsService;
	...
	public AbstractWaybillService() {
		...
		localRuleVerifyService = injector
				.getInstance(LocalRuleVerifyService.class);

		priceRebateService = injector.getInstance(PriceRebateService.class);

		waybillStockService = injector.getInstance(WaybillStockService.class);

		orgInfoService = injector.getInstance(OrgInfoService.class);

		administrativeRegionsService = injector
				.getInstance(AdministrativeRegionsService.class);

		productService = injector.getInstance(ProductService.class);

		salesDepartmentService = injector
				.getInstance(SalesDepartmentService.class);

		districtDao = injector
				.getInstance(DistrictDao.class);
		
		configurationParamsService = injector
		.getInstance(ConfigurationParamsService.class);
		
		salesDescExpandsService = injector
		.getInstance(SalesDescExpandsService.class);			
    ...
    {
    	Object number = SessionContext.get(WaybillConstants.WAYBILL_NO);
    	if(number != null)
    	{
    		//新运单
    		Long newNumber = Long.valueOf(waybillNo);
    		//上次一次提交的运单
    		Long oldNumber = Long.valueOf(number.toString());
    		
    		Long value = newNumber - oldNumber;
    		
    		Long absolute = Long.valueOf(WaybillConstants.INTERVAL);
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:00:36
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryOuterRemark()
	 */
	@Override
	public List<DataDictionaryValueEntity> queryOuterRemark() {
		return this.dictionaryValueSerivce.queryOuterRemark();
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:00:45
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryRefundType()
	 */
	@Override
	public List<DataDictionaryValueEntity> queryRefundType() {
		return this.dictionaryValueSerivce.queryRefundType();
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:00:58
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryReturnBillType()
	 */
	@Override
	public List<DataDictionaryValueEntity> queryReturnBillType() {
		return this.dictionaryValueSerivce.queryReturnBillType();
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:01:47
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#isProhibitGoods(java.lang.String)
	 */
//	@Override
...
//	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:02:11
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#isValuablesGoods(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:02:47
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryPickUpGoodsAir()
	 */
//	@Override
...
//	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 上午09:03:39
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryLimitAmount(java.lang.String)
	 */
	@Override
	public String queryLimitAmount(String goodsName) {
		return this.baseDataService.queryLimitAmount(goodsName);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-24 下午05:03:24
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#isVehicleDirect(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	public boolean isVehicleDirect(String weight, String volume) {
		return this.localRuleVerifyService.isVehicleDirect(weight, volume);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-25 上午10:40:34
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#isValueGoods(int,
	...
	/**
	 * 将CustomerDto转化为CustomerContactDto列表
	 * 
	 * @author 026123-foss-lifengteng
	 * @date 2012-11-16 下午7:52:31
	 */
	public List<CustomerContactDto> convertToDto(CustomerDto customer) {
		List<CustomerContactDto> list = new ArrayList<CustomerContactDto>();
		CustomerContactDto customerContact = new CustomerContactDto();

		List<ContactEntity> contactList = customer.getContactList();
		for (ContactEntity contact : contactList) {
			customerContact.setAddress(contact.getAddress());
			customerContact.setChargeMode("");
			customerContact.setContactName(contact.getContactName());
			customerContact.setCustCode(customer.getCusCode());
			customerContact.setCustName(customer.getName());
			customerContact.setIdCard(contact.getIdCard());
			customerContact.setMobilePhone(contact.getMobilePhone());
			customerContact.setOfficePhone(contact.getContactPhone());
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-10-29 下午03:25:53
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryBySaleDept(java.lang.String,
	 *      java.lang.String, java.lang.String)
	 */
	@Override
	public FreightRouteEntity queryRouteBySaleDept(String transType,
			String departureSaleDept, String arrivalSaleDept) {
		return this.baseDataService.queryRouteBySaleDept(transType,
				departureSaleDept, arrivalSaleDept);
	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-11-1 下午01:47:29
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryBillingWay()
	 */
//	@Override
...
//	}
	 ...
	 * 
	 * @author 025000-FOSS-helong
	 * @date 2012-11-1 下午01:47:48
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#isWeightByVolume(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	public boolean isWeightByVolume(String goodsWeight, String goodsVolume) {
		return localRuleVerifyService
				.isWeightByVolume(goodsWeight, goodsVolume);
	}
	...
	public List<DataDictionaryValueEntity> queryOrderType() {
		return this.dictionaryValueSerivce.queryOrderType();
	}

	@Override
	public List<DataDictionaryValueEntity> queryOrderStatus() {
		return this.dictionaryValueSerivce.queryOrderStatus();
	}

	@Override
	public DataDictionaryValueEntity queryDataDictoryValueEntity(
			String termsCode, String valueCode) {
		return dictionaryValueSerivce.queryDataDictoryValueByCode(termsCode,
				valueCode);
	}

	@Override
	public ProductEntity queryTransTypeById(String transTypeId) {
		return baseDataService.queryTransTypeById(transTypeId);
	}
	...
	public AdministrativeRegionsEntity queryAdministrativeRegionsByCode(
		...
		AdministrativeRegionsEntity entity = administrativeRegionsService
	...
	public ProductEntity getProductByCache(String productCode, Date billDate) {
		...
		if (billDate == null) {
			// Assignment of parameter billDate is not allowed. (sornar)
			return productService.getProductByCache(productCode, new Date());
		} else {
	 ...
	 * @see
	 */
	protected void dataInsert(JasperContext jctx, WaybillEditUI ui,WaybillEntity waybillEntity, UserEntity user) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {

		WaybillPrintBean resourceBean=ui.getWaybillPrintBean();
		// 数据填充
				...
				if (resourceBean.getOtherFeeList() != null) {
					for (OtherFeeBean temp : resourceBean.getOtherFeeList()) {
					    if(StringUtils.isNotBlank(temp.getOtherFeeName())){
							if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_9){
							    otherFeeValue.append(temp.getOtherFeeName()).append(" ").append(temp.getOtherFeeValue()).append("\n");
							}else if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_8){
							    otherFeeValue.append(temp.getOtherFeeName()).append("  ").append(temp.getOtherFeeValue()).append("\n");
							}else if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_7){
							    otherFeeValue.append(temp.getOtherFeeName()).append("   ").append(temp.getOtherFeeValue()).append("\n");
							}else if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_6){
							    otherFeeValue.append(temp.getOtherFeeName()).append("    ").append(temp.getOtherFeeValue()).append("\n");
							}else if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_5){
							    otherFeeValue.append(temp.getOtherFeeName()).append("        ").append(temp.getOtherFeeValue()).append("\n");
							}else if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_4){
							    otherFeeValue.append(temp.getOtherFeeName()).append("            ").append(temp.getOtherFeeValue()).append("\n");
							}else if(temp.getOtherFeeName().length()== NumberConstants.NUMBER_3){
							    otherFeeValue.append(temp.getOtherFeeName()).append("               ").append(temp.getOtherFeeValue()).append("\n");
							}else{
							    otherFeeValue.append(temp.getOtherFeeName()).append("                           ").append(temp.getOtherFeeValue()).append("\n");
							}
		...
		String receiveInfo = ui.getConsignerPanel().getTxtConsignerArea().getText() + resourceBean.getDeliveryCustomerAddress();
		if(StringUtil.isNotBlank(resourceBean.getReceiveCustomerAddressNote())){
			receiveInfo = receiveInfo + "(" + resourceBean.getReceiveCustomerAddressNote() + ")";
		}
		String deliverInfo = ui.getConsigneePanel().getTxtConsigneeArea().getText() + resourceBean.getReceiveCustomerAddress();
		if(StringUtil.isNotBlank(resourceBean.getDeliveryCustomerAddressNote())){
			deliverInfo = deliverInfo + "(" + resourceBean.getDeliveryCustomerAddressNote() + ")";
		}
		jctx.put("consignorAddr", isBeanValueNull(receiveInfo));// "$F发货人地址"
		jctx.put("addr", isBeanValueNull(deliverInfo));// "$F收货人地址"
...
//		deliveryCustomerName
		...
		if (waybillEntity != null && waybillEntity.getReceiveOrgCode() != null) {
			...
			//添加广告语
			jctx.put("benefitActivity", isBeanValueNull(printUtil.getWaybillDocAd(waybillEntity.getReceiveOrgCode(), DictionaryValueConstants.DEPARTURE_CITY)));
		...
		jctx.put("insuranceCharge1", isBeanValueNull(resourceBean.getInsuranceFee()));// "$F保价费");t
		...
		exchangeRate = getConvertFeeRate(FossConstants.CURRENCY_CODE_HKD, new Date());
		
		//通过综合将预付原始金额转换目标金额
		BigDecimal noPayAmountHK = getConvertFee(resourceBean.getPrePayAmount(), FossConstants.CURRENCY_CODE_HKD, new Date());
		BigDecimal toPayAmountHK = getConvertFee(resourceBean.getToPayAmount(), FossConstants.CURRENCY_CODE_HKD, new Date());
		...
		OrgAdministrativeInfoEntity consigorNetInfo = printUtil.getOrg(waybillEntity.getReceiveOrgCode());
		...
		//如果收货网点不为""则追加"/"符号
		String deliveryCustomerPickupOrgName = tempDeliveryCustomerPickupOrgName==null?"":tempDeliveryCustomerPickupOrgName+PrintUtil.OBLIQUE_LINE;
...
//	}
	...
	private BigDecimal getConvertFee(BigDecimal rmbAmout,String currentCode,Date date){
		BigDecimal money = this.getExchangedFee(rmbAmout, currentCode, date);
		if (money != null) {
	...
	private BigDecimal getConvertFeeRate(String currentCode,Date date){
		BigDecimal feeRate = this.getExchangedFeeRate(currentCode, date);
		if (feeRate != null) {
			return feeRate;
		}else {
			return BigDecimal.ZERO;
	...
	@Override
	public String queryStartStocksDepartmentService(WaybillEntity waybillEntity) {
		return waybillStockService
				.queryStartStocksDepartmentService(waybillEntity);
	}

	@Override
	public String queryEndStocksDepartmentService(WaybillEntity waybillEntity) {
		return waybillStockService
	...
	public SaleDepartmentEntity querySaleDeptByCode(String code) {
		return baseDataService.querySaleDepartmentByCodeOnline(code);
	}
	 ...
	 */
	@Override
	public SaleDepartmentEntity querySaleDeptByCode(String code,Date billTime) {
	...
	public List<SaleDepartmentEntity> querySaleDepartmentInner(String name) {
		return salesDepartmentService.querySaleDepartmentInner(name);
	}
...
//	}
	...
	public List<OrgAdministrativeInfoEntity> queryOrgAirDepartment(){
		return orgInfoService.queryOrgAirDepartment();
	}
	 ...
	 * 查询行政区域编码
	 * @author foss-sunrui
	 * @date 2013-2-22 下午4:45:03
	 * @param degree
	 * @param name
	 * @param parentDistCode
	 * @return 
	 * @see com.deppon.foss.module.pickup.creating.client.service.IWaybillService#queryDistrictCode(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public String queryDistrictCode(String degree,String name,String parentDistCode){
		AdministrativeRegionsEntity entity = new AdministrativeRegionsEntity();
		entity.setDegree(degree);
		entity.setName(name);
		if(!DictionaryValueConstants.DISTRICT_PROVINCE.equals(degree)){
			entity.setParentDistrictCode(parentDistCode);
		}
		AdministrativeRegionsEntity newEntity = districtDao.queryByName(entity);
		if(newEntity!=null){
			return newEntity.getCode();
		}else{
			return null;
		}
	}
...
//	}
	...
	public List<EWaybillPrintDto> printEWaybillInfos(String waybillNo,
