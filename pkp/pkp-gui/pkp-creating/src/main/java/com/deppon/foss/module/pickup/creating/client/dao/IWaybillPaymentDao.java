 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/dao/IWaybillPaymentDao.java
 * 
 ...
 */
public interface IWaybillPaymentDao {
	/**
	 * 批量新增付款明细数据
	 * @author 026123-foss-lifengteng
	 * @date 2012-11-5 下午2:00:28
	 */
	void addBatch(List<WaybillPaymentEntity> waybillPaymentList);
