 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/action/OpenSalesDeptWaybillUIAction.java
 * 
 * FILE NAME        	: OpenSalesDeptWaybillUIAction.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * @version
 */
public class OpenSalesDeptWaybillUIAction extends
	AbstractOpenUIAction<SalesDeptWaybillUI> {
	...
	private static final Log log = LogFactory
			.getLog(OpenSalesDeptWaybillUIAction.class);

	// 国际化
	private static final II18n i18n = I18nManager
			.getI18n(OpenSalesDeptWaybillUIAction.class);
	...
	public void openUIAction() {
		...
		editConfig.setTitle(i18n.get("foss.gui.creating.salesDeptWaybillUI.title"));
		editConfig.setPluginId("com.deppon.foss.module.pkp-creating");
		IEditor editor = application
				.openEditorAndRetrun(editConfig,
						"com.deppon.foss.module.pickup.creating.client.ui.SalesDeptWaybillUI");

		SalesDeptWaybillUI salesDeptWaybillUI = (SalesDeptWaybillUI) editor.getComponent();
		
		log.info("open UI :com.deppon.foss.module.pickup.creating.client.ui.SalesDeptWaybillUI"+editor);
	...
	@Override
	public Class<SalesDeptWaybillUI> getOpenUIType() {
		return SalesDeptWaybillUI.class;
	}
