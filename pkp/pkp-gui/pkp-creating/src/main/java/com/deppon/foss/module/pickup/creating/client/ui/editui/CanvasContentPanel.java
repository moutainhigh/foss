 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/ui/editui/CanvasContentPanel.java
 * 
 * FILE NAME        	: CanvasContentPanel.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * </p>
 * <p style="display:none">
 * version:V1.0,author:Administrator,date:2012-10-17 上午11:16:01,content:
 * </p>
 * 
 * @author 025000-FOSS-helong
 * @date 2012-10-17 上午11:16:01
 * @since
 * @version
 */
public class CanvasContentPanel extends JPanel {
	 ...
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(CanvasContentPanel.class);
	 ...
	 * 其它价格PANEL
	 */
	private OtherCostPanel otherCost = new OtherCostPanel();
	
	private CargoRoutePanel cargoRoutePanel = new CargoRoutePanel();
	
	/**
	 * 折扣优惠面板
	 */
	private ConcessionsPanel concessionsPanel = new ConcessionsPanel();
	 ...
	 */
	public OtherCostPanel getOtherCost() {
		return otherCost;
	}
	
	public ConcessionsPanel getConcessionsPanel() {
		return concessionsPanel;
	}

	public CargoRoutePanel getCargoRoutePanel() {
