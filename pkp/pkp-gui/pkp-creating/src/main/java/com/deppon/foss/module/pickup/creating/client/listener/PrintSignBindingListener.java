 ...
 * @version
 */
public class PrintSignBindingListener implements IBindingListener {
	...
	private static Log log = LogFactory.getLog(PrintSignBindingListener.class);
	
	/**
	 * 国际化对象
	 */
	private static final II18n i18n = I18nManager.getI18n(PrintSignBindingListener.class); 
	
	public PrintSignBindingListener(PrintSignUI ui) {
		this.ui = ui;
	}
