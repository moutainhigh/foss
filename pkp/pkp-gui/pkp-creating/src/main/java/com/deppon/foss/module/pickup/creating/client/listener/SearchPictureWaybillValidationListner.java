 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/creating/client/listener/SalesDeptWaybillValidationListner.java
 * 
 * FILE NAME        	: SalesDeptWaybillValidationListner.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
...
/**
 * 图片查询SearchPictureWaybillValidationListner
 * @author hehaisu
 *
 */
public class SearchPictureWaybillValidationListner implements IValidationListener  {
