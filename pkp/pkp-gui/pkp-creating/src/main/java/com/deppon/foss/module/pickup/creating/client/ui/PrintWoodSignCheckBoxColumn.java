 ...
 *
 */
public class PrintWoodSignCheckBoxColumn  extends AbstractCellEditor implements  TableCellEditor, TableCellRenderer  {  
	...
	//log
	private Log LOG = LogFactory.getLog(PrintWoodSignCheckBoxColumn.class);
     ...
     * LinkTableMode
     */
    private LinkWoodTableModePrint dtm;  
     ...
     * @param ui
     */
    public PrintWoodSignCheckBoxColumn(TableColumn tc, PrintSignUI ui)  
    {  
    ...
    public Component getTableCellEditorComponent(JTable table,  
        ...
        //  当单元格处于编辑状态时  
    	if(dtm==null){
    		dtm = (LinkWoodTableModePrint)table.getModel(); 
    	}
        this.row = row;  
        if(renderButtonList.size()<row+1){
        	JCheckBox renderButton = new JCheckBox(); 

        	renderButton.setHorizontalAlignment(JLabel.LEFT);
	...
	*/
	    ...
	    public void itemStateChanged(ItemEvent e) { 
			...
			if(obj!=null && obj.equals(renderButton)) {
				if(renderButton.isSelected()) {
					String waybillNo = dtm.getValueAt(row, 1).toString();
	 ...
	 * @date 2015-11-11 下午2:35:05
	 */
	public void setCheckBoxPartSelected(PrintSignUI ui,JCheckBox checkBox){
		//获得对象集合
	 ...
	 * @author 220125
	 * @date 2015-11-11 下午3:55:34
	 */
	public void setCheckBoxAllSelected(PrintSignUI ui){
		//获得对象集合
		List<JCheckBox> list = ui.getList();
		//判断集合是否为空
		if(CollectionUtils.isEmpty(list)){
