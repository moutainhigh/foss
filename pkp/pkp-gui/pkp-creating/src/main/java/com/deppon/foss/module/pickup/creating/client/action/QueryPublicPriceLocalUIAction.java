 ...
 *
 */
public class QueryPublicPriceLocalUIAction implements IButtonActionListener<WaybillEditUI>{
	...
	public void actionPerformed(ActionEvent e) {
		...
		QueryPublishPriceUI panel= ui.getQueryPublishPriceUI();
