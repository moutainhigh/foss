...
public class ExpEWaybillSortPendingButtonColumn extends AbstractCellEditor implements TableCellEditor, TableCellRenderer, ActionListener { 
	//日志
	public static final Logger LOGGER = LoggerFactory.getLogger(ExpEWaybillSortPendingButtonColumn.class);
	 ...
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(ExpEWaybillSortPendingButtonColumn.class); 
     ...
     * LinkTableMode
     */
    private ExpEWaybillSortTableMode dtm;  
     ...
     * table mode
     */
    private ExpEWaybillSortTableMode tableModel; 
     ...
     * @param ui
     */
    public ExpEWaybillSortPendingButtonColumn(TableColumn tc, ExpSalesDepartEWaybillUI ui, ExpEWaybillSortTableMode tableModel) {  
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int viewRow, int column) {  
        ...
        if(tableModel!=null){
    		...
    		if(ignoreChieseName.contains(statusChinese)){
    	        ...
    	        dtm = (ExpEWaybillSortTableMode)table.getModel();  
    	        this.row = row;
    	        return editorButton;  
    		}
    	}else{
    ...
    public void actionPerformed(ActionEvent arg0) {  
    	try {
    		//读取运单号
    		Object object = dtm.getValueAt(this.row, 3);
    		if(object == null){
    			//订单号
    			object = dtm.getValueAt(this.row, 4);
    			if(object == null){
