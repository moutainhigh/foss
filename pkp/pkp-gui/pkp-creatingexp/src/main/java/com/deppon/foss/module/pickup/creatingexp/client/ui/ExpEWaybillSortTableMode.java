 ...
 */
public class ExpEWaybillSortTableMode extends AbstractTableModel {

	private static final long serialVersionUID = 1116386589304301730L;
	
	/**
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(ExpEWaybillSortTableMode.class);

	//log object
	private static Log log = LogFactory.getLog(ExpEWaybillSortTableMode.class);
	...
	private String[] tableHeader = {
		...
		//运单状态,订单重量,运单重量,订单体积,运单体积,订单件数,运单件数,付款方式,总费用,代收货款金额,订单退回原因
			i18n.get("foss.gui.creating.ExpReturnedGoodsWaybillUI.Butten.create.wayBillNO"),//运单号
			i18n.get("foss.gui.creating.expEWaybillTableMode.column.eleven"),//发货客户编码
			i18n.get("foss.gui.creating.expEWaybillSortTableMode.column.operatorCode"),//操作人工号
			i18n.get("foss.gui.creating.expEWaybillSortTableMode.column.sort"),//分拣转运场
			i18n.get("foss.gui.creating.expEWaybillSortTableMode.column.sortScanTime")//扫描时间
	};
	
	private Object[][] data;
	
	public ExpEWaybillSortTableMode(Object[][] data){
		this.data = data;
	}
