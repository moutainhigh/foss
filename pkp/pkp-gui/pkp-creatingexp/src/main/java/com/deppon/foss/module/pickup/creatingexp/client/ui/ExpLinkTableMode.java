 ...
 * @version
 */
public class ExpLinkTableMode extends AbstractTableModel {
	 ...
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(ExpLinkTableMode.class); 

	//log object
	private static Log log = LogFactory.getLog(ExpLinkTableMode.class);
	...
	private String[] tableHeader = {i18n.get("foss.gui.creating.linkTableMode.column.zero"),
			...
			i18n.get("foss.gui.creating.linkTableMode.column.nineteen"),
			i18n.get("foss.gui.creating.linkTableMode.column.eighteen")};
	
	private Object[][] data;
	
	public ExpLinkTableMode(Object[][] data){
		this.data = data;
	}
