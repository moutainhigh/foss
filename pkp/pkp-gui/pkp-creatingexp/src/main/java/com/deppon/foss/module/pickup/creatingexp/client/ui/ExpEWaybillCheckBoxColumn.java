 ...
 * 选中导出列
 */
public class ExpEWaybillCheckBoxColumn  extends AbstractCellEditor implements  TableCellEditor, TableCellRenderer  {  
	private static final long serialVersionUID = 1L;
	
	//log
	private Log LOG = LogFactory.getLog(ExpEWaybillCheckBoxColumn.class);
    ...
    public ExpEWaybillCheckBoxColumn(TableColumn tc, ExpSalesDepartEWaybillUI ui){  
	...
	*/
	    ...
	    public void itemStateChanged(ItemEvent e) { 
			...
			if(obj!=null && obj.equals(renderButton)) {
				if(renderButton.isSelected()) {
					...
					Object object = dtm.getValueAt(row, NumberConstants.NUMBER_4);
					if(object == null){
						return;
					}else{
	 ...
	 */
	public void setCheckBoxPartSelected(ExpSalesDepartEWaybillUI ui,JCheckBox checkBox){
		//获得对象集合
	 ...
	 */
	public void setCheckBoxAllSelected(ExpSalesDepartEWaybillUI ui){
