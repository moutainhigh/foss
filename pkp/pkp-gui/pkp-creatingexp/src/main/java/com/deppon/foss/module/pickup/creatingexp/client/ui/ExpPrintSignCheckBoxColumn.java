 ...
 *
 */
public class ExpPrintSignCheckBoxColumn  extends AbstractCellEditor implements  TableCellEditor, TableCellRenderer  {  
	...
	//log
	private Log LOG = LogFactory.getLog(ExpPrintSignCheckBoxColumn.class);
     ...
     * LinkTableMode
     */
    private ExpLinkTableModePrint dtm;  
     ...
     * @param ui
     */
    public ExpPrintSignCheckBoxColumn(TableColumn tc, ExpPrintSignUI ui)  
    {  
    ...
    public Component getTableCellEditorComponent(JTable table,  
        ...
        //  当单元格处于编辑状态时  
    	if(dtm==null){
    		dtm = (ExpLinkTableModePrint)table.getModel(); 
    	}
        this.row = row;  
	...
	*/
	 ...
	 */
	public void setCheckBoxPartSelected(ExpPrintSignUI ui,JCheckBox checkBox){
		//获得对象集合
	 ...
	 */
	public void setCheckBoxAllSelected(ExpPrintSignUI ui){
		//获得对象集合
		List<JCheckBox> list = ui.getList();
		//判断集合是否为空
		if(CollectionUtils.isEmpty(list)){
