 ...
 * @version
 */
public class ExpOfflineButtonColumn extends AbstractCellEditor implements  TableCellEditor, TableCellRenderer ,
   ActionListener {  
	 ...
	 * 国际化对象
	 */
	private II18n i18n = I18nManager.getI18n(ExpOfflineButtonColumn.class); 
	
	//log object
	private Log LOG = LogFactory.getLog(ExpOfflineButtonColumn.class);
     ...
     * @param ui
     */
    public ExpOfflineButtonColumn(TableColumn tc, ExpSalesDeptWaybillUI ui)  
    {  
