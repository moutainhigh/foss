...
public class ExpSalesDeptExportAction extends
		AbstractButtonActionListener<ExpSalesDeptWaybillUI> {
	
	// 国际化
	private static final II18n i18n = I18nManager.getI18n(ExpSalesDeptExportAction.class);
