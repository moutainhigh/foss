 ...
 */
public class ExpSalesDeptInputAction extends AbstractButtonActionListener<ExpSalesDeptWaybillUI> {
	
	// 国际化
	private static final II18n i18n = I18nManager.getI18n(ExpSalesDeptInputAction.class);
	...
	public void actionPerformed(ActionEvent e) {
		ExpLinkTableMode tableModel = null;
		...
		if(flag){
			...
			if(list != null && list.size() > 0){
				...
				if(canImport){//可以导入
					tableModel = new ExpLinkTableMode(ui.getArray(list,1));
			...
			if(tableModel != null){
				...
				new ExpOfflineButtonColumn(table.getColumn(i18n.get("foss.gui.creating.salesDeptInputAction.MsgBox.oprateColumn")), ui);
