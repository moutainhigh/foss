 ...
 *
 */
public class ExpSubmitConfirmCompareImportDialog  extends JDialog {
	...
	private II18n i18n = I18nManager
			.getI18n(ExpSubmitConfirmCompareImportDialog.class);
	 ...
	 * @param waybillEditUI
	 */
	public ExpSubmitConfirmCompareImportDialog(WaybillPanelVo vo,
			ExpWaybillEditUI waybillEditUI) {
	...
	public void init() {
		...
		lblWaybillNum.setFont(new Font("宋体", Font.BOLD, 14));
