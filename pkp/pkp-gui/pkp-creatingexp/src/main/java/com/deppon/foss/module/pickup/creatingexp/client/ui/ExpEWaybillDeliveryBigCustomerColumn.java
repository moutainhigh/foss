 ...
 */
public class ExpEWaybillDeliveryBigCustomerColumn implements TableCellRenderer {
	//日志
	public static final Logger LOGGER = LoggerFactory.getLogger(ExpEWaybillDeliveryBigCustomerColumn.class);
	 ...
	 * @param tableModel
	 */
	public ExpEWaybillDeliveryBigCustomerColumn(TableColumn tc,ExpSalesDepartEWaybillUI ui,ExpEWaybillTableMode tableModel,Object[][] datas) {
	...
	public Component getTableCellRendererComponent(JTable table, Object value,boolean isSelected, boolean hasFocus, int viewRow, int column) {
		//非空判断
    	if(tableModel == null){
    		tableModel = (ExpEWaybillTableMode)table.getModel(); 
    	}
