...
public class ExpSalesDeptDeleteAction extends AbstractButtonActionListener<ExpSalesDeptWaybillUI> {
	
	// 国际化
	private static final II18n i18n = I18nManager.getI18n(ExpSalesDeptDeleteAction.class);
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			ExpSalesDeptSearchAction searchAction = new ExpSalesDeptSearchAction();
