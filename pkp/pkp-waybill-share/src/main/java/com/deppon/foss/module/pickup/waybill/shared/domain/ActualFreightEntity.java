...
public class ActualFreightEntity extends BaseEntity {
	 ...
	 * 到达件数超出值
	 */
	private Integer arriveGoodsQtyMargin;

	/**
	 * 到达未出库件数超出值
	 */
	private Integer arriveNotOutGoodsQtyMargin;
	...
	/**
	 * @return the arriveGoodsQtyMargin
	 */
	public Integer getArriveGoodsQtyMargin() {
		return arriveGoodsQtyMargin;
	}

	/**
	 * @param arriveGoodsQtyMargin the arriveGoodsQtyMargin to set
	 */
	public void setArriveGoodsQtyMargin(Integer arriveGoodsQtyMargin) {
		this.arriveGoodsQtyMargin = arriveGoodsQtyMargin;
	}

	/**
	 * @return the arriveNotOutGoodsQtyMargin
	 */
	public Integer getArriveNotOutGoodsQtyMargin() {
		return arriveNotOutGoodsQtyMargin;
	}

	/**
	 * @param arriveNotOutGoodsQtyMargin the arriveNotOutGoodsQtyMargin to set
	 */
	public void setArriveNotOutGoodsQtyMargin(Integer arriveNotOutGoodsQtyMargin) {
		this.arriveNotOutGoodsQtyMargin = arriveNotOutGoodsQtyMargin;
	}
	...
	/**
	 * @param isEcs the isEcs to set
	 */
	public void setIsEcs(String isEcs) {
		this.isEcs = isEcs;
	}
}
