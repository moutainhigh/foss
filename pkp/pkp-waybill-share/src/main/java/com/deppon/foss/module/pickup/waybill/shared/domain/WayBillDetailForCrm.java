...
public class WayBillDetailForCrm {
    ...
    private List<WaybillCostInfoForCrm> waybillCostInfos;
	...
	public List<WaybillCostInfoForCrm> getWaybillCostInfos() {
		return waybillCostInfos;
	}
	public void setWaybillCostInfos(List<WaybillCostInfoForCrm> waybillCostInfos) {
