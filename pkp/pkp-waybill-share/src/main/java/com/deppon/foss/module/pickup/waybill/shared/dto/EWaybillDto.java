 ...
 * 
 */
public class EWaybillDto implements Serializable{
	...
	// 提货方式
	private DataDictionaryValueEntity receiveMethod;
	...
	public ProductEntity getProductCode() {
		return productCode;
	}

	public void setProductCode(ProductEntity productCode) {
		this.productCode = productCode;
	}

	public DataDictionaryValueEntity getReceiveMethod() {
		return receiveMethod;
	}

	public void setReceiveMethod(DataDictionaryValueEntity receiveMethod) {
