 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/shared/dto/AccountingResultDto.java
 * 
 * FILE NAME        	: AccountingResultDto.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class AccountingResultDto {
	...
	/**
	 * 签收单返还方式1:'客户签收单原件返回',2:'客户签收单传真返回',3:'运单签收联原件返回',4:'运单签收联传真返回'，5:’无需签单’
	 */
	...
	/**
	 * 运单状态（与FOSS的状态信息一致，由网站再做处理：库存中、XX部门-XX部门在途运输、派送中、正常签收/异常签收）
	 */
	private String wayBillState;

	/**
	 * 签收时间(运单的签收时间，若未签收则为空)
	 */
	...
	/**
	 * @param transProperties
	 *            the transProperties to set.
	 */
