 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/shared/dto/WaybillRfcForAccountServiceDto.java
 * 
 * FILE NAME        	: WaybillRfcForAccountServiceDto.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * <p style="display:none">version:V1.0,author:foss-gengzhe,date:2013-1-23 下午3:03:07,content:TODO </p>
 * @author foss-gengzhe
 * @date 2013-1-23 下午3:03:07
 * @since
 * @version
 */
public class WaybillRfcForAccountServiceDto implements Serializable{

	/**
	 * 序列化版本号
	 */
	private static final long serialVersionUID = -8947575267995092868L;
