 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/shared/domain/LabeledGoodTodoEntity.java
 * 
 * FILE NAME        	: LabeledGoodTodoEntity.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 */
public class LabeledGoodTodoEntity extends BaseEntity {
	...
	//是否需要重新入库
	private String needRestock;
	
	public String getNeedRestock() {
		return needRestock;
	}
	
	public void setNeedRestock(String needRestock) {
