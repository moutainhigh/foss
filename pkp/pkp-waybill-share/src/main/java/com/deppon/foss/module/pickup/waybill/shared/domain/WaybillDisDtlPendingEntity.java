 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/shared/domain/WaybillDisDtlPendingEntity.java
 * 
 * FILE NAME        	: WaybillDisDtlPendingEntity.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * @date 2012-10-29 上午11:10:07
 */
public class WaybillDisDtlPendingEntity extends BaseEntity{

    /**
	 * 序列化标识
	 */
	private static final long serialVersionUID = -8280906438246623531L;
    ...
    // 运单费用明细ID
    private String waybillChDePgId;
	...
	/**
	 * @param pricingEntryCode the pricingEntryCode to set
	 */
	...
	/**
	 * @param dicountId the dicountId to set
	 */
	...
	/**
	 * @return the waybillChDePgId
	 */
	public String getWaybillChDePgId() {
		return waybillChDePgId;
	}

	/**
	 * @param waybillChDePgId the waybillChDePgId to set
	 */
	public void setWaybillChDePgId(String waybillChDePgId) {
		this.waybillChDePgId = waybillChDePgId;
	}
