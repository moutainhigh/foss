 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/pickup/edi/ValidationWebTest.java
 * 
 ...
 ******************************************************************************/
package com.deppon.foss.module.pickup.edi;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/pkp-edi-itf/services/ediService?wsdl";
	}
}