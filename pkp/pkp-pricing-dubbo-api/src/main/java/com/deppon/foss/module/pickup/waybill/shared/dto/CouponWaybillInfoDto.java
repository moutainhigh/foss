 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/waybill/shared/dto/CouponWaybillInfoDto.java
 * 
 * FILE NAME        	: CouponWaybillInfoDto.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 * <p style="display:none">version:V1.0,author:foss-sunrui,date:2012-11-15 下午4:35:04, </p>
 * @author foss-sunrui
 * @date 2012-11-15 下午4:35:04
 * @since
 * @version
 * 
 * 录入货物信息SUC业务规则
 ...
 * 
 */
public class CouponWaybillInfoDto implements Serializable {

    /**
     * 序列化标识
     */
    private static final long serialVersionUID = 9191663640150385377L;
    //运单号
    ...
    //费用明细
    protected List<AmountInfoDto> amountInfoList;
    
    /**
     * 定价优化项目--配合降价返券需求
     * 
     * 增加四个字段（出发城市名称、出发城市编码、到达城市名称、到达城市编码）
     * 
     * @author Foss-206860
     * */
    //出发城市名称
    protected String arrivedCity;
    //出发城市编码
    protected String arrivedCityCode;
    //到达城市名称
    protected String leaveCity;
    //到达城市编码
    protected String leaveCityCode;
    
    protected String createOrChange;
    
    
	
	
	public String getCreateOrChange() {
		return createOrChange;
	}

	public void setCreateOrChange(String createOrChange) {
	...
	public void setArrivedCityCode(String arrivedCityCode) {
		this.arrivedCityCode = arrivedCityCode;
	}
	...
	public String getLeaveCityCode() {
		return leaveCityCode;
	}

	public void setLeaveCityCode(String leaveCityCode) {
		this.leaveCityCode = leaveCityCode;
	}
	...
	/**
	 *@param leaveMobile the leaveMobile to set.
	 */
	...
	/**
	 *@param leavePhone the leavePhone to set.
	 */
	...
	/**
	 *@param leaveDept the leaveDept to set.
	 */
	...
	/**
	 *@param arrivedDept the arrivedDept to set.
	 */
	...
	/**
	 *@param arrivedOutDept the arrivedOutDept to set.
	 */
	...
	/**
	 * @return the amountInfoList .
	 */
	public List<AmountInfoDto> getAmountInfoList() {
		return amountInfoList;
	}
	
	/**
	 *@param amountInfoList the amountInfoList to set.
	 */
	public void setAmountInfoList(List<AmountInfoDto> amountInfoList) {
