 ...
 * 
 * FILE PATH        	: src/main/java/com/deppon/foss/module/pickup/pickup/api/server/dao/ICashDiffReportDao.java
 * 
 * FILE NAME        	: ICashDiffReportDao.java
 * 
 * AUTHOR			: FOSS接送货系统开发组
 * 
 ...
 *
 */
public interface ICashDiffReportDao {
	...
	/**
	 * 查看现金差异报表 no pagination
	 * @param dto
	 * @return
	 */
	List<RtCashDiffReportDto> 
		queryCashDiffReport(CashDiffReportDto dto);
	 ...
	 * @return
	 */
	Long queryCashDiffReportTotal(CashDiffReportDto dto);
}