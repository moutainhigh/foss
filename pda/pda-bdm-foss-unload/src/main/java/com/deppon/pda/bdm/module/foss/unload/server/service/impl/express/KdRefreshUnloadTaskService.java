 ...
 * @since
 */
public class KdRefreshUnloadTaskService implements
	...
	public List<UnldCrgDetail> service(AsyncMsg asyncMsg, QryUnldInfo param)
		...
		try {
			res = pdaUnloadTaskService.refrushUnloadTaskPackage(param
					.getTaskCode());
	...
	public String getOperType() {
		return UnLoadConstant.OPER_TYPE_UNLD_TASK_RFSH_PAKAGE.VERSION;
	}
