...
*/ 
public class UnldExceReportScanService implements IBusinessService<Void, UnldExceReportScanEntity> {
	...
	@Transactional
	@Override
	public UnldExceReportScanEntity parseBody(AsyncMsg asyncMsg) throws PdaBusiException {
	...
	public Void service(AsyncMsg asyncMsg, UnldExceReportScanEntity unldExceReportScanEntity)
		...
		try {
			...
			pdaUnloadDiffReportService.handleUnloadDiffReport(
	...
	public String getOperType() {
		return UnLoadConstant.OPER_TYPE_UNLD_EXCE_SCAN.VERSION;
	}
