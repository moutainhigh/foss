...
Ext.define('Foss.predeliver.deliverbill.PrintGridPanel', {
			...
			constructor : function(config) {
				var me = this, cfg = Ext.apply({}, config);
				me.store = Ext
						.create('Foss.predeliver.deliverbill.PrintDeliverStore');
		...
		beforeload : function(store, operation, eOpts) {
			Ext.apply(operation, {
				params : {
					...
					'deliverbillVo.deliverbillDto.id' : store.getDeliverbillId()
				}
			});
		}
	},
...
Ext.define('Foss.predeliver.deliverbill.PrintDeliverbillWindow', {
	...
	constructor : function(config) {
		var me = this, cfg = Ext.apply({}, config);
		me.items = [me.getDeliverPrintHeadInfo(), me.getDeliverPrintGrid(),
