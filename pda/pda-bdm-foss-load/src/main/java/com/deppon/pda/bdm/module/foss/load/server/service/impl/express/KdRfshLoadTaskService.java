 ...
 * @author wfy
 */
public class KdRfshLoadTaskService implements IBusinessService<List<LoadCrgDetail>, QryLoadInfo>{

	private IPDATransferLoadService pdaTransferLoadService;
	private static final Log LOG = LogFactory.getLog(KdRfshLoadTaskService.class);
	/**
	 * 
	...
	public List<LoadCrgDetail> service(AsyncMsg asyncMsg, QryLoadInfo param)
		...
		try {
			 ...
			 res =  pdaTransferLoadService.refrushLoadTaskPackageDetail(param.getTaskCode());
	...
	public String getOperType() {
		return LoadConstant.OPER_TYPE_LOAD_RFSHLOAD.VERSION;
	}
