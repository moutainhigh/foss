 ...
 * @date 2015-1-29
 */
public class SmtLoadTaskEWaybillService implements IBusinessService<Void, SubmitLoadTask>{
	...
	public String getOperType() {
		return AcceptConstant.OPER_TYPE_EXP_RCV_LOAD_TASK_SUBMIT.VERSION;
	}
