 ...
 * @date 2014-12-9    
 */ 
public class RfshExpLoadTaskService implements IBusinessService<List<LoadCrgDetail>, QryLoadInfo>{
	private IPDATransferLoadService pdaTransferLoadService;
	private static final Log LOG = LogFactory.getLog(RfshExpLoadTaskService.class);
	/**
	 * 
	...
	public String getOperType() {
		return LoadConstant.OPER_TYPE_LOAD_RFSEXPDETAIL.VERSION;
	}
