 ...
 * @author wfy
 */
public class KdRfshSalesDepartmentTaskService implements IBusinessService<List<SalesDepartmentCrgDetail>, QrySalesDepartmentInfo>{

	private IPDATransferLoadService pdaTransferLoadService;
	private static final Log LOG = LogFactory.getLog(KdRfshSalesDepartmentTaskService.class);
	/**
	 * 
	...
	public List<SalesDepartmentCrgDetail> service(AsyncMsg asyncMsg, QrySalesDepartmentInfo param)
		...
		try {
			 ...
			 res =  pdaTransferLoadService.refrushSaleLoadTaskPackageDetail(param.getTaskCode());
	...
	public String getOperType() {
		return LoadConstant.OPER_TYPE_SALES_DEPARTMENT_RFSHLOAD.VERSION;
	}
