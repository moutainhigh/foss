 ...
 */
public class SmtLoadTaskIsNotAdminException extends PdaBusiException{

	private static final long serialVersionUID = 1L;
	
	public SmtLoadTaskIsNotAdminException(){
		super();
	}
	
	public SmtLoadTaskIsNotAdminException(Throwable cause){
		super(cause);
	}
	@Override
