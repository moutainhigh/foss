 ...
 *
 */
public class AsyncMsgSyncDao extends iBatis3DaoImpl implements IAsyncMsgSyncDao{
	/**
	 * 
	 * <p>TODO(更改异步消息状态)</p> 
	 * @author Administrator
	 * @date 2013-3-20 下午7:45:37
	 * @param asyncMsgId
	 * @param syncStatus 
