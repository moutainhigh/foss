...
public class AsyncDataGroupSecondQueue implements IAsyncDataSecondQueue<GroupQueueMessage> {
	...
	private static AsyncDataGroupSecondQueue instance;
	
	private AsyncDataGroupSecondQueue(){
		id = UUID.randomUUID().toString();
	}
	
	public static AsyncDataGroupSecondQueue getInstance(){
		if(instance == null){
			instance = new AsyncDataGroupSecondQueue();
		}
		return instance;
	}
