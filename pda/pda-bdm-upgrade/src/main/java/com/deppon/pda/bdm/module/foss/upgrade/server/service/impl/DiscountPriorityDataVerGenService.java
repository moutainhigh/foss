...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.DisCountPriorityEntity;
...
public class DiscountPriorityDataVerGenService extends
		AbstractBaseDataVerGenService<DisCountPriorityEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_DISCOUNT_PRIORITY.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<DisCountPriorityEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (DisCountPriorityEntity entity : localDatas) {
			...
			buffer.append(isNull(entity.getLevels())).append(Constant.VERTICAL_LINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_DISCOUNT_PRIORITY
