...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.MarketingEventEntity;
...
public class MarketingEventDataVerGenService extends
		AbstractBaseDataVerGenService<MarketingEventEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_MARKETING_EVENT.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<MarketingEventEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (MarketingEventEntity entity : localDatas) {
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_MARKETING_EVENT
