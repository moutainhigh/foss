...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.LadingStationEntity;
...
public class ExpressLadingStationDataVerGenService extends
		AbstractBaseDataVerGenService<LadingStationEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		...
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_LADINGSTATION.toUpperCase() + ".txt";
		return filePath;
	}

	@Override
	public String dealLocalDatas(Set<LadingStationEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (LadingStationEntity entity : localDatas) {
			buffer.append(isNull(entity.getId())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDeptCode())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getFinalOutField())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPickArea())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDeliverAre())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getIsPickup())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getIsDelivery())).append(Constant.VERTICAL_LINE);
			
			buffer.append(isNull(entity.getSalesDepartment())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getSignBill())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPickupToDoor())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDelivery())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPickupself())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDeliverAreadesc())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPickupAreadesc())).append(Constant.NEWLINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_LADINGSTATION
