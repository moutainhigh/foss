...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.GoodsTypeEntity;
...
public class GoodsTypeDataVerGenService extends
		AbstractBaseDataVerGenService<GoodsTypeEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_GOODSTYPE.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<GoodsTypeEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (GoodsTypeEntity entity : localDatas) {
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_GOODSTYPE + Constant.UNDERLINE_DELIMITER
