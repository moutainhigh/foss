...
public class RouteDetailDataVerGenService extends
	...
	public String dealLocalDatas(Set<RouteDetailEntity> localDatas) {
		...
		if (localDatas != null && !localDatas.isEmpty()) {
			for (RouteDetailEntity routeDetailEntity : localDatas) {
				buffer.append(isNull(routeDetailEntity.getId())).append(
						Constant.VERTICAL_LINE);
				buffer.append(isNull(routeDetailEntity.getRouteCode())).append(
						Constant.VERTICAL_LINE);
				buffer.append(isNull(routeDetailEntity.getStationSer()))
						.append(Constant.VERTICAL_LINE);
				buffer.append(isNull(routeDetailEntity.getDepartureDept()))
						.append(Constant.VERTICAL_LINE);
				buffer.append(isNull(routeDetailEntity.getDestDept())).append(
						Constant.VERTICAL_LINE);
				buffer.append(isNull(routeDetailEntity.getStoreNum())).append(
						Constant.NEWLINE);
