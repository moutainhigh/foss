 ...
 * @version
 */
public class PriceRegionOrgEntity extends BaseEntity{
	/**
	 * TODO（用一句话描述这个变量表示什么）
	 */
	...
	private String include_org_id;
	private String include_org_code;
	...
	public String getInclude_org_id() {
		return include_org_id;
	}
	public void setInclude_org_id(String include_org_id) {
		this.include_org_id = include_org_id;
	}
	public String getInclude_org_code() {
		return include_org_code;
	}
	public void setInclude_org_code(String include_org_code) {
		this.include_org_code = include_org_code;
	}
