...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.PricingValuationEntity;
...
public class PricingValuationDataVerGenService extends
		AbstractBaseDataVerGenService<PricingValuationEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_PRICING_VALUATION.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<PricingValuationEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (PricingValuationEntity entity : localDatas) {
			buffer.append(isNull(entity.getId())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getCode())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getName())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getGoods_type_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getGoods_type_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getProduct_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getProduct_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDept_region_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getArrv_region_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getSales_channel_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getSales_channel_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPricing_entry_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPricing_entry_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPrice_plan_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPrice_plan_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getMarketing_event_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getMarketing_event_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getLong_or_short())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getCurrency_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getCentralize_pickup())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getFlight_shift())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPricing_industry_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getPricing_industry_code())).append(Constant.VERTICAL_LINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_PRICING_VALUATION
