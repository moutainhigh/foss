...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.EffectiveRegionEntity;
...
public class ExpressEffectiveRegionDataVerGenService extends
		AbstractBaseDataVerGenService<EffectiveRegionEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_EFFECTIVE_REGION.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<EffectiveRegionEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (EffectiveRegionEntity entity : localDatas) {
			...
			buffer.append(isNull(entity.getNationCode())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getProvCode())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getCityCode())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getCountyCode())).append(Constant.VERTICAL_LINE);
//			if (entity.getBeginTime() != null) {
//				buffer.append(DateUtils.formatDateTime(entity.getBeginTime())).append(Constant.VERTICAL_LINE);
//			} else {
//				buffer.append(Constant.BLANK).append(Constant.VERTICAL_LINE);
//			}
			if (entity.getEndTime() != null) {
				buffer.append(DateUtils.formatDateTime(entity.getEndTime())).append(Constant.VERTICAL_LINE);
			} else {
				buffer.append(Constant.BLANK).append(Constant.VERTICAL_LINE);
			}
			buffer.append(isNull(entity.getType())).append(Constant.NEWLINE);
		}
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_EFFECTIVE_REGION
