...
public class ExpressEffectivePlanDetailDataVerGenService extends
	...
	public QueryLocalListDto initBaseDataParam(AsyncMsg asyncMsg,
		...
		// 1通过快递deptCode 从部门区域关系表中查找区域编码
		String deptCode=dto.getDeptCode();
		List<String> regionCodes =systemFunDao.getExpressRegionCodeByDeptCode(deptCode);
	...
	public String getRegionCode(DeptEntity dept){
		...
		if(dept.getDeptCounty()!=null && !dept.getDeptCounty().equals("")){
			regionCode=systemFunDao.getExpressRegionByCount(dept.getDeptCounty());
		}
		if(regionCode==null && dept.getDeptCity()!=null && !dept.getDeptCity().equals("") ){
			regionCode=systemFunDao.getExpressRegionByCity(dept.getDeptCity());
		}
		if(regionCode==null && dept.getDeptProvince()!=null && !dept.getDeptProvince().equals("") ){
			regionCode=systemFunDao.getExpressRegionByProvince(dept.getDeptProvince());
		}
