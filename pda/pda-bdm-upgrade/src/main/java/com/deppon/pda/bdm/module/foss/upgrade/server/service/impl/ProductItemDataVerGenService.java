...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.ProductItemEntity;
...
public class ProductItemDataVerGenService extends
		AbstractBaseDataVerGenService<ProductItemEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_PRODUCT_ITEM.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<ProductItemEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (ProductItemEntity entity : localDatas) {
			buffer.append(isNull(entity.getId())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getT_srv_goodstype_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getT_srv_goodstype_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getT_srv_product_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getT_srv_product_code())).append(Constant.VERTICAL_LINE);
			...
			buffer.append(isNull(entity.getFee_bottom())).append(Constant.VERTICAL_LINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_PRODUCT_ITEM + Constant.UNDERLINE_DELIMITER
