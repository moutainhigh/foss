...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.SalesDeptAsteriskEntity;

/**
 * 
 * TODO(基础数据-星号部门)
 * <p style="display:none">modifyRecord</p>
 * <p style="display:none">version:V1.0,author:chengang,date:2013-5-17 下午4:20:39,content:TODO </p>
 * @author chengang
...
public class SalesDeptAsteriskDataVerGenService extends
		AbstractBaseDataVerGenService<SalesDeptAsteriskEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		...
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_SALESDEPT_ASTERISK.toUpperCase() + ".txt";
		return filePath;
	}

	@Override
	public String dealLocalDatas(Set<SalesDeptAsteriskEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (SalesDeptAsteriskEntity entity : localDatas) {
			buffer.append(isNull(entity.getId())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getSalesDeptId())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getAsterisk_code())).append(Constant.NEWLINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_SALESDEPT_ASTERISK + Constant.UNDERLINE_DELIMITER
