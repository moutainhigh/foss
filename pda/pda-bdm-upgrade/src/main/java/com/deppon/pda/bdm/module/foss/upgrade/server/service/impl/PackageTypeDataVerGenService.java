...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.PackageTypeEntity;
...
public class PackageTypeDataVerGenService extends
		AbstractBaseDataVerGenService<PackageTypeEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_PACKAGE_TYPE.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<PackageTypeEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (PackageTypeEntity entity : localDatas) {
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_PACKAGE_TYPE + Constant.UNDERLINE_DELIMITER
	...
	public String getBaseDataClassName() {
		...
		return PackageTypeEntity.class.getName();
	}
