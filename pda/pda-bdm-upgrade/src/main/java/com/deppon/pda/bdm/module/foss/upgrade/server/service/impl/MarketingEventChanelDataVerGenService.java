...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.MarketingEventChanelEntity;
...
public class MarketingEventChanelDataVerGenService extends
		AbstractBaseDataVerGenService<MarketingEventChanelEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_MARKETING_EVENT_CHANEL.toUpperCase()
				+ ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<MarketingEventChanelEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (MarketingEventChanelEntity entity : localDatas) {
			...
			buffer.append(isNull(entity.getT_srv_marketing_event_id())).append(Constant.VERTICAL_LINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_MARKETING_EVENT_CHANEL
