...
public class ExpressRouteDataVerGenService extends
	...
	public String dealLocalDatas(Set<RouteEntity> localDatas) {
		...
		if (localDatas != null && !localDatas.isEmpty()) {
			for (RouteEntity routeEntity : localDatas) {
				buffer.append(isNull(routeEntity.getId())).append(Constant.VERTICAL_LINE);
				buffer.append(isNull(routeEntity.getDepartureCity())).append(Constant.VERTICAL_LINE);
				buffer.append(isNull(routeEntity.getDestCity())).append(Constant.VERTICAL_LINE);
				buffer.append(isNull(routeEntity.getTransMode())).append(Constant.VERTICAL_LINE);
				buffer.append(isNull(routeEntity.getIsDefault())).append(Constant.NEWLINE);
