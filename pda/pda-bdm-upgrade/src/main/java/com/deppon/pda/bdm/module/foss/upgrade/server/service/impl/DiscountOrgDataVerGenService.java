...
import com.deppon.pda.bdm.module.foss.upgrade.shared.domain.DisCountOrgEntity;
 ...
 * </p>
 * <p style="display:none">
 * version:V1.0,author:chengang,date:2013-3-18 下午2:59:14,content:TODO
 * </p>
 * 
 * @author chengang
 * @date 2013-3-18 下午2:59:14
 * @since
 * @version
 */

public class DiscountOrgDataVerGenService extends
		AbstractBaseDataVerGenService<DisCountOrgEntity> {
	...
	public String bulidAllPath(String currVer, File file) {
		String filePath = file.getParent() + File.separator + currVer
				...
				+ Constant.TABLE_NAME_DISCOUNT_ORG.toUpperCase() + ".txt";
		return filePath;
	}
	 ...
	 */
	@Override
	public String dealLocalDatas(Set<DisCountOrgEntity> localDatas) {
		StringBuffer buffer = new StringBuffer();
		// 把字段值封装到StringBuffer中
		for (DisCountOrgEntity entity : localDatas) {
			buffer.append(isNull(entity.getId()) + Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDept_org_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getArrv_org_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getT_srv_pricing_valuation_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDept_org_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getArrv_org_id())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDept_org_type_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getArrv_org_type_code())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getDept_org_type_name())).append(Constant.VERTICAL_LINE);
			buffer.append(isNull(entity.getArrv_org_type_name())).append(Constant.VERTICAL_LINE);
	...
	public void zipAllBaseDataFiles(String filePath, String buffer) {
		...
		String[] filed = PropertyConstant.PRO_DATA_MAP.get(
				Constant.TABLE_NAME_DISCOUNT_ORG + Constant.UNDERLINE_DELIMITER
