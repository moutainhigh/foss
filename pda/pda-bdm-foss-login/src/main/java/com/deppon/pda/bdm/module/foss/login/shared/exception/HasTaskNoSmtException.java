 ...
 */
public class HasTaskNoSmtException extends PdaBusiException{
private static final long serialVersionUID = -8795819955980486273L;
	 ...
	 * @param message 异常消息
	 */
	public HasTaskNoSmtException(String taskType) {
		super();
	 ...
	 * @param cause 原因
	 */
	public HasTaskNoSmtException(Throwable cause) {
		super(cause);
	} 
	
	public String getErrCode() {
		return ExceptionConstant.ERRCODE_BUSI_LOGIN_TASKNOSMT;
	}
