...
//				goodsweight, pcsweight, from, to);
	...
	private static byte[] getELPCommand(String cnpyCd, String cnpyNm,
		...
		cmdBuilder.append("A145,50,0,8,2,2,N,").append("\"").append(cnpyNm)
				.append("\"").append("\r\n");
		cmdBuilder.append("A45,150,0,8,1,2,N,\"货运单号\"").append("\r\n");
		cmdBuilder.append("A155,155,0,4,1,2,N,\"/AWB.NO\"").append("\r\n");
		cmdBuilder.append("A215,205,0,5,1,1,N,").append("\"").append(waybillNo)
				.append("\"").append("\r\n");
		cmdBuilder.append("A45,280,0,8,1,2,N,\"件数\"").append("\r\n");
		cmdBuilder.append("A95,285,0,4,1,2,N,\"/PCS\"").append("\r\n");
		cmdBuilder.append("A85,335,0,5,1,1,N,").append("\"").append(pieces)
				.append("\"").append("\r\n");
		cmdBuilder.append("A210,280,0,8,1,2,N,\"货物重量\"").append("\r\n");
		cmdBuilder.append("A315,285,0,4,1,2,N,\"/WTS.(KG)\"").append("\r\n");
		cmdBuilder.append("A275,335,0,5,1,1,N,").append("\"")
				.append(goodsweight).append("\"").append("\r\n");
		cmdBuilder.append("A525,280,0,8,1,2,N,\"本件重量\"").append("\r\n");
		cmdBuilder.append("A635,285,0,4,1,2,N,\"/WTHS\"").append("\r\n");
		cmdBuilder.append("A585,335,0,5,1,1,N,").append("\"").append(pcsweight)
				.append("\"").append("\r\n");
		cmdBuilder.append("A45,410,0,8,1,2,N,\"始发站\"").append("\r\n");
		cmdBuilder.append("A120,415,0,4,1,2,N,\"/FROM\"").append("\r\n");
		cmdBuilder.append("A75,465,0,8,2,2,N,").append("\"").append(from)
				.append("\"").append("\r\n");
		cmdBuilder.append("A425,410,0,8,1,2,N,\"目的站\"").append("\r\n");
		cmdBuilder.append("A500,415,0,4,1,2,N,\"/TO\"").append("\r\n");
		cmdBuilder.append("A455,465,0,8,2,2,N,").append("\"").append(to)
				.append("\"").append("\r\n");
