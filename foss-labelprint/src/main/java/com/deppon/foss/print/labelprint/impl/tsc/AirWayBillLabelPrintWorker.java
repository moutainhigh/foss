...
//				goodsweight, pcsweight, from, to);
	...
	private static byte[] getELPCommand(String cnpyCd, String cnpyNm,
		...
		cmdBuilder.append("LO275,280,3,130").append("\r\n");
		cmdBuilder.append("LO525,280,3,130").append("\r\n");
		cmdBuilder.append("LO400,410,3,130").append("\r\n");
		cmdBuilder.append("A145,50,0,8,2,2,N,").append("\"").append(cnpyNm)
				.append("\"").append("\r\n");
		cmdBuilder.append("A45,155,0,8,1,1,N,\"货运单号/AWB NC.\"").append("\r\n");
		cmdBuilder.append("A215,205,0,5,1,1,N,").append("\"").append(waybillNo)
				.append("\"").append("\r\n");
		cmdBuilder.append("A45,285,0,8,1,1,N,\"件数/PCS\"").append("\r\n");
		cmdBuilder.append("A125,335,0,5,1,1,N,").append("\"").append(pieces)
				.append("\"").append("\r\n");
		cmdBuilder.append("A285,285,0,8,1,1,N,\"货物重量/WTS.\"").append("\r\n");
		cmdBuilder.append("A345,335,0,5,1,1,N,").append("\"")
				.append(goodsweight).append("\"").append("\r\n");
		cmdBuilder.append("A535,285,0,8,1,1,N,\"本件重量/WTHS\"").append("\r\n");
