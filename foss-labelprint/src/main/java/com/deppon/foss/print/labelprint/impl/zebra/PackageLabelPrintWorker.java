...
//		printStrTemplate.append("R160,0\n");//设置左边距，上边距
		printStrTemplate.append("R" + labelForm.getLeft() + "," + labelForm.getTop() + "\n");//设置打印左边距和上边距
		printStrTemplate.append("X035,1,16,455,700\r\n");//画矩形框
		printStrTemplate.append("LO35,350,420,8\r\n");//框内横线
		printStrTemplate.append("LO175,1,8,700\r\n");//第一条竖线
		printStrTemplate.append("LO315,1,8,350\r\n");//第一条竖线
		
		printStrTemplate.append("A430,40,1,8,3,2,N,\"德邦快递\"\r\n");//打印"德邦快递"四个字
		//读取德邦LOGO图片
//		printStrTemplate.append("GM\"DPLOGO\"").append(len).append("\r\n");
//		printStrTemplate.append("A385,160,1,8,2,2,N,\"快递\"\r\n");//在图片下打印上"快递"两个字
		...
		printStrTemplate.append("B400,395,1,1,2,24,90,N,\""+labelForm.getBarCode()+"\"\r\n");//条形码
		//打印包编码
		printStrTemplate.append("A290,390,1,2,2,2,N,\""+labelForm.getBarCode()+"\"\r\n");//条形码
...
//		end.append("GG380,20,\"DPLOGO\"").append("\r\n");
		end.append("P1\r\n");//打印一份
