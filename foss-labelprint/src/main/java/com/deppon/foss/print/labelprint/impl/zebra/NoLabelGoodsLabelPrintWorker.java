...
public class NoLabelGoodsLabelPrintWorker extends LabelPrintWorker {
	...
	public void printByZebra(LabelPrintContext lblPrintContext) throws Exception 
	{
		...
		for (Map m : lst){
			...
			printStrParam.append("A275,480,1,8,1,1,N,\""+(String)m.get("packing")+"\"\r\n");//包装  
			...
			printStrParam.append("A310,18,1,8,2,1,N,\""+currentOrgName+"\"\r\n");                 //当前部门
			printStrParam.append("A236,10,1,8,1,1,N,\""+(String)m.get("goodsareanameorhandovernolbl")+"\"\r\n");//货区/交接单号lbl
			printStrParam.append("A220,130,1,4,2,1,N,\""+(String)m.get("goodsareanameorhandoverno")+"\"\r\n"); //货区/交接单号
...
//			}
			printStrParam.append("A158,10,1,8,1,1,N,\"【品名】\"\r\n");
			printStrParam.append("A150,130,1,8,1,1,N,\""+(String)m.get("goodsname")+"\"\r\n");//品名
			printStrParam.append("A80,10,1,8,1,1,N,\"【重量】\"\r\n");                          //重量
			printStrParam.append("A60,130,1,4,1,1,N,\""+(String)m.get("weight")+"\"\r\n");     //重量
			printStrParam.append("A80,265,1,8,1,1,N,\"【体积】\"\r\n");
			printStrParam.append("A60,380,1,4,1,1,N,\""+(String)m.get("volume")+"\"\r\n");     //体积
			
//			//画线条
//			printStrParam.append("X10,10,2,780,540\r\n");//画矩形框
//			printStrParam.append("LO300,460,3,80\r\n"); //第一条竖线
//			printStrParam.append("LO560,10,3,455\r\n"); //第二条竖线
//			printStrParam.append("LO13,140,765,3\r\n"); //第一条横线
//			printStrParam.append("LO13,250,765,3\r\n");//第二条横线
//			printStrParam.append("LO13,390,550,3\r\n");//第三条横线
//			printStrParam.append("LO13,460,765,3\r\n");//第四条横线
			
			//输出内容
//			printStrParam.append("A20,18,0,8,1,1,N,\"德邦物流\"\r\n");              //打印公司LOGO
//			printStrParam.append("LO20,50,180,3\r\n");                             //LOGO下面的线
//			printStrParam.append("A20,60,0,8,1,1,N,\""+userName+"\"\r\n");         //工号		
//			printStrParam.append("A20,100,0,8,1,1,N,\""+printDateStr+"\"\r\n");     //打印日期			
//			printStrParam.append("B230,25,0,1,2,12,98,N,\""+(String)m.get("barcode")+"\"\r\n");    //条码
//			printStrParam.append("A580,50,0,8,1,2,N,\"无标签多货\"\r\n");             //打印中文【无标签】			
//			String pcsAndTotalpcs = (Integer)m.get("serialno")+"/"+(String)m.get("totalpieces");
//			printStrParam.append("A570,158,0,8,1,1,N,\""+pcsAndTotalpcs+"\"\r\n");//总件数
//			printStrParam.append("A570,200,0,8,1,1,N,\""+(String)m.get("packing")+"\"\r\n");//包装  
//			printStrParam.append("A575,280,0,4,2,2,N,\"W\"\r\n");                           //W[无标签开头拼音字母]
//			printStrParam.append("A605,280,0,4,2,2,N,\""+(String)m.get("waybillnumber1")+"\"\r\n");//单号1
//			printStrParam.append("A575,355,0,4,2,2,N,\""+(String)m.get("waybillnumber2")+"\"\r\n");//单号2
//			printStrParam.append("A20,158,0,8,2,2,N,\""+currentOrgName+"\"\n");                 //当前部门
//			printStrParam.append("A20,263,0,8,1,1,N,\""+(String)m.get("goodsareanameorhandovernolbl")+"\"\r\n");//货区/交接单号lbl
//			printStrParam.append("A20,320,0,8,2,2,N,\""+(String)m.get("goodsareanameorhandoverno")+"\"\r\n"); //货区/交接单号
////			if(lblPrintContext.getTestEnvInd()!=null && lblPrintContext.getTestEnvInd().length()>0 ){
////				printStrParam.append("A460,290,0,8,1,2,R,\""+lblPrintContext.getTestEnvInd()+"\"\n");
////			}
//			printStrParam.append("A20,410,0,8,1,1,N,\"【品名】\"\r\n");
//			printStrParam.append("A145,410,0,8,1,1,N,\""+(String)m.get("goodsname")+"\"\r\n");//品名
//			printStrParam.append("A20,480,0,8,1,1,N,\"【重量】\"\r\n");                          //重量
//			printStrParam.append("A145,480,0,8,1,1,N,\""+(String)m.get("weight")+"\"\r\n");     //重量
//			printStrParam.append("A310,480,0,8,1,1,N,\"【体积】\"\r\n");
//			printStrParam.append("A430,480,0,8,1,1,N,\""+(String)m.get("volume")+"\"\r\n");     //体积
