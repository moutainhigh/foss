package com.deppon.foss.print.labelprint.impl.sato;
...
^PQ1,0,1,Y^XZ
			*/
			...
			//^FO5,6^GB469,308,8^FS最左边的数线
			printStrTemplate.append("^FO5,6^GB469,308,1^FS\r\n");
			//^FO10,218^GB458,0,8^FS"德邦快递"上面的横线
			printStrTemplate.append("^FO7,218^GB464,0,1^FS\r\n");
			//^FO19,251^GB113,0,8^FS德邦快递下面的小横线
			printStrTemplate.append("^FO19,251^GB113,0,1^FS\r\n");
			//^FO62,7^GB0,213,8^FS紧贴上海市右面的数线
			printStrTemplate.append("^FO62,0^GB0,220,1^FS\r\n");
