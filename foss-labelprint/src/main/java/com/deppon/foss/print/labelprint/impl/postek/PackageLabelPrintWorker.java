...
//		packageForm.setGoodQty(goodQty);
	...
	public List<byte[]> printByZebra(LabelPrintContext lblPrintContext) throws Exception {
		...
		//printStrTemplate.append("X080,50,16,400,600\r\n");//画矩形框.
		printStrTemplate.append("LO15,1,420,16\r\n");//框上面横线
		printStrTemplate.append("LO15,10,16,700\r\n");//框左面竖线
		printStrTemplate.append("LO15,701,420,16\r\n");//框下面横线
		printStrTemplate.append("LO430,10,16,700\r\n");//框右面竖线
		printStrTemplate.append("LO15,350,420,9\r\n");//框内横线
		printStrTemplate.append("LO175,10,9,700\r\n");//第一条竖线
		printStrTemplate.append("LO315,10,9,350\r\n");//第一条竖线
		
//		printStrTemplate.append("A415,40,1,8,2,2,N,\"德邦快递\"\r\n");//打印"德邦快递"四个字
		//读取德邦LOGO图片()
//		printStrTemplate.append("GM\"DPLOGO\"").append(len).append("\r\n");
		
		printStrTemplate.append("A425,20,1,8,4,3,N,\"德邦快递\"\r\n");//在图片下打印上"快递"两个字
		
		printStrTemplate.append("A298,20,1,8,2,2,N,\"始发地：\"\r\n");//始发地
		printStrTemplate.append("A158,20,1,8,2,2,N,\"目的地：\"\r\n");//目的地
		printStrTemplate.append("A158,370,1,8,2,2,N,\"件数：\"\r\n");//件数
		//B129,95,0,1,4,12,160,N,"B122333"
		printStrTemplate.append("B400,410,1,1,2,12,120,N,\""+labelForm.getBarCode()+"\"\r\n");//条形码
		//打印包编码
		printStrTemplate.append("A260,410,1,2,2,2,N,\""+labelForm.getBarCode()+"\"\r\n");//条形码
