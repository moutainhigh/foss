...
public class ModifyFormatJRViewer extends JPanel implements JRHyperlinkListener {
	  private static final Log log = LogFactory.getLog(ModifyFormatJRViewer.class);
	  ...
	  private transient SimpleFileResolver fileResolver;
	  private JasperPrint fullJasperPrint;
	  private JasperPrint noImgJasperPrint;
	  private int pageIndex;
	  private boolean pageError;
	  private float zoom;

	  private transient JRGraphics2DExporter exporter;

	  private int screenResolution = REPORT_RESOLUTION;

	  private float realZoom;
	  private static final int zoomSplit = 8;
	  ...
	  //设置与其他地方间距多少
	  private javax.swing.JPanel pnlSep04;
	  //半页
	  private javax.swing.JLabel btnHalfView;
	  //设置与其他地方间距多少
	  private javax.swing.JPanel pnlSep05;
	  //全页
	  private javax.swing.JLabel btnFullView;
	  ...
	  private transient KeyListener keyNavigationListener = new KeyListener() {
	  ...
	  protected transient JRSaveContributor lastSaveContributor;

	  public ModifyFormatJRViewer(JasperPrint jrPrint) throws Exception {
	    this(jrPrint, null, null , false);
	  }

	  public ModifyFormatJRViewer(JasperPrint fulljp, JasperPrint noimgjp, Locale locale, boolean isPrintHalf) throws Exception {
	    this(fulljp, noimgjp, locale, null, isPrintHalf);
	  }

	  public ModifyFormatJRViewer(JasperPrint fulljp, JasperPrint noimgjp,
	      Locale locale, ResourceBundle resBundle, boolean isPrintHalf) throws Exception {
	    ...
	    initBtnHalfOrFull(isPrintHalf);

	    addHyperlinkListener(this);
	  }

	  private void initBtnHalfOrFull(boolean isPrintHalf) {
		  //设置为红色
		  if(isPrintHalf){
			  btnHalfView.setForeground(Color.RED);
			  btnHalfView.setFont(new Font("宋体",Font.BOLD,12));
			  btnFullView.setFont(new Font("宋体",Font.BOLD,10));
			  btnFullView.setEnabled(false);
		  }else{
			  btnFullView.setForeground(Color.RED);
			  btnFullView.setFont(new Font("宋体",Font.BOLD,12));
			  btnHalfView.setFont(new Font("宋体",Font.BOLD,10));
			  btnHalfView.setEnabled(false);
		  }		
	}
	...
	private void setScreenDetails() {
	  ...
	  public void clear() {
	    emptyContainer(this);
	    fullJasperPrint = null;
	    noImgJasperPrint = null;
	  }
	  
	  private JasperPrint getDisplayJasperPrint(){
		  if(fullJasperPrint!=null){
	  ...
	  protected void initResources(Locale locale, ResourceBundle resBundle) {
	    ...
	    if (resBundle == null) {
	      this.resourceBundle = ResourceBundle.getBundle("com/deppon/foss/print/viewer/messages", getLocale());
	    } else {
	  ...
	  protected void initSaveContributors() throws Exception {
	  ...
	  private boolean isOnlyHyperlinkListener() {
	    int listenerCount;
	  ...
	  private static final Dimension BTN_DIMESION = new Dimension(23, 23);
	  private static final Dimension WINDOW_DIMESION = new Dimension(450, 150);
	  private void initComponents()throws Exception {
	    ...
	    btnHalfView = new javax.swing.JLabel("半页版");
	    btnFullView = new javax.swing.JLabel("全页版");
	    DefaultComboBoxModel model = new DefaultComboBoxModel();
	    for (int i = 0; i < zooms.length; i++) {
	      model.addElement(String.valueOf(zooms[i] + "%"));
	    }
	    cmbZoom.setModel(model);
	    
	    if(noImgJasperPrint!=null ){
	      chkShowImage = new JCheckBox("显示背景");
	      chkShowImage.setSelected(true);
	      chkShowImage.addActionListener(new ActionListener() {
	    ...
	    btnSave.setMaximumSize(BTN_DIMESION);
	    btnSave.setMinimumSize(BTN_DIMESION);
	    btnSave.setPreferredSize(BTN_DIMESION);
	    ...
	    btnPrint.setMaximumSize(BTN_DIMESION);
	    btnPrint.setMinimumSize(BTN_DIMESION);
	    btnPrint.setPreferredSize(BTN_DIMESION);
	    ...
	    btnFirst.setMaximumSize(BTN_DIMESION);
	    btnFirst.setMinimumSize(BTN_DIMESION);
	    btnFirst.setPreferredSize(BTN_DIMESION);
	    ...
	    btnPrevious.setMaximumSize(BTN_DIMESION);
	    btnPrevious.setMinimumSize(BTN_DIMESION);
	    btnPrevious.setPreferredSize(BTN_DIMESION);
	    ...
	    btnNext.setMaximumSize(BTN_DIMESION);
	    btnNext.setMinimumSize(BTN_DIMESION);
	    btnNext.setPreferredSize(BTN_DIMESION);
	    ...
	    btnLast.setMaximumSize(BTN_DIMESION);
	    btnLast.setMinimumSize(BTN_DIMESION);
	    btnLast.setPreferredSize(BTN_DIMESION);
	    ...
	    btnActualSize.setMaximumSize(BTN_DIMESION);
	    btnActualSize.setMinimumSize(BTN_DIMESION);
	    btnActualSize.setPreferredSize(BTN_DIMESION);
	    ...
	    btnFitPage.setMaximumSize(BTN_DIMESION);
	    btnFitPage.setMinimumSize(BTN_DIMESION);
	    btnFitPage.setPreferredSize(BTN_DIMESION);
	    ...
	    btnFitWidth.setMaximumSize(BTN_DIMESION);
	    btnFitWidth.setMinimumSize(BTN_DIMESION);
	    btnFitWidth.setPreferredSize(BTN_DIMESION);
	    ...
	    btnZoomIn.setMaximumSize(BTN_DIMESION);
	    btnZoomIn.setMinimumSize(BTN_DIMESION);
	    btnZoomIn.setPreferredSize(BTN_DIMESION);
	    ...
	    btnZoomOut.setMaximumSize(BTN_DIMESION);
	    btnZoomOut.setMinimumSize(BTN_DIMESION);
	    btnZoomOut.setPreferredSize(BTN_DIMESION);
	    ...
	    /*if(noImgJasperPrint!=null ){
	      tlbToolBar.add(chkShowImage);
	    }*/
	    pnlSep04.setMaximumSize(new java.awt.Dimension(10, 300));
	    tlbToolBar.add(pnlSep04);
	    //半页
	    tlbToolBar.add(btnHalfView);
	    
	    pnlSep05.setMaximumSize(new Dimension(23, 200));
	    tlbToolBar.add(pnlSep05);
	    
	    //整页
	    tlbToolBar.add(btnFullView);
	  ...
	  void txtGoToActionPerformed(java.awt.event.ActionEvent evt){
	    try {
	      ...
	      if (pageNumber != pageIndex + 1 && pageNumber > 0 && pageNumber <= getDisplayJasperPrint().getPages().size()) {
	  ...
	  void pnlMainComponentResized(java.awt.event.ComponentEvent evt) {
	    ...
	    if (btnFitPage.isSelected()) {
	      ...
	      setRealZoomRatio(((float) pnlInScroll.getVisibleRect().getWidth() - 20f) / getDisplayJasperPrint().getPageWidth());
	  ...
	  void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {
	    ...
	    if (retValue == JFileChooser.APPROVE_OPTION) {
	      ...
	      try {
	        contributor.save(getDisplayJasperPrint(), file);
	      } catch (JRException e) {
	    ...
	    Thread thread = new Thread(new Runnable() {
	      public void run() {
	        try {
	          ...
	          ModifyFormatJRViewer.this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//	          JasperPrintManager.printReport(getDisplayJasperPrint(), true);
	          //打印时背景图片不打印
	          if(noImgJasperPrint!=null){
	        	  JasperPrintManager.printReport(noImgJasperPrint, true);	            
	          }else{
	            JasperPrintManager.printReport(fullJasperPrint, true);
	          }      
	        } catch (Exception ex) {
	          if (log.isErrorEnabled()) {
	            log.error("Print error.", ex);
	          }
	          JOptionPane.showMessageDialog(ModifyFormatJRViewer.this, getBundleString("error.printing"));
	        } finally {
	        	ModifyFormatJRViewer.this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	  ...
	  {
	    // Add your handling code here:
	    setPageIndex(getDisplayJasperPrint().getPages().size() - 1);
	    refreshPage();
	  }
	  ...
	  private void setPageIndex(int index) {
	    if (getDisplayJasperPrint() != null && getDisplayJasperPrint().getPages() != null && getDisplayJasperPrint().getPages().size() > 0) {
	      if (index >= 0 && index < getDisplayJasperPrint().getPages().size()) {
	        pageIndex = index;
	        pageError = false;
	        btnFirst.setEnabled((pageIndex > 0));
	        btnPrevious.setEnabled((pageIndex > 0));
	        btnNext.setEnabled((pageIndex < getDisplayJasperPrint().getPages().size() - 1));
	        btnLast.setEnabled((pageIndex < getDisplayJasperPrint().getPages().size() - 1));
	        txtGoTo.setEnabled(btnFirst.isEnabled() || btnLast.isEnabled());
	        txtGoTo.setText(String.valueOf(pageIndex + 1));
	        lblStatus.setText(MessageFormat.format(getBundleString("page"), new Object[] { Integer.valueOf(pageIndex + 1), Integer.valueOf(getDisplayJasperPrint().getPages().size()) }));
	      }
	    } else {
	  ...
	  protected void loadReport(JasperPrint fulljp, JasperPrint noimgjp) {
	    fullJasperPrint = fulljp;
	    noImgJasperPrint = noimgjp;
	    type = TYPE_OBJECT;
	  }
	  ...
	  protected void refreshPage() {
	    ...
	    Dimension dim = new Dimension((int) (getDisplayJasperPrint().getPageWidth() * realZoom) + zoomSplit, 
	        (int) (getDisplayJasperPrint().getPageHeight() * realZoom) + zoomSplit);
	    ...
	    if (maxImageSize <= 0) {
	      ...
	      long imageSize = JRPrinterAWT.getImageSize(getDisplayJasperPrint(), realZoom);
	  ...
	  protected void setPageImage() {
	    ...
	    if (pageError) {
	      ...
	      try {
	        image = JasperPrintManager.printPageToImage(getDisplayJasperPrint(), pageIndex, realZoom);
	      } catch (Exception e) {
	        if (log.isErrorEnabled()) {
	  ...
	  protected Image getPageErrorImage() {
	    Image image = new BufferedImage((int) (getDisplayJasperPrint().getPageWidth() * realZoom) + 1, (int) (getDisplayJasperPrint().getPageHeight() * realZoom) + 1, BufferedImage.TYPE_INT_RGB);
	  ...
	  public void setZoomRatio(float newZoom) {
	    if (newZoom > 0) {
	      ...
	      if (Float.compare(zoom, newZoom) != 0) {
	        zoom = newZoom;
	  ...
	  private void setRealZoomRatio(float newZoom) {
	    if (newZoom > 0 && Float.compare(realZoom, newZoom) != 0) {
	  ...
	  public void setFitPageZoomRatio() {
	    setRealZoomRatio(((float) pnlInScroll.getVisibleRect().getHeight() - 20f) / getDisplayJasperPrint().getPageHeight());
	  }
	  ...
	  protected void paintPage(Graphics2D grx) {
	    ...
	    try {
	      ...
	      exporter.setParameter(JRExporterParameter.JASPER_PRINT, getDisplayJasperPrint());
	      ...
	      SwingUtilities.invokeLater(new Runnable() {
	        public void run() {
	          JOptionPane.showMessageDialog(ModifyFormatJRViewer.this, getBundleString("error.displaying"));
	        }
	      });
	    }
	  }
	  ...
	  protected void drawPageError(Graphics grx) {
	    ...
	    grx.fillRect(0, 0, getDisplayJasperPrint().getPageWidth() + 1, getDisplayJasperPrint().getPageHeight() + 1);
	  }
	  ...
	  protected void keyNavigate(KeyEvent evt) {
	    ...
	    case KeyEvent.VK_END:
	      homeEndNavigate(getDisplayJasperPrint().getPages().size() - 1);
	      break;
	    default:
	      refresh = false;
	    }
	  ...
	  private void dnNavigate(KeyEvent evt) {
	    ...
	    if ((scrollPane.getViewport().getHeight() > pnlPage.getHeight() || scrollPane.getVerticalScrollBar().getValue() == bottomPosition) && pageIndex < getDisplayJasperPrint().getPages().size() - 1) {
	      setPageIndex(pageIndex + 1);
	  ...
	  private void fitPage() {
	    float heightRatio = ((float) pnlInScroll.getVisibleRect().getHeight() - 20f) / getDisplayJasperPrint().getPageHeight();
	    float widthRatio = ((float) pnlInScroll.getVisibleRect().getWidth() - 20f) / getDisplayJasperPrint().getPageWidth();
	    setRealZoomRatio(heightRatio < widthRatio ? heightRatio : widthRatio);
	  }

	  static class PageRenderer extends JLabel {
	    private static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;

	    private boolean renderImage;
	    ModifyFormatJRViewer viewer = null;

	    public PageRenderer(ModifyFormatJRViewer viewer) {
	      this.viewer = viewer;
	    }
