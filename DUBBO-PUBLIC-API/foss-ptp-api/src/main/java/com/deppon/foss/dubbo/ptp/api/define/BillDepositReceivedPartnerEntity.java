...
public class BillDepositReceivedPartnerEntity implements Serializable {
	...
	/**
	 * @param cashierAccounting
	 *            the cashierAccounting to set
	 */
	 ...
	 *            the billDepositReceivedEntityList to set
	 */
	...
	/**
	 * @param generatingOrgCodes
	 *            the generatingOrgCodes to set
	 */
	 ...
	 *            the totalUnverifyAmount to set
	 */
