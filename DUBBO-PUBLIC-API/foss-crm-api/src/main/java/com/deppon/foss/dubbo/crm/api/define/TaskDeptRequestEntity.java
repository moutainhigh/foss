...
/**
 * FOSS可以根据运单的库存状态匹配出相应的任务部门，并通过接口将任务部门传给CRM。 此类是定义 CRM传递给FOSS中转接口之间参数
 * 
 * @author 335284
 * @since 2016.11.23
 */
public class TaskDeptRequestEntity implements Serializable {
	...
	/**
	 * 调用类型 1、methodType == 1 匹配任务部门 2、methodType == 2 匹配工单短信部门
	 */
