...
public class CustCustbasedata extends BaseEntity implements Serializable {
	...
	public String toString() {
		return "CustCustbasedata [fid=" + fid + ", faddrtype=" + faddrtype + ", fareaid=" + fareaid
				+ ", fbecomememtime=" + fbecomememtime + ", fbilltitle=" + fbilltitle + ", fbrandworth=" + fbrandworth
				+ ", fbusstype=" + fbusstype + ", fchannel=" + fchannel + ", fchannelsource=" + fchannelsource
				+ ", fcity=" + fcity + ", fcityid=" + fcityid + ", fcompaddr=" + fcompaddr + ", fcompanyproperty="
				+ fcompanyproperty + ", fcompanyscop=" + fcompanyscop + ", fcontactid=" + fcontactid + ", fcreatetime="
				+ fcreatetime + ", fcreateuserid=" + fcreateuserid + ", fcreditrate=" + fcreditrate + ", fcustname="
				+ fcustname + ", fcustnature=" + fcustnature + ", fcustnumber=" + fcustnumber + ", fcustpotentialtype="
				+ fcustpotentialtype + ", fcuststatus=" + fcuststatus + ", fcusttype=" + fcusttype + ", fdegree="
				+ fdegree + ", fdeptid=" + fdeptid + ", ffocusdeptid=" + ffocusdeptid + ", ffocusdeptname="
				+ ffocusdeptname + ", fisacceptmarket=" + fisacceptmarket + ", fisfocuspay=" + fisfocuspay
				+ ", fisimportcustor=" + fisimportcustor + ", fisparentcompany=" + fisparentcompany
				+ ", fisredeempoints=" + fisredeempoints + ", fisspecial=" + fisspecial + ", fistrangoods="
				+ fistrangoods + ", flastchangtime=" + flastchangtime + ", flastmodifyuserid=" + flastmodifyuserid
				+ ", flastupdatetime=" + flastupdatetime + ", flastyearincome=" + flastyearincome + ", flastyearprofit="
				+ flastyearprofit + ", fnextlevel=" + fnextlevel + ", fparentcompanyid=" + fparentcompanyid
				+ ", fparentnumber=" + fparentnumber + ", fpreferenceservice=" + fpreferenceservice + ", fprocredit="
				+ fprocredit + ", fprovince=" + fprovince + ", fprovinceid=" + fprovinceid + ", frecommendcust="
				+ frecommendcust + ", fregistaddress=" + fregistaddress + ", fregisterfund=" + fregisterfund
				+ ", fremark=" + fremark + ", fresponsibillity=" + fresponsibillity + ", fsimplename=" + fsimplename
				+ ", ftaxregnumber=" + ftaxregnumber + ", ftradeid=" + ftradeid + ", fupgradesource=" + fupgradesource
				+ ", fversionnumber=" + fversionnumber + ", fdeptidStandardcode=" + fdeptidStandardcode
				+ ", financeCancel=" + financeCancel + ", fshipperSms=" + fshipperSms + ", freceiverSms=" + freceiverSms
				+ ", fisAccurateCollection=" + fisAccurateCollection + ", ifBigCustomer=" + ifBigCustomer
				+ ", fisExpKeycustomer=" + fisExpKeycustomer + ", fcustcategory=" + fcustcategory + ", custGroup="
				+ custGroup + ", fistTrade=" + fistTrade + ", secondTrade=" + secondTrade + ", fossId=" + fossId
				+ ", ifElecBillBigCust=" + ifElecBillBigCust + ", fteanLimit=" + fteanLimit + ", fixedReceiveMobile="
				+ fixedReceiveMobile + ", fcompaddrRemark=" + fcompaddrRemark + ", finvoiceType=" + finvoiceType
				+ ", flabelleavemonth=" + flabelleavemonth + ", blackListCategory=" + blackListCategory
				+ ", expHandChargeBusiType=" + expHandChargeBusiType + ", setProportion=" + setProportion
