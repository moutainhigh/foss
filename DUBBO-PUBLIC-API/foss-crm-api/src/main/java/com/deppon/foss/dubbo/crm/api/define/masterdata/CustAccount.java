...
public class CustAccount extends BaseEntity implements Serializable {
    ...
    */
	...
	public String toString() {
		return "CustAccount [fid=" + fid + ", fcreateuserid=" + fcreateuserid + ", fcreatedeptid=" + fcreatedeptid
				+ ", fcreatetime=" + fcreatetime + ", flastupdateuserid=" + flastupdateuserid + ", flastupdatedeptid="
				+ flastupdatedeptid + ", flastupdatetime=" + flastupdatetime + ", fbank=" + fbank
				+ ", fisdefaultaccount=" + fisdefaultaccount + ", fcountname=" + fcountname + ", fbankprovinceid="
				+ fbankprovinceid + ", fbankarea=" + fbankarea + ", fbankcityid=" + fbankcityid + ", ffinancelinkman="
				+ ffinancelinkman + ", flinkmanmobile=" + flinkmanmobile + ", fsubbankname=" + fsubbankname
				+ ", fbankaccount=" + fbankaccount + ", frelation=" + frelation + ", fbelongcustom=" + fbelongcustom
				+ ", fstatus=" + fstatus + ", faccountnature=" + faccountnature + ", faccountuse=" + faccountuse
				+ ", flinkmanphone=" + flinkmanphone + ", fbankid=" + fbankid + ", fsubbanknameid=" + fsubbanknameid
				+ ", ffinancelinkmanid=" + ffinancelinkmanid + ", fbankprovincename=" + fbankprovincename
				+ ", fbankcityname=" + fbankcityname + "]";
	}
}