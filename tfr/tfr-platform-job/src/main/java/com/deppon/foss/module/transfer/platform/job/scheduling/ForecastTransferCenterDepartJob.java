 ...
 */
public class ForecastTransferCenterDepartJob extends BaseStateFulJob {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ForecastTransferCenterDepartJob.class);
	...
	protected void doExecute(JobExecutionContext context)
		...
		try {
			...
			jobProcess = tfrCommonService.queryJobInfo(
					TfrJobBusinessTypeEnum.FORECAST_TRANSFERCENTER_DEPART,
			...
			forecastJOBService.forecastTransferCenterTotal(
					ForecastConstants.FORECAST_DEPART,
			...
			jobProcessLogEntity
					.setBizName(TfrJobBusinessTypeEnum.FORECAST_TRANSFERCENTER_DEPART
							.getBizName());
			jobProcessLogEntity
					.setBizCode(TfrJobBusinessTypeEnum.FORECAST_TRANSFERCENTER_DEPART
							.getBizCode());
