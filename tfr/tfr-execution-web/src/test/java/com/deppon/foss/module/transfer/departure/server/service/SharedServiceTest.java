...
@Transactional 
public class SharedServiceTest extends 
		AbstractTransactionalJUnit4SpringContextTests
{
	...
	{  
		sharedService.refreshDataForActionTask("CALCULATE_TRANSPORT_PATH");
//		sharedService.refreshDataForActionTask("BILL_STATUS"); 
//		sharedService.refreshDataForActionTask("INSTOCK");       
//		sharedService.doRefresh(); 
	}   
