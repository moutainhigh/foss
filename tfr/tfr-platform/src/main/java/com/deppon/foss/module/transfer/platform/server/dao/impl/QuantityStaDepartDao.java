...
public class QuantityStaDepartDao extends iBatis3DaoImpl implements
		IQuantityStaDepartDao {

	private static final String NAMESPACE = "com.deppon.foss.module.transfer.platform.api.server.dao.IQuantityStaDepartDao.";
	...
	@Override
	public void deleteDepart(QuantityStaGoodsCondDto dto) {
		super.getSqlSession().delete(NAMESPACE + "deleteDepart", dto);
	}
	...
	@Override
	public void delete2ndDayDepart(QuantityStaGoodsCondDto dto) {
		super.getSqlSession().delete(NAMESPACE + "delete2ndDayDepart", dto);
	}

	@Override
	public void delete2ndDayDepartFcst(QuantityStaGoodsCondDto dto) {
		super.getSqlSession().delete(NAMESPACE + "delete2ndDayDepartFcst", dto);
	}
