 ...
 ******************************************************************************/
package com.deppon.foss.prt.ldppartiallinesn;
...
//				StringBuffer serialNos = new StringBuffer();
				...
				for(HandOverBillSerialNoDetailEntity handOverBillSerialNoDetail : handOverBillSerialNoDetails) {
					...
					//流水号
					m.put("serialNo", handOverBillSerialNoDetail.getSerialNo());
					//流水号明细
					m.put("serialNos",Integer.valueOf(handOverBillSerialNoDetail.getSerialNo()));
					//运单号
