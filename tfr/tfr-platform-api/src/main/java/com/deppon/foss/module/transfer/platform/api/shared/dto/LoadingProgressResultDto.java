 ...
 */
public class LoadingProgressResultDto implements Serializable{
	 ...
	 * 装车效率 单位min/T
	 */
	private BigDecimal loadEfficiency;
	
	
	/** 
	 * @return loadEfficiency 
	 */
	public BigDecimal getLoadEfficiency() {
		return loadEfficiency;
	}

	/** 
	 * @param loadEfficiency 要设置的 loadEfficiency 
	 */
	public void setLoadEfficiency(BigDecimal loadEfficiency) {
