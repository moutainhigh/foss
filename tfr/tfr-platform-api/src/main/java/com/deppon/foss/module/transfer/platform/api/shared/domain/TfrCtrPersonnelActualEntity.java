...
/**
 * 外场实际人员实体，对应表结构tfr.t_opt_tc_personnel_actual
 * @author Ouyang
 */
public class TfrCtrPersonnelActualEntity extends BaseEntity {

	private static final long serialVersionUID = -8844774123146354059L;
	...
	public String toString() {
		return "TfrCtrPersonnelActualEntity [transferCenterCode="
				...
				+ other + ", totalQty=" + totalQty + ", dimission=" + dimission
