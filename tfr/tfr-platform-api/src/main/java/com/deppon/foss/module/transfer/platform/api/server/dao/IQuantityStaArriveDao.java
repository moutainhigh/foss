...
public interface IQuantityStaArriveDao {

	/**
	 * @desc 将到达实际货量插入最近16天的表
	 ...
	 * @author Ouyang
	 */
	void deleteArrive(QuantityStaGoodsCondDto dto);

	/**
	 * @desc 调用pkg_opt_quantity_sta_arrive.pro_insert_actual生成到达实际货量
	 * @param dto
	 ...
	 * @author Ouyang
	 */
	void delete2ndDayArrive(QuantityStaGoodsCondDto dto);
	 ...
	 * @author Ouyang
	 */
	void delete2ndDayArriveFcst(QuantityStaGoodsCondDto dto);

	/**
	 * @desc 调用pkg_opt_quantity_sta_arrive. pro_insert_2nd_actual生成第2天到达实际货量
	 * @param dto
	...
	/**
	 * @desc 将T_OPT_STA_arrive_16DAY中超过16天的数据复制至T_OPT_STA_arrive_HIS
	 * @param date
	...
	/**
	 * @desc 将T_OPT_STA_arrive_16DAY中超过16天的数据删除
	 * @param date
	 * @date 2014年9月3日 下午4:11:56
	 * @author Ouyang
	 */
	...
	/**
	 * @desc 将T_OPT_STA_arrive_FCST中超过8天的数据复制至T_OPT_STA_arrive_FCST_HIS
	 * @param date
	 * @date 2014年9月3日 下午4:11:56
	 * @author Ouyang
	 */
	...
	/**
	 * @desc 将T_OPT_STA_arrive_FCST中超过8天的数据删除
	 * @param date
	 * @date 2014年9月3日 下午4:11:56
	 * @author Ouyang
	 */
