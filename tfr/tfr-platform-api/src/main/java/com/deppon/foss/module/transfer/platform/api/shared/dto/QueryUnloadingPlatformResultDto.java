 ...
 */
public class QueryUnloadingPlatformResultDto implements Serializable{
	...
	*/
	...
	public void setUnloadedVolume(BigDecimal unloadedVolume) {
		this.unloadedVolume = unloadedVolume.setScale(PlatformConstants.SONAR_NUMBER_3,BigDecimal.ROUND_HALF_UP);
	}
	...
	public void setUnloadedWeight(BigDecimal unloadedWeight) {
		this.unloadedWeight = unloadedWeight.setScale(PlatformConstants.SONAR_NUMBER_3,BigDecimal.ROUND_HALF_UP);
	}
	...
	public void setPredictCompleteMinutes(BigDecimal predictCompleteMinutes) {
		this.predictCompleteMinutes = predictCompleteMinutes.setScale(PlatformConstants.SONAR_NUMBER_5,BigDecimal.ROUND_HALF_UP);
	}
