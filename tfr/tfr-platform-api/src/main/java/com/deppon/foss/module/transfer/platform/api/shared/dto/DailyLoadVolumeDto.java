 ...
 *  
 */
public class DailyLoadVolumeDto extends BaseEntity {
	...
	*/ 
	...
	/**
	 * 月承载量
	* @fields monthLoadVolume
	* @author 14022-foss-songjie
	* @update 2014年7月1日 上午11:18:32
	* @version V1.0
	*/
	private BigDecimal monthLoadVolume;
	...
	* @version 1.0
	* @author 14022-foss-songjie
	* @update 2014年7月1日 上午11:19:01
	*/
	public BigDecimal getMonthLoadVolume() {
		return monthLoadVolume;
	}

	
	/**
	* @description 月承载量
	* @param monthLoadVolume
	* @version 1.0
	* @author 14022-foss-songjie
	* @update 2014年7月1日 上午11:19:04
	*/
	public void setMonthLoadVolume(BigDecimal monthLoadVolume) {
		this.monthLoadVolume = monthLoadVolume;
	}
