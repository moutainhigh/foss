 ...
 *  
 *  FILE PATH     :src/main/java/com/deppon/foss/module/transfer/scheduling/api/server/dao/ITruckDepartPlanUpdateDao.java
 * 
 ...
 */
public interface ITruckDepartPlanUpdateDao {
	/**
	 * 新增日志
	 * 
	 * @author 096598-foss-zhongyubing
	 ...
	 */
	Long queryTotalCount(TruckDepartPlanDetailDto detailDto);

	/**
	 * 批量新增日志
	 * 
	 * @author 096598-foss-zhongyubing
	 * @date 2012-12-4 上午10:08:21
	 */
