...
Ext.define('Foss.unload.unloadtaskbindtrayDetail.QueryUnloadBindTrayDetailStore', {
	...
	proxy : {
		...
		actionMethods:'POST',
		// 请求的url
		url : unload.realPath('queryUnloadbindTrayDetailByUnloadTaskNoExpress.action'),
		// 定义一个读取器
		reader : {
			// 以JSON的方式读取
			type : 'json',
	...
	constructor: function(config){
		...
		me.tbar = [{
			...
			handler : function(){
				...
				Ext.Ajax.request({
					url : unload.realPath('exportUnloadTaskbindTrayDetailExcelExpress.action'),
					method : 'POST',
...
Ext.onReady(function() {
	...
	//卸车任务编号
	recordForm.findField('unloadTaskNo').setValue(unload.traybindmanager.unloadTaskNo);
	//卸车创建人
	recordForm.findField('unloadCreator').setValue(unload.traybindmanager.createrName);
	//创建卸车任务时间
	recordForm.findField('unloadTaskCreateTime').setValue(unload.traybindmanager.createTime);
	//已扫描总件数
	Ext.getCmp('Foss_unload_unloadtaskbindtrayDetail_totalPieces').setValue(unload.traybindmanager.unLoadScanPieces);
	//已绑定件数
	Ext.getCmp('Foss_unload_unloadtaskbindtrayDetail_bindPieces').setValue(unload.traybindmanager.bindPieces);
	//叉车扫描件数
	Ext.getCmp('Foss_unload_unloadtaskbindtrayDetail_scanPieces').setValue(unload.traybindmanager.scanPieces);
	//托盘绑定率
	Ext.getCmp('Foss_unload_unloadtaskbindtrayDetail_bindRate').setValue(unload.traybindmanager.bindRate+"%");
	...
	Ext.Ajax.request({
		url : unload.realPath('queryUnloadTaskbindTrayExpress.action'),
		params : params,
		success : function(response){
			var result = Ext.decode(response.responseText);
			//定义基本信息实体
			var basicInfo = result.unloadbindTrayVo.unloadbindTrayListExpress;
			//绑定model
