 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/module/transfer/management/api/server/dao/ISendSignBillDao.java
 *  
 *  FILE NAME          :ISendSignBillDao.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 */
public interface ISendSignBillDao {
	 ...
	 * @date 2012-11-29 上午10:50:47
	 */
	 List<SendSignBillEntity> queryExportSendSignBill(SendSignBillDto sendSignBillDto); 
