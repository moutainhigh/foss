 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/module/transfer/management/api/server/dao/IOtherSignBillDao.java
 *  
 *  FILE NAME          :IOtherSignBillDao.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 */
public interface IOtherSignBillDao {
	/**
	 *   新增其他签单
	 * 
	 * @author dp-liming
	 ...
	 * @date 2012-11-29 上午10:50:47
	 */
	 List<OtherSignBillEntity> queryExportOtherSignBill(OtherSignBillDto otherSignBillDto); 
