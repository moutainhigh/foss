...
Ext.define('Foss.forecastQuantity.JoinCarAdjust.LineInfoOnePanel', {
	...
	items : [{
		padding : '10 0 10 0',
		columnWidth: 1,
		text : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.joinCarAdjust.lineOne'),
		...
		padding : '10 0 10 0',
		xtype : 'displayfield',
		fieldLabel : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.joinCarAdjust.OrigVolume'),
		labelWidth: 70,
		allowBlank : true,
		name : 'oneOrigVolume'
	}, {
		...
		xtype : 'label',
		columnWidth: .1,
		text : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.volumeUnit')
	}, {
		columnWidth: .9,
		padding : '0 0 10 0',
		xtype : 'displayfield',
		fieldLabel : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.joinCarAdjust.adjustVolume'),
		labelWidth: 70,
		allowBlank : true,
...
Ext.define('Foss.forecastQuantity.JoinCarAdjust.LineInfoTwoPanel', {
	...
	items : [{
		padding : '10 0 10 0',
		columnWidth: 1,
		text : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.joinCarAdjust.lineTwo'),
		style : 'font-weight:bold;'
	}, {
		columnWidth: 1,
		itemId: 'two_path'
...
Ext.define('Foss.forecastQuantity.JoinCarAdjust.AdjustInputPanel', {
	...
	items : [{
			...
			items : [{
						xtype : 'label',
						columnWidth : .4,
						text : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.joinCarAdjust.adjustVolume')
					}, {
						xtype : 'numberfield',
						name : 'adjustVolume',
						columnWidth : .45
...
Ext.define('Foss.forecastQuantity.JoinCarAdjust.OperatePanel', {
	...
	items : [{
				...
				xtype : 'button',
				disabled : !scheduling.forecastQuantity.isPermission('scheduling/changeQuantityButton'),
				hidden : !scheduling.forecastQuantity.isPermission('scheduling/changeQuantityButton'),
				text : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.check'),
				cls : 'yellow_button',
				columnWidth : .2,
				handler : function() {
					...
					if (adjustVolume == 0) {
						Ext.MessageBox.alert(scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.hint'), scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.noChange'));
						return false;
					}
					...
					Ext.Ajax.request({
								url : scheduling.realPath('changeQuantity.action'),
								jsonData : params,
								success : function(response) {
									Ext.ux.Toast.msg(scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.hint'), scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.success'));
									scheduling.forecastQuantity.queryResult.store.load();
									window.close();
								},
				...
				xtype : 'button',
				text : scheduling.forecastQuantity.i18n('foss.scheduling.forecastQuantity.cancle'),
				cls : 'yellow_button',
				columnWidth : .2,
				handler : function() {
