 ...
 ******************************************************************************/
package com.deppon.foss.prt.stoagentwaybill;
 ...
 */
public class STOAgentWaybillPrtDataSource implements MultiJasperDataSource {
	/**
	 * @author niuly
	 * @date 2014-08-21 15:22:12
	 * @function 新建数据源
	...
	public void addAgentWaybillPrintrecord(String waybillNo, String agentWaybillNo, Date createTime, IPrintAgentWaybillService printAgentWabillService, 
			String currentDeptCode, String currentDeptName, String currentUserCode, String currentUserName , String printTemplate) {
		//交接单打印记录
		...
		//设置公司编码
		printRecord.setAgentCompanyCode(printTemplate);
		//设置公司名字
		printRecord.setAgentCompanyName(PartiallineConstants.agentWaybillMap.get(printTemplate));
		//设置打印次数
...
//				parameter.put("receiverTel", waybillEntity.getReceiverTel());
				...
				//代理公司code
				String printTemplate = (String) jasperContext.get("printTemplate");
				
				//插入代理面单打印记录
				addAgentWaybillPrintrecord(waybillNos[i], agentWaybillNos[i], new Date(), printAgentWabillService, 
						currentDeptCode, currentDeptName, currentUserCode, currentUserName , printTemplate);
			}
			return parameter;
		}
