 ...
 ******************************************************************************/
package com.deppon.foss.prt.ucagentwaybill;
 ...
 */
public class UCAgentWaybillPrtDataSource implements MultiJasperDataSource {
	/**
	 * @author niuly
	 * @date 2014-08-21 15:22:12
	 * @function 新建数据源
	...
	public void addAgentWaybillPrintrecord(String waybillNo, String agentWaybillNo, Date createTime, IPrintAgentWaybillService printAgentWabillService, 
		...
		//设置公司编码
		printRecord.setAgentCompanyCode(PartiallineConstants.AGENT_WAYBILL_UC);
		//设置公司名字
		printRecord.setAgentCompanyName(PartiallineConstants.agentWaybillMap.get(PartiallineConstants.AGENT_WAYBILL_UC));
		//设置打印次数
...
//				parameter.put("agentWaybillNo", agentWaybillNos[i]);
				...
				//发货人手机
				parameter.put("deliverPhone", waybillEntity.getDeliverPhone());
				//收货人
				parameter.put("receiverName", waybillEntity.getReceiverName());
				//收货人电话
				parameter.put("receiverTel", waybillEntity.getReceiverTel());
				//收货人手机
				parameter.put("receiverPhones", waybillEntity.getReceiverPhone());
				//收货人地址
				String receiverAddr = new StringBuffer().append(waybillEntity.getReceiverProv())
						.append(waybillEntity.getReceiverCity())
						.append(waybillEntity.getReceiverDist())
						.append(waybillEntity.getReceiverAddr()).toString();
				parameter.put("receiverAddr", receiverAddr);
				//货物名称
			...
			System.out.println("receiverPhone4=================" + parameter.get("receiverPhones"));
			return parameter;
		}
