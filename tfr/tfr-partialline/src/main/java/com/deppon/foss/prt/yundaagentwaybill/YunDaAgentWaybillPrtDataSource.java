 ...
 ******************************************************************************/
package com.deppon.foss.prt.yundaagentwaybill;
 ...
 */
public class YunDaAgentWaybillPrtDataSource implements MultiJasperDataSource {
	/**
	 * @author niuly
	 * @date 2014-08-21 15:22:12
	 * @function 新建数据源
	...
	public void addAgentWaybillPrintrecord(String waybillNo, String agentWaybillNo, Date createTime, IPrintAgentWaybillService printAgentWabillService, 
		...
		//设置公司编码
		printRecord.setAgentCompanyCode(PartiallineConstants.AGENT_WAYBILL_YUNDA);
		//设置公司名字
		printRecord.setAgentCompanyName(PartiallineConstants.agentWaybillMap.get(PartiallineConstants.AGENT_WAYBILL_YUNDA));
		//设置打印次数
