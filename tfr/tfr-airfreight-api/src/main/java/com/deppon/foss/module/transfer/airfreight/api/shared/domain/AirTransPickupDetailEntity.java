 ...
 *  package_name  : 
 *  
 *  FILE PATH          :/AirTransPickupDetailEntity.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 * @date 2012-12-25 下午6:27:13
 */
public class AirTransPickupDetailEntity extends BaseEntity {
	private static final long serialVersionUID = 95566010998396272L;
	/**
	 * 中转提货清单外键ID
	 */
	 ...
	 * 设置 中转提货清单外键ID.
	 *
	 * @param airTransferPickupbillId the new 中转提货清单外键ID
	 */
	...
	/**
	 * @return airPickQty : return the property airPickQty.
	 * @author 269701-foss-lln
	 * @update 2016年5月28日 上午10:20:19
	 * @version V1.0
	 */
	...
	/**
	 * @param airPickQty : set the property airPickQty.
	 * @author 269701-foss-lln
	 * @update 2016年5月28日 上午10:20:19
	 * @version V1.0
	 */
