...
Ext.define('Foss.airfreight.StockStatusStore',{
	...
	data:{
		'items':[ 
			{code:'',name:airfreight.airCargoVolume.i18n('foss.airfreight.all')},	
			{code:'NOTLEAVE',name:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.billing')},
			{code:'HANDOVER',name: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.handover')},
			{code:'INSTORE',name: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.instore')},
			{code:'Y',name: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.load')}
		]
	},
	proxy:{
		type:'memory',
...
Ext.define('Foss.airfreight.queryForm',{
	...
	frame: true,
	border: false,
	title : airfreight.airCargoVolume.i18n('foss.airfreight.airSpaceQueryForm.title'),	
	fieldDefaults: {
		msgTarget: 'side',
		labelWidth: 75
	},
	...
	items: [{
		xtype: 'combo',
		fieldLabel: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.stockStatus'),
		name: 'stockStatus',
		displayField: 'name',
		valueField:'code', 
		columnWidth:.25,
		...
		fieldLabel: airfreight.airCargoVolume.i18n('foss.airfreight.arrvRegionName'),//目地站
		name: 'arrvRegionCode',
		columnWidth:.25,
		listeners: {
		...
		name: 'flightType',
		fieldLabel: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.flightType'),
		queryMode: 'local',
		forceSelection: true,
		editable: true,
		value: '',
		columnWidth: .25
			...
			'valueCode':'',
			'valueName': airfreight.airCargoVolume.i18n('foss.airfreight.all')
	}),{
		xtype:'dynamicorgcombselector',
		fieldLabel:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.assembleOrgName'),
		...
		columnWidth: .2,
		items:[{
			boxLabel  : airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.rangeDateField'),
			name      : 'dateType',  
			checked : true,
			inputValue: 'createTime'  //表示是开单时间
		},{
			boxLabel  : airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.handoverTime'),
			name      : 'dateType',  
		...
		layout:'column',
		items : [{
			text : airfreight.airCargoVolume.i18n('foss.airfreight.airSpaceQueryForm.button.reset'),  //重置
			columnWidth : .1,
			handler : function() {
				...
				if(airfreight.airCargoVolume.dept.airDispatch == 'Y'){
					cmbOrgCode.getStore().load({params:{'commonOrgVo.name' : airfreight.airCargoVolume.dept.name}});
					cmbOrgCode.setValue(airfreight.airCargoVolume.dept.code);
				}
			...
			text : airfreight.airCargoVolume.i18n('foss.airfreight.airSpaceQueryForm.button.search'),//查询
			columnWidth : .1,
			cls:'yellow_button',
			handler : function() {
				var form = this.up('form').getForm();
		    	if(form.isValid()){
		    		airfreight.airCargoVolume.pagingBar.moveFirst();
					airfreight.airCargoVolume.store.load();
		    	}
			}
		},{
			text: airfreight.airCargoVolume.i18n('foss.airfreight.airSpaceQueryForm.button.export'), //导出
			cls:'yellow_button',
			columnWidth:.1,
			...
			handler:function(){
				...
				Ext.Ajax.request({
					url:airfreight.realPath('airCargoVolumeExportExcel.action'),
		...
		render : function(panel,text){
			...
			Ext.Ajax.request({
				...
				success : function(response) {
					...
					airfreight.airCargoVolume.dept = dept;
...
Ext.define('Foss.airfreight.airCargoVolumeStore',{
	...
	proxy: {
	        type: 'ajax',
	        url: airfreight.realPath('queryAirCargoVolume.action'),//"queryAirCargoVolume"
		...
		listeners: {			
			datachanged: function(store, operation, epots){
				var queryForm = airfreight.queryForm;
				if (queryForm != null) {
					...
					Ext.Ajax.request({
						url : airfreight.realPath('queryAirCargoVolumeTotal.action'),
						jsonData:array,
						success : function(response) {
							var json = Ext.decode(response.responseText);							
							//在json中取出对象
							...
							if(airCargoVolumeList != null && airCargoVolumeList.length>0 ){	
								...
								var count = 0;
								var toolbarArray = airfreight.airCargoVolumeGrid.down('toolbar').query('textfield');
								...
								top.Ext.MessageBox.alert(airfreight.airCargoVolume.i18n('foss.airfreight.messageBox.alert.tip.title'),json.message);
							}
						},
...
Ext.define('Foss.airfreight.airSpaceDetailStore',{
	...
	proxy: {
	        type: 'ajax',
	        url: airfreight.realPath('queryAirSpaceForVolume.action'),
	        actionMethods: {read: 'POST'},
	        reader: {
	            type: 'json',
...
Ext.define('Foss.airfreight.airCargoVolume.airCargoVolumeGrid', {
	...
	//定义表格的标题
	title: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.airCargoVolumeGrid.title'),
	frame: true,
    bodyCls: 'autoHeight',
	cls: 'autoHeight',
	autoScroll: true,
	...
	columns: [{
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.waybillNo'), 
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.createOrgName'), 
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.handoverTime'), 
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.arrvRegionName'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.airWaybillNo'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.flightNo'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			dataIndex: 'flightNo' ,
			flex: 1.3 
			...
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.stockStatus'),
			//关联model中的字段名
			dataIndex: 'stockStatus',
			renderer:function(value){
				if(value=='NOTLEAVE') return airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.billing');
				else if(value=='INSTORE') return airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.instore');
				else  if(value=='Y') return airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.load');
				else  return airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.handover');
				},
				flex: 1.3 
		},{ 
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.makeWaybillWay'),
			//关联model中的字段名
			...
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.flightType'),	
			//关联model中的字段名
			...
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.goodsSize'),	
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			dataIndex: 'goodsSize',
			flex: 1.3 
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.goodsWeight'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.billWeight'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.goodsVolume'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.fee'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			dataIndex: 'fee' ,
			flex: 1.3 
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.goodsName'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			dataIndex: 'goodsName' ,
			flex: 1.3 
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.pickupType'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.deptOrgName'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.receviceDept'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			...
			//字段标题
			header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.codAmount'),
	    	xtype : 'ellipsiscolumn',
			//关联model中的字段名
			dataIndex: 'codAmount' ,
			flex: 1.3 
		...
		dockedItems:[{
			   ...
			   items:[{
				   fieldLabel:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.weightTotal'),	
				   labelWidth:70,
				   columnWidth:.15,
				   dataIndex: 'weightTotal'
			   },{
				   fieldLabel:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.volumeTotal'),
				   columnWidth:.15,
		...
		constructor: function(config){
			...
			airfreight.airCargoVolume.pagingBar = me.bbar;
			me.callParent([cfg]);
		}
});
...
Ext.define('Foss.airfreight.airCargoVolume.TaskExplainContainer',{
	...
	items:[{
		...
		html:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.load'),
		columnWidth:.25
	},{
			margin: '2 5 0 0',
			cls: 'predeliver_notice_customer_row_green'
	},{
		html:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.instore'),
		columnWidth:.25
	},{
			margin: '2 5 0 0',
			cls: 'predeliver_notice_customer_row_orange'
	},{
		html:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.billing'),
		columnWidth:.25
	},{
			margin: '2 5 0 0',
			cls: 'predeliver_notice_customer_row_yellow'
	},{
		html:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.handover'),
		columnWidth:.25
	}]
});
...
Ext.define('Foss.airfreight.airCargoVolume.airSpaceDetailGrid', {
	...
	collapsible: true,
	animCollapse: false,
	title:airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.airSpaceDetailGrid.title'),
	cls:'autoHeight',
	bodyCls:'autoHeight',
	emptyText : airfreight.airCargoVolume.i18n('foss.airfreight.emptyText'),
	store: null,
	selModel: null,	
	autoScroll:true,	
	columns: [{		
		...
		sortable: false, 
		//字段标题
		header:  airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.takeOffDate'),
		//关联model中的字段名
		...
		sortable: false, 
		//字段标题
		header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.earlySpaceTotal'), //即日达总仓位</br>(公斤)
		//关联model中的字段名
		...
		sortable: false, 
		//字段标题
		header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.middaySpaceTotal'), //次日达总仓位</br>(公斤), 
		//关联model中的字段名
		...
		sortable: false, 
		//字段标题
		header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.transitSpaceTotal'), //航空普运总仓位</br>(公斤) 
		//关联model中的字段名
		...
		sortable: false, 
		//字段标题
		header: airfreight.airCargoVolume.i18n('foss.airfreight.airCargoVolume.label.transitSpaceTotal'), //'中转总仓位</br>（公斤）', 
		//关联model中的字段名
		dataIndex: 'transitSpaceTotal'
	}*/],
	constructor: function(config){
		...
		airfreight.airCargoVolume.store=me.store;
	
		me.callParent([cfg]);
	}	
});

airfreight.airCargoVolume.dept = '';
