...
<ext:module subModule="airNotifyCustomersIndex"/>
<link rel="stylesheet" type="text/css" href="${styles}/predeliver.css">
<script type="text/javascript" src="${scripts}/airNotifyCustomers.js"></script>
<script type="text/javascript" src="${scripts}/../print/print.js"></script>
<body>
	<div id="mainAreaPanel">
		<div id="T_airfreight-airNotifyCustomersIndex-body"></div>
	</div>
</body>
