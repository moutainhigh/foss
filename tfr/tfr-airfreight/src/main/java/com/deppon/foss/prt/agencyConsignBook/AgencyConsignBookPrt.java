 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/prt/agencyConsignBook/AgencyConsignBookPrt.java
 *  
 *  FILE NAME          :AgencyConsignBookPrt.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
...
public class AgencyConsignBookPrt extends JFrame {
	...
	public static void main(String[] args ){
		try{
			AgencyConsignBookPrt prt = new AgencyConsignBookPrt();
			
			JasperContext jctx = new JasperContext();
			jctx.setPrtkey("agencyConsignBook");
