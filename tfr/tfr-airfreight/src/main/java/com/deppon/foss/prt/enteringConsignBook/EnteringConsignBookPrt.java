 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/prt/enteringConsignBook/EnteringConsignBookPrt.java
 *  
 *  FILE NAME          :EnteringConsignBookPrt.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
...
public class EnteringConsignBookPrt extends JFrame {
	...
	public static void main(String[] args ){
		try{
			EnteringConsignBookPrt prt = new EnteringConsignBookPrt();
			
			JasperContext jctx = new JasperContext();
			jctx.setPrtkey("enteringConsignBook");
			//jctx.setJasperfile("com/deppon/foss/framework/jasper/demo/demoprt.jrxml");
			//jctx.setDatasourceclz("com.deppon.foss.framework.jasper.demo.DemoPrtDataSource");
