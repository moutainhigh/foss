 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/prt/agency/AgencyListPrt.java
 *  
 *  FILE NAME          :AgencyListPrt.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
...
public class AgencyListPrt extends JFrame {
	...
	public static void main(String[] args ){
		try{
			AgencyListPrt prt = new AgencyListPrt();
			
			JasperContext jctx = new JasperContext();
			jctx.setPrtkey("agency");
