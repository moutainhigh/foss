 ...
 * @update 2016年11月21日
 */
public class FinshSaleWKLoadTaskDto {
...
//	String taskNo,Date loadEndTime,String deviceNo,String loaderCode
	...
	public String toString() {
		return "FinshWKLoadTaskDto [loadTaskNo=" + loadTaskNo
				+ ", loadEndTime=" + loadEndTime + ", operationOrgCode="
				+ operationOrgCode + ", operationTime=" + operationTime
				+ ", operatorNo=" + operatorNo + ", sendType=" + sendType
				+ ", isCancel=" + isCancel + ", loaderCode=" + loaderCode
				+ ", taskStatus=" + taskStatus + ", deviceNo=" + deviceNo
