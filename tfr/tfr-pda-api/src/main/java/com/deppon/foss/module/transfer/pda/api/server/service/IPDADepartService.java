 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/module/transfer/pda/api/server/service/IPDADepartService.java
 *  
 *  FILE NAME          :IPDADepartService.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 */
public interface IPDADepartService extends IService
{
	/**
	 * 
	 * 记录PDA发车时间
