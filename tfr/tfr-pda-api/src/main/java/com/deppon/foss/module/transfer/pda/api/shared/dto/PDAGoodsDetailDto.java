 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/module/transfer/pda/api/shared/dto/PDAGoodsDetailDto.java
 *  
 *  FILE NAME          :PDAGoodsDetailDto.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 * 返回给PDA装卸车任务列表父类Dto
 * @author dp-duyi
 * @date 2013-1-24 上午10:00:47
 */
public class PDAGoodsDetailDto implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7025267658442874812L;
