 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/module/transfer/load/api/shared/domain/SealDestDetailEntity.java
 *  
 *  FILE NAME          :SealDestDetailEntity.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 * @date 2012-10-22 下午2:19:59
 */
public class SealDestDetailEntity extends BaseEntity implements Serializable {
	
	private static final long serialVersionUID = -1143232678695014588L;
