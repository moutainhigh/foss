 ...
 *  DESCRIPTION   : 落地配外发管理
 *  
 *  FILE PATH     :src/main/java/com/deppon/foss/module/transfer/partialline/api/shared/dto/LdpExternalBillDto.java
 * 
 *  FILE NAME     :LdpExternalBillDto.java
 *  
 *  AUTHOR        : FOSS中转开发组
 *  
 *  TIME          : 
...
import com.deppon.foss.module.transfer.partialline.api.shared.domain.LdpExternalBillEntity;
