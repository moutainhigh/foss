 ...
 *  DESCRIPTION   : 落地配外发管理
 *  
 *  FILE PATH     :src/main/java/com/deppon/foss/module/transfer/partialline/api/shared/dto/LdpExternalBillWayBillInfoDto.java
 * 
 *  FILE NAME     :LdpExternalBillWayBillInfoDto.java
 *  
 *  AUTHOR        : FOSS中转开发组
 *  
 *  TIME          : 
 ...
 */
public class LdpExternalBillWayBillInfoDto implements java.io.Serializable {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -9129577159797204231L;
	// 运单信息
	/**
	 * 运单号WAYBILL_NO
	 */
	...
	/**
	 * 获取 收货日期//开单时间BILL_TIME.
	 * 
	 * @return the 收货日期//开单时间BILL_TIME
	 */
	...
	/**
	 * 设置 收货日期//开单时间BILL_TIME.
	 * 
	 * @param billTime
	 *            the new 收货日期//开单时间BILL_TIME
	 */
