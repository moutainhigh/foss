 ...
 * 2014-10-10
 */
public interface IMatchTaskOrgService4dubbo extends IService {
	 ...
	 * @return
	 */
	List<Org2CrmEntity> matchTaskOrg(String waybillNo , String callMan ,  String callType);
	 ...
	 * @return
	 */
	List<Org2CrmEntity> matchTaskOrg(String waybillNo , String callType);
