 ...
 *  
 *  FILE PATH     : src/main/java/com/deppon/foss/module/transfer/load/api/shared/vo/SealDestDetailVo.java
 *  
 *  FILE NAME          :SealDestDetailVo.java
 * 
 *  AUTHOR  : FOSS中转系统开发组
 *  
 *  TIME              : 
 ...
 * @date 2012-12-25 下午6:49:24
 */
public class SealDestDetailVo extends BaseEntity implements Serializable {
	private static final long serialVersionUID = 4348934263513911559L;
    ...
    /**后门封签类型,BACK	后门, SIDE侧门**/
    private String backSealType;			//后门封签类型,BACK	后门, SIDE侧门
    /**后门操作时间**/
    ...
    /**到达封签明细-后门**/
    private SealDestDetailEntity backSeal;
    /**到达封签明细-侧门**/
    private SealDestDetailEntity sideSeal;
    
	/**
	 * 获取 到达封签明细-后门*.
	 *
	 * @return the 到达封签明细-后门*
	 */
	public SealDestDetailEntity getBackSeal() {
		return backSeal;
	}
	 ...
	 * 设置 到达封签明细-后门*.
	 *
	 * @param backSeal the new 到达封签明细-后门*
	 */
	public void setBackSeal(SealDestDetailEntity backSeal) {
	 ...
	 * 获取 到达封签明细-侧门*.
	 *
	 * @return the 到达封签明细-侧门*
	 */
	public SealDestDetailEntity getSideSeal() {
		return sideSeal;
	}
	 ...
	 * 设置 到达封签明细-侧门*.
	 *
	 * @param sideSeal the new 到达封签明细-侧门*
	 */
	public void setSideSeal(SealDestDetailEntity sideSeal) {
	...
	/**
	 * 获取 后门封签类型,BACK	后门, SIDE侧门*.
	 *
	 * @return the 后门封签类型,BACK	后门, SIDE侧门*
	 */
	...
	/**
	 * 设置 后门封签类型,BACK	后门, SIDE侧门*.
	 *
	 * @param backSealType the new 后门封签类型,BACK	后门, SIDE侧门*
	 */
	...
	/**
	 * 获取 侧门封签类型,BACK后门, SIDE侧门*.
	 *
	 * @return the 侧门封签类型,BACK后门, SIDE侧门*
	 */
	...
	/**
	 * 设置 侧门封签类型,BACK后门, SIDE侧门*.
	 *
	 * @param sideSealType the new 侧门封签类型,BACK后门, SIDE侧门*
	 */
