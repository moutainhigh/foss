 ...
 * 2014-8-20
 */
public class QueryWaybillForExpressPackageConditionDto implements Serializable {
	private static final long serialVersionUID = 42117488384535875L;
	...
	//是否存在快递 始发线路
	private boolean isExistPackageLine;
	...
	public boolean getIsExistPackageLine() {
		return isExistPackageLine;
	}
	public void setIsExistPackageLine(boolean isExistPackageLine) {
		this.isExistPackageLine = isExistPackageLine;
	}
