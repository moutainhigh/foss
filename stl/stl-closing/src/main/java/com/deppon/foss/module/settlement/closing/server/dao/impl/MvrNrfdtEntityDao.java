 ...
 */
public class MvrNrfdtEntityDao extends iBatis3DaoImpl implements IMvrNrfdtEntityDao {

	/** The Constant NAMESPACES. */
	private static final String NAMESPACES = "foss.stv.MvrNrfdtEntityDao.";// 命名空间路径
	...
	@Override
	public List<MvrNrfdtEntity> selectByConditions(MvrNrfdtDto dto, int start, int limit) {
