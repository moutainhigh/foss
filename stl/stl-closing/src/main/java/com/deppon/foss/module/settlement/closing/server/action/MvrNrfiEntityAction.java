 ...
 */
public class MvrNrfiEntityAction extends AbstractAction {

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LogManager
			.getLogger(MvrNrfiEntityAction.class);

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** 始发专线往来月报表Service. */
	private IMvrNrfiEntityService mvrNrfiEntityService;
	...
	public String query() {
		...
		try {
			...
			// 查询始发专线往来月报表合计
			MvrNrfiEntity total = mvrNrfiEntityService
					.selectTotalByConditions(mvrNrfiDto);

			// 总条数>0时查询
			if (null != total && total.getCount() > 0) {
				// 查询始发专线往来月报表
				List<MvrNrfiEntity> resultList = mvrNrfiEntityService
			...
			// 查询始发专线往来月报表异常
			LOGGER.error("查询始发专线往来月报表异常：" + e.getErrorCode(), e);
	...
	public String export() {
		...
		try {
			...
			List<MvrNrfiEntity> result = this.mvrNrfiEntityService
			...
			// 导出文件名称：
			try {
				String exportExeclName = "始发专线往来月报表" + mvrNrfiDto.getPeriod();
			...
			// 记录日志
			LOGGER.error("始发专线往来月报表导出异常：" + e.getErrorCode(), e);
			// 异常返回
			return returnError("始发专线往来月报表导出异常：" + e.getErrorCode());
			// 异常处理
		} catch (Exception e) {
			// 记录日志
			LOGGER.error("始发专线往来月报表导出异常：" + e.getMessage(), e);
			// 异常返回
			return returnError("始发专线往来月报表导出异常：" + e.getMessage());
			// 异常处理
		}
	}
	...
	private ExportResource exportNRfiResource(List<MvrNrfiEntity> list) {
		...
		HeaderRows rowContent2 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.SIX, SettlementReportNumber.SEVEN, "开单运单【01】"); // 2
		HeaderRows rowContent3 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.EIGHT, SettlementReportNumber.ELEVEN,"还款运单总运费（月结临时欠款网上支付）【01】"); // 4
		HeaderRows rowContent4 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.TWELVE, SettlementReportNumber.FIFTEEN, "还款运单总运费（到付）【01】"); // 4
		HeaderRows rowContent5 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.SIXTEEN, SettlementReportNumber.NINETEEN, "还款运单总运费（到付）【02】"); // 4
		HeaderRows rowContent6 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ZERO, SettlementReportNumber.TWENTY, SettlementReportNumber.THIRTY_FIVE, "理赔"); // 16
		HeaderRows rowContent6_1 = new HeaderRows(SettlementReportNumber.ONE, SettlementReportNumber.ONE, SettlementReportNumber.TWENTY, SettlementReportNumber.TWENTY_FOUR, "出发部门申请"); // 5
		HeaderRows rowContent6_2 = new HeaderRows(SettlementReportNumber.ONE, SettlementReportNumber.ONE, SettlementReportNumber.TWENTY_FIVE, SettlementReportNumber.THIRTY_FIVE, "到达部门申请"); // 11
		HeaderRows rowContent7 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.THIRTY_SIX, SettlementReportNumber.FIFTY, "预收客户"); // 15
		HeaderRows rowContent8 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.FIFTY_ONE, SettlementReportNumber.FIFTY_EIGHT, "小票"); // 8
		HeaderRows rowContent9 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.FIFTY_NINE, SettlementReportNumber.SEVENTY, "代收货款"); // 12
		HeaderRows rowContent10 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ZERO, SettlementReportNumber.SEVENTY_ONE, SettlementReportNumber.EIGHTY_SIX, "退运费"); // 16
		HeaderRows rowContent10_1 = new HeaderRows(SettlementReportNumber.ONE, SettlementReportNumber.ONE, SettlementReportNumber.SEVENTY_ONE, SettlementReportNumber.SEVENTY_FIVE, "出发部门申请"); // 5
		HeaderRows rowContent10_2 = new HeaderRows(SettlementReportNumber.ONE, SettlementReportNumber.ONE, SettlementReportNumber.SEVENTY_SIX, SettlementReportNumber.EIGHTY_SIX, "到达部门申请"); // 11
		HeaderRows rowContent11 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.EIGHTY_SEVEN, SettlementReportNumber.EIGHTY_SEVEN, "装卸费"); // 1
		HeaderRows rowContent12 = new HeaderRows(SettlementReportNumber.ZERO, SettlementReportNumber.ONE, SettlementReportNumber.EIGHTY_EIGHT, SettlementReportNumber.EIGHTY_NINE, "服务补救"); // 2
	...
	private String[] getExcelHeads() {
		return new String[] { "期间", "发票标记", "产品类型", "部门类型", "部门编码", "部门名称",
				"开单现金", "开单银行卡", "还款现金未签收", "还款银行未签收", "还款现金已签收", "还款银行已签收",
				"还款现金未签收", "还款银行未签收", "还款现金已签收", "还款银行已签收", "还款现金未签收",
				"还款银行未签收", "还款现金已签收", "还款银行已签收", "出发部门申请-01理赔冲02始发应收已签收",
				"出发部门申请-02理赔冲01始发应收已签收", "出发部门申请-01理赔冲02始发应收未签收",
				"出发部门申请-02理赔冲01始发应收未签收", "出发部门申请-01理赔付款申请", "到达部门申请-01理赔冲收入",
				"到达部门申请-02理赔冲收入", "到达部门申请-01理赔付款申请", "到达部门申请-01理赔冲01到达应收已签收",
				...
				"02预收客户冲01小票应收", "还款代收货款现金未签收", "还款代收货款银行未签收",
				"应付代收货款冲01应收到付运费已签收", "应付代收货款冲01应收到付运费未签收",
				"应付代收货款冲01应收始发运费已签收", "应付代收货款冲01应收始发运费未签收",
				"应付代收货款冲02应收到付运费已签收", "应付代收货款冲02应收到付运费未签收",
				"应付代收货款冲02应收始发运费已签收", "应付代收货款冲02应收始发运费未签收", "应付代收货款冲01小票应收",
				"应付代收货款冲02小票应收", "出发部门申请-01退运费付款申请", "出发部门申请-01退运费冲02始发应收已签收",
	...
	private List<List<String>> exportMvrNrfi(List<MvrNrfiEntity> list) {
		...
		String[] columns = { "period", "invoiceMark", "productCode", "orgType",
				"orgCode", "orgName", "deoCh", "deoCd", "uroOrigChNpod",
				"uroOrigCdNpod", "uroOrigChPod", "uroOrigCdPod",
				"uroDestChNpod", "uroDestCdNpod", "uroDestChPod",
				"uroDestCdPod", "urtDestChNpod", "urtDestCdNpod",
				"urtDestChPod", "urtDestCdPod", "claimOrigoWoOrigRcvtPod",
				"claimOrigtOrigRcvoPod", "claimOrigoWoOrigRcvtNpod",
				"claimOrigtWoOrigRcvoNpod", "claimOrigoPayApply",
				"claimDestoIncome", "claimDesttIncome", "claimDestoPayApply",
				...
				"codUrChNpod", "codUrCdNpod", "codPayWoDestRcvoPod",
				"codPayWoDestRcvoNpod", "codPayWoOrigRcvoPod",
				"codPayWoOrigRcvoNpod", "codPayWoDestRcvtPod",
				"codPayWoDestRcvtNpod", "codPayWoOrigRcvtPod",
				"codPayWoOrigRcvtNpod", "codPayWoOthRcvo", "codPayWoOthRcvt",
	...
	public void setMvrNrfiEntityService(
			IMvrNrfiEntityService mvrNrfiEntityService) {
		this.mvrNrfiEntityService = mvrNrfiEntityService;
	}
}
