 ...
 * @version
 */
public class BillLandPayableAgencyDao extends iBatis3DaoImpl implements IBillLandPayableAgencyDao {
	...
	public List<BillPayableEntity> queryBillPayableEntityParams(
		...
		if((billPayableAgencyDto != null) && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryLandBillPayableEntityParams", billPayableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillPayableEntity> queryBillPayableEntityParams(
		...
		if(billPayableAgencyDto != null && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryLandBillPayableEntityParams", billPayableAgencyDto);
		}
		return null;
	}
	...
	public Long queryBillPayableEntityParamsCount(BillPayableAgencyDto billPayableDto){
		if(billPayableDto != null){
			return (Long) this.getSqlSession().selectOne(NAMESPACE + "queryLandBillPayableEntityParamsCount" , billPayableDto);
		}
		return null;
	}
	...
	public List<BillPayableEntity> queryByPayableNOs(
		...
		if (CollectionUtils.isNotEmpty(billPayableAgencyDto.getPayableNos()) ||
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryLandByPayableNOs", billPayableAgencyDto,rowBounds);
		}
		return null;
	}
    ...
    public Long queryByPayableNOsCount(
    	...
    	if(billPayableDto != null){
			return (Long) this.getSqlSession().selectOne(NAMESPACE + "queryLandByPayableNOsCount" , billPayableDto);
		}
		return null;
    }
	...
	public List<BillPayableEntity> queryBySourceBillNOs(
		...
		if (billPayableAgencyDto != null && (
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryLandBySourceBillNOs", billPayableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillPayableEntity> queryBySourceBillNOs(
			BillPayableAgencyDto billPayableAgencyDto){
		return this.getSqlSession().selectList(NAMESPACE + "queryLandBySourceBillNOs", billPayableAgencyDto);
	}
    ...
    public Long queryBySourceBillNOsCount(BillPayableAgencyDto billPayableDto){
    	if(billPayableDto != null){
			return (Long) this.getSqlSession().selectOne(NAMESPACE + "queryLandBySourceBillNOsCount" , billPayableDto);
		}
		return null;
    }
}
