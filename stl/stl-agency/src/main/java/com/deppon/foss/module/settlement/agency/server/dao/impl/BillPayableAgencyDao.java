 ...
 * @version
 */
public class BillPayableAgencyDao extends iBatis3DaoImpl implements IBillPayableAgencyDao {
	...
	public List<BillPayableEntity> queryBillPayableEntityParams(
		...
		if((billPayableAgencyDto != null) && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryBillPayableEntityParams", billPayableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillPayableEntity> queryBillPayableEntityParams(
		...
		if(billPayableAgencyDto != null && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryBillPayableEntityParams", billPayableAgencyDto);
		}
		return null;
	}
	...
	public Long queryBillPayableEntityParamsCount(BillPayableAgencyDto billPayableDto){
		if(billPayableDto != null){
			return (Long) this.getSqlSession().selectOne(NAMESPACE + "queryBillPayableEntityParamsCount" , billPayableDto);
		}
		return null;
	}
	...
	public List<BillPayableEntity> queryByPayableNOs(
		...
		if (CollectionUtils.isNotEmpty(billPayableAgencyDto.getPayableNos()) ||
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryByPayableNOs", billPayableAgencyDto,rowBounds);
		}
		return null;
	}
    ...
    public Long queryByPayableNOsCount(
    	...
    	if(billPayableDto != null){
			return (Long) this.getSqlSession().selectOne(NAMESPACE + "queryByPayableNOsCount" , billPayableDto);
		}
		return null;
    }
	...
	public List<BillPayableEntity> queryBySourceBillNOs(
		...
		if (billPayableAgencyDto != null && (
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryBySourceBillNOs", billPayableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillPayableEntity> queryBySourceBillNOs(
			BillPayableAgencyDto billPayableAgencyDto){
		return this.getSqlSession().selectList(NAMESPACE + "queryBySourceBillNOs", billPayableAgencyDto);
	}
    ...
    public Long queryBySourceBillNOsCount(BillPayableAgencyDto billPayableDto){
    	if(billPayableDto != null){
			return (Long) this.getSqlSession().selectOne(NAMESPACE + "queryBySourceBillNOsCount" , billPayableDto);
		}
		return null;
    }
}
