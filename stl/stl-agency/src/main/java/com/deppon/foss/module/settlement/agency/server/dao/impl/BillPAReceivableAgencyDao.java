 ...
 * @version
 */
public class BillPAReceivableAgencyDao extends iBatis3DaoImpl implements IBillPAReceivableAgencyDao {
	...
	public List<BillReceivableEntity> queryBillReceivableEntityParams(
		...
		if (billReceivableAgencyDto != null && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryPABillReceivableEntityParams", billReceivableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillReceivableEntity> queryBillReceivableEntityParams(
		...
		if (billReceivableAgencyDto != null && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryPABillReceivableEntityParams", billReceivableAgencyDto);
		}
		return null;
	}
	...
	public Long queryBillReceivableEntityParamsCount(BillReceivableAgencyDto billReceivableDto){
		if(billReceivableDto != null){
			return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryPABillReceivableEntityParamsCount",billReceivableDto);
		}
		return null;
	}
	...
	public List<BillReceivableEntity> queryByReceivableNOs(
		...
		if (billReceivableAgencyDto != null && (
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryPAByReceivableNOs", billReceivableAgencyDto,rowBounds);
		}
		return null;
	}
    ...
    public Long queryByReceivableNOsCount(
    	...
    	if(billReceivableDto != null){
			return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryPAByReceivableNOsCount",billReceivableDto);
		}
		return null;
    }
	...
	public List<BillReceivableEntity> queryBySourceBillNOs(
		...
		if (billReceivableAgencyDto != null && (
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryPABySourceBillNOs", billReceivableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillReceivableEntity> queryBySourceBillNOs(
			BillReceivableAgencyDto billReceivableAgencyDto){
		return this.getSqlSession().selectList(NAMESPACE + "queryPABySourceBillNOs", billReceivableAgencyDto);
	}
    ...
    public Long queryBySourceBillNOsCount(BillReceivableAgencyDto billReceivableDto){
    	if(billReceivableDto != null){
			return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryPABySourceBillNOsCount",billReceivableDto);
		}
		return null;
    }
