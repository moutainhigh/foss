 ...
 * @version
 */
public class BillLandReceivableAgencyDao extends iBatis3DaoImpl implements IBillLandReceivableAgencyDao {
	...
	public List<BillReceivableEntity> queryBillReceivableEntityParams(
		...
		if (billReceivableAgencyDto != null && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryLandBillReceivableEntityParams", billReceivableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillReceivableEntity> queryBillReceivableEntityParams(
		...
		if (billReceivableAgencyDto != null && (
			...
			return this.getSqlSession().selectList(NAMESPACE + "queryLandBillReceivableEntityParams", billReceivableAgencyDto);
		}
		return null;
	}
	...
	public Long queryBillReceivableEntityParamsCount(BillReceivableAgencyDto billReceivableDto){
		if(billReceivableDto != null){
			return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryLandBillReceivableEntityParamsCount",billReceivableDto);
		}
		return null;
	}
	...
	public List<BillReceivableEntity> queryByReceivableNOs(
		...
		if (billReceivableAgencyDto != null && (
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryLandByReceivableNOs", billReceivableAgencyDto,rowBounds);
		}
		return null;
	}
    ...
    public Long queryByReceivableNOsCount(
    	...
    	if(billReceivableDto != null){
			return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryLandByReceivableNOsCount",billReceivableDto);
		}
		return null;
    }
	...
	public List<BillReceivableEntity> queryBySourceBillNOs(
		...
		if (billReceivableAgencyDto != null && (
			...
			RowBounds rowBounds = new RowBounds(start,limit);
			return this.getSqlSession().selectList(NAMESPACE + "queryLandBySourceBillNOs", billReceivableAgencyDto,rowBounds);
		}
		return null;
	}
	...
	public List<BillReceivableEntity> queryBySourceBillNOs(
			BillReceivableAgencyDto billReceivableAgencyDto){
		return this.getSqlSession().selectList(NAMESPACE + "queryLandBySourceBillNOs", billReceivableAgencyDto);
	}
    ...
    public Long queryBySourceBillNOsCount(BillReceivableAgencyDto billReceivableDto){
    	if(billReceivableDto != null){
			return (Long)this.getSqlSession().selectOne(NAMESPACE + "queryLandBySourceBillNOsCount",billReceivableDto);
		}
		return null;
    }
