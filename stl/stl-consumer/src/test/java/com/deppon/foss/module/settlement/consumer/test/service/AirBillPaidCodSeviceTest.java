 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/consumer/test/service/AirBillPaidCodSeviceTest.java
 * 
 * FILE NAME        	: AirBillPaidCodSeviceTest.java
 * 
 * AUTHOR			: FOSS结算系统开发组
 * 
 ...
 * @date 2012-11-12 下午4:45:55
 */
public class AirBillPaidCodSeviceTest extends BaseTestCase {
	...
	public void testQueryByWaybill() {
		...
		List<AirBillPaidCODGridDto> queryResult = this.airBillPaidCodService
	...
	public void testQueryByAuditDate() {
		...
		// 执行审核
		this.airBillPaidCodService.makeEffectiveBillCOD(codIds,
		...
		// 签收状态
		conditionVo.setAirStatus("ALL");
		// 代收货款类别
		conditionVo.setCodType("ALL");
		// 应付组织
		conditionVo.setOrgCode("destOrgCode");

		long rows = this.airBillPaidCodService.queryTotalRowsByAuditDate(
				ConsumerTestUtil.getCurrentInfo(), conditionVo).getTotalCount();
	...
	public void testAuditAirCod() {
		...
		// 进行验证
		this.airBillPaidCodService.makeEffectiveBillCOD(ids,
				ConsumerTestUtil.getCurrentInfo());
	}
	...
	public void testAntiAuditAirCod() {
		...
		// 错误的反审核
		try {
			this.airBillPaidCodService.reverseEffectiveBillCOD(ids,
					ConsumerTestUtil.getCurrentInfo());
		} catch (Exception ex) {
