 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/bankift/ValidationWebTest.java
 * 
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/stl-bank-itf/receiveAuditStateService?wsdl";
	}
}
