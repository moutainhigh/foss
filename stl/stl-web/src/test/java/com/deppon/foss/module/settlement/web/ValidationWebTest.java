 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/web/ValidationWebTest.java
 * 
...
package com.deppon.foss.module.settlement.web;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/stl-web";
	}
}
