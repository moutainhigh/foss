 ...
 * @version
 */
public interface IBillLandPayableAgencyService extends IService{
	 ...
	 * @see
	 */
	BillPayableAgencyDto queryLandPayablePage(BillPayableAgencyDto billPayableAgencyDto,int start, int limit,CurrentInfo currentInfo);
	 ...
	 * @see
	 */
	HSSFWorkbook landPayableListExport(BillPayableAgencyDto billPayableAgencyDto,
	 ...
	 * @see
	 */
	BillPayableAgencyDto writeBackLandOtherBillPayable(List<BillPayableAgencyDto> billPayableAgencyDtos,
     ...
     * @see
     */
	BillPayableAgencyDto auditLandOtherBillPayable(List<BillPayableAgencyDto> billPayableAgencyDtos,
    		BillPayableAgencyDto billPayableAgencyDto,CurrentInfo currentInfo);
	 ...
	 * @see
	 */
    BillPayableAgencyDto reverseAuditLandOtherBillPayable(List<BillPayableAgencyDto> billPayableAgencyDtos,
    		BillPayableAgencyDto billPayableAgencyDto,CurrentInfo currentInfo);
