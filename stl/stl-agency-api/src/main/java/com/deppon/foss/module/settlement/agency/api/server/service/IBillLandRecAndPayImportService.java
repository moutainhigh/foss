 ...
 * @version
 */
public interface IBillLandRecAndPayImportService extends IService {
	 ...
	 * @return
	 * @throws Exception 
	 * @see com.deppon.foss.module.settlement.agency.api.server.service.IBillLandRecAndPayImportService#importRecAndPaylist(java.io.File, java.lang.String)
	 */
	 ...
	 * @see
	 */
	void saveLandImportPayAndRec(BillRecAndPayImportDto billRecAndPayImportDto,
