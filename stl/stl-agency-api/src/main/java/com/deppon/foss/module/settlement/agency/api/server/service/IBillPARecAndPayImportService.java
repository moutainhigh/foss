 ...
 * @version
 */
public interface IBillPARecAndPayImportService extends IService {
	 ...
	 * @return
	 * @throws Exception 
	 * @see com.deppon.foss.module.settlement.agency.api.server.service.IBillPARecAndPayImportService#importRecAndPaylist(java.io.File, java.lang.String)
	 */
	 ...
	 * @see
	 */
	void savePAImportPayAndRec(BillRecAndPayImportDto billRecAndPayImportDto,
