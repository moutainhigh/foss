 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/consumer/test/BaseTestCase.java
 * 
...
package com.deppon.foss.module.settlement.ptpitf.test;
...
@ContextConfiguration(locations = {
		...
		"classpath:com/deppon/foss/module/base/baseinfo/server/META-INF/expressCity-bean.xml",//查快递点部
		"classpath:com/deppon/foss/module/base/baseinfo/server/META-INF/expressPartSalesDept-bean.xml",//查快递点部
...
//        "classpath:com/deppon/foss/module/pickup/waybill/server/META-INF/spring.xml",
		"classpath:com/deppon/foss/module/settlement/ptpitf/test/META-INF/spring.xml" })
