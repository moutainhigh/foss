 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/financeitf/UpdateCashIncomerptSendUtilTest.java
 * 
 * FILE NAME        	: UpdateCashIncomerptSendUtilTest.java
 * 
 * AUTHOR			: FOSS结算系统开发组
 * 
...
public class UpdateCashIncomerptSendUtilTest {

	@Ignore
	public static void main(String[] args) throws Exception {
		sendUpdateCashIncomerptResult2FOSS();
	}

	private static void sendUpdateCashIncomerptResult2FOSS() throws Exception {
		String queueName = "QU_FOSS_REQUEST_COM_IN";
		String backServiceCode = "FOSS_ESB2FOSS_UPDATE_CASHINCOMERPT";
		int expPattern = 3; // 单向
...
//				"ESB_FIN_SELF2ESB_UPDATE_CASHINCOMERPT");
//		message.setText(body);
//		producer.send(message);
	}

	private static String getCODPayResultText() throws Exception {
		String path = "com/deppon/foss/module/settlement/financeitf/FOSS_UPDATE_CASHINCOMERPT_REQUEST.xml";
