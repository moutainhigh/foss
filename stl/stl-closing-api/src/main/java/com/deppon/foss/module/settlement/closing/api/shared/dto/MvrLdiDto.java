 ...
 */
public class MvrLdiDto extends MvrLdiEntity {
	...
	/** 查询结果列表. */
	private List<MvrLdiEntity> queryList;
	 ...
	 * @return queryList
	 */
	public List<MvrLdiEntity> getQueryList() {
		/*
		 *@get
		 *@ return queryList
		 */
	 ...
	 * @param queryList
	 */
	public void setQueryList(List<MvrLdiEntity> queryList) {
		/*
		 *@set
