 ...
 * @version
 */
public class CouponInfoDtoForVTS implements Serializable {
	...
	// 运单信息实体
	private CouponWaybillInfoDtoForVTS waybillInfo;
   ...
   //优惠券备注   仅供图片开单使用
	 ...
	 */
	public CouponWaybillInfoDtoForVTS getWaybillInfo() {
		return waybillInfo;
	}
	 ...
	 */
	public void setWaybillInfo(CouponWaybillInfoDtoForVTS waybillInfo) {
