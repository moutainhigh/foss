 ...
 * 收付款模块实体基体
 * 
 * @ClassName: PayCenterBaseDO
 * @author & 周禹安 | zhouyuan008@deppon.com
 * @date 2016年10月29日 下午1:29:21
 */
public  class PayCenterBaseDO implements Serializable {
	 ...
	 * 部门编码信息
	 */
	private String deptInfoDeptCode;
	
	/**
	 * 封装部门信息-部门名称
	 */
	private String deptInfoDeptName;
	
	/**
	 * 封装部门信息
	 */
	private String deptInfoDeptUnifiedCode;
	...
	public String getDeptInfoDeptCode() {
		return deptInfoDeptCode;
	}

	public void setDeptInfoDeptCode(String deptInfoDeptCode) {
		this.deptInfoDeptCode = deptInfoDeptCode;
	}

	public String getDeptInfoDeptName() {
		return deptInfoDeptName;
	}

	public void setDeptInfoDeptName(String deptInfoDeptName) {
		this.deptInfoDeptName = deptInfoDeptName;
	}

	public String getDeptInfoDeptUnifiedCode() {
		return deptInfoDeptUnifiedCode;
	}

	public void setDeptInfoDeptUnifiedCode(String deptInfoDeptUnifiedCode) {
		this.deptInfoDeptUnifiedCode = deptInfoDeptUnifiedCode;
	}
