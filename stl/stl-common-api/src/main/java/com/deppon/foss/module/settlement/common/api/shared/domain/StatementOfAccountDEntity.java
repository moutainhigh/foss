...
/**
 * 对账单明细（一定期间内多组应收单、应付单、预收单、预付单的集合，用于和客户或者代理进行账款核对与结算）
 * 
 * @author 045738-foss-maojianqiang
 * @date 2012-10-16 上午10:04:00
 */
public class StatementOfAccountDEntity extends BaseEntity {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -617527523506761020L;
