...
public class BillReceivableEntity extends BaseEntity {
    ...
    */
	...
	public String getSettleCustCode() {
		return settleCustCode;
	}

	public void setSettleCustCode(String settleCustCode) {
		this.settleCustCode = settleCustCode;
	}

	public String getSettleCustName() {
		return settleCustName;
	}

	public void setSettleCustName(String settleCustName) {
		this.settleCustName = settleCustName;
	}
