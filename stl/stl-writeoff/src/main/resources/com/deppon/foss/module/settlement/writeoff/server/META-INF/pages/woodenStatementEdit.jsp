...
<ext:module subModule="woodenStatementEdit" groups="woodenStatementEdit"/>
...
<script type="text/javascript">
	...
	//单据类型
	writeoff.STATEMENT_OF_ACCOUNT__BILL_TYPE__YF_WOODEN_ACCOUNT = '<s:property value="@com.deppon.foss.module.settlement.common.api.shared.define.SettlementDictionaryConstants@STATEMENT_OF_ACCOUNT__BILL_TYPE__YF_WOODEN_ACCOUNT"/>';
	writeoff.STATEMENT_OF_ACCOUNT__BILL_TYPE__YS_WOODEN_ACCOUNT = '<s:property value="@com.deppon.foss.module.settlement.common.api.shared.define.SettlementDictionaryConstants@STATEMENT_OF_ACCOUNT__BILL_TYPE__YS_WOODEN_ACCOUNT"/>';
	//外部对公账号、外部对私账户
	...
	writeoff.FIN_ACCOUNT_TYPE_DPSON = '<s:property value="@com.deppon.foss.module.base.dict.api.shared.define.DictionaryValueConstants@FIN_ACCOUNT_TYPE_DPSON"/>';
	//来源单据编号 对账单
