...
public class CustomersNotReconciledDao extends iBatis3DaoImpl implements ICustomersNotReconciledDao {
	private static final String NAMESPACE = "foss.stl.CustomersNotReconciledDao.";
	@SuppressWarnings("unchecked")
	@Override
	public List<CustomersNotReconciledEntity> queryCustomersNotReconciled(CustomersNotReconciledDto dto) {
		List<CustomersNotReconciledEntity> list = getSqlSession().selectList(NAMESPACE + "queryCustomersNotReconciled", dto);
		return list;
	}
}
