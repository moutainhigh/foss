CREATE OR REPLACE PACKAGE PKG_STL_VCH_DAILY_LAND_APT IS
...
END PKG_STL_VCH_DAILY_LAND_APT;
/
CREATE OR REPLACE PACKAGE BODY PKG_STL_VCH_DAILY_LAND_APT IS
