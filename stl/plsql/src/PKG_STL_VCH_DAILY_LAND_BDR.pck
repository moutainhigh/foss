CREATE OR REPLACE PACKAGE PKG_STL_VCH_DAILY_LAND_BDR IS
...
END PKG_STL_VCH_DAILY_LAND_BDR;
/
CREATE OR REPLACE PACKAGE BODY PKG_STL_VCH_DAILY_LAND_BDR IS
  ...
  BEGIN
   ...
   INSERT INTO STV.T_STL_DVD
      ...
      SELECT SYS_GUID(), --ID
             P_PERIOD, --期间
             PKG_STL_VCH_COMMON.LAND_BDR_WO_OTH_RCV, --业务场景
       ...
       WHERE WO.WRITEOFF_TYPE = PKG_STL_COMMON.WRITEOFF_WRITEOFF_TYPE_BR --坏账冲应收
             ...
             AND RCV.BILL_TYPE = PKG_STL_COMMON.RECEIVABLE_BILL_TYPE_LR --空运其他应收
             AND WO.AMOUNT<>0
