CREATE OR REPLACE PACKAGE PKG_STL_VCH_DAILY_UR_DEST IS
...
END PKG_STL_VCH_DAILY_UR_DEST;
/
CREATE OR REPLACE PACKAGE BODY PKG_STL_VCH_DAILY_UR_DEST IS
	...
	BEGIN
		...
		INSERT INTO STV.T_STL_DVD
			...
			SELECT SYS_GUID(), --ID
						 P_PERIOD, --期间
						 PKG_STL_VCH_COMMON.UR_DEST_CH_NPOD, --业务场景
		...
		INSERT INTO STV.T_STL_DVD
			...
			SELECT SYS_GUID(), --ID
						 P_PERIOD, --期间
						 PKG_STL_VCH_COMMON.UR_DEST_CD_NPOD, --业务场景
						 RCV.CUSTOMER_CODE, --客户编码
						 RCV.CUSTOMER_NAME, --客户名称
						 RCV.CUSTOMER_TYPE, --客户类型
						 DECODE(RCV.PRODUCT_CODE,
		...
		INSERT INTO STV.T_STL_DVD
			...
			SELECT SYS_GUID(), --ID
						 P_PERIOD, --期间
						 PKG_STL_VCH_COMMON.UR_DEST_CH_POD, --业务场景
						 RCV.CUSTOMER_CODE, --客户编码
						 RCV.CUSTOMER_NAME, --客户名称
						 RCV.CUSTOMER_TYPE, --客户类型
						 DECODE(RCV.PRODUCT_CODE,
		...
		INSERT INTO STV.T_STL_DVD
			...
			SELECT SYS_GUID(), --ID
						 P_PERIOD, --期间
						 PKG_STL_VCH_COMMON.UR_DEST_CD_POD, --业务场景
						 RCV.CUSTOMER_CODE, --客户编码
						 RCV.CUSTOMER_NAME, --客户名称
						 RCV.CUSTOMER_TYPE, --客户类型
						 DECODE(RCV.PRODUCT_CODE,
