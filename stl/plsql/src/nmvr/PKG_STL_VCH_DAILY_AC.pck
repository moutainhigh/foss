...
CREATE OR REPLACE PACKAGE BODY PKG_STL_VCH_DAILY_AC IS
	...
	BEGIN
		...
		--1)01弃货、违禁品、全票丢货——开单为月结临时欠款网上支付未核销
		DECLARE
		...
		--2)01弃货、违禁品、全票丢货——开单为月结临时欠款网上支付已核销
		DECLARE
		...
		--4)02弃货、违禁品、全票丢货——开单为月结临时欠款网上支付未核销
		DECLARE
		...
		--5)02弃货、违禁品、全票丢货——开单为月结临时欠款网上支付已核销
		DECLARE
