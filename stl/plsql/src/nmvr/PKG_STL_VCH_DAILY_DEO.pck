CREATE OR REPLACE PACKAGE PKG_STL_VCH_DAILY_DEO IS
...
END PKG_STL_VCH_DAILY_DEO;
/
CREATE OR REPLACE PACKAGE BODY PKG_STL_VCH_DAILY_DEO IS
	...
	BEGIN
		...
		INSERT INTO STV.T_STL_NDVD
			...
			SELECT SYS_GUID(), --ID
						 P_PERIOD, --期间
						 PKG_STL_VCH_COMMON.DEO_CH, --业务场景
   ...
   --3)开单银行卡
		INSERT INTO STV.T_STL_NDVD
			...
			SELECT SYS_GUID(), --ID
						 P_PERIOD, --期间
						 PKG_STL_VCH_COMMON.DEO_CD, --业务场景
						 CASH.CUSTOMER_CODE, --客户编码
						 CASH.CUSTOMER_NAME, --客户名称
						 CASH.CUSTOMER_TYPE, --客户类型
						 DECODE(CASH.PRODUCT_CODE,
