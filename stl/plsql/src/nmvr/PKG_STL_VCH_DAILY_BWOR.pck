CREATE OR REPLACE PACKAGE PKG_STL_VCH_DAILY_BWOR IS
...
END PKG_STL_VCH_DAILY_BWOR;
/
CREATE OR REPLACE PACKAGE BODY PKG_STL_VCH_DAILY_BWOR IS
		...
		INSERT INTO STV.T_STL_NDVD
			...
			SELECT SYS_GUID(), --ID
			 ...
			 WHERE WO.WRITEOFF_TYPE = PKG_STL_COMMON.WRITEOFF_WRITEOFF_TYPE_BR --坏账冲应收
						 AND ACC.BILL_TYPE IN
						 (PKG_STL_COMMON.BAD_ACCOUNT_BILL_TYPE_BADDEDTS,
									PKG_STL_COMMON.BAD_ACCOUNT_BILL_TYPE_INCOME) --坏账损失、保险理赔
