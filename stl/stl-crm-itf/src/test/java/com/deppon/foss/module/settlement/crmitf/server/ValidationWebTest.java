 ...
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/crmitf/server/ValidationWebTest.java
 * 
...
package com.deppon.foss.module.settlement.crmitf.server;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/stl-crm-itf/stlCustomerService?wsdl";
	}
}
