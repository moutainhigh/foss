...
<ext:module subModule="ofvpaymentRpt" groups="ofvpaymentRpt"/>
<script type="text/javascript">
</script>
<script type="text/javascript" src="${scripts}/../print/print.js"></script>
<%-- <script type="text/javascript" src="${scripts}/queryOutFindVehiclePaymentReport.js"> --%>
</script>
</head>
<body>
	<div id="mainAreaPanel">
		<div id="T_pay-outfindvehiclepaymentReport-body"></div>
	</div>
</body>
</html>