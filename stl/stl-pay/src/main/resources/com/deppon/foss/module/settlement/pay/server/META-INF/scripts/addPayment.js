...
<%--  <script type="text/javascript" src="${scripts}/addPayment.js">
</script>   --%>
 <script type="text/javascript" >
...
// 		Ext.Msg.alert('<ext:i18nForJsp key="foss.stl.pay.common.alert"/>','<ext:i18nForJsp key="foss.stl.pay.addPayment.customerCodeIsNullWarning"/>');
// 		return false;
// 	}
// 	//客户名称不能为空
// 	if(Ext.isEmpty(customerName)){
// 		Ext.Msg.alert('<ext:i18nForJsp key="foss.stl.pay.common.alert"/>','<ext:i18nForJsp key="foss.stl.pay.addPayment.customerNameIsNullWarning"/>');
// 		return false;
// 	}
 ...
 Ext.define('Foss.payment.AddFormPanel',{
 	...
 	items:[{
		...
		accountTypes:pay.FIN_ACCOUNT_TYPE_PUBLIC+","+pay.FIN_ACCOUNT_TYPE_PRIVATE,
