...
<ext:module subModule="queryPdaPayInReport" groups="queryPdaPayInReport"/>
<%-- <script type="text/javascript" src="${scripts}/../print/print.js"></script>
<script type="text/javascript" src="${scripts}/pdaPayInQuery.js"> </script>--%>
</head>
<body>
	<div id="mainAreaPanel">
		<div id="T_pay-queryPdaPayInReport-body"></div>
	</div>
</body>
</html>