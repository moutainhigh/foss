 ...
 * 
 * PROJECT NAME	: stl-job
 * 
 * FILE PATH        	: src/test/java/com/deppon/foss/module/settlement/ValidationWebTest.java
 * 
...
package com.deppon.foss.module.settlement;
...
public class ValidationWebTest extends AbstractValidationWebTest {
	...
	protected String getValidationUrl() {
		return "http://localhost:8280/stl-job";
	}
}
