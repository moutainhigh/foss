...
public abstract class FossTTLCache<V> extends DefaultTTLRedisCache<V> {
     ...
     * 登录验证码缓存
     */
	public static final String BSE_LOGIN_VALIDATOR ="CacheLoginValidator";
	 ...
	 * 精准电商到达价格区域缓存 UUID
	 */
	public static final String PKP_PRICE_REGION_ECGOODS_ARRIVE_UUID = "CachePriceEcGoodsRegionArrive";
	/**
	 * 精准电商到达区域与组织关系缓存 UUID
	 */
	public static final String PKP_PRICE_ECGOODS_REGION_ORG_ARRIVE_UUID = "CachePriceRegionEcGoodsOrgArrive";
	...
	public static final String BSE_FULL_FREIGHT_ROUTE = "BseFullFreightRoute";

	/**
	 * 精准电商价格区域缓存 UUID
	 */
	public static final String PKP_PRICE_REGION_EC_UUID = "CachePriceEcRegion";

	/**
	 * 精准电商价格区域与组织关系缓存 UUID
	 */
	public static final String PKP_PRICE_REGION_EC_ORG_UUID = "CachePriceRegionbEcOrg";
